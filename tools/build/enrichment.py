...
def _mitre_by_tactic(technique_ids):
    ...
    tech_path = os.path.join(PROJECT_ROOT, "mitre_techniques.json")
    tech_db = {}
...
def validate_non_technical(data):
    ...
    nt_path = os.path.join(PROJECT_ROOT, "non-technical-view.js")
...
def validate_docs_uc_map(data):
    ...
    map_path = os.path.join(PROJECT_ROOT, "docs-uc-map.js")

...
| `dist/uc/UC-X.Y.Z/uc.md` | Generated by `tools/build/templates/uc.py::render_markdown_twin`; published via Pages as the LLM-friendly markdown twin. Replaces the deleted in-tree `content/cat-*/UC-*.md` companions (F21 close, 2026-05-18). |

...
| Prometheus<sup class="ref">[<a href="#ref-1">1</a>]</sup> | `dist/observability/catalogue.prom` | Text exposition of the same rollups for scrape-friendly monitoring |
...
<a id="ref-1"></a>**[1]** Prometheus Authors. (2026). *Prometheus Documentation*. Cloud Native Computing Foundation. Retrieved May 11, 2026, from https://prometheus.io/docs/introduction/overview/

<details>
<summary>Additional online sources cited in the document body (1)</summary>

<a id="ref-2"></a>**[2]** prometheus.io. *Prometheus text exposition format*. Retrieved May 11, 2026, from https://prometheus.io/docs/instrumenting/exposition_formats/

...
Lane D (2026-05-19) adds a [SARIF 2.1.0](https://docs.oasis-open.org/sarif/sarif/v2.1.0/) export path so Splunk operators can ingest catalogue quality findings into GitHub Code Scanning, Azure DevOps, GitLab, or Splunk SOAR without bespoke parsers.

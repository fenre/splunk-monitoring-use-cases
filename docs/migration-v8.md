...
The unified app now ships every tier-1 compliance saved search (CMMC, DORA,
GDPR, HIPAA, ISO 27001, NIS2, NIST 800-53, NIST CSF, PCI DSS, SOC 2,
SOX ITGC, UK GDPR) **disabled by default** plus the `uc_compliance_mappings`

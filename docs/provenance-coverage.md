...
_Generated 2026-04-17T08:13:05Z — 6,304 use cases audited._
...
| Origin | UCs |
| ------ | --- |
| Splunk official (`splunk-official`) | 4,532 (71.9%) |
| Vendor official (`vendor-official`) | 572 (9.1%) |
| MITRE ATT&CK (`mitre-attack`) | 300 (4.8%) |
| Standards (`nist-compliance`) | 93 (1.5%) |
| Threat intel (`threat-intel`) | 469 (7.4%) |
| Splunk blog (`splunk-blog`) | 47 (0.7%) |
| Community (`community`) | 142 (2.3%) |
| Other (`unclassified`) | 149 (2.4%) |
...
| Cat 22 | 1,167 | 1,167 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |

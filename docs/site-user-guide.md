...
- **Premium apps** — UCs that depend on Splunk Enterprise Security<sup class="ref">[<a href="#ref-5">5</a>]</sup>, ITSI, SOAR, etc.
- **CIM model** — pick from the [CIM models inventory](cim-models-inventory.md).
- **App / TA** — Splunkbase<sup class="ref">[<a href="#ref-7">7</a>]</sup> ID list. UCs that match any selected TA.
...
- **MITRE ATT&CK<sup class="ref">[<a href="#ref-1">1</a>]</sup> Coverage Map** — visual tactic × technique grid with click-to-filter.

...
| 8 | **`data/equipment-app-map.json` + `/api/v1/equipment/app-index.json`** | [`docs/equipment-app-map.md`](equipment-app-map.md), [`schemas/equipment-app-map.schema.json`](../schemas/equipment-app-map.schema.json) | ➕ Additive-only within v1 | Equipment picker phases — expanding slug coverage, adding Splunkbase<sup class="ref">[<a href="#ref-4">4</a>]</sup>/DSA refs | Removing a slug entry, narrowing `apps[]` without deprecation | Additive slug/app entries ship freely; removals follow the `/api/v1/` deprecation policy. Gated by `audit-equipment-app-map --check`. |
...
<a id="ref-3"></a>**[3]** Splunk Inc. (2026). *Splunk Developer Documentation*. Splunk LLC, a Cisco company. Retrieved May 11, 2026, from https://dev.splunk.com/

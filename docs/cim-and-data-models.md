...
Use cases in this repo often reference **Splunk Common Information Model<sup class="ref">[<a href="#ref-1">1</a>]</sup> (CIM)** and **Data Model Acceleration (DMA)**. Some newer content may also align with **OCSF** (Open Cybersecurity Schema Framework). This page explains what they are and how they fit the use cases.
...
* [`docs/mitre-attack-mapping.md`](mitre-attack-mapping.md) — how
  CIM-normalised data feeds the MITRE ATT&CK<sup class="ref">[<a href="#ref-2">2</a>]</sup> technique mappings used
...
<a id="ref-8"></a>**[8]** docs.splunk.com. *CIM Data Models list*. Retrieved May 11, 2026, from https://docs.splunk.com/Documentation/CIM/latest/User/ListOfDataModels

<a id="ref-9"></a>**[9]** docs.splunk.com. *Configure TAs for CIM*. Retrieved May 11, 2026, from https://docs.splunk.com/Documentation/CIM/latest/User/ConfigureTAs

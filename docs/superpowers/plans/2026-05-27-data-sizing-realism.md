...
2. Splunkbase<sup class="ref">[<a href="#ref-8">8</a>]</sup> TA: `https://splunkbase.splunk.com/app/491` (Splunk_TA_paloalto — default `props.conf` for per-sourcetype rates)
3. Splunk Lantern<sup class="ref">[<a href="#ref-7">7</a>]</sup>: Firewall sizing — `https://lantern.splunk.com/Splunk_Platform/Use_Cases/Architectures/Splunk_Validated_Architectures`
...
Citation targets: AWS CloudTrail<sup class="ref">[<a href="#ref-1">1</a>]</sup> pricing & sizing (vendor-sizing) + Azure Monitor<sup class="ref">[<a href="#ref-3">3</a>]</sup> Activity logs (vendor-sizing) + GCP Cloud Audit Logs (vendor-sizing). Cross-cloud average — note in citation.
...
Citation targets: OPC UA spec (rfc) + Unified Automation OPC UA Server perf (vendor-blog) + Splunk Edge Hub<sup class="ref">[<a href="#ref-6">6</a>]</sup> OPC UA add-on (splunkbase-ta).
...
<a id="ref-5"></a>**[5]** Microsoft Corporation. (2026). *Windows Server Documentation*. Retrieved May 11, 2026, from https://learn.microsoft.com/en-us/windows-server/

<a id="ref-6"></a>**[6]** Splunk Inc. (2026). *Splunk Edge Hub Documentation*. Splunk LLC, a Cisco company. Retrieved May 11, 2026, from https://docs.splunk.com/Documentation/EdgeHub

<a id="ref-7"></a>**[7]** Splunk Inc. (2026). *Splunk Lantern — customer success knowledge base*. Splunk LLC, a Cisco company. Retrieved May 11, 2026, from https://lantern.splunk.com/

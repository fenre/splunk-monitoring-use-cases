...
- The tool's per-source ingest numbers for the **25 Tier-1+Tier-2 calibrated
  ...
  Splunkbase<sup class="ref">[<a href="#ref-8">8</a>]</sup> TA defaults / Splunk Lantern<sup class="ref">[<a href="#ref-7">7</a>]</sup> guidance they cite. Drift outside
...
| 9 | `dsa_it_cloud_iaas` | Cloud IaaS (AWS CloudTrail<sup class="ref">[<a href="#ref-1">1</a>]</sup> + Azure Activity + GCP Audit) | IT Systems & Hardware | three vendor sizing PDFs (cross-cloud average) |
...
| 12 | `it_windows` | Windows Server<sup class="ref">[<a href="#ref-4">4</a>]</sup> (Security / System logs) | IT Systems & Hardware | Splunkbase Windows TA + Lantern |
...
<a id="ref-3"></a>**[3]** Microsoft Corporation. (2026). *Microsoft Entra ID Documentation*. Retrieved May 11, 2026, from https://learn.microsoft.com/en-us/entra/identity/

<a id="ref-4"></a>**[4]** Microsoft Corporation. (2026). *Windows Server Documentation*. Retrieved May 11, 2026, from https://learn.microsoft.com/en-us/windows-server/

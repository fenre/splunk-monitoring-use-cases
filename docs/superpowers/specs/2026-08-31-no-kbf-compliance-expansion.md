...
2. Add `obligationModel` pointing to source map, coverage matrix, and methodology doc (NIS2<sup class="ref">[<a href="#ref-1">1</a>]</sup> pattern).
...
<a id="ref-3"></a>**[3]** lovdata.no. *Lovdata SF/forskrift/2012-12-07-1157*. Retrieved May 11, 2026, from https://lovdata.no/dokument/SF/forskrift/2012-12-07-1157

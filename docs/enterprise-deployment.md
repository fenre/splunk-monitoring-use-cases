...
4. **`DA-ESS-monitoring-use-cases`** — Enterprise Security content pack
   with correlation searches, MITRE ATT&CK<sup class="ref">[<a href="#ref-3">3</a>]</sup> governance and analytic
   stories.
...
|-----------|---------|--------|-------|
| Splunk Enterprise / Cloud | 9.0.0 | 10.2.x | Splunk Cloud customers must use the Splunkbase<sup class="ref">[<a href="#ref-8">8</a>]</sup> "vetted" release of the TA (see §6 for validation). |
| Splunk Common Information Model<sup class="ref">[<a href="#ref-5">5</a>]</sup> | 5.3.0 | 6.0.x | Required for every content pack. |
| Splunk IT Service Intelligence<sup class="ref">[<a href="#ref-7">7</a>]</sup> | 4.15 | 4.19 | Only required for the ITSI content pack. |
| Splunk Enterprise Security<sup class="ref">[<a href="#ref-6">6</a>]</sup> | 7.3 | 8.1 | Only required for the ES content pack. |
...
| Check | Tool | Status |
|-------|------|--------|
| Splunk AppInspect<sup class="ref">[<a href="#ref-4">4</a>]</sup> (cloud vetting) | `splunk-appinspect inspect <pack>.spl --mode precert` | Expected to pass. |
...
<a id="ref-9"></a>**[9]** github.com. *latest GitHub release*. Retrieved May 11, 2026, from https://github.com/fenre/splunk-monitoring-use-cases/releases/latest

<a id="ref-10"></a>**[10]** fenre.github.io. *fenre.github.io: Splunk Monitoring Use Cases*. Retrieved May 11, 2026, from https://fenre.github.io/splunk-monitoring-use-cases/

<a id="ref-11"></a>**[11]** github.com. *GitHub: fenre/splunk-monitoring-use-cases*. Retrieved May 11, 2026, from https://github.com/fenre/splunk-monitoring-use-cases

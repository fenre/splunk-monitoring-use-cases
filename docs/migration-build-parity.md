...
| `regulations`    | 667           | 0               | 5 + 57 globally    | Sidecar regs add real coverage (e.g. UC-1.1.108 → CJIS / Cyber Essentials<sup class="ref">[<a href="#ref-1">1</a>]</sup> / HITRUST) and normalise legacy aliases (`HIPAA` → `HIPAA Security` to match the slug in `data/regulations.json`). |
...
<a id="ref-1"></a>**[1]** National Cyber Security Centre (UK). (2025). *Cyber Essentials — Montpellier (2025)*. NCSC, IASME Consortium. https://www.ncsc.gov.uk/cyberessentials/overview

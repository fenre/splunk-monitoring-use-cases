...
> Management (cat 9.4), Cloud Identity Providers — Okta and Duo (cat
...
| PAM | CyberArk, BeyondTrust, Delinea, HashiCorp Vault | Splunk_TA_cyberark, Splunk_TA_beyondtrust, Splunk_TA_delinea, Splunk_TA_vault |
...
Run the SOX 404 access-management evidence dashboard. Export PDF for
...
§7-§8, HIPAA §164.308, NIS2 Art. 21(2)(d), DORA Art. 9, CMMC L2/L3,
...
- **Splunk Enterprise Security** — identity RBA, impossible-travel,

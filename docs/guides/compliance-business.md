---
title: Compliance & Business Analytics Domain Master Guide — Cost & Capacity Management (cat-20), Regulatory & Compliance Frameworks (cat-22), Business Analytics & Executive Intelligence (cat-23) end-to-end with Splunk Enterprise Security, Splunk SOAR, Splunk ITSI, Splunk DB Connect, OSCAL Evidence Automation, FOCUS Spec, ITIL v4 + ISO 20000, COSO ERM, Clause Navigator, Evidence Packs, Regulatory Primer
type: domain-guide
domains: [Compliance, Business Analytics, FinOps, Risk, Governance]
categories: [20, 22, 23]
product: Splunk Enterprise Security (ES) 8 + Splunk SOAR + Splunk Mission Control + Splunk IT Service Intelligence (ITSI) + Splunk DB Connect + Splunk Add-on for Microsoft Cloud Services + Splunk Add-on for ServiceNow + Splunk Add-on for Salesforce + Splunk Add-on for Workday + Splunk Add-on for SAP + Splunk Add-on for Oracle + Splunk Add-on for AWS + Splunk Add-on for Microsoft 365 + Splunk Add-on for Google Workspace + Splunk Add-on for Cisco Webex + Splunk Stream + Splunk Connect for Syslog (SC4S) + Splunk Cloud Platform + Splunk Federated Search for Amazon S3 + Splunk Edge Processor + Splunk Data Manager + Splunk Compliance Add-on for HIPAA / PCI / FFIEC / SOX + Splunk Asset & Identity Framework + Splunk RBA Risk-Based Alerting + Clause Navigator + Compliance Story + Regulatory Primer + Evidence Packs (per-framework)
product_aliases: [compliance, regulatory compliance, regulatory monitoring, compliance monitoring, GRC, governance risk compliance, governance, risk and compliance, governance risk and compliance, regulator, regulator-ready, regulator ready, regulator-grade, audit-ready, audit ready, audit-grade, audit grade, evidence pack, evidence packs, audit evidence, evidence chain, chain of custody, immutable timeline, immutable evidence, attestation, attestation engine, control attestation, control evidence, control monitoring, continuous control monitoring, CCM, key control, key risk indicator, KRI, key control indicator, KCI, OSCAL, NIST OSCAL, OSCAL component, OSCAL system security plan, SSP, OSCAL profile, OSCAL catalog, OSCAL assessment plan, OSCAL assessment results, OSCAL POAM, FedRAMP OSCAL, three lines of defense, 3LoD, three lines model, IIA three lines, COSO ERM, COSO Internal Control, COSO IC, ISACA COBIT, COBIT 2019, COBIT 5, IT4IT, Open Group IT4IT, GRC platform, ServiceNow GRC, ServiceNow IRM, integrated risk management, IRM, RSA Archer, MetricStream, OneTrust, OneTrust GRC, LogicGate, AuditBoard, Workiva Wdesk, Workiva, Hyperproof, ZenGRC, RSA Risk Cloud, Galvanize, Galvanize HighBond, Galvanize ITGC, Diligent, Diligent Boards, Diligent Compliance, Resolver, ServiceNow Vendor Risk Management, VRM, third-party risk management, TPRM, vendor risk, supplier risk, third-party assurance, SOC 2 audit, SOC 2 Type 1, SOC 2 Type II, SOC 3, ISAE 3402, ISAE 3000, SSAE 18, SSAE 21, AT-C 105, AT-C 205, AICPA, AICPA TSC, AICPA Trust Services Criteria, Trust Services Criteria, common criteria, additional criteria, security availability processing integrity confidentiality privacy, security, availability, processing integrity, confidentiality, privacy, CC6, CC7, CC8, CC9, A1, PI1, C1, P1, ISO 27001, ISO 27001 ISMS, information security management system, ISMS, Annex A, Annex A control, Annex SL, ISO 27017, ISO 27018, ISO 27017 cloud, ISO 27018 PII cloud, ISO 27701, privacy information management system, PIMS, ISO 27035, incident management, ISO 27037 digital evidence, ISO 22301, business continuity management system, BCMS, ISO 31000, risk management ISO, ISO 19011, audit guide, ISO 27002 controls, ISO 19770, ISO 19770 IT asset management, ITAM, software asset management, SAM, GDPR, General Data Protection Regulation, EU GDPR, UK GDPR, Data Protection Act 2018, DPA 2018, ePrivacy Directive, ePrivacy Regulation, Schrems II, EU-US Data Privacy Framework, EU-US DPF, DPF, transatlantic data flow, SCC, Standard Contractual Clauses, BCR, Binding Corporate Rules, DPIA, data protection impact assessment, ROPA, record of processing activities, DPO, data protection officer, controller, processor, joint controller, joint controllership, sub-processor, sub processor, data subject, data subject rights, DSR, DSAR, data subject access request, right to erasure, right to be forgotten, RTBF, right of access, right to rectification, right to restriction, right to data portability, right to object, right not to be subject to automated decision making, automated decision-making, automated decision making, profiling, special category personal data, special categories of personal data, sensitive personal data, criminal offence data, EDPB, European Data Protection Board, EDPB guidelines, ICO, Information Commissioner's Office, CNIL, AEPD, BfDI, Garante, Datatilsynet, FDPIC, Swiss Federal Data Protection and Information Commissioner, FedDPA, ICO fine, GDPR fine, NIS2, NIS Directive, EU NIS2, Network and Information Systems Directive, essential entity, important entity, NIS2 Article 21, Article 23, NIS2 Annex II, EU 2022/2555, ENISA, European Union Agency for Cybersecurity, NIS2 24-hour, NIS2 24h, NIS2 72-hour, NIS2 72h, NIS2 one month, supervisory authority, NIS2 supervisory authority, CSIRT, computer security incident response team, national CSIRT, member state, EU member state, DORA, Digital Operational Resilience Act, EU 2022/2554, ICT risk management framework, ICT-related incident, ICT third-party risk, TLPT, threat-led penetration testing, threat led penetration testing, ICT third-party service provider, critical or important function, CIF, oversight framework, lead overseer, lead overseer authority, JST, Joint Examination Team, ESA, European Supervisory Authorities, EBA, ESMA, EIOPA, Pillar 1, Pillar 2, Pillar 3, ICT-related incident classification, root cause analysis, RCA, post-incident review, EU AI Act, AI Act, EU 2024/1689, AI Act 2024/1689, prohibited AI practices, high-risk AI system, high risk AI system, foundation model, general-purpose AI, GPAI, general purpose AI, AI Office, EU AI Office, conformity assessment, model card, model evaluation, AI risk classification, AI Liability Directive, EU AI Liability Directive, ePrivacy Regulation, e-Privacy Regulation, eIDAS, eIDAS Regulation, eIDAS 2.0, EU Digital Identity Wallet, EUDI, EUDI Wallet, NIS Cooperation Group, EU CRA, Cyber Resilience Act, Product Liability Directive, PLD, EU 2024/2853, US compliance, US privacy, CCPA, California Consumer Privacy Act, CPRA, California Privacy Rights Act, CPRA 2023, California Civil Code 1798, CCPA SB 1392, CCPA AB 825, OAG California, California Office of Attorney General, OAG, CPPA, California Privacy Protection Agency, CPPA regulations, CPRA regulations, ADMT, automated decision-making technology, Texas Data Privacy and Security Act, TDPSA, Texas DPSA, Virginia VCDPA, Colorado CPA, Connecticut CTDPA, Utah UCPA, Iowa ICDPA, Indiana INCDPA, Tennessee TIPA, Montana MCDPA, Oregon OCPA, Florida FDBR, Texas TDPSA, Washington WMHA, My Health My Data, MHMDA, New Jersey NJDPA, Maryland MODPA, Minnesota MNCDPA, Nebraska NEDPA, New Hampshire NHCDPA, Rhode Island RICDPA, Maine MCDPA, Kentucky KCPA, Illinois BIPA, BIPA, biometric privacy, Genetic Information Privacy Act, GIPA, Illinois GIPA, FTC Section 5, FTC Health Breach Notification Rule, HBNR, FTC HBNR, FTC Safeguards Rule, GLBA Safeguards Rule, GLBA, Gramm-Leach-Bliley Act, FFIEC, Federal Financial Institutions Examination Council, FFIEC CAT, FFIEC Cybersecurity Assessment Tool, FFIEC IT Examination Handbook, FFIEC Authentication Guidance, FFIEC Architecture Infrastructure and Operations Booklet, AIO booklet, NCUA, OCC, OCC Heightened Standards, FDIC, FRB, FED, federal reserve, federal reserve cyber guidance, NYDFS, NYDFS 23 NYCRR 500, NYDFS Part 500, NYDFS cybersecurity regulation, NYDFS amended, second amendment NYDFS, NYDFS Class A, IRS Pub 1075, IRS Publication 1075, IRS 1075, federal tax information, FTI, FTA, federal tax administration, CJIS, CJIS Security Policy, CJIS v5.9.4, FBI CJIS, NIST 800-53, NIST 800-53 r5, NIST SP 800-53, NIST SP 800-53 Rev 5, NIST 800-53 Revision 5, NIST 800-171, NIST SP 800-171 r3, NIST 800-218, NIST SSDF, secure software development framework, NIST 800-207, NIST zero trust, NIST CSF, NIST CSF 2.0, NIST Cybersecurity Framework, GV, ID, PR, DE, RS, RC, NIST CSF Govern, NIST CSF Identify, NIST CSF Protect, NIST CSF Detect, NIST CSF Respond, NIST CSF Recover, NIST 800-92, NIST 800-92 log management, NIST IR 8259, NIST 800-184, NIST 800-184 ransomware recovery, FedRAMP, FedRAMP Moderate, FedRAMP High, FedRAMP rev 5, FedRAMP rev 5 baselines, FedRAMP authorization, ATO, authorization to operate, JAB, Joint Authorization Board, FedRAMP PMO, JAB ATO, P-ATO, agency ATO, FISMA, Federal Information Security Modernization Act, FISMA Act of 2014, OMB A-130, NIST RMF, Risk Management Framework, NIST 800-37, CMMC, CMMC 2.0, CMMC Level 1, CMMC Level 2, CMMC Level 3, CMMC L1, CMMC L2, CMMC L3, DFARS 252.204-7012, DFARS 7012, DFARS 7019, DFARS 7020, DFARS 7021, controlled unclassified information, CUI, federal contract information, FCI, defense industrial base, DIB, DIBCAC, DCSA, Defense Counterintelligence and Security Agency, DC3, DoD CIO, ATO requirements, NIST 800-172, advanced controls, IRS Section 6103, IRS 6103, criminal justice information, CJI, NIST 800-53A, control assessment, NIST 800-53B, NIST control selection, control inheritance, control implementation summary, CIS, control inheritance summary, OSCAL package, FedRAMP Continuous Monitoring, ConMon, FedRAMP ConMon, FedRAMP 3PAO, third party assessment organization, 3PAO, FedRAMP package, agency ConMon, OSCAL POAM, plan of action and milestones, POAM, POA&M, SOX, Sarbanes-Oxley, Sarbanes-Oxley Act, SOX 404, SOX 404a, SOX 404b, ITGC, IT general controls, ICFR, internal control over financial reporting, ICOFR, COSO Internal Control Framework, PCAOB, Public Company Accounting Oversight Board, PCAOB AS 2201, PCAOB AS 5, PCAOB AS 1305, AICPA AU-C 315, AU-C 940, segregation of duties, SoD, segregation, SoD violation, IT asset management, ITAM, IT asset, change management ITGC, change management control, access control ITGC, computer operations ITGC, application controls, automated control, manual control, key control, sub-process, control owner, ICFR scoping, financial system, financial application, ERP, GL, general ledger, OFB, ledger, sub-ledger, sub ledger, subledger, GL close, financial close, period-end close, period end close, journal entry, JE, manual journal entry, MJE, top-side adjustment, post-close adjustment, AR, accounts receivable, AP, accounts payable, treasury, FP&A, financial planning and analysis, BS, balance sheet, P&L, profit and loss, income statement, cash flow statement, EPS, earnings per share, EBITDA, free cash flow, FCF, working capital, days sales outstanding, DSO, days payable outstanding, DPO, days inventory outstanding, DIO, cash conversion cycle, CCC, ARR, annual recurring revenue, MRR, monthly recurring revenue, NRR, net retention rate, GRR, gross retention rate, customer lifetime value, CLV, LTV, customer acquisition cost, CAC, payback period, magic number, rule of 40, NDR, net dollar retention, gross margin, contribution margin, EBIT, operating income, operating margin, gross profit margin, net profit margin, ROIC, return on invested capital, ROCE, return on capital employed, FOCUS, FinOps Open Cost & Usage Specification, FinOps Foundation, FinOps Framework, FinOps Practitioner, KubeCost, OpenCost, cloud cost allocation, cost allocation, cost categories, cost allocation tags, showback, chargeback, IT cost, IT spend, IT financial management, ITFM, IT financial management, technology business management, TBM, Apptio, Apptio Cloudability, Apptio Targetprocess, Apptio Aptu, FinancialForce, NetSuite, NetSuite ARM, NetSuite OneWorld, NetSuite Financials, Oracle ERP Cloud, Oracle Fusion ERP, Oracle E-Business Suite, EBS, Oracle Fusion Apps, SAP S/4HANA, SAP, SAP ECC, SAP HANA, SAP BW, SAP BTP, SAP SuccessFactors, SAP Fieldglass, SAP Concur, SAP Ariba, SAP Hybris, SAP MDG, Master Data Governance, SAP CDS, Workday, Workday Financials, Workday HCM, Workday Adaptive Planning, Workday Prism, Workday RaaS, Workday Reports as a Service, Salesforce Sales Cloud, Salesforce Service Cloud, Salesforce Marketing Cloud, Salesforce Commerce Cloud, Salesforce CRM Analytics, Salesforce CDP, Customer Data Platform, Salesforce Data Cloud, Salesforce Genie, Salesforce Bulk API, Salesforce Bulk API 2.0, Salesforce SOQL, Salesforce SOSL, Salesforce REST, Salesforce Streaming API, Salesforce CDC, Change Data Capture, Salesforce Platform Events, Service Cloud, Marketing Cloud, MuleSoft, MuleSoft Anypoint, Anypoint Platform, Anypoint Studio, Anypoint Exchange, Tableau, Tableau Server, Tableau Cloud, Tableau Online, Tableau Prep, Tableau Bridge, Power BI, Power BI Service, Power BI Premium, Power BI Embedded, Power BI Report Server, Power Automate, Microsoft Fabric, OneLake, Direct Lake, dataflow, semantic model, Looker, Looker Studio, Looker dashboards, LookML, Sigma Computing, ThoughtSpot, Domo, Qlik Sense, Qlik View, Sisense, Mode Analytics, Hex, Notion, ClickHouse, ClickStack, Apache Superset, Metabase, Redash, Tellius, Datawatch, Snowflake Analytics, BigQuery Analytics, Databricks SQL Analytics, Adobe Analytics, Google Analytics 4, GA4, Google Marketing Platform, GMP, Adobe Real-Time CDP, Segment, mParticle, Hightouch, Reverse ETL, Census, Hightouch reverse ETL, RudderStack, Snowplow, Amplitude, Mixpanel, Heap, Pendo, FullStory, LogRocket, Hotjar, Crazy Egg, ContentSquare, Customer Data Platform, CDP, master data management, MDM, Informatica MDM, Reltio MDM, Profisee MDM, Stibo Systems, IBM InfoSphere MDM, Riversand, Tibco MDM, master data, golden record, customer 360, person 360, account 360, sustainability, ESG, environmental social governance, ESG reporting, GRI, Global Reporting Initiative, SASB, Sustainability Accounting Standards Board, IFRS S1, IFRS S2, ISSB, International Sustainability Standards Board, CSRD, Corporate Sustainability Reporting Directive, EU 2022/2464, ESRS, European Sustainability Reporting Standards, CSDDD, Corporate Sustainability Due Diligence Directive, EU 2024/1760, TCFD, Task Force on Climate-related Financial Disclosures, SBTi, Science Based Targets Initiative, RE100, scope 1, scope 2, scope 3, Scope 1 emissions, Scope 2 emissions, Scope 3 emissions, GHG Protocol, Greenhouse Gas Protocol, location-based scope 2, market-based scope 2, RECs, Renewable Energy Certificates, GOs, Guarantees of Origin, PPA, Power Purchase Agreement, energy attribute certificate, EAC, carbon offset, carbon credit, voluntary carbon market, VCM, compliance carbon market, EU ETS, Emissions Trading System, CBAM, Carbon Border Adjustment Mechanism, CDP disclosure, formerly Carbon Disclosure Project, supply chain disclosure, scope 3 cat 1, scope 3 cat 11, scope 3 cat 15, scope 3 financed emissions, PCAF, Partnership for Carbon Accounting Financials, financed emissions, carbon accounting, ENTSO-E, EU emission factor, IPCC factor, BEIS factor, US EPA factor, EPA factor, EPA eGRID, US Renewable Energy, EU taxonomy, EU Green Taxonomy, EU Sustainable Finance, EU 2020/852, SFDR, Sustainable Finance Disclosure Regulation, EU 2019/2088, principle adverse impacts, PAI, sustainable investment, NERC, NERC CIP, NERC CIP-002, NERC CIP-003, NERC CIP-004, NERC CIP-005, NERC CIP-006, NERC CIP-007, NERC CIP-008, NERC CIP-009, NERC CIP-010, NERC CIP-011, NERC CIP-013, NERC CIP-014, NERC PER, NERC TOP, NERC EOP, NERC FAC, NERC INT, NERC IRO, NERC MOD, NERC PRC, NERC TPL, FERC, FERC Order, FERC NOPR, ITU-T, ITU-T E.500, IEC 62443, IEC 62443-3-3, IEC 62443-4-2, ISA-99, ISA/IEC 62443, NIST SP 800-82, NIST SP 800-82 Rev 3, ICS Cert, CISA ICS-CERT, CISA Cyber Defense, KEV catalog, Known Exploited Vulnerabilities, EPSS, Exploit Prediction Scoring System, FIRST EPSS, EU CRA, Cyber Resilience Act, EU 2024/2847, MAS TRM, Monetary Authority of Singapore Technology Risk Management, MAS Notice 644, HKMA STRP, HKMA Supervisory Policy, HKMA SA-2, HKMA SR Letter, RBI Cybersecurity Framework, RBI Master Direction, IRDAI, Insurance Regulatory and Development Authority of India, IRDAI Circular, APRA CPS 234, APRA Prudential Standards, BIS, Basel III, Basel IV, BCBS 239, BCBS Risk Data Aggregation, ECB, ECB SREP, ECB Supervisory Review and Evaluation Process, MAR, Market Abuse Regulation, MiFID II, Markets in Financial Instruments Directive, MiFID II amendment, MiFID II MiFIR, EMIR, European Market Infrastructure Regulation, EMIR Refit, SFTR, Securities Financing Transactions Regulation, CSDR, Central Securities Depositories Regulation, Dodd-Frank, Dodd-Frank Act, CFTC, Commodity Futures Trading Commission, FINMA, Swiss Financial Market Supervisory Authority, BaFin, Federal Financial Supervisory Authority, FINRA, Financial Industry Regulatory Authority, SEC, US Securities and Exchange Commission, SEC cyber rule, SEC cyber disclosure, SEC Cybersecurity Disclosure Rule, SEC Form 8-K Item 1.05, Item 1.05, AICPA TSP, Trust Service Principles, AICPA SOC for Cybersecurity, SOC for Cybersecurity, SOC for Supply Chain, AICPA SOC, business continuity, BCM, business continuity management, ISO 22301, RTO, recovery time objective, RPO, recovery point objective, MTPD, maximum tolerable period of disruption, MAO, maximum acceptable outage, BCP, business continuity plan, DR, disaster recovery, DRP, disaster recovery plan, BIA, business impact analysis, business impact assessment, business resilience, operational resilience, operational risk, ERM, enterprise risk management, enterprise risk, risk register, risk appetite, risk tolerance, key risk indicator, KRI, risk-adjusted return on capital, RAROC, value at risk, VaR, expected shortfall, ES, conditional value at risk, CVaR, stress test, scenario analysis, reverse stress test, three-line model, IIA, Institute of Internal Auditors, internal audit, IIA Standards, AMA, advanced measurement approach, BIA, basic indicator approach, TSA, the standardized approach]
splunkbase_urls:
...
sourcetypes:
  ...
  - kubecost:export
  - opencost:export
  - sap:ecc:journal_entry
  - sap:s4hana:financial_close
  - workday:hcm:attrition
  ...
  - powerbi:audit
  - looker:audit
ta_versions: "Splunk Enterprise Security 8.0+; ESCU current quarterly drop; Splunk SOAR 6.x; Splunk DB Connect 3.18+; Splunk Add-on for ServiceNow 9.x; Splunk Add-on for Salesforce 4.x; Splunk Add-on for Workday 2.x; Splunk Add-on for SAP 4.x"
splunk_versions: "9.0, 9.1, 9.2, 9.3, 9.4 (current), 10.0+; Splunk Cloud Platform; Splunk Mission Control"
cross_products: [Cost & Capacity Management (cat 20.1-20.3 — finops-cost-capacity.md), Regulatory & Compliance Frameworks (cat 22 — regulatory-compliance-master.md + per-framework evidence packs), Business Analytics & Executive Intelligence (cat 23 — business-analytics.md), Identity & Access Management (cat 9 — security-monitoring.md domain master), Security Infrastructure (cat 10 — security-monitoring.md), Network Security & Zero Trust (cat 17 — security-monitoring.md), Service Management & ITSM (cat 16 — service-management-itsm.md), DevOps & CI/CD (cat 12 — devops-cicd.md), Splunk Platform Health (cat 13.1 — splunk-platform-health.md), Splunk ITSI (cat 13.2 — splunk-itsi.md)]
compliance_frameworks: [SOC 2 Type II — CC6 + CC7 + CC8 + CC9 + A1 + PI1 + C1 + P1, ISO 27001:2022 (Annex A 93 controls) + ISO 27017 (cloud) + ISO 27018 (PII in clouds) + ISO 27701 (PIMS), ISO 27035 (incident mgmt) + ISO 27037 (digital evidence) + ISO 22301 (BCMS) + ISO 31000 (risk), HIPAA Security Rule §164.308 + §164.310 + §164.312 + Privacy Rule §164.530, PCI DSS 4.0 (12 requirements), GDPR Art. 5 + 25 + 30 + 32 + 33 + 34 + 35 (DPIA), UK GDPR + DPA 2018, NIS2 Directive (EU) 2022/2555 (Annex I + II + Article 21 + 23), DORA (EU) 2022/2554 (Articles 5-23 + Lead Overseer + TLPT), CMMC 2.0 Levels 1/2/3, NIST CSF 2.0 (Govern / Identify / Protect / Detect / Respond / Recover), NIST SP 800-53 r5 (all 20 control families), NIST SP 800-171 r3 (CUI), NIST SP 800-218 SSDF, NIST SP 800-207 (ZTA), FedRAMP Moderate + High (rev 5 baselines) + ConMon + OSCAL packages, FISMA (US federal), GLBA Safeguards Rule (FTC final rule 2023), FFIEC Cybersecurity Assessment Tool (CAT) + FFIEC IT Examination Handbook, IRS Pub 1075 (FTI), CJIS Security Policy v5.9.4, NYDFS 23 NYCRR 500 (financial services), NERC CIP-002 thru CIP-013 (electric sector), TSA Pipeline Security Directive, ISA/IEC 62443 (OT/ICS), EU AI Act 2024/1689, EU CSRD 2022/2464 (sustainability reporting) + ESRS, EU CSDDD 2024/1760 (sustainability due diligence), EU CRA 2024/2847 (Cyber Resilience Act), EU eIDAS 2.0, EU PSD2 + DORA financial services overlay, AICPA TSC + SOC 2 + SOC 3, MAS TRM (Singapore), HKMA STRP-1 (Hong Kong), RBI Cybersecurity Framework (India), APRA CPS 234 (Australia), Cyber Essentials + Cyber Essentials Plus (UK NCSC), IRAP (Australia), K-ISMS (Korea), ISMAP (Japan), CCPA + CPRA + state privacy (TX TDPSA + VA VCDPA + CO CPA + CT CTDPA + UT UCPA + IA ICDPA + TN TIPA + MT MCDPA + OR OCPA + FL FDBR + WA WMHA + NJ NJDPA + MD MODPA + MN MNCDPA + IL BIPA + GIPA + NH NHCDPA + RI RICDPA + ME MCDPA + KY KCPA), Sarbanes-Oxley (SOX 404a + 404b + ITGC + ICFR), PCAOB AS 2201 + AS 5, COSO Internal Control Framework (5 components, 17 principles) + COSO ERM (8 components, 20 principles), ISACA COBIT 2019, Open Group IT4IT, AICPA SSAE 18 + SSAE 21, GRI + SASB + IFRS S1/S2 (sustainability), GHG Protocol Scope 1+2+3, TCFD recommendations, EU Taxonomy + SFDR, MITRE ATT&CK + D3FEND, OWASP Top 10 + ASVS, CIS Critical Security Controls v8, ITIL v4 + ISO 20000-1, IIA Standards (Three Lines of Defense)]
maturity_tiers: {crawl: 22, walk: 60, run: 50}
...
| **DPO** | GDPR / UK GDPR / state privacy law DPIA evidence + DSAR fulfilment | `docs/evidence-packs/gdpr.md`, `docs/evidence-packs/uk-gdpr.md` |
...
```mermaid
flowchart LR
    subgraph "Compliance Source Plane (cat-22)"
        SOC2[SOC 2 controls<br/>CC6/CC7/CC8/CC9 + A1]
        ISO[ISO 27001 Annex A<br/>+ 27017/27018/27701]
        REGS[GDPR + UK GDPR + NIS2 +<br/>DORA + CMMC + HIPAA]
        US[NIST CSF + 800-53 + 800-171<br/>+ FedRAMP + SOX + NYDFS]
        IND[NERC CIP + IEC 62443 +<br/>EU AI Act + CSRD + ESRS]
        OTHER[State privacy laws + APAC<br/>+ MENA + LATAM regs]
    end

    subgraph "Cost & Capacity Plane (cat-20)"
        FINOPS[FinOps Framework<br/>Inform/Optimize/Operate]
        CUR[AWS CUR + Azure CM +<br/>GCP Billing + FOCUS spec]
        KUBECOST[KubeCost / OpenCost]
        TBM[Apptio TBM /<br/>Cloudability / Flexera]
        LICENSE[License & Subscription<br/>Microsoft / Salesforce / Splunk]
    end

    subgraph "Business Analytics Plane (cat-23)"
        ERP[SAP S/4HANA / Oracle ERP /<br/>NetSuite / Workday Financials]
        CRM[Salesforce / Dynamics 365 /<br/>HubSpot]
        HRIS[Workday HCM / SAP SF /<br/>BambooHR]
        DW[Snowflake / BigQuery /<br/>Databricks / Redshift]
        BI[Tableau / Power BI / Looker<br/>+ Adobe / GA4]
        ESG[GHG Protocol + GRI + TCFD +<br/>CSRD / ESRS]
    end
    ...
    subgraph "Splunk Ingest Tier"
        ...
        SC4S[SC4S syslog]
        EP[Splunk Edge Processor<br/>field-level redaction]
    end
    ...
    IDX --> CIM[CIM data models +<br/>Operational Telemetry +<br/>compliance custom DM]

    CIM --> ES[Splunk ES<br/>+ ESCU + RBA risk scoring]
    CIM --> ITSI[Splunk ITSI<br/>compliance service tree<br/>+ ESG service tree]
    CIM --> SOAR[Splunk SOAR<br/>attestation playbooks]

    ES --> NOTABLE[Notable events<br/>+ risk objects +<br/>analyst disposition]
    ITSI --> SCORECARD[Executive Scorecards<br/>+ Glass Tables]

    NOTABLE --> EVIDENCE[audit_evidence index<br/>7-year retention<br/>RBAC restricted]
    SCORECARD --> EVIDENCE
    SOAR --> EVIDENCE

    EVIDENCE --> CLAUSE[Clause Navigator<br/>obligation → search<br/>matrices]
    EVIDENCE --> EVPACK[Evidence Packs<br/>per-framework markdown]
    EVIDENCE --> PRIMER[Regulatory Primer<br/>briefing decks]
    EVIDENCE --> OSCAL[OSCAL packages<br/>FedRAMP ConMon]
    EVIDENCE --> ATTEST[Attestation cadence<br/>SME countersignature<br/>KVStore lookups]

    classDef compliance fill:#fef3c7,stroke:#f59e0b,color:#78350f
    classDef cost fill:#fce7f3,stroke:#db2777,color:#831843
    classDef biz fill:#dcfce7,stroke:#16a34a,color:#166534
    classDef ingest fill:#e1f5ff,stroke:#0ea5e9,color:#075985
    classDef analytics fill:#ede9fe,stroke:#7c3aed,color:#4c1d95
    classDef evidence fill:#fef2f2,stroke:#ef4444,color:#7f1d1d

    class SOC2,ISO,REGS,US,IND,OTHER compliance
    class FINOPS,CUR,KUBECOST,TBM,LICENSE cost
    class ERP,CRM,HRIS,DW,BI,ESG biz
    class DBC,REST,HEC,UF,SC4S,EP ingest
    class IDX,CIM,ES,ITSI,SOAR,NOTABLE,SCORECARD analytics
    class EVIDENCE,CLAUSE,EVPACK,PRIMER,OSCAL,ATTEST evidence
```
...
| DORA | 40 | `docs/evidence-packs/dora.md` | Tier-1 |
| CCPA / CPRA | 25 | (state-privacy section) | Tier-2 |
| PCI DSS 4.0 | 90 | `docs/evidence-packs/pci-dss.md` | Tier-1 |
| HIPAA Security Rule | 55 | `docs/evidence-packs/hipaa-security.md` | Tier-1 |
| SOX ITGC | 35 | `docs/evidence-packs/sox-itgc.md` | Tier-1 |
| NIST CSF 2.0 | 50 | `docs/evidence-packs/nist-csf.md` | Tier-1 |
...
| EU AI Act | 25 | (AI governance pack) | Tier-2 |
...
- Splunk ITSI — Compliance service tree

...
|---|---|---|
| **CIO / VP Engineering** | DORA metrics, SLO scorecard, capacity model, business-service KPI map | `regulatory-compliance-master.md`, `compliance-business.md` |
...
9. **OpenTelemetry traces** — Splunk Distribution of OTel Collector to APM (Splunk Observability Cloud) or `app_traces`.
...
**OpenTelemetry Specification** defines consistent attribute names
...
| HIPAA Security Rule | `docs/evidence-packs/hipaa-security.md` | §164.312(b) audit controls — 7.x DB audit + 16.x ITSM |
| PCI DSS 4.0 | `docs/evidence-packs/pci-dss.md` | Req 6, 10, 11 — 12.x DevOps, 13.x monitoring, 16.x change |
| GDPR | `docs/evidence-packs/gdpr.md` | Art. 32 — 7.x DB + 13.x monitoring |
...
- Splunk Application Performance Monitoring (APM) — https://docs.splunk.com/Observability/apm
- Splunk Real User Monitoring (RUM) — https://docs.splunk.com/Observability/rum

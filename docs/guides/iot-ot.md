...
> with Splunk. **249 use cases** spanning Splunk Edge Hub<sup class="ref">[<a href="#ref-1">1</a>]</sup> deployment,
...
> (Purdue model boundary monitoring), MITRE ATT&CK<sup class="ref">[<a href="#ref-5">5</a>]</sup> for ICS coverage,
> NERC CIP<sup class="ref">[<a href="#ref-6">6</a>]</sup> / IEC 62443<sup class="ref">[<a href="#ref-2">2</a>]</sup> / NIS2<sup class="ref">[<a href="#ref-3">3</a>]</sup> compliance, and the full OT visibility
...
| Layer | Platform | TA / Splunkbase<sup class="ref">[<a href="#ref-13">13</a>]</sup> |
|-------|----------|------|
...
<a id="ref-1"></a>**[1]** Splunk Inc. (2026). *Splunk Edge Hub Documentation*. Splunk LLC, a Cisco company. Retrieved May 11, 2026, from https://docs.splunk.com/Documentation/EdgeHub

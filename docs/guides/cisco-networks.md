...
| **Catalyst Center (DNAC)** | [Catalyst Center Guide](catalyst-center.md) |
...
| **CIM** | Splunk Common Information Model (CIM) Add-on (Splunkbase 1621) for Network_Traffic, Authentication, Change models |

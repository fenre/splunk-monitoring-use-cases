...
| **FortiGate + FortiSandbox** | UTM (AV, IPS, web filter, DNS), FortiSandbox dynamic analysis |
...
| **Compliance** | PCI 5.x, NIST SI-3, NIS2 |
...
*Last updated: 2026-05-09. Covers Palo Alto PAN-OS 11.x, Fortinet FortiOS 7.x, Cisco Firepower 7.x, Check Point R81+.*

...
> The definitive guide to monitoring Kubernetes<sup class="ref">[<a href="#ref-1">1</a>]</sup> with Splunk. 46 use cases
...
- **Cluster Receiver Deployment (singleton)** — collects:
  ...
  - Prometheus<sup class="ref">[<a href="#ref-11">11</a>]</sup> scrapes of `kube-state-metrics`, `kube-apiserver`, `kubelet`, `node-exporter` via the `prometheus` receiver
...
UC-3.2.7, .19, .40 (control plane health) map to NIS2<sup class="ref">[<a href="#ref-5">5</a>]</sup> Article 21(2)(a) "policies on risk analysis and information system security" via demonstrated continuous monitoring.
...
| CIS Kubernetes Benchmark<sup class="ref">[<a href="#ref-4">4</a>]</sup> | [cisecurity.org/benchmark/kubernetes](https://www.cisecurity.org/benchmark/kubernetes) |
...
<a id="ref-4"></a>**[4]** Center for Internet Security. (2025). *CIS Kubernetes Benchmark*. https://www.cisecurity.org/benchmark/kubernetes
...
<a id="ref-7"></a>**[7]** National Institute of Standards and Technology. (2017). *Application Container Security Guide*. U.S. Department of Commerce. NIST SP 800-190. Retrieved May 11, 2026, from https://csrc.nist.gov/pubs/sp/800/190/final
...
<a id="ref-12"></a>**[12]** Red Hat, Inc. (2026). *Red Hat OpenShift Container Platform Documentation*. Retrieved May 11, 2026, from https://docs.openshift.com/container-platform/latest/welcome/index.html
...
<a id="ref-17"></a>**[17]** github.com. *splunk-otel-collector*. Retrieved May 11, 2026, from https://github.com/signalfx/splunk-otel-collector-chart

<a id="ref-18"></a>**[18]** github.com. *github.com/signalfx/splunk-otel-collector*. Retrieved May 11, 2026, from https://github.com/signalfx/splunk-otel-collector

<a id="ref-19"></a>**[19]** kubernetes.io. *kubernetes.io/docs*. Retrieved May 11, 2026, from https://kubernetes.io/docs

<a id="ref-20"></a>**[20]** github.com. *github.com/kubernetes/kube-state-metrics*. Retrieved May 11, 2026, from https://github.com/kubernetes/kube-state-metrics

<a id="ref-21"></a>**[21]** kubernetes.io. *kubernetes.io/docs/tasks/debug/debug-cluster/audit/*. Retrieved May 11, 2026, from https://kubernetes.io/docs/tasks/debug/debug-cluster/audit/

<a id="ref-22"></a>**[22]** splunkbase.splunk.com. *splunkbase.splunk.com/app/1876*. Retrieved May 11, 2026, from https://splunkbase.splunk.com/app/1876

<a id="ref-23"></a>**[23]** splunkbase.splunk.com. *splunkbase.splunk.com/app/3110*. Retrieved May 11, 2026, from https://splunkbase.splunk.com/app/3110

<a id="ref-24"></a>**[24]** splunkbase.splunk.com. *splunkbase.splunk.com/app/3088*. Retrieved May 11, 2026, from https://splunkbase.splunk.com/app/3088

...
> Platform layer (cat 5.8, 29 UCs). Covers Cisco Catalyst SD-WAN
...
because PCI / HIPAA / GDPR-protected traffic ends up traversing
unintended paths.
...
| No audit-grade access trail | RBAC + audit-log retention satisfies SOX / PCI / HIPAA |
...
- **Splunk ITSI** — SD-WAN service tree (controller → site → tunnel)
...
UC-5.8.13 satisfy DORA Art. 8 evidence requirements.

...
> Comprehensive monitoring guide for **Grafana** (15 UCs in cat-13.6)
...
| Splunk Observability Cloud APM / RUM / Synthetics | [Splunk Observability Cloud Guide](splunk-observability-cloud.md) |
...
| **Splunk OpenTelemetry Collector** ≥ 0.115 | For Prometheus / metrics scrape |
...
|---|---|
| **NIST 800-53 AU-2 / AU-12** | Grafana audit log captured + retained |
| **NIST 800-53 SI-4** | Continuous monitoring of observability stack |
| **ISO 27001 A.12.4** | Logging and monitoring (Grafana / Fluentd internal logs) |
| **SOC 2 CC7.2** | System monitoring including the monitoring tools |
| **DORA Art. 16-17** | ICT operations resilience including telemetry layer |
| **PCI-DSS req 10** | Audit log of access to systems showing PCI data via Grafana |
| **HIPAA 164.312(b)** | Audit log of access to PHI dashboards |

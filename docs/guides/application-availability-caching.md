...
2. **Vault audit goes to a 7-year retention class.** Vault audit
   evidence is required by SOC 2<sup class="ref">[<a href="#ref-2">2</a>]</sup> CC9, PCI DSS §10, HIPAA<sup class="ref">[<a href="#ref-14">14</a>]</sup> §164.312.
...
Splunk Observability Cloud<sup class="ref">[<a href="#ref-12">12</a>]</sup> → Synthetic Monitoring → New test:
...
<a id="ref-7"></a>**[7]** Murphy, N., et al. (2018). *Alerting on SLOs (Chapter 5 of The Site Reliability Workbook)*. O'Reilly Media / Google. https://sre.google/workbook/alerting-on-slos/

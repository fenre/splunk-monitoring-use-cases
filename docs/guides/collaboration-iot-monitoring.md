---
title: Collaboration & IoT/OT Monitoring Domain Master Guide — Email & Collaboration (cat-11), IoT & Operational Technology (cat-14) end-to-end with Splunk Enterprise Security, Splunk SOAR, Splunk ITSI, Splunk Operational Telemetry data model, Splunk OT Security Add-on, Cisco Webex / UCM / ESA / Cyber Vision / Edge Intelligence / Meraki MT, Microsoft 365 + Defender, Google Workspace, IEC 62443, NIST SP 800-82, OPC-UA, MQTT, Modbus, BACnet, Zeek ICS
type: domain-guide
domains: [Collaboration, Email, Unified Communications, IoT, OT, ICS, Industrial Control Systems, Building Management, Edge Computing]
categories: [11, 14]
product: Splunk Enterprise Security (ES) 8 + Splunk SOAR + Splunk Mission Control + Splunk IT Service Intelligence (ITSI) + Splunk OT Security Add-on + Splunk Operational Telemetry data model + Splunk Add-on for Microsoft Cloud Services + Splunk Add-on for Microsoft Office 365 + Splunk Add-on for Microsoft 365 Defender + Splunk Add-on for Google Workspace + Cisco Webex Meetings Add-on + Cisco Webex App + Cisco Webex REST Add-on + Cisco UCM Add-on + Cisco ESA Add-on + Cisco Cyber Vision Add-on + Cisco Edge Intelligence Add-on + Splunk Edge Hub + Splunk Add-on for Cisco Meraki + Splunk Add-on for Cisco Meraki MT (sensors) + Splunk Add-on for OPC-UA + Splunk Add-on for Modbus + Splunk Add-on for MQTT + Splunk Add-on for BACnet + Splunk Add-on for SNMP + Splunk Add-on for Zeek + Splunk Stream + Splunk Connect for Syslog (SC4S) + Splunk Connect for SNMP + Litmus Edge + Nozomi Networks (parallel sensor pattern)
product_aliases: [collaboration, collaboration platform, collaboration suite, collaboration tools, communication tools, productivity suite, unified communications, UC, unified comms, UCaaS, contact center, contact-center, ContactCenter, CCaaS, contact center as a service, video conferencing, video conf, virtual meetings, online meetings, web conferencing, webconf, telepresence, video collaboration, video calling, voice calling, calling platform, voice over IP, VoIP, IP telephony, IPT, telephony, PBX, Private Branch Exchange, IP-PBX, hosted PBX, PSTN, public switched telephone network, dial tone, SIP, Session Initiation Protocol, SIP trunk, SIP trunking, SBC, session border controller, RTP, real-time transport protocol, codec, G.711, G.729, Opus, H.264, H.265, MOS, mean opinion score, jitter, packet loss, latency, audio video, AV, AVoIP, audio over IP, AES67, Dante, audio engineering society 67, room intelligence, room booking, room scheduler, room control, hot desking, hotdesk, hot-desk, free address, hoteling, hot office, smart office, smart building, smart workplace, hybrid work, hybrid working, remote work, work from home, WFH, work from anywhere, WFA, distributed workforce, return to office, RTO, in-office, hybrid policy, mail, email, electronic mail, e-mail, mail server, mail relay, mail gateway, mail security, mail filter, mail flow, mail transport, MTA, mail transfer agent, MUA, mail user agent, MDA, mail delivery agent, mail loop, mail bounce, NDR, non-delivery report, message tracking, message trace, message tracking, mailbox, mail store, exchange, exchange server, exchange online, EXO, exchange hybrid, on-premises exchange, on-prem exchange, OWA, Outlook Web App, Outlook Web Access, ActiveSync, EAS, Exchange ActiveSync, MAPI, MAPI/HTTP, RPC over HTTP, RPC/HTTP, EWS, Exchange Web Services, EXCH, Edge Transport, Hub Transport, Mailbox Server, Client Access Server, OAB, offline address book, public folders, distribution list, dynamic distribution group, mail flow rule, transport rule, journal, journal mailbox, journal recipient, journaling, archive mailbox, in-place archive, online archive, retention tag, retention policy, MRM, messaging records management, eDiscovery, eDiscovery hold, litigation hold, in-place hold, content search, eDiscovery search, hold report, hold notification, ETB, eDiscovery target box, mailbox audit, mailbox audit log, owner audit, delegate audit, admin audit, admin audit log, AAL, mailbox forwarding, autoforward, auto-forward, external forwarding, RemoteDomain, mail flow connector, send connector, receive connector, edge subscription, hybrid configuration wizard, HCW, ECP, Exchange Control Panel, EAC, Exchange Admin Center, MEC, Modern Exchange Center, EOP, Exchange Online Protection, ATP, Advanced Threat Protection, Defender for Office 365, MDO, MDO Phish, Safe Attachments, Safe Links, Anti-spam, anti-phish, anti-malware, ZAP, zero-hour auto purge, threat explorer, threat tracker, attack simulator, attack simulation training, simulator, phishing simulation, phish simulation, business email compromise, BEC, EAC, email account compromise, EAC, vendor email compromise, VEC, conversation hijack, thread hijack, thread injection, BEC fraud, CEO fraud, CFO fraud, gift card scam, payroll diversion, invoice fraud, wire fraud, ACH fraud, Microsoft 365, M365, Office 365, O365, Microsoft 365 Apps, Office 365 Apps, Office Apps, Microsoft Teams, MS Teams, Teams Phone, Teams calling, Teams meeting, Teams chat, Teams channel, Teams app, Teams policies, Teams meeting policies, Teams calling policies, Teams messaging policies, Teams setup policies, Teams app permission policies, OneDrive, OneDrive for Business, ODB, ODfB, SharePoint, SharePoint Online, SPO, SharePoint sites, SharePoint Embedded, OneDrive sync, OneDrive sync client, ODSP, OneNote, Microsoft Stream, Stream classic, Stream live event, Microsoft Stream live, Yammer, Viva Engage, Viva Connections, Viva Insights, Viva Topics, Viva Goals, Viva Glint, Microsoft Project, Project for the Web, Microsoft Planner, Planner, Microsoft Visio, Visio, Microsoft Forms, Forms, Microsoft Sway, Sway, Microsoft Lists, Lists, Power Apps, Power Automate, Power Pages, Power BI, Power Platform, Power Fx, Microsoft Bookings, Microsoft Loop, Loop, Loop component, Microsoft Mesh, Mesh, Mesh avatar, Microsoft Copilot, Copilot for Microsoft 365, M365 Copilot, Copilot Studio, Copilot Pro, Microsoft Whiteboard, Whiteboard, Microsoft Lens, Office Lens, Microsoft To Do, To Do, Outlook Mobile, Outlook Web, Outlook Calendar, Outlook Tasks, Microsoft 365 Group, Office 365 Group, M365 group, unified group, modern group, Outlook group, Teams group, group conversation, group connector, group calendar, group SharePoint, group OneNote, group Planner, Outlook calendar sharing, calendar sharing, calendar publishing, calendar permissions, free/busy, free busy, free-busy, Microsoft Graph, Graph API, Microsoft Graph API, MS Graph, Graph permissions, Graph delegated, Graph application, Graph subscription, Graph webhooks, change notifications, Graph activity log, Microsoft Entra ID, Entra ID, Azure AD, AAD, Azure Active Directory, Entra ID P1, Entra ID P2, Entra Suite, Entra Verified ID, Entra Permissions Management, Entra Identity Protection, Identity Protection, Microsoft Defender for Identity, MDI, Defender for Identity, Defender for Endpoint, MDE, Defender for Cloud Apps, MDCA, MCAS, Defender XDR, Microsoft Defender XDR, Microsoft 365 Defender, M365 Defender, Microsoft Sentinel, Sentinel, Microsoft Purview, Purview, Microsoft Purview Information Protection, MIP, Microsoft Information Protection, sensitivity label, retention label, retention policy Purview, Microsoft Purview Communication Compliance, Communication Compliance, MCC, Microsoft Purview Insider Risk Management, Insider Risk Management, IRM Purview, Microsoft Purview eDiscovery, Microsoft Purview Audit, Audit Premium, Audit Standard, Microsoft Purview Compliance Manager, Compliance Manager, Compliance Score, Microsoft Purview Records Management, Records Management, Microsoft Purview Information Barriers, Information Barriers, Microsoft Purview Customer Lockbox, Customer Lockbox, Microsoft Purview Privileged Access Management, Privileged Access Management, PAM, Microsoft Purview Data Loss Prevention, Endpoint DLP, Microsoft Purview DLP, Purview DLP, Microsoft Purview Data Lifecycle Management, DLM, Data Lifecycle Management, Microsoft Purview Data Map, Data Map, Microsoft Purview Data Catalog, Data Catalog, Microsoft Purview Data Estate Insights, Data Estate Insights, Microsoft Purview Unified Catalog, Unified Catalog, ms graph audit, audit unified, unified audit log, UAL, Office 365 audit log, M365 audit log, M365 management activity API, Management Activity API, MAA, Office 365 Management Activity API, Office 365 audit, M365 admin audit, Microsoft 365 admin audit, Office 365 message trace, M365 message trace, message trace API, Google Workspace, GWS, G Suite, Google Apps, Google Workspace Enterprise, GWS Enterprise, GWS Business, Gmail, Google Mail, Google Calendar, Google Drive, Google Docs, Google Sheets, Google Slides, Google Forms, Google Sites, Google Meet, Google Chat, Google Voice, Google Hangouts, Hangouts, Google Vault, Google Vault retention, Google Workspace Admin Console, GWS Admin Console, Google Workspace audit, Workspace audit, Workspace admin audit, Workspace login audit, Workspace drive audit, Workspace gmail audit, Workspace meet audit, Workspace mobile audit, Google Workspace API, Admin SDK, Admin SDK Reports API, Admin SDK Directory API, Drive API, Calendar API, Gmail API, Meet API, Workspace marketplace, GWS marketplace, GWS data export, GWS Vault export, Vault export, Cisco Webex, Webex, Webex Meetings, Webex Calling, Webex Calling Multi-Tenant, MT, Webex Calling Dedicated Instance, DI, Webex Webinars, Webex Events, Webex Training, Webex Support, Webex Contact Center, Webex CC, WxCC, Webex App, Webex App for Devices, Webex Devices, Webex Room, Webex Room Bar, Webex Board, Webex Desk Pro, Webex Desk, Webex Desk Mini, Cisco Room Kit, Cisco Room Kit Mini, Cisco Room Kit Plus, Cisco Room Kit Pro, Webex Room Panorama, Cisco Touch 10, Cisco Navigator, Webex Hub, Webex Edge for Devices, Webex Hybrid Calendar, Webex Hybrid Message, Webex Hybrid Calling, Hybrid Services, Webex Connect, Webex CPaaS, Webex APIs, webexapis, webexapis.com, Webex REST API, Webex Admin API, Webex Analytics API, Webex People API, Webex Meetings API, Webex Webhooks, Webex Bot, xAPI, Webex xAPI, Cisco xAPI, Cisco Endpoint API, Macros, Webex Macros, Webex Calling REST, Calling Admin API, Webex Edge Audio, Cisco Webex Calling, Cisco Calling, Cisco Calling CDR, CDR, call detail record, CMR, call management record, hunt group, call queue, auto attendant, AA, IVR, interactive voice response, voicemail, VM, voicemail to email, VM to email, voicemail PIN, voice intelligence, voice intelligence services, VIS, Cisco AI assistant, Webex AI Assistant, AI noise reduction, audio intelligence, Cisco Unified Communications Manager, CUCM, Unified CM, Cisco Call Manager, Call Manager, Call Manager Express, CME, CUCM CDR, CUCM CMR, Cisco Unity Connection, Unity Connection, Cisco Unified Presence, CUP, Cisco IM and Presence, IM&P, Cisco UCCE, UCCE, Cisco Unified Contact Center Enterprise, Cisco UCCX, UCCX, Cisco Unified Contact Center Express, Cisco Finesse, Finesse, Cisco SocialMiner, Cisco MediaSense, Cisco PCCE, PCCE, Packaged Contact Center Enterprise, Cisco TelePresence, TelePresence, CTS, Cisco MX, MX series, MX300, MX700, MX800, SX series, SX10, SX20, SX80, EX series, EX60, EX90, Cisco DX series, DX70, DX80, Cisco IP Phone, IP Phone, Cisco 8800 series, Cisco 8800, 8841, 8851, 8861, 8865, Cisco 7800 series, Cisco 7800, 7811, 7821, 7841, 7861, Cisco 6800 series, Cisco 6841, 6851, ATA, analog terminal adapter, ATA 191, Cisco WiFi calling, WiFi calling, Webex Edge Connect, Edge Connect, Webex Edge Connect Premium, Webex Edge Audio, Webex Cloud-Connected UC, CCUC, Cloud Connected UC, Webex CCUC, telepresence, video endpoint, video endpoints, Cisco Email Security, Cisco ESA, ESA, IronPort, Cisco IronPort, Email Security Appliance, ESA C-series, ESA C100, C300, C600, ESA M-series, M170, M390, M690, ESA Cloud, Cloud Email Security, CES, Secure Email Cloud Gateway, SEG, Secure Email, Cisco Secure Email, Cisco Talos, Talos, Talos email reputation, SBRS, sender base reputation score, IPAS, anti-phishing, IronPort Anti-Spam, McAfee Anti-Virus, Sophos AV, ETF, External Threat Feeds, threat grid, AMP, AMP for Email, advanced malware protection, file reputation, file analysis, URL filtering, outbreak filter, Outbreak Filters, Virus Outbreak Filter, VOF, content filter, message filter, message tracking ESA, mail logs ESA, mail policy, incoming mail policy, outgoing mail policy, HAT, Host Access Table, RAT, Recipient Access Table, SMTP routing, mail routes, encrypted communication, TLS encryption ESA, encrypted message reporting, ESA reporting, Cisco Threat Defense for Email, EOL ESA, ESA on prem, ESA on-prem, Cisco IoT, Cisco IoT platform, Cisco IoT Operations Dashboard, Cisco IoT OD, IoT OD, Cisco Cyber Vision, Cyber Vision, CV, Cisco CV, CV Center, CV sensor, CV global center, CV local center, IC3000, IR1101, IR829, IR1800, IR8100, Cisco Catalyst Industrial Ethernet, IE, Catalyst IE, IE3300, IE3400, IE9300, Catalyst IE Rugged, Cisco IoT field devices, Cisco IoT field network, Cisco Edge Intelligence, EI, Cisco Edge Intelligence agent, EI agent, Data Logic, Data Rules, Cisco Industrial Network Director, IND, IND device pack, Cisco IoT Cloud Connect, Cisco Field Network Director, FND, Cisco Resilient Mesh, CRM resilient mesh, Cisco IIoT Connectivity Router, IR, Industrial Router, Cisco IR ROM, Cisco IOx, IOx, Cisco IOx package, IOx app, IOS-XE IOx, ICS, industrial control system, industrial control systems, OT, operational technology, OT/ICS, IT/OT convergence, IT-OT, IT/OT, ICS/SCADA, SCADA, supervisory control and data acquisition, DCS, distributed control system, distributed control systems, PLC, programmable logic controller, RTU, remote terminal unit, IED, intelligent electronic device, HMI, human machine interface, human-machine interface, HMI Workstation, HMI workstation, MES, manufacturing execution system, MOM, manufacturing operations management, ERP-MES integration, MES-PLC integration, EAM, enterprise asset management, CMMS, computerized maintenance management system, ICS-CERT, CISA ICS, KEV, known exploited vulnerabilities, EPSS, exploit prediction scoring system, ICS vulnerability, ICS-CVE, OT-CVE, Purdue model, Purdue model levels, level 0, level 1, level 2, level 3, level 3.5, level 4, level 5, IDMZ, industrial demilitarized zone, IDMZ DMZ, OT DMZ, NIST 800-82, NIST 800-82 r3, NIST SP 800-82, NIST IR 8259, IEC 62443, ISA 99, ISA/IEC 62443, IEC 62443-2-1, IEC 62443-3-2, IEC 62443-3-3, IEC 62443-4-1, IEC 62443-4-2, ISO/IEC 27019, ISO 27019, NERC CIP, NERC CIP-002, NERC CIP-005, NERC CIP-007, NERC CIP-008, NERC CIP-010, NERC CIP-011, NERC CIP-013, NERC CIP-014, BES, bulk electric system, ICS-CSWP, NIST cybersecurity for smart grids, FERC, federal energy regulatory commission, TSA Pipeline Security Directive, TSA pipeline, TSA SD-2, TSA SD-3, EPA America's Water Infrastructure Act, AWIA, EPA cyber, FDA QSR, FDA 21 CFR Part 11, FDA part 11, GxP, good manufacturing practice, GMP, good distribution practice, GDP, good clinical practice, GCP, good laboratory practice, GLP, good practice, GxP validation, computer system validation, CSV, MQTT, MQTT broker, Mosquitto, MQTT topic, MQTT QoS, MQTT retain, MQTT subscribe, MQTT publish, MQTT-SN, MQTT-SN gateway, AMQP, Advanced Message Queueing Protocol, RabbitMQ, ActiveMQ, AMQP 1.0, OPC, OPC Classic, OPC-DA, OPC-HDA, OPC UA, OPC-UA, OPC Unified Architecture, OPC UA pub/sub, OPC UA Information Model, OPC UA Companion Spec, OPC Foundation, Modbus, Modbus TCP, Modbus RTU, Modbus ASCII, Modbus master, Modbus slave, Modbus client, Modbus server, function code, Modbus exception, BACnet, BACnet/IP, BACnet/MSTP, BACnet object, ASHRAE 135, BACnet/SC, BACnet/SC mesh, BACnet/IP6, DNP3, distributed network protocol 3, DNP3 SAv2, IEC 60870-5-104, IEC 60870-5-103, IEC 61850, IEC 61850-90-5, IEEE 1646, IEEE 1815, ICCP, Inter-control Center Protocol, EtherNet/IP, EIP, ENIP, Allen-Bradley, Rockwell Automation, Studio 5000, Logix, ControlLogix, CompactLogix, GuardLogix, FactoryTalk, FactoryTalk View, FactoryTalk View SE, FactoryTalk Historian, FactoryTalk Asset Centre, AssetCentre, FactoryTalk EnergyMetrix, FactoryTalk Transaction Manager, FactoryTalk VantagePoint, ROCKWELL ftvm, Rockwell ICS, Profinet, PROFINET, PROFIBUS, PROFIBUS DP, PROFIBUS PA, EtherCAT, CC-Link, Mechatrolink, SERCOS, FOUNDATION Fieldbus, FF, HART, HART communicator, WirelessHART, ISA100, ISA100.11a, ISA100 Wireless, IO-Link, IO-Link master, OPC IO-Link Companion Spec, EtherCAT P, ASi, AS-Interface, ASi-5, RAPIEnet, RAPIEnet 2, ZigBee, Z-Wave, Thread, Matter, Matter over WiFi, Matter over Thread, LoRaWAN, LoRa, LoRa Alliance, ABP, OTAA, Sigfox, NB-IoT, Narrowband IoT, LTE-M, Cat-M, Cat-M1, Cat-NB1, NB1, NB2, 5G NR, 5G NR-IoT, 5G LPWA, BLE, Bluetooth Low Energy, Bluetooth, Bluetooth Mesh, BLE Mesh, ANT+, EnOcean, KNX, KNX/IP, KNX RF, KNX Secure, DALI, DALI-2, BLE beacon, iBeacon, Eddystone, NFC, RFID, RTLS, real-time location system, UWB, Ultra-Wideband, ultra wideband, Wi-Fi RTT, FTM, fine timing measurement, GPS, GNSS, INS, IMU, asset tracking, asset tracker, fleet tracking, cold chain, cold-chain, cold chain logistics, cold chain monitoring, temperature compliance, FDA cold chain, USP 1079, USP 1079.4, GDP cold chain, perishable goods, vaccine cold chain, blood cold chain, biologic cold chain, food cold chain, vaccine integrity, ambient monitoring, HVAC, heating ventilation air conditioning, BMS, building management system, BAS, building automation system, BAS, FAS, fire alarm system, NFPA 72, NFPA 25, NFPA, fire panel, fire detection, life safety, NFPA 110, generator monitoring, ATS, automatic transfer switch, transfer switch, UPS, uninterruptible power supply, battery monitoring, battery management system, BMS, generator, gen set, genset, switchgear, MCC, motor control center, VFD, variable frequency drive, drives, motor drives, AHU, air handling unit, RTU, rooftop unit, FCU, fan coil unit, VAV, variable air volume, CAV, constant air volume, chiller, chiller plant, cooling tower, condenser, evaporator, refrigerant, R-410A, R-32, R-454B, ammonia, NH3, glycol, brine, secondary loop, primary loop, primary-secondary, primary secondary, primary/secondary, energy recovery ventilator, ERV, HRV, heat recovery ventilator, energy recovery, demand controlled ventilation, DCV, building energy management, BEMS, EMS, energy management system, energy KPI, energy intensity, energy use intensity, EUI, kWh per square foot, kWh/sqft, ENERGY STAR, ASHRAE 90.1, ASHRAE 62.1, ASHRAE 55, IAQ, indoor air quality, indoor environmental quality, IEQ, occupancy sensor, motion sensor, presence detection, occupancy analytics, hot desking analytics, hot-desking, RTLS, location services, indoor positioning, IPS, indoor positioning system, location analytics, Cisco Spaces, Cisco Spaces metadata, Spaces SDK, Spaces App, Spaces firehose, Spaces Operations Insights, Spaces Smart Workspaces, RIGHT NOW, Cisco DNA Spaces, DNA Spaces, water leak detection, water leak, leak detection, leak rope, leak cable, water hammer, water hammer arrestor, Legionella, Legionella prevention, ASHRAE 188, NHS estates, HSG274, BS 8580, BSRIA, public health water, recirculation, hot water recirculation, ATP testing, water testing, cooling tower water, cooling tower compliance, evaporative cooling, refrigeration leak, F-Gas, F-Gas regulation, EU 2024/573, F-Gas EU, EU F-Gas, EPA SNAP, EPA Section 608, EPA Section 609, ozone-depleting substance, ODS, GWP, global warming potential, refrigerant tracking, refrigerant management, leak detection refrigerant, ALD, automatic leak detection, RGM, refrigeration gas monitoring, ammonia leak, ammonia refrigeration, IIAR, International Institute of Ammonia Refrigeration, Litmus Edge, Litmus, Litmus DataHub, Litmus Edge Manager, Litmus REST, Litmus broker, Litmus driver, Nozomi Networks, Nozomi, Nozomi Vantage, Nozomi Guardian, Nozomi Arc, Nozomi Vantage IQ, Nozomi Smart Polling, Claroty, Claroty xDome, Claroty Continuous Threat Detection, CTD, Claroty Edge, Claroty Secure Remote Access, SRA, Dragos, Dragos Platform, Dragos Worldview, Tenable OT Security, Tenable.ot, Tenable OT, Indegy, Forescout eyeInspect, Forescout SilentDefense, eyeInspect, SCADAfence, Microsoft Defender for IoT, Defender for IoT, MDFI, Azure Defender for IoT, ServiceNow OT Management, OT Management, OT discovery, OT inventory, OT vulnerability management, OT VM, OT patch management, OT change management, OT incident response, OT IR, OT SOC, OT NOC, ICS SOC, OT-SOC, MERIDIAN, Wedge, Industrial Internet of Things, IIoT, Industry 4.0, Industry 4_0, Industry 4 0, smart factory, smart manufacturing, factory of the future, FoF, lights-out manufacturing, lights out manufacturing, lights-out, autonomous factory, autonomous manufacturing, digital thread, digital twin, Digital Twin Consortium, ISO 23247, asset performance management, APM, equipment effectiveness, OEE, overall equipment effectiveness, MTBF, mean time between failures, MTTR, mean time to repair, MTTA, mean time to acknowledge, MTTD, mean time to detect, FMEA, failure modes effects analysis, FMEA-MSR, RCM, reliability centered maintenance, reliability centred maintenance, predictive maintenance, prescriptive maintenance, condition-based maintenance, CBM, vibration analysis, oil analysis, thermography, infrared thermography, IR thermography, partial discharge analysis, PD analysis, ultrasonic analysis, motor current signature analysis, MCSA, EMTP, ANSYS Twin Builder, MATLAB Simulink, Simulink, Simulink digital twin, NVIDIA Omniverse, AVEVA Plant Information Management, AVEVA, AVEVA PI, OSIsoft PI, PI System, PI Server, PI Vision, PI Asset Framework, PI AF, PI Web API, AVEVA System Platform, AVEVA Plant SCADA, AVEVA Edge, AVEVA Insight, GE Digital Predix, Predix, GE Digital iFix, iFix, GE CIMPLICITY, CIMPLICITY, GE Digital Proficy, Proficy, Honeywell Forge, Honeywell Experion, Experion, Honeywell PHD, Process History Database, PHD, Yokogawa CENTUM VP, CENTUM VP, Yokogawa Exaquantum, Emerson DeltaV, DeltaV, Emerson Ovation, Ovation, Emerson Plantweb, Plantweb, Emerson Plantweb Optics, Plantweb Optics, Schneider Electric EcoStruxure, EcoStruxure, Schneider Modicon, Modicon, Schneider Wonderware, Wonderware, ABB 800xA, 800xA, ABB Ability, ABB Edge Genix, Genix, Siemens Insights Hub, Insights Hub, MindSphere, Siemens MindSphere, Siemens SINEC, SINEC, Siemens Industrial Edge, Industrial Edge, Siemens TIA Portal, TIA Portal, Siemens SIMATIC, SIMATIC, S7, S7-1500, S7-1200, Profinet IO, Mitsubishi MELSEC, MELSEC, Mitsubishi MELFA, MELFA, MELSOFT, GX Works3, Omron Sysmac, Sysmac, NJ controller, NJ-series, NX-series, NJ501, Hitachi EH series, Beckhoff TwinCAT, TwinCAT 3, B&R Automation, B&R, Aprol, Power Automation, Power Engineer]
splunkbase_urls:
  - https://splunkbase.splunk.com/app/3110
  - https://splunkbase.splunk.com/app/3260
...
sourcetypes:
  ...
  - ms:o365:audit:exchange
  - ms:o365:audit:sharepoint
  - ms:o365:audit:azuread
  - ms:o365:audit:onedrive
  - ms:o365:audit:teams
  - ms:o365:audit:powerbi
  - mscs:azure:eventhub
  - msdef:o365:alert
  - msdef:identity:alert
  - gws:reports:login
  - gws:reports:admin
  - gws:reports:drive
  - gws:reports:gmail
  - gws:reports:meet
  - cisco:webex:meetings:history
  - cisco:webex:meetings:attendee
  - cisco:webex:calling:cdr
  - cisco:webex:calling:cmr
  - cisco:webex:audit
  - cisco:webex:devices
  - cisco:ucm:cdr
  - cisco:ucm:cmr
  ...
  - splunk:edge_hub:sensor
  - splunk:edge_hub:opcua
  - splunk:edge_hub:modbus
  - splunk:edge_hub:mqtt
  - splunk:edge_hub:bacnet
  - splunk:edge_hub:snmp
  - opcua:metrics
  - modbus:tcp
  - mqtt:topic
  - bacnet:object
  ...
  - litmus:edge
  - nozomi:guardian
ta_versions: "Splunk Add-on for Microsoft Cloud Services 5.x; Splunk Add-on for Microsoft 365 1.x; Splunk Add-on for Microsoft 365 Defender 2.x; Splunk Add-on for Google Workspace 2.x; Cisco Webex Meetings Add-on 1.x; Cisco UCM Add-on 4.x; Cisco ESA Add-on 4.x; Cisco Cyber Vision Add-on 4.x; Splunk Add-on for OPC-UA 1.x; Splunk Add-on for Modbus 1.x; Splunk Connect for Syslog 3.x; Splunk Connect for SNMP 1.x"
splunk_versions: "9.0, 9.1, 9.2, 9.3, 9.4 (current), 10.0+; Splunk Cloud Platform"
cross_products: [Cisco Webex (cat 11.3.x + 11.5.x — webex.md), Microsoft 365 (cat 11.1.x — microsoft-365.md), Google Workspace (cat 11.2.x — google-workspace.md), Cisco UCM (cat 11.3.x — cisco-ucm.md), Cisco ESA (cat 11.4.x — cisco-esa.md), Cisco Cyber Vision (cat 14.9.x — cisco-cyber-vision.md), Cisco Edge Intelligence (cat 14.5.x — cisco-edge-intelligence.md), Splunk Edge Hub (cat 14.3.x — splunk-edge-hub.md), Cisco Meraki MT sensors (cat 14.1.x — meraki-mt.md), Zeek ICS (cat 14.7.x — zeek-ics.md), Litmus Edge (cat 14.5.x — litmus-edge.md), Operational Telemetry data model — operational-telemetry-data-model.md, IoT/OT integration patterns — iot-ot.md]
compliance_frameworks: [ISA/IEC 62443 (zones + conduits + SR security requirements), NIST SP 800-82 r3 (Guide to ICS Security), NERC CIP-002 thru CIP-013 (electric sector), TSA Pipeline Security Directive SD-2 + SD-3, FDA 21 CFR Part 11 (electronic records / signatures) + GxP, EPA America's Water Infrastructure Act (AWIA), EU NIS2 (essential entities + important entities), GDPR + CCPA (collaboration audit trails for personal data), HIPAA (collaboration tools handling PHI), SOC 2 (collaboration availability + processing integrity), MITRE ATT&CK for ICS, MITRE D3FEND, ENISA OT recommendations, ISO/IEC 27019 (energy utility), ISO 22301 BCMS for OT continuity, ASHRAE 188 (Legionella prevention), HSG274 (UK Legionella), F-Gas Regulation EU 2024/573 + EPA SNAP / Section 608, FOUNDATION Fieldbus + HART safety, IEC 61508 (functional safety) + IEC 61511 (process safety), ISA-84.00.01 (process safety integrity), Cisco Validated Designs (CVDs) for OT segmentation]
maturity_tiers: {crawl: 18, walk: 50, run: 40}
...
|---|---|---|
| **CISO** | Cross-domain BEC + OT threat picture, compliance mapping (NIS2 essential entity, IEC 62443 SR) | `security-monitoring.md`, `iot-ot.md` |
...
| **Compliance Officer** | NIS2 + IEC 62443 + NERC CIP + AWIA + 21 CFR Part 11 evidence | `compliance-business.md`, `docs/evidence-packs/` |
...
10. **Splunk Edge Hub** sensor + protocol adapter → `edge_hub*`.
...
```mermaid
flowchart LR
    subgraph "Collaboration Source Plane (cat-11)"
        M365[Microsoft 365<br/>EXO + Teams + SPO + ODB]
        DEFENDER[Microsoft Defender<br/>Office 365 + Identity + Cloud Apps]
        GWS[Google Workspace<br/>Gmail + Drive + Meet + Calendar]
        WEBEX[Cisco Webex<br/>Meetings + Calling + Devices + CC]
        UCM[Cisco UCM<br/>CDR + CMR + UC apps]
        ESA[Cisco ESA<br/>Mail policy + AMP + Talos]
    end

    subgraph "OT/IoT Source Plane (cat-14)"
        PLC[PLC + RTU + IED<br/>Allen-Bradley / Siemens / Modicon]
        DCS[DCS<br/>Honeywell / Yokogawa / Emerson / ABB]
        HMI[HMI + Historian<br/>AVEVA PI / OSIsoft / iFix]
        SCADA[SCADA<br/>FactoryTalk / WonderWare / GE]
        BMS[BMS / BAS<br/>HVAC / Lighting / Access / Fire]
        SENSOR[IoT Sensors<br/>Meraki MT / Litmus / OEM]
        ROUTER[Cisco IR + IE<br/>IR1101 / IR8100 / IE3300]
    end

    subgraph "OT Discovery Plane"
        CV[Cisco Cyber Vision<br/>passive deep-packet]
        NOZOMI[Nozomi Guardian /<br/>Claroty xDome /<br/>Dragos / Forescout]
        ZEEK[Zeek ICS scripts<br/>passive on SPAN]
        SCANNER[active scanners<br/>off by default]
    end

    subgraph "Splunk Ingest / Edge Tier"
        SC4S[SC4S syslog]
        SCSNMP[SC4SNMP]
        REST[REST API modular<br/>OAuth2 + Webhook]
        HEC[Splunk HEC<br/>OTel + Edge Hub<br/>+ Edge Intelligence]
        UF[Universal Forwarder]
        EH[Splunk Edge Hub<br/>OPC-UA / Modbus / MQTT /<br/>BACnet / SNMP onboard sensors]
        EI[Cisco Edge Intelligence<br/>Data Rules + Data Logic JS]
    ...
    IDX --> CIM[CIM data models +<br/>Operational Telemetry DM +<br/>OT Security DM]

    CIM --> ES[Splunk ES<br/>+ ESCU + RBA risk scoring]
    CIM --> ITSI[Splunk ITSI<br/>OT service tree<br/>+ collaboration service tree]
    CIM --> SOAR[Splunk SOAR<br/>BEC + OT playbooks]

    ES --> NOTABLE[Notable events<br/>+ ICS-CERT + KEV<br/>+ MITRE ATT&CK ICS]
    ITSI --> SCORECARD[Plant Health Scorecards<br/>+ Mail Flow Glass Tables]

    NOTABLE --> EVIDENCE[audit_evidence<br/>+ ot_security index<br/>RBAC + immutable]
    SCORECARD --> EVIDENCE
    SOAR --> EVIDENCE

    EVIDENCE --> NIS2_REPORTING[NIS2 essential entity<br/>24h early warning]
    EVIDENCE --> IEC62443[IEC 62443 zone /<br/>conduit attestation]
    EVIDENCE --> NERC[NERC CIP CIP-005 /<br/>CIP-007 / CIP-013]
    EVIDENCE --> AWIA[EPA AWIA water<br/>cyber attestation]
    EVIDENCE --> CFR21[FDA 21 CFR Part 11<br/>electronic records]

    classDef collab fill:#e1f5ff,stroke:#0ea5e9,color:#075985
    classDef ot fill:#fef3c7,stroke:#f59e0b,color:#78350f
    classDef discovery fill:#dcfce7,stroke:#16a34a,color:#166534
    classDef ingest fill:#fce7f3,stroke:#db2777,color:#831843
    classDef analytics fill:#ede9fe,stroke:#7c3aed,color:#4c1d95
    classDef compliance fill:#fef2f2,stroke:#ef4444,color:#7f1d1d

    class M365,DEFENDER,GWS,WEBEX,UCM,ESA collab
    class PLC,DCS,HMI,SCADA,BMS,SENSOR,ROUTER ot
    class CV,NOZOMI,ZEEK,SCANNER discovery
    class SC4S,SCSNMP,REST,HEC,UF,EH,EI,STREAM,EP ingest
    class IDX,CIM,ES,ITSI,SOAR,NOTABLE,SCORECARD analytics
    class EVIDENCE,NIS2_REPORTING,IEC62443,NERC,AWIA,CFR21 compliance
```
...
- **Contact Center**: bridge JSON / HEC pipelines as first-class
  ...
  per skill group.
- **Audit**: `cisco:webex:audit` for SOC 2-style change control
...
| **GDPR Art. 32** | Mail | 11.1.8 + audit retention |
| **HIPAA Security Rule** | Mail | M365 audit + holds for ePHI |

...
For SOC 2 CC6.6 and ISO 27017 audits, the auditor wants **one place
...
provider's CloudWatch / Azure Monitor / Cloud Monitoring service.
...
2. **CSPM findings always go to a 7-year retention class.** SOC 2
   ISO 27001 PCI DSS HIPAA NIS2 DORA evidence retention all converge

...
> Palo Alto Networks, Fortinet FortiGate, Cisco Firepower/ASA, Check
...
| **Splunk Enterprise Security** | Optional but strongly recommended for the SOC use cases |
...
- Palo Alto PAN-OS (all log types)

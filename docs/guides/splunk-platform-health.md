...
- **Splunk on Splunk (SoS)** — older Splunkbase<sup class="ref">[<a href="#ref-12">12</a>]</sup> app for additional visualisations
...
| Splunk Lantern<sup class="ref">[<a href="#ref-9">9</a>]</sup> - Platform monitoring | [lantern.splunk.com](https://lantern.splunk.com) (search "monitoring console") |
...
<a id="ref-3"></a>**[3]** AXELOS. (2019). *ITIL 4 — IT service management practices* (4th edition). https://www.axelos.com/certifications/itil-service-management

<a id="ref-4"></a>**[4]** Beyer, B., Jones, C., Petoff, J., & Murphy, N. R. (Eds.). (2016). *Site Reliability Engineering: How Google Runs Production Systems*. O'Reilly Media. ISBN 978-1491929124. https://sre.google/sre-book/table-of-contents/

<a id="ref-5"></a>**[5]** Gregg, B. (2012). *The USE Method: Utilization, Saturation, and Errors*. brendangregg.com. https://www.brendangregg.com/usemethod.html
...
<a id="ref-13"></a>**[13]** docs.splunk.com. *docs.splunk.com/Documentation/Splunk/latest/DMC*. Retrieved May 11, 2026, from https://docs.splunk.com/Documentation/Splunk/latest/DMC

<a id="ref-14"></a>**[14]** splunk.com. *www.splunk.com/en_us/pdfs/tech-brief/splunk-validated-architectures.pdf*. Retrieved May 11, 2026, from https://www.splunk.com/pdfs/tech-brief/splunk-validated-architectures.pdf

<a id="ref-15"></a>**[15]** splunkbase.splunk.com. *splunkbase.splunk.com/app/4055*. Retrieved May 11, 2026, from https://splunkbase.splunk.com/app/4055

<a id="ref-16"></a>**[16]** splunkbase.splunk.com. *splunkbase.splunk.com/app/748*. Retrieved May 11, 2026, from https://splunkbase.splunk.com/app/748

<a id="ref-17"></a>**[17]** docs.splunk.com. *docs.splunk.com/Documentation/SplunkCloud/latest/Admin*. Retrieved May 11, 2026, from https://docs.splunk.com/Documentation/SplunkCloud/latest/Admin

<a id="ref-18"></a>**[18]** lantern.splunk.com. *Splunk Lantern: article*. Retrieved May 11, 2026, from https://lantern.splunk.com

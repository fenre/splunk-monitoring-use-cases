...
> The definitive guide to monitoring Windows Server fleets with Splunk —
...
> trails for SOX, PCI, HIPAA, and CIS Microsoft Benchmarks. 130 use cases
...
MDE forwards alerts to the Microsoft 365 Defender unified console; pull via the [Microsoft 365 Defender Add-on for Splunk](https://splunkbase.splunk.com/app/6207). Correlate with WinEventLog:
...
| Splunk CIM | [docs.splunk.com/Documentation/CIM](https://docs.splunk.com/Documentation/CIM/latest/User/Overview) |

...
| HIPAA Security Rule<sup class="ref">[<a href="#ref-14">14</a>]</sup> (BAA scope) | `docs/evidence-packs/hipaa-security.md` | 4.1.7 S3 + 4.2.x storage + 4.3.x storage |
| PCI DSS 4.0 (cloud merchant) | `docs/evidence-packs/pci-dss.md` | 3.x container security + 4.x cloud security |
| GDPR<sup class="ref">[<a href="#ref-5">5</a>]</sup> | `docs/evidence-packs/gdpr.md` | All cat-4 |
| NIS2<sup class="ref">[<a href="#ref-4">4</a>]</sup> | `docs/evidence-packs/nis2.md` | All cat-4 + cat-3 |
| DORA<sup class="ref">[<a href="#ref-6">6</a>]</sup> | `docs/evidence-packs/dora.md` | 4.x ICT third-party + 20.x resilience |
...
- Splunk Observability Cloud<sup class="ref">[<a href="#ref-1">1</a>]</sup> — https://docs.splunk.com/Observability
...
<a id="ref-18"></a>**[18]** splunkbase.splunk.com. *Splunkbase app #2882*. Retrieved May 11, 2026, from https://splunkbase.splunk.com/app/2882
...
<a id="ref-20"></a>**[20]** splunkbase.splunk.com. *Splunkbase app #4055*. Retrieved May 11, 2026, from https://splunkbase.splunk.com/app/4055

<a id="ref-21"></a>**[21]** splunkbase.splunk.com. *Splunkbase app #4995*. Retrieved May 11, 2026, from https://splunkbase.splunk.com/app/4995

<a id="ref-22"></a>**[22]** splunkbase.splunk.com. *Splunkbase app #5557*. Retrieved May 11, 2026, from https://splunkbase.splunk.com/app/5557
...
<a id="ref-26"></a>**[26]** docs.aws.amazon.com. *AWS Documentation: Evaluate Config*. Retrieved May 11, 2026, from https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config.html

<a id="ref-27"></a>**[27]** docs.aws.amazon.com. *AWS Documentation: Guardduty*. Retrieved May 11, 2026, from https://docs.aws.amazon.com/guardduty/

<a id="ref-28"></a>**[28]** docs.aws.amazon.com. *AWS Documentation: Securityhub*. Retrieved May 11, 2026, from https://docs.aws.amazon.com/securityhub/

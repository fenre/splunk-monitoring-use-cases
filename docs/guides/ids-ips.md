...
> Firepower, Palo Alto Threat Prevention, FortiGate IPS, Check Point
...
> pipeline through Splunk Enterprise Security.
...
> Intrusion_Detection CIM, ready for ES correlation, MITRE ATT&CK
...
- **Compliance requirement** — explicit in PCI-DSS 11.x, NIST CSF DE.CM-1
...
PAN-OS Threat logs cover IPS, Antivirus, Anti-spyware, URL filtering, WildFire, DNS Security.

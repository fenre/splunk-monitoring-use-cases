...
1. **Install Cisco ThousandEyes App for Splunk** ([Splunkbase 7719](https://splunkbase.splunk.com/app/7719)) on a Heavy Forwarder or search head with management capability.
...
**Q: Can I get test results into Splunk Observability Cloud (Splunk APM)?**

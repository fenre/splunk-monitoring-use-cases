...
> ecosystem **outside vanilla Kubernetes** — Docker Engine + Compose
> hosts, Red Hat OpenShift Container Platform, container registries
...
3. **Registry push events are not optional.** If a developer pushes
   ...
   non-negotiable for SOC 2 / PCI / HIPAA evidence.
...
- **CIS Kubernetes Benchmark** — see `kubernetes.md`
...
(US federal SBOM mandate) and EU NIS2 supply-chain provisions.
...
Highlights:
- NIST SP 800-190 evidence pack auto-generation
...
- EU AI Act art. 9/12/15 evidence for AI-serving containers

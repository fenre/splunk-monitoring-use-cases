...
| **Compliance Officer** | NIS2 / DORA / SOC 2 / ISO 27001 / NERC CIP / PCI DSS / FedRAMP infrastructure-control evidence | `compliance-business.md`, `docs/evidence-packs/` |
...
| **GDPR Art. 32** | All | Security of processing |

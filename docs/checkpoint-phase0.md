...
|---|---|---:|---|
| Interview guide | `docs/auditor-research/interview-guide.md` | 174 lines | 45-minute structured interview with QSA / DPO / SOC-2 / ISO / SOX<sup class="ref">[<a href="#ref-6">6</a>]</sup> variants; covers consent, evidence-pack realities, clause-level vocabulary tests. |
...
* Target sample: **≥ 12 interviews** spread across 3 framework clusters
  (financial/SOX + PCI, privacy/GDPR<sup class="ref">[<a href="#ref-2">2</a>]</sup> + HIPAA<sup class="ref">[<a href="#ref-8">8</a>]</sup>, public-sector/NIS2<sup class="ref">[<a href="#ref-1">1</a>]</sup> + DORA<sup class="ref">[<a href="#ref-3">3</a>]</sup>)
...
APRA CPS 234, EU AI Act<sup class="ref">[<a href="#ref-4">4</a>]</sup>, EU CRA, eIDAS 2.0, and six more. All are

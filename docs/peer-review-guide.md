...
- `data/crosswalks/**` — the ATT&CK<sup class="ref">[<a href="#ref-4">4</a>]</sup>, D3FEND<sup class="ref">[<a href="#ref-5">5</a>]</sup>, OSCAL, and OLIR crosswalks.
...
2. For every `compliance[]` entry, grep the regulation's version in
   ...
   format in `commonClauses[]`. Example for GDPR<sup class="ref">[<a href="#ref-2">2</a>]</sup>:
   ```bash
...
- `derivationSource.inheritanceMode` must match the mode declared in
  `regulations.json` (`identity` for UK GDPR<sup class="ref">[<a href="#ref-10">10</a>]</sup>; `mapped` for the
  others).
...
<a id="ref-1"></a>**[1]** California Office of the Attorney General. (2020). *California Consumer Privacy Act / California Privacy Rights Act*. State of California. CA Civ Code § 1798.100 et seq. https://oag.ca.gov/privacy/ccpa
...
<a id="ref-3"></a>**[3]** Federative Republic of Brazil. (2018). *Lei Geral de Proteção de Dados Pessoais (LGPD)*. Government of Brazil. Lei nº 13.709/2018. https://www.gov.br/anpd/pt-br

<a id="ref-4"></a>**[4]** MITRE Corporation. (2026). *MITRE ATT&CK Knowledge Base*. MITRE Engenuity. https://attack.mitre.org/

<a id="ref-5"></a>**[5]** MITRE Corporation. (2026). *MITRE D3FEND Knowledge Graph*. MITRE. https://d3fend.mitre.org/
...
<a id="ref-10"></a>**[10]** United Kingdom Parliament. (2018). *Data Protection Act 2018 (UK GDPR, retained EU law)*. The Stationery Office. 2018 c. 12. https://www.legislation.gov.uk/ukpga/2018/12/contents

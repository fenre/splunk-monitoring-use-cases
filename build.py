...
def write_data_js(data, cat_meta, output_path, recently_added=None):
    """Write data.js with DATA, CAT_META, CAT_GROUPS, EQUIPMENT, FILTER_FACETS, and RECENTLY_ADDED."""
...
def main():
    ...
    size_kb = write_data_js(data, cat_meta, OUTPUT, recently_added)

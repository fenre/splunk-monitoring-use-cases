...
**User intent:** "What GDPR<sup class="ref">[<a href="#ref-3">3</a>]</sup> clauses don't have any Splunk coverage in this catalog?"
...
**User intent:** "I have Cisco ISE<sup class="ref">[<a href="#ref-2">2</a>]</sup>. What can I monitor?"

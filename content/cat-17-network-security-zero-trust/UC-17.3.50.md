...
- `stats` rolls up events into metrics; results are split **by src_asset, dst_asset, dst_port, process_name** so each row reflects one combination of those dimensions.

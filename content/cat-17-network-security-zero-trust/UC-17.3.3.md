...
- `stats` rolls up events into metrics; results are split **by src_workload, dest_workload, dest_port, policy_name** so each row reflects one combination of those dimensions.

...
Step 3 — Validate
Reconcile each scorecard KPI to the system that owns that number: ERP, CRM dashboard, support tool, HR, and the planning or BI tool leadership trusts. For blended KPIs, use the same time zone, currency, and definitions as the board pack.

<!-- AUTO-GENERATED from UC-16.1.23.json — DO NOT EDIT -->
...
*We see what share of standard requests we finish in good order, so we can balance people and process with demand.*
...
Slower or fewer completions with approver PTO, customer waits, vendor delays, and intake spikes after a large incident.

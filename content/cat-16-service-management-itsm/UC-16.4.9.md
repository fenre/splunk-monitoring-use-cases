<!-- AUTO-GENERATED from UC-16.4.9.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Change, Performance

*We count how often we have to back out, so we know when a train or a platform is still too risky for comfort.*
...
Rollbacks that spike in big cutovers, legacy retirements, or stricter post-audit close codes.

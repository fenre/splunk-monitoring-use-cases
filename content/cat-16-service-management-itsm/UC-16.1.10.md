<!-- AUTO-GENERATED from UC-16.1.10.json — DO NOT EDIT -->
...
*We time how long routine requests take end to end, so we can trim slow steps in catalog and approval paths.*

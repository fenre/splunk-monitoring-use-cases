...
*We check whether we resolve and respond inside the time we promised, so we know when service levels slip and which teams need support.*
...
Compliance dips with seasonal ticket mix, new targets, or month-end pushes; compare with the official report before a hard escalation.

<!-- AUTO-GENERATED from UC-16.3.6.json — DO NOT EDIT -->
...
> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Compliance &middot; **Status:** Verified

*We follow big incidents from start through the learning write-up, so the big ones do not close without a lesson.*

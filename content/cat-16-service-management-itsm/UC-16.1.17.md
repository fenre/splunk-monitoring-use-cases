...
*We check whether we close the way our policy says, so automated or bulk closes do not hide real work.*
...
Auto-close and workflow noise during template updates, new teams learning closure reasons, or a workflow upgrade weekend.

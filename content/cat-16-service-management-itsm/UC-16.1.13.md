<!-- AUTO-GENERATED from UC-16.1.13.json — DO NOT EDIT -->
...
*We track how often work jumps up the on-call chain, so we can see real pressure versus noisy or mis-tuned rules.*
...
On-call and escalation noise from flapping tools, new monitoring, or one big issue that bounces through many names.

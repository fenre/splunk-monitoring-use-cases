<!-- AUTO-GENERATED from UC-16.3.15.json — DO NOT EDIT -->
...
> **Criticality:** High &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Performance, Compliance

*We surface problem records that sit open, so the organization either drives root-cause work or says why the problem stays open on purpose.*
...
Stale or old records while waiting on a vendor, a customer reply, a patch, or work we chose to park on purpose.

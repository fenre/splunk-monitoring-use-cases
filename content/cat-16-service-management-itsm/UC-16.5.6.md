<!-- AUTO-GENERATED from UC-16.5.6.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Compliance, Performance

*We trend whether we answer inside the time we promised, so first-touch habits stay in line with the contract and the story we tell the business.*

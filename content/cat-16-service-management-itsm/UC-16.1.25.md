...
> **Criticality:** Critical &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Performance, Compliance

*We compare first human touch to what we said we would do, so customers are not left waiting in silence.*
...
MTTR and response drifts from harder incidents, new staff, on-call experience mix, or a wider scope of what we close as done.

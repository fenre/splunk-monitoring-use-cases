<!-- AUTO-GENERATED from UC-16.2.3.json — DO NOT EDIT -->
...
*We find things that have no good parent in the book of record, so ownership and support lines stay clear.*
...
- Ensure the following data sources are available: ServiceNow configuration items (snow:cmdb_ci) with owner, support group, and business service mapping.

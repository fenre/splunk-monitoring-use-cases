...
*We trend how often work jumps a level, so understaffing, noisy tools, and real sev-1s show up in one line on the page.*
...
Trend lines that move with seasonality, a new reporting job, a field change in the tool, or a few loud weeks in operations.

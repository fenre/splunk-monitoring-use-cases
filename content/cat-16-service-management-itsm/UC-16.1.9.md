...
*We line up change activity with a burst of customer issues, so we can tell a real break from coincidence fast.*
...
Loose cause links when many incidents land near the same change window; not every line is a true regression.

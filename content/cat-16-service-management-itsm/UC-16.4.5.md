...
> **Criticality:** High &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Operations, Risk

*We watch how often we use emergency change, so a culture of rush does not become the normal way we ship.*
...
High emergency counts during sev-1s, hotfix waves, and new environments that are still shaky; pair with the incident log.

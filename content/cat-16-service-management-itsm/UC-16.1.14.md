<!-- AUTO-GENERATED from UC-16.1.14.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Performance, Compliance

*We look for work at risk of missing its promise time, so we can act while there is still room to help the customer.*
...
SLA pressure during shift handoffs, night and weekend work with few people, or holiday and regional long weekends with thin coverage.

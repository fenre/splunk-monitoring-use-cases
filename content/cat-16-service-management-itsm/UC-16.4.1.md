<!-- AUTO-GENERATED from UC-16.4.1.json — DO NOT EDIT -->
...
*We look for change work that is missing the nod we said we need, so risky moves do not land without the right eyeballs.*
...
Apparent bypass during emergency work, pre-approved break-glass, or late documentation right after a sev-1.

...
*We watch hardware that is out of or near end of support, so we replace or extend before a failure in the night.*
...
Date-driven alerts that race with refresh cycles, bulk imports, and hardware still under a vendor with a different record.

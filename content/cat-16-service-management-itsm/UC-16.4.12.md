...
> **Criticality:** Medium &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Compliance, Operations

*We watch how many changes ride the pre-approved, lighter path, so we are not abusing a fast lane for work that is not really standard.*
...
Standard versus normal mix when you add pre-approved types, retrain, or run an audit that changes what people pick.

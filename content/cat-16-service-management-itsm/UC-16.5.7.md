<!-- AUTO-GENERATED from UC-16.5.7.json — DO NOT EDIT -->
...
> **Criticality:** Medium &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Capacity, Operations

*We trend how people reach us by phone, portal, and chat, so we staff and train for the way the world really contacts us.*
...
- `stats` rolls up events into metrics; results are split **by _time, ch** so each row reflects one combination of those dimensions.
...
Shifts in how people reach us after portal, chat, and phone rollouts, or when a big outage drives everyone to one channel.

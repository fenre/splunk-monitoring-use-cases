<!-- AUTO-GENERATED from UC-16.1.16.json — DO NOT EDIT -->
...
*We break out old work by how urgent it is, so the right leaders see what must not wait.*
...
- `stats` rolls up events into metrics; results are split **by pri, bucket** so each row reflects one combination of those dimensions.

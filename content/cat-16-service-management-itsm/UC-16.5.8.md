<!-- AUTO-GENERATED from UC-16.5.8.json — DO NOT EDIT -->
...
*We trend how much in-flight work we carry by how urgent it is, so the queue does not grow quietly until we miss every promise.*
...
Backlog and work-in-process swings during freezes, year-end code lock, or a slow vendor for many tickets at once.

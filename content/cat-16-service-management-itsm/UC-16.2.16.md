<!-- AUTO-GENERATED from UC-16.2.16.json — DO NOT EDIT -->
...
> **Criticality:** High &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Compliance, Performance

*We find things we have not re-seen in a long time, so we refresh or retire before we plan on bad truth.*
...
- `stats` rolls up events into metrics; results are split **by ci_class, support_group** so each row reflects one combination of those dimensions.

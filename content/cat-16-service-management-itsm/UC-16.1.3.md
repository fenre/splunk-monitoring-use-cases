<!-- AUTO-GENERATED from UC-16.1.3.json — DO NOT EDIT -->
...
*We measure how long it takes to fix different kinds of work, so we can see which areas drag and whether we are improving over time.*

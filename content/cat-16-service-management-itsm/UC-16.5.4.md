<!-- AUTO-GENERATED from UC-16.5.4.json — DO NOT EDIT -->
...
*We trend fix time by how urgent work is, so we see if our promises to customers are drifting over the quarters.*
...
- `stats` rolls up events into metrics; results are split **by priority, _time** so each row reflects one combination of those dimensions.

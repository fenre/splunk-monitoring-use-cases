<!-- AUTO-GENERATED from UC-16.1.6.json — DO NOT EDIT -->
...
*We watch how many underlying problems are open and moving, so we can fund root-cause work before the same pain keeps coming back.*
...
- `stats` rolls up events into metrics; results are split **by category, subcategory, cmdb_ci** so each row reflects one combination of those dimensions.
...
Problem work rising during big outages, vendor bugs, and right after a major product release; context matters for trend pages.

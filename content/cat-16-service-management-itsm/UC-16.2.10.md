...
*We find systems that are live but not in the book, so we add them, own them, and protect them on purpose.*
...
Unknown installs and license gaps from BYOD-style tools, new packaging, and shadow projects that are not in the inventory feed yet.

...
*We check required fields for each class of thing we track, so every record is fit for the job we ask the book to do.*
...
Coverage gaps while onboarding new systems, after mergers, during discovery or field changes, or when teams skip owner updates in busy months.

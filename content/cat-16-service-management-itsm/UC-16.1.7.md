<!-- AUTO-GENERATED from UC-16.1.7.json — DO NOT EDIT -->
...
*We watch how often we move work between people, so we can see unclear intake, shaky handoffs, or a team that is overloaded.*
...
Reassignments from severity changes, support model cutovers, or a very large event touching many groups.

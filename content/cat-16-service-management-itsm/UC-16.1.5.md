<!-- AUTO-GENERATED from UC-16.1.5.json — DO NOT EDIT -->
...
*We look for two pieces of work that might step on the same thing at once, so we can coordinate before a window turns into a customer surprise.*

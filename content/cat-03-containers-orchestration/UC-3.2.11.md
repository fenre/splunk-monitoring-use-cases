...
HPA scaling events show when applications are hitting capacity. Repeated max-scale events indicate undersized limits or unexpected traffic.
...
Line chart (replica count over time), Table of scaling events, Area chart.

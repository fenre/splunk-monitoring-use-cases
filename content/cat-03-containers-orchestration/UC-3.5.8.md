...
• `stats` rolls up events into metrics; results are split **by cluster_name, destination_service_name** so each row reflects one combination of those dimensions.

...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Fault, Availability, Performance &middot; **Wave:** Crawl &middot; **Status:** Verified

*When one of the small programs in the system keeps failing, a safety switch automatically stops sending it work to prevent the problem from spreading — we monitor when those safety switches activate so the team can fix the broken program.*

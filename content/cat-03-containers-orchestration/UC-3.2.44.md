...
---
id: "3.2.44"
title: "Node Pool Auto-Repair Events"
criticality: "medium"
...
Managed Kubernetes auto-replace unhealthy nodes; tracking repairs explains brief capacity dips and correlates with hardware or image issues.
...
• `stats` rolls up events into metrics; results are split **by cluster_name, node_pool, _raw** so each row reflects one combination of those dimensions.
...
Timeline (repairs), Table (pool, message), Single value (repairs/day).

...
- [kube-state-metrics — PodDisruptionBudget metrics](https://github.com/kubernetes/kube-state-metrics/blob/main/docs/metrics/workload/)
- [Google Kubernetes Engine — Pod disruption budgets](https://cloud.google.com/kubernetes-engine/docs/how-to/)

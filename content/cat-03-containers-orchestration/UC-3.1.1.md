...
- [Docker CLI reference — docker events](https://docs.docker.com/reference/cli/docker/events/)
- [Linux kernel documentation — cgroup v2](https://www.kernel.org/doc/Documentation/cgroup-v2.txt)
- [Splunk Observability — OpenTelemetry Collector for Kubernetes (containers agent install)](https://docs.splunk.com/observability/en/gdi/opentelemetry/install-k8s.html)

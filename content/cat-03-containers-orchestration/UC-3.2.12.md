...
• `stats` rolls up events into metrics; results are split **by user.username, verb, objectRef.resource, objectRef.namespace** so each row reflects one combination of those dimensions.

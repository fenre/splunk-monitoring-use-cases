...
• `stats` rolls up events into metrics; results are split **by metric_name, namespace, persistentvolumeclaim, node** so each row reflects one combination of those dimensions.

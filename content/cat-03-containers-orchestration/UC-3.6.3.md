...
Deployments per day or week by namespace show delivery cadence and whether release practices are steady or chaotic. Sudden drops or spikes often correlate with code freezes, incidents, or CI/CD automation changes.
...
Column chart (deployments per period by namespace), line chart (weekly total velocity trend).

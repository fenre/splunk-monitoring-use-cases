...
---
id: "3.2.40"
title: "Persistent Volume Snapshot Status"
criticality: "medium"
...
Failed or stale snapshots break restore RPO; monitoring `VolumeSnapshot` and CSI driver status supports backup verification.
...
Table (snapshot, status), Timeline, Single value (failed snapshots 24h).

<!-- AUTO-GENERATED from UC-2.6.3.json — DO NOT EDIT -->
...
*We keep an eye on connection Failure Analysis and raise the alarm before it drags down real work or real outages start.*
...
- `stats` rolls up events into metrics; results are split **by failure_type, delivery_group, _time** so each row reflects one combination of those dimensions.

...
*We keep an eye on resource Pool Utilization and Limits and raise the alarm before it drags down real work or real outages start.*
...
Pool limit breaches may come from time-boxed test spikes or month-end jobs; use baselines and known batch windows to avoid paging for expected bursts.

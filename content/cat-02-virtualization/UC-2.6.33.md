...
*We follow when the system turns virtual computers on and off to match the day, and when that schedule slips or the machines fail to start — so you catch wasted power or a thin pool before it hurts real work.*

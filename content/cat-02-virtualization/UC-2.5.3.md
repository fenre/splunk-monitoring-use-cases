<!-- AUTO-GENERATED from UC-2.5.3.json — DO NOT EDIT -->
...
*We keep an eye on iGEL UMS Server Health and raise the alarm before it drags down real work or real outages start.*
...
- `stats` rolls up events into metrics; results are split **by ums_server** so each row reflects one combination of those dimensions.

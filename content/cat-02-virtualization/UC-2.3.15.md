<!-- AUTO-GENERATED from UC-2.3.15.json — DO NOT EDIT -->
...
> **Criticality:** Medium &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Configuration, Security

*We keep an eye on disk Cache Mode Audit and raise the alarm before it drags down real work or real outages start.*
...
- `stats` rolls up events into metrics; results are split **by host, vm_name, disk_target** so each row reflects one combination of those dimensions.
...
KVM and scripted metrics may gap when collectors restart, SSH keys roll, or virsh is blocked by lockfiles; a single null interval is not always a full outage.

...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Performance, Capacity

*We count how many virtual desktops start at the same time and flag unusual surges, so you calm a boot storm before storage and the hypervisor layer choke and the morning shift cannot log in.*

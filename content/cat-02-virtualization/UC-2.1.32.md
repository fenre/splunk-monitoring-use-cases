<!-- AUTO-GENERATED from UC-2.1.32.json — DO NOT EDIT -->
...
*We keep an eye on host Certificate Expiration and raise the alarm before it drags down real work or real outages start.*
...
Certificate warnings can repeat during staged re-issuance, mixed-version clusters, or when a replacement CA is not yet trusted on every management client.

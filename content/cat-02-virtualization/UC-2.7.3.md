...
> **Criticality:** Critical &middot; **Difficulty:** Advanced &middot; **Pillar:** IT Operations &middot; **Type:** Availability, Fault &middot; **Status:** Verified

*We listen for signs that the servers lost agreement on who is in charge, which is when automatic fixes can accidentally make things worse unless people step in carefully.*
...
Nutanix Prism alerts and jobs can line up with disk rebuilds, rolling upgrades, or RF changes; wait for the cluster task list to show completion before over-reacting to transient counters.

...
*We track when your virtual machines wait too long for CPU time, so we can catch overload or unfair resource shares before the slowness hits real work.*
...
CPU ready time can spike during vMotion, host maintenance mode, DRS rebalancing, or right after power-on; correlate with change windows and cluster load before re-sizing VMs.

<!-- AUTO-GENERATED from UC-2.1.38.json — DO NOT EDIT -->
...
*We keep an eye on host Syslog Forwarding Health and raise the alarm before it drags down real work or real outages start.*

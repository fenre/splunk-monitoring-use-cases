<!-- AUTO-GENERATED from UC-2.4.7.json — DO NOT EDIT -->
...
> **Criticality:** Medium &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Availability, Fault

*We keep an eye on oVirt / RHV Data Center Health and raise the alarm before it drags down real work or real outages start.*
...
- `stats` rolls up events into metrics; results are split **by id** so each row reflects one combination of those dimensions.
...
Citrix and NetScaler signals may reflect planned catalog publishes, autoscale, or ADC failover exercises; use delivery-group and change metadata before treating as a defect.

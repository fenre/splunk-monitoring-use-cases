...
> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Performance, Availability &middot; **Status:** Verified

*We time how long it takes to move a running computer from one physical machine to another, and flag when those moves fail or drag on.*

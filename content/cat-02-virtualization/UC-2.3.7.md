<!-- AUTO-GENERATED from UC-2.3.7.json — DO NOT EDIT -->
...
*We keep an eye on host CPU Model and Migration Compatibility and raise the alarm before it drags down real work or real outages start.*

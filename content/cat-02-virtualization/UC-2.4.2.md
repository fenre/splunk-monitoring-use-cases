<!-- AUTO-GENERATED from UC-2.4.2.json — DO NOT EDIT -->
...
*We keep an eye on backup Coverage Validation and raise the alarm before it drags down real work or real outages start.*

<!-- AUTO-GENERATED from UC-2.3.14.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Availability, Capacity

*We keep an eye on zFS Pool Health for Proxmox/KVM and raise the alarm before it drags down real work or real outages start.*

...
*We check how hard each session host is hitting its disks and how full its local write cache is, so you run out of room before a freeze or mass logon failure, not after.*

...
*We keep an eye on affinity and Anti-Affinity Rule Violations and raise the alarm before it drags down real work or real outages start.*
...
Rule violations can show during rolling moves, DRS rebalancing, or host evacuations; treat as urgent only if the cluster cannot restore compliance on its own.

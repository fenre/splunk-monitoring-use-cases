<!-- AUTO-GENERATED from UC-2.1.24.json — DO NOT EDIT -->
...
*We keep an eye on host NTP Clock Drift and raise the alarm before it drags down real work or real outages start.*
...
NTP and clock step events may occur when hosts rejoin a site after maintenance, or after stratum and peer changes; verify against expected maintenance and time-server work.

...
*We line up what the virtual desktops cost in the public cloud with how many people actually used them, so you can see waste from machines left running and tune the auto-sizing rules with numbers everyone trusts.*

<!-- AUTO-GENERATED from UC-2.6.23.json — DO NOT EDIT -->
...
> **Criticality:** High &middot; **Difficulty:** Beginner &middot; **Pillar:** Security &middot; **Type:** Fault

*We keep an eye on application Crash and Error Reporting and raise the alarm before it drags down real work or real outages start.*
...
- `stats` rolls up events into metrics; results are split **by AppName, AppVersion** so each row reflects one combination of those dimensions.

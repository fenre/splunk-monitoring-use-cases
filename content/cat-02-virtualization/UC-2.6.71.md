...
*We count when sensitive file rules are tripped, what happened next, and when labels do not line up with what the rules expect — so you catch risky sharing and weak rules before a leak or audit surprise.*

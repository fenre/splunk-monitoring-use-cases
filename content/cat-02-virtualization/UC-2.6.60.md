...
*We line up the sign-in story from the identity side with the one from the virtual-workspace side, so when folks cannot log in you see whether a trust certificate, a policy block, or a name mismatch is the real villain.*

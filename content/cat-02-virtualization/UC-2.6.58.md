...
*We turn the cloud’s picture of how smooth each session feels into simple charts, so you spot when slowness spreads before the phones light up and you know whether the fix is the app image or the network path.*
...
- [Citrix Analytics for Performance (overview)](https://docs.citrix.com/en-us/citrix-analytics/)

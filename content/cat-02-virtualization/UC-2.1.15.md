<!-- AUTO-GENERATED from UC-2.1.15.json — DO NOT EDIT -->
...
> **Criticality:** Medium &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Compliance, Configuration

*We track VM lifecycle for change management compliance and resource governance — so you catch performance or capacity problems before they hurt real work.*
...
Collected automatically via Splunk_TA_vmware vCenter events. Create daily report. Correlate with change management tickets. Alert on deletions of production VMs.

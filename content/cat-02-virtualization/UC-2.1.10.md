...
*We keep an eye on vSAN Health and raise the alarm before it drags down real work or real outages start.*
...
vSAN health can warn during disk group rebuilds, component resync, or one-host maintenance; treat as incident only when the condition persists after resync finishes.

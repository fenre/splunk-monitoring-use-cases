...
> **Criticality:** Medium &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Performance, Capacity

*We keep an eye on vMware DRS Effectiveness and raise the alarm before it drags down real work or real outages start.*

---

## Description

DRS migrations per hour, cluster imbalance score, and recommendations vs. applied. High migration frequency may indicate oscillation; low application of recommendations suggests manual mode or constraint conflicts. Tracks whether DRS is effectively balancing the cluster.
...
Line chart (migrations per hour by cluster), Table (cluster, migrations, baseline), Bar chart (recommendations vs applied).

## Known False Positives

Host and VM health signals can move during vMotion, DRS, backup jobs, and scheduled maintenance; trend persistence and match alerts to vCenter or ESXi change windows.

...
> **Criticality:** Medium &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security, Operations &middot; **Status:** Verified

*We summarize which virtual machines are being blocked from talking to others and which rule did the blocking, to spot misconfiguration or suspicious chatter.*

<!-- AUTO-GENERATED from UC-2.1.47.json — DO NOT EDIT -->
...
*We keep an eye on network Packet Loss and Retransmit and raise the alarm before it drags down real work or real outages start.*
...
Splunk_TA_vmware collects net.droppedRx/Tx.summation. Alert when any VM shows >0 dropped packets sustained over 5 minutes. Compute loss percentage when packet counters available. Correlate with net.usage.average for saturation. Check dvSwitch policies, physical NIC utilization, and VMXNET3 driver version.

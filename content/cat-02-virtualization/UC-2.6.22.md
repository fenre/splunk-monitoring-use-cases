<!-- AUTO-GENERATED from UC-2.6.22.json — DO NOT EDIT -->
...
*We keep an eye on which applications use the most CPU and memory on shared session machines and raise the alarm before it drags down real work or real outages start.*
...
- `stats` rolls up events into metrics; results are split **by AppName, User, Host** so each row reflects one combination of those dimensions.

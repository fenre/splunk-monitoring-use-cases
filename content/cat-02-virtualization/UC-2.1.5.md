<!-- AUTO-GENERATED from UC-2.1.5.json — DO NOT EDIT -->
...
*We keep an eye on snapshot Sprawl and raise the alarm before it drags down real work or real outages start.*
...
Splunk_TA_vmware collects VM inventory including snapshots. Run daily report identifying snapshots >72 hours old. Escalate snapshots >7 days to VM owners. Include snapshot size to show storage impact.
...
Snapshot age alerts may fire for intentional long-running snapshots during storage migration, tests, or vendor-guided holds; confirm with the owner before delete requests.

...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Performance, Availability

*We check that the shared graphics card inside your virtual desktops has the right software and a current license, so heavy apps and video do not go silent in reduced mode or fail when people need them most.*

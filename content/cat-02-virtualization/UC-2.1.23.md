<!-- AUTO-GENERATED from UC-2.1.23.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Beginner &middot; **Pillar:** Security &middot; **Type:** Availability

*We keep an eye on unexpected Power State Changes and raise the alarm before it drags down real work or real outages start.*
...
Power-state changes may reflect approved automation, DRS, HA, or host evacuation; correlate to change and incident records before calling an outage.

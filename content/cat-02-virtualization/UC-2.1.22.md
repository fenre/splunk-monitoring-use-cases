<!-- AUTO-GENERATED from UC-2.1.22.json — DO NOT EDIT -->
...
*We keep an eye on service Health and raise the alarm before it drags down real work or real outages start.*
...
- `stats` rolls up events into metrics; results are split **by host, source** so each row reflects one combination of those dimensions.

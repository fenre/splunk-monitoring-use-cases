...
*We list which app versions and device types are actually connecting, so you see who is behind on upgrades before support tickets and old bugs come back in waves.*

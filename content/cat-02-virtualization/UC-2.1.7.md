<!-- AUTO-GENERATED from UC-2.1.7.json — DO NOT EDIT -->
...
*We keep an eye on hA Failover Events and raise the alarm before it drags down real work or real outages start.*
...
Collect vCenter events via Splunk_TA_vmware. Create critical real-time alert on HA failover events. Correlate with host hardware health and ESXi syslog for root cause.

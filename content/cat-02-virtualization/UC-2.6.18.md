<!-- AUTO-GENERATED from UC-2.6.18.json — DO NOT EDIT -->
...
*We keep an eye on application Unresponsiveness (UI Hangs) Detection and raise the alarm before it drags down real work or real outages start.*

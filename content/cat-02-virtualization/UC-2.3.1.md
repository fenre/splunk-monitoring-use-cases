...
*We keep an eye on how hard each virtual machine is working on the host (CPU and memory) and raise the alarm before it drags down real work or real outages start.*

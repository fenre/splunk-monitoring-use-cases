...
*We keep an eye on template Inventory and Staleness and raise the alarm before it drags down real work or real outages start.*
...
Stale template alerts may be expected for images kept only for break-glass restore; exclude those catalogs or extend freshness for DR-only content.

<!-- AUTO-GENERATED from UC-2.1.25.json — DO NOT EDIT -->
...
*We keep an eye on storage I/O Control (SIOC) Throttling and raise the alarm before it drags down real work or real outages start.*
...
- `stats` rolls up events into metrics; results are split **by datastore, host** so each row reflects one combination of those dimensions.

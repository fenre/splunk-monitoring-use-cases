...
*We record when someone’s desktop is tied to a different person or group than before, so risky or surprise access changes are visible in plain reporting, not only inside the admin console.*

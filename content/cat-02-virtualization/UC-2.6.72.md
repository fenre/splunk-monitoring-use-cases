...
*We look for the hallmarks of someone hauling out huge piles of files, sharing links in a sudden rush, or doing it in odd off-hours — so you catch data walking out the door before the damage is done.*
...
- [Citrix — ShareFile audit logging overview](https://docs.citrix.com/en-us/)

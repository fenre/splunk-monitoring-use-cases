<!-- AUTO-GENERATED from UC-2.1.31.json — DO NOT EDIT -->
...
*We keep an eye on fault Tolerance Status and Replication Lag and raise the alarm before it drags down real work or real outages start.*
...
FT and replication may lag during network maintenance or when secondary paths fail over; ignore brief lag if the UI shows a clean return to full protection.

...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Security, Performance

*We look at the modern “front door to apps” the same way you would a guarded lobby — who got in, what they opened, and whether the round trip was snappy or stuck — so policy holds up without people feeling the new walls.*
...
Session and launch time spikes may track image updates, profile migrations, or broker outages; compare to the same app on other sites before blaming the network only.

...
*We keep an eye on guest OS Disk Space via VMware Tools and raise the alarm before it drags down real work or real outages start.*
...
VMware Tools status can report transiently during reboots, upgrades, or when guests are powered off for imaging; re-check on next poll before escalation.

...
*We keep a simple list of which desktop software and Windows build each shared computer is really running, so you are not caught with old, unsupported versions when audits or upgrades come due.*

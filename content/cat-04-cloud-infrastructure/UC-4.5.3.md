<!-- AUTO-GENERATED from UC-4.5.3.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by FunctionName, metric_name** so each row reflects one combination of those dimensions.

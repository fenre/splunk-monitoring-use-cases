...
*Autopilot scales node pools automatically; failed scale-outs leave pods pending and degrade service goals.*
...
During a roll-out, nodes come and go and metrics briefly look off. We ignore short windows that line up with a deployment and we focus on steady-state failures after the cluster is calm again.

<!-- AUTO-GENERATED from UC-4.1.3.json — DO NOT EDIT -->
...
*We keep an eye on security group changes. Security group changes can expose services to the internet. Unauthorized modifications are a primary attack vector and c. We want the right people to notice in time, not only when a customer or an auditor stumbles on it first.*
...
Auto scaling, Elastic Beanstalk, or verified Terraform/CloudFormation that updates the same CIDRs or rules during a ticketed change.

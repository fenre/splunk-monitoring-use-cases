<!-- AUTO-GENERATED from UC-4.5.8.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by resource.labels.function_name, resource.labels.region** so each row reflects one combination of those dimensions.

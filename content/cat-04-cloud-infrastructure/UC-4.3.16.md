<!-- AUTO-GENERATED from UC-4.3.16.json — DO NOT EDIT -->
...
*Unusual push/pull may indicate abuse.*
...
- `stats` rolls up events into metrics; results are split **by method resource.labels.repository** so each row reflects one combination of those dimensions.

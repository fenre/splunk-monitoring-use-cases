<!-- AUTO-GENERATED from UC-4.3.34.json — DO NOT EDIT -->
...
• `stats` rolls up events into metrics; results are split **by resource.labels.job_name, bin(_time, 5m)** so each row reflects one combination of those dimensions.

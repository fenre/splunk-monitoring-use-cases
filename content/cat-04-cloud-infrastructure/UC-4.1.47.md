...
*We keep an eye on glue job run failures and duration. Glue job failures break ETL pipelines. Duration trends support capacity and cost optimization. We want the right people to notice in time, not only when a customer or an auditor stumbles on it first.*

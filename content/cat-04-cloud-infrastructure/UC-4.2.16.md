<!-- AUTO-GENERATED from UC-4.2.16.json — DO NOT EDIT -->
...
*Logic App run failures break automation and integrations.*
...
- `stats` rolls up events into metrics; results are split **by resourceId runId** so each row reflects one combination of those dimensions.

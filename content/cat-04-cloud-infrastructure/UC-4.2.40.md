...
*Failed or missed backup jobs leave restore gaps; operational health must be tracked per protected item.*
...
Table (item, status), Timeline (job outcomes), Single value (failed jobs 24h).

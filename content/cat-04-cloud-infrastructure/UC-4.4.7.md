...
> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security, Fault

*Log pipelines (CloudTrail → cloud storage → our monitoring platform, Event Hub → our monitoring platform, Pub/Sub → our monitoring platform) can break.*

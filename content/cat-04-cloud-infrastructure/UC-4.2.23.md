<!-- AUTO-GENERATED from UC-4.2.23.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by _time, resourceId** so each row reflects one combination of those dimensions.

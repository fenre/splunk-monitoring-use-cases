<!-- AUTO-GENERATED from UC-4.2.14.json — DO NOT EDIT -->
...
*Probe failures mean backends are unhealthy; traffic stops flowing to those instances.*
...
**Azure Load Balancer Health Probe Failures** — Probe failures mean backends are unhealthy; traffic stops flowing to those instances.

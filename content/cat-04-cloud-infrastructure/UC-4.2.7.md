<!-- AUTO-GENERATED from UC-4.2.7.json — DO NOT EDIT -->
...
*Clusters cluster health monitoring ensures Kubernetes workloads are running reliably on Azure's managed platform.*

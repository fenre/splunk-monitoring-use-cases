<!-- AUTO-GENERATED from UC-4.5.10.json — DO NOT EDIT -->
...
Cold starts, retries, and a bad client sending junk traffic can all raise error counts without a code bug. We look at the share of invocations and we compare the same time last week before we assume the function is broken.

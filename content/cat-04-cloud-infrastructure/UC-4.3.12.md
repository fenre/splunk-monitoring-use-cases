<!-- AUTO-GENERATED from UC-4.3.12.json — DO NOT EDIT -->
...
*Cloud SQL CPU, storage, and replication lag impact application performance and DR.*
...
**Cloud SQL Instance Metrics and Replication Lag** — Cloud SQL CPU, storage, and replication lag impact application performance and DR.

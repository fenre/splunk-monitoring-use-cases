...
*We keep an eye on inspector vulnerability and finding trends. Vulnerability and image-scan findings the pipeline raised so the backlog stays honest. We want the right people to notice in time, not only when a customer or an auditor stumbles on it first.*
...
Accepted risks for legacy apps; images you already planned to replace; test registries in lower accounts.

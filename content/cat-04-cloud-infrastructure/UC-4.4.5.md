<!-- AUTO-GENERATED from UC-4.4.5.json — DO NOT EDIT -->
...
> **Criticality:** Medium &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security, Configuration

*Unified inventory of resources across AWS/Azure/GCP supports compliance, cost, and drift detection.*
...
- `stats` rolls up events into metrics; results are split **by resource_type** so each row reflects one combination of those dimensions.
...
A plan can show a diff right after a release while state catches up, or when we intentionally tuned something in the console during an emergency. We confirm the workspace and the window before we treat it as unplanned drift.

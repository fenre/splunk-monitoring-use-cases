...
*We keep an eye on elastic ip association. Unassociated Elastic IPs cost money. Tracking associations supports inventory accuracy and cost management. We want the right people to notice in time, not only when a customer or an auditor stumbles on it first.*
...
Elastic IP moves during failover drills, load-balancer rebinds, and documented network refactors.

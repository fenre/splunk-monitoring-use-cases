<!-- AUTO-GENERATED from UC-4.2.3.json — DO NOT EDIT -->
...
*Privileged role assignments (Global Admin, Privileged Role Admin) grant extreme power.*
...
**Entra ID Privilege Escalation** — Privileged role assignments (Global Admin, Privileged Role Admin) grant extreme power.

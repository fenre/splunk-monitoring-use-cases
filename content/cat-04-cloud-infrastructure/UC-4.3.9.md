<!-- AUTO-GENERATED from UC-4.3.9.json — DO NOT EDIT -->
...
*Unhealthy backends receive no traffic; request count and latency indicate load and performance.*
...
**Cloud Load Balancing Backend Health and Request Count** — Unhealthy backends receive no traffic; request count and latency indicate load and performance.

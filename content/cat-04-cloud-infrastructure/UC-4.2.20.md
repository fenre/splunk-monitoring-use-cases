<!-- AUTO-GENERATED from UC-4.2.20.json — DO NOT EDIT -->
...
*Delivery failures mean subscribers did not receive events.*
...
- `stats` rolls up events into metrics; results are split **by topic eventSubscriptionName errorCode** so each row reflects one combination of those dimensions.

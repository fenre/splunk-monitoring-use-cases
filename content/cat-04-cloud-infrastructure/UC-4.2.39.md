<!-- AUTO-GENERATED from UC-4.2.39.json — DO NOT EDIT -->
...
• `stats` rolls up events into metrics; results are split **by resourceId, bin(_time, 5m)** so each row reflects one combination of those dimensions.

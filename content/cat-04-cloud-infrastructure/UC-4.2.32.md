<!-- AUTO-GENERATED from UC-4.2.32.json — DO NOT EDIT -->
...
• `stats` rolls up events into metrics; results are split **by identity.claims.name, callerIpAddress, resourceId** so each row reflects one combination of those dimensions.

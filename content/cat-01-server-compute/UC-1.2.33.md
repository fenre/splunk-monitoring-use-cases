...
*We show when the audit and logging rules on a machine are changed, which can hide mischief if someone turns the cameras off.*
...
Hardening projects and GPO rewrites reconfigure subcategories. Pair every burst with a change or GPO number.

<!-- AUTO-GENERATED from UC-1.1.41.json — DO NOT EDIT -->
...
*SMART errors predict disk failure, enabling proactive replacement before data loss occurs — so you find out before users do when something is slowing down or breaking.*
...
A small number of reallocated or pending sectors is often advisory; vendors define when to replace. Trend the metric, do not act on a single read.

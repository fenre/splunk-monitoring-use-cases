...
*We look at who creates or renames a local sign-in on a server, so extra local accounts or surprise renames do not sit there outside your central account rules.*
...
Imaging, lab, and break-glass local admins during rack; sysprep. Use naming convention and GPO for LAPS-managed locals.

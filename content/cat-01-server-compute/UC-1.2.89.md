...
*We keep a simple story of when a server last started and whether shutdowns look clean, so the team can tell maintenance restarts from power or software surprises.*
...
Patch Tuesday, hypervisor host maintenance, and deliberate cluster move. Correlate with VM migration and change calendar; treat repeated 6008 as hardware or driver priority.

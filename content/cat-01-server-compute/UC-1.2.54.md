...
*We help you know when a forwarder of Windows logs to a central place is losing connection, so you are not missing security events in one region quietly.*
...
Short collector restarts and cert rollouts. Sustained 103/111 patterns mean central logging gaps—*that* is the audit and IR risk.

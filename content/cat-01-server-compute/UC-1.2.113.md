...
*We look for new or changed links between programs and little shared libraries, because that is an old and still popular way to make a good program run attacker code on purpose.*
...
App upgrades rewriting CLSID; .NET and Office repairs. Use stack of command line, signer, and path under `Software\Classes`.

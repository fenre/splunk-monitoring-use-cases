<!-- AUTO-GENERATED from UC-1.2.134.json — DO NOT EDIT -->
...
*Detect servers waiting for reboot after Windows updates — so you find out before users do when something is slowing down or breaking.*

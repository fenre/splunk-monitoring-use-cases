...
*We catch changes to the local administrators group on Windows servers, because that is still a quick way for anyone with a foothold to hand themselves full control on the box.*
...
Planned access reviews; GPO and AGPM; break-glass group adds with tickets. Exempt with expiring JIRA and named approver; review quarterly.

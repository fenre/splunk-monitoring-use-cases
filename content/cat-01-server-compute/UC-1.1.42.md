<!-- AUTO-GENERATED from UC-1.1.42.json — DO NOT EDIT -->

---
id: "1.1.42"
title: "SSD Wear Leveling and Health"
criticality: "high"
...
*SSD wear metrics indicate remaining lifespan, enabling proactive replacement planning — so you find out before users do when something is slowing down or breaking.*

---

## Description

SSD wear metrics indicate remaining lifespan, enabling proactive replacement planning.
...
Wear and health percentages move slowly; firmware can change how values are reported. Use the vendor's on-box tool to confirm before replacement.

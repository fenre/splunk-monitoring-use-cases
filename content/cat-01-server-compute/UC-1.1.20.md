...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Security &middot; **Type:** Availability, Fault

*Unexpected reboots may indicate kernel panics, hardware failure, or unauthorized changes — so you find out before users do when something is slowing down or breaking.*
...
Planned reboots, patching, and hypervisor operations match surprise reboots in the data. Correlate with change windows and VM platform events.

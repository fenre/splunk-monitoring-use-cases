...
*We watch sudo-related messages so you can see repeated failed attempts or fishy privilege use — a sign someone may be poking at admin access or misusing a normal account.*
...
Automation, break-glass accounts, and honest typos can look like policy violations. Whitelist service principals and require change or ticket context for out-of-band alerts.

<!-- AUTO-GENERATED from UC-1.1.109.json — DO NOT EDIT -->

---
id: "1.1.109"
title: "Account Expiry Monitoring"
criticality: "medium"
...
*We list accounts nearing expiry so owners renew or disable them before contractors and temp users keep access too long.*

---

## Description

Account expiry tracking ensures user accounts remain valid and prevents access with expired credentials.
...
- `stats` rolls up events into metrics; results are split **by host, user, days_until_expiry** so each row reflects one combination of those dimensions.
...
Service accounts with `chage -I -1` or non-expiring shadow fields never reach `days_until_expiry==0` in your feed—validate script logic. Contractor accounts that should expire may be extended by approved HR actions; suppress with a lookup of expected extensions.

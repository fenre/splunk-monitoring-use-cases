<!-- AUTO-GENERATED from UC-1.2.132.json — DO NOT EDIT -->
...
*Detect tasks that failed to run or returned non-zero result codes — so you find out before users do when something is slowing down or breaking.*
...
- `stats` rolls up events into metrics; results are split **by host, TaskName** so each row reflects one combination of those dimensions.

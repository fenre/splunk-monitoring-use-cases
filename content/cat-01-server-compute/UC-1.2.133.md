<!-- AUTO-GENERATED from UC-1.2.133.json — DO NOT EDIT -->

---
id: "1.2.133"
title: "Windows WMI Repository Health"
criticality: "medium"
...
*WMI corruption breaks many monitoring agents, SCCM, and management tools — so you find out before users do when something is slowing down or breaking.*

---

## Description

WMI corruption breaks many monitoring agents, SCCM, and management tools. Detecting broken WMI enables early remediation before dependent systems fail.
...
Table (host, WMI status), Single value (hosts with WMI issues), Alert.

...
*We help you know when a log file on disk is close to the max size you allowed, so it does not stop writing the events you need for audits and support.*
...
High churn apps on small forward buffers look ‘full’ by percent but are by design. Cross-check with max size policy and your retention, not a once-a-day 90% only.

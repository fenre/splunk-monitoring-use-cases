...
> **Criticality:** High &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Capacity, Performance &middot; **Status:** Draft

*We warn when a Mac’s main disk is almost full so it doesn’t freeze up or stop updating when space runs out.*
...
APFS local snapshots and Time Machine locals can make `/System/Volumes/Data` look fuller than a Finder “Get Info” until snapshots are thinned. Network home directories or FUSE mounts can confuse `df` field parsing—test on a pilot Mac. iCloud purge and Mobile Accounts can free space minutes after a noisy alert.

...
*We look for a burst of ticket requests that can mean someone is trying to grab password hashes to crack offline later.*
...
Service accounts, legacy SPNs, and Tier-2 services request many TGS. Hunt on *new* SPN+user pairings, not volume alone.

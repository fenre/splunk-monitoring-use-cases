...
*Multipath failovers indicate storage path degradation requiring immediate investigation to prevent I/O loss — so you find out before users do when something is slowing down or breaking.*
...
Planned path failovers, cable work, and driver resets can trigger multipath messages without user impact. Require loss of all paths or a sustained state before top severity.

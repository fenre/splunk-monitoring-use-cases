<!-- AUTO-GENERATED from UC-1.1.11.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Fault

*Kernel panics cause immediate system crashes and potential data corruption — so you find out before users do when something is slowing down or breaking.*
...
Some 'Oops' and driver messages are recoverable. Hardware tests and stress runs can also emit crash-like text. Read the full log line and correlate with real outages.

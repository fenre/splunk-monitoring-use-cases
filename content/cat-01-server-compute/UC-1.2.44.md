...
*We look for a user or account that is touching a lot more file shares at once than normal, which can be a data hunt in progress.*
...
Indexers, data movers, and backup software scan many shares. A high share count is often the job, not a person browsing randomly.

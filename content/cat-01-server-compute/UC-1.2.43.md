...
*We help you know when a cluster of servers that keep each other online is in trouble, so a storage or network blip does not take the whole app down by surprise.*
...
Planned move groups, patch reboots, and node drains are normal. Sustained resource offline without change is the real signal.

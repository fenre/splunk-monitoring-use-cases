...
*We show when someone widens the list of things virus scanning ignores on a machine, so a quick troubleshooting exception does not quietly stay wide open forever.*
...
Vendor-required paths during app deploy; temporary DevExclusions. Require ticket ID in notes; auto-expire exclusions with GPO or pipeline review.

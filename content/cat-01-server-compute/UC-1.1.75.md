...
*We help you know when the old “become another user” command keeps failing, which can be someone guessing a password for a powerful account or a script that’s stuck in a loop.*
...
Monitoring scripts that intentionally exercise **su** in **cron**; **failures=1** for a person mis-typing once—`>3` already dampens; **user** misparsed from **PAM** lines—**props** work first.

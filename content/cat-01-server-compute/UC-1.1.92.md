...
*We make sure security audit records keep flowing from Linux hosts so we are not blind to changes and logins when auditors or incident response need the trail.*

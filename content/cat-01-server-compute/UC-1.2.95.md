...
> **Criticality:** Medium &middot; **Difficulty:** Expert &middot; **Pillar:** Observability &middot; **Type:** Availability

*We look at the health of Windows containers and the Hyper-V layer under them so application teams see a guest pause or service fault before every app on the host feels it.*
...
Live migration, backup integration service pauses, and planned node drain; dev clusters. Correlates with SCVMM and cluster resource state.

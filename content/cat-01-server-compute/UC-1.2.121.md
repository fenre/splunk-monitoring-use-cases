...
*We look at the everyday DNS questions each client makes so a single device asking the wrong mix of names stands out the way a sick or misbehaving machine often does.*
...
CDNs, AV cloud lookups, and dev containers; first boot. Baseline by subnet + DHCP scope.

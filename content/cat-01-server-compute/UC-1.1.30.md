...
*High run queue depth with elevated scheduling latency causes visible application performance degradation — so you find out before users do when something is slowing down or breaking.*
...
Boot, batch peaks, and wrong `procs_cpu` in your eval can inflate the ratio. Fix inventory fields before changing scheduler alerts.

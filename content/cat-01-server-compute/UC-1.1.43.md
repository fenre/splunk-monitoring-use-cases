...
*Fstrim failures indicate potential SSD performance degradation from lack of proper space reclamation — so you find out before users do when something is slowing down or breaking.*
...
Regular `fstrim` and vendor maintenance can cluster related log lines. Distinguish scheduled from unexpected manual TRIMs.

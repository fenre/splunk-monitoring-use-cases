...
*NUMA imbalance causes memory locality issues and performance degradation on multi-socket systems — so you find out before users do when something is slowing down or breaking.*
...
Single-socket or pinned workloads can look 'imbalanced' by design. Compare to baseline and app placement, not a universal threshold only.

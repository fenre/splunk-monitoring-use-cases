...
> **Criticality:** High &middot; **Difficulty:** Beginner &middot; **Pillar:** Security &middot; **Type:** Availability, Security &middot; **Status:** Draft

*We check that each Mac’s clock matches the real world so logins and secure connections don’t randomly fail because the time is off.*

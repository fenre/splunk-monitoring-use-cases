<!-- AUTO-GENERATED from UC-1.1.40.json — DO NOT EDIT -->
...
*XFS errors indicate potential corruption in high-performance storage systems commonly used in enterprise environments — so you find out before users do when something is slowing down or breaking.*
...
XFS may log retryable conditions under load or a short storage stall. Escalate on persistent and application-visible file errors.

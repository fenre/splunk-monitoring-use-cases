...
*We watch how worn down laptop batteries are getting so support can replace them before people suddenly run out of juice in the middle of work.*
...
Loaner laptops and lab units can sit at high cycle counts for years on AC without field risk. `ioreg` values jump after SMC reset or macOS updates—confirm with a second sample before procurement tickets. TCC/privacy prompts can block `ioreg` in some user sessions; the script may return partial fields that look worse than reality.

...
*We check how full your disks are on each drive, and we help you add space or clean up before the server runs out of room to work.*
...
Low free space can be short-lived during upgrades, VSS, backups, and temp file bursts. Some volumes are intentionally small; alert by tier.

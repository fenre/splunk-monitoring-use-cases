...
*We show when someone’s account is locked and which machine caused it, so support can fix the right password or app instead of guessing.*
...
Users with multiple devices, cached creds, and help-desk lockouts are common. The caller computer field tells you where to look first.

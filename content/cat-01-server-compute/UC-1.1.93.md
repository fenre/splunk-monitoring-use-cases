<!-- AUTO-GENERATED from UC-1.1.93.json — DO NOT EDIT -->

---
id: "1.1.93"
title: "Rsyslog Queue Backlog Monitoring"
criticality: "medium"
...
*We watch rsyslog queue depth so we know when the log shipper is falling behind before messages are dropped or the disk fills.*

---

## Description

Rsyslog queue backlog indicates log forwarding issues or overload of remote syslog infrastructure.
...
Short spikes in `queue_size` during remote indexer restarts or TLS renegotiation often clear without data loss. imuxsock or local-only actions can still show queue metrics depending on how you named `queue_size` in the custom parser—confirm field names against a sample event.

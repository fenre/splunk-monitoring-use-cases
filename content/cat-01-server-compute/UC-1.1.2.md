...
> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Performance &middot; **Wave:** Crawl

*We keep an eye on memory and swap so you get warning before the machine runs out of room, starts swapping hard, or the system starts killing programs to stay alive.*
...
Memory use rises during warm-up, cache fill, and after service restarts. Some runtimes keep large allocations by design. Correlate with deploys, batch jobs, and heap settings.

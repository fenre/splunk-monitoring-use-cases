<!-- AUTO-GENERATED from UC-1.1.32.json — DO NOT EDIT -->

---
id: "1.1.32"
title: "Transparent Hugepage Compaction Stalls"
criticality: "high"
...
*THP compaction stalls indicate severe memory fragmentation affecting latency-sensitive workloads — so you find out before users do when something is slowing down or breaking.*

---

## Description

THP compaction stalls indicate severe memory fragmentation affecting latency-sensitive workloads.
...
THP and compaction show up at boot and after memory tuning. Treat repeated stalls in production, not one-off dmesg lines, as the signal.

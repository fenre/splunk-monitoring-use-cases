...
*We look for the kind of directory access that copies the keys to the kingdom, which is a serious sign someone may be staging a domain-wide attack.*
...
Backups, recovery tools, and AAD connect can replicate rights that look like DCSync. Whitelist well-known service principals and paths.

...
> **Criticality:** Critical &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Security, Change

*We alert when a hidden but powerful part of the directory that controls who stays an admin is changed, because that is a favorite trick for staying in charge without looking like a normal admin change.*
...
Rare but approved hardening that touches AdminSDHolder; AD forest recovery; some third-party IDM or AD management tools. Every hit should have a change record and named approver; default expectation is **zero** unplanned events.

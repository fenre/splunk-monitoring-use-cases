...
*We help you know when a scheduled “do this later” task on the machine did not run when it should, which can quietly break backups or clean-up jobs.*
...
Hosts that sleep or **hibernate**; **DST** jumps; **timer** units that intentionally **skip** overlaps—read the specific **systemd** wording in `_raw` before paging.

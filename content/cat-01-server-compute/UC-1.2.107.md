...
*We look at whether file copies between sites through DFS are healthy, so a stuck backlog does not turn into different folders and broken logon scripts for half the company.*
...
Planned file replication across sites; large initial sync. Watch backlog duration vs. steady state; treat sustained growth as incident.

...
*We see when someone adds, changes, or removes Windows firewall rules, which matters for who can reach the box over the network.*
...
GPO and Intune can push many rule changes during hardening. Expect bursts during build seasons; use change records to explain volume.

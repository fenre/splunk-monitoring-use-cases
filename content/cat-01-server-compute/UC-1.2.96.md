...
*We watch for full copy requests of your whole DNS zone so you can see transfers that are not in your list of real secondaries before someone walks away with a map of your names.*
...
Legit secondary promotion and zone transfer to DR; MNAME misconfig. Allowlist by peer server IP; burst during DNS migration.

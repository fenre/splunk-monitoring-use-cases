...
> **Criticality:** High &middot; **Difficulty:** Beginner &middot; **Pillar:** Security &middot; **Type:** Configuration, Compliance

*We catch unauthorized user creation or modification — so you find out before users do when something is slowing down or breaking.*
...
Help desk and directory automation create many legitimate account and group events. Route on unexpected actors, off-hours, or missing change numbers.

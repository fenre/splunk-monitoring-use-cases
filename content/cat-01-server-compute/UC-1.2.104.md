...
*We track how long disk read and write operations take on Windows servers so the team sees storage getting sick before programs start timing out and people feel the drag everywhere.*
...
Backup merge, index optimization, and large report jobs; CSV under Hyper-V during live migration. Layer with `PhysicalDisk` queue length and vendor array stats.

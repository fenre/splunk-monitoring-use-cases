...
*Hugepage contention or allocation failures impact database and large memory workload performance — so you find out before users do when something is slowing down or breaking.*
...
Databases and JVMs use huge pages on purpose. Compare to the expected mode for that host's role before reacting.

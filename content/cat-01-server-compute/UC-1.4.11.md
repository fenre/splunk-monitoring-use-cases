...
> **Criticality:** Medium &middot; **Difficulty:** Advanced &middot; **Pillar:** Security &middot; **Type:** Configuration

*We remember how each server is supposed to start up and compare that to what it would do today, so a surprise change to the boot order does not leave you with a system that will not start the right way after a reboot.*

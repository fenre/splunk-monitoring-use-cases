...
*We notice when the system is so short on memory that it starts force-quitting programs — so you can act before a critical app disappears with little warning.*
...
Memory tuning tests, container limits, and one-off jobs can force OOM during maintenance. Correlate with deploys, cgroup or Kubernetes limits, and large batch work.

...
*We count Kerberos sign-in problems so you can tell bad keys and clocks from someone guessing passwords at the domain door.*
...
Clock skew, service accounts with bad secrets, and lab Kerberos hiccups create clusters. NTP and account hygiene fix many rows.

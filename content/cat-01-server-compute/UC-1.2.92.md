...
*We watch the front door for remote desktop access through the gateway so failed tries and heavy use line up with what the network and identity teams expect before a small problem spreads.*
...
Pentest or red-team windows; user lockouts; legacy clients. Baseline by country and client version; require velocity per user+source before CRIT.

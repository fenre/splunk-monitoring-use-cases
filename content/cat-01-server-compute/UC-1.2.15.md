...
*We watch the pattern of name lookups the DNS server is handling, and we help you know when the service is under unusual load or odd query types show up.*
...
Start-of-day, Wi-Fi, and guest VLANs spike DNS. Compare to a sane baseline; some failure types are normal during re-pointing and upgrades.

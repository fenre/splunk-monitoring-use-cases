...
> **Criticality:** Critical &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Capacity &middot; **Wave:** Walk

*We watch how full your disks are getting so you can add space, clean up, or plan storage before a full filesystem stops apps or logging.*
...
Usage may jump during log rotation, large temporary files, index or database maintenance, and release deployments. One-time growth on a data volume can be expected.

<!-- AUTO-GENERATED from UC-1.1.106.json — DO NOT EDIT -->

---
id: "1.1.106"
title: "Power Supply State Changes"
...
*We alert when syslog says a power supply went bad or offline so datacenter staff can swap hardware before redundancy is gone.*

---

## Description

Power supply state changes indicate hardware failures requiring immediate physical intervention.
...
Planned PDU or grid work, firmware updates that re-enumerate PSUs, and vendor log text that contains “failed” during a successful self-test can false-match. Narrow keywords to your platform’s actual syslog phrases.

...
*We watch for logrotate failures in syslog so log files do not silently grow forever and fill the disk or hide what happened on the server.*

---

## Description

Log rotation failures can cause log files to grow unbounded, consuming disk space and impacting log analysis.

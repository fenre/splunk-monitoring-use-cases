...
> **Criticality:** Low &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Fault

*We check the health of the built-in file search service on Windows servers so we know when people might not find their files and mail in the place they expect on busy shares.*
...
Index reset after feature update; large first-time crawl; antivirus locking files. Check disk space, antivirus exclusions, and `SearchIndexer` CPU vs baseline.

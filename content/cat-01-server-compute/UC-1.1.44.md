...
*Process memory leaks cause gradual performance degradation and eventual OOM situations — so you find out before users do when something is slowing down or breaking.*
...
Intentional cache growth, heap growth after deploy, and large batch jobs add RSS. Require a sustained upward trend and baseline, not one interval.

...
*Degraded RAID arrays mean data loss risk and potential performance impact during rebuild — so you find out before users do when something is slowing down or breaking.*
...
Rebuilds, copyback, and slow parity operations can show 'degraded' until the array finishes. Check storage events for auto-recovery before calling a Sev-1.

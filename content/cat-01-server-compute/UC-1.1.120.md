...
*We measure how deep symlink chains go so odd loops or runaway indirections do not slow programs or hide attacks.*
...
Build trees, language package caches, and vendor installers sometimes create long but benign chains—allowlist those roots. Your scanner should detect cycles; without it, a loop can blow up the scripted input before Splunk.

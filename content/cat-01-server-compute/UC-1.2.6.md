...
*We count failed sign-ins by user and source so you can tell a guessing attack, a stuck script, and a person mistyping a password apart more quickly.*
...
Service accounts with bad passwords, scanners, and SSO hiccups cluster failures. Private IP geolocation is often wrong; pair with your asset and account lists.

<!-- AUTO-GENERATED from UC-1.1.17.json — DO NOT EDIT -->
...
*We catch stopped services before users notice — so you find out before users do when something is slowing down or breaking.*
...
Socket-activated services may look 'inactive' when idle. Planned stops and blue/green deploys also look like outages. Add host-role context and change-window suppressions.

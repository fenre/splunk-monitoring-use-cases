...
*We look for a short list of command-line patterns that are often used when someone is already inside the network and trying to run download or file tricks.*
...
IT tools (`certutil`, `bitsadmin`, `mshta`, `rundll32`) are used in patching and MECM. Add parent, hash, and signer to avoid 24/7 red noise.

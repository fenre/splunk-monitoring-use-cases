...
*We look at program-started network connections to odd places, after we have removed your usual on-network ranges, so a beacon stands out a bit more clearly.*
...
Browsers, updaters, and agents reach the whole internet. Baseline the same parent process; rare parent + new rare destination is a better story than a raw denylist miss.

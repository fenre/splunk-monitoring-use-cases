...
| streamstats window=30 global=f last(znodes) as _prev_node_growth by host
| eval node_growth = znodes - _prev_node_growth| where node_growth > 100000 OR approx_bytes > 10737418240
```

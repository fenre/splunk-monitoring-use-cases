...
> **Criticality:** Low &middot; **Difficulty:** Beginner &middot; **Pillar:** IT Operations &middot; **Type:** Compliance, Performance &middot; **Status:** Draft

*We use this to support service owners reviewing quality alongside security teams.*
...
4xx spikes from web crawlers, scanners, or after URL routing changes. We tune exclusions for known bots when needed.

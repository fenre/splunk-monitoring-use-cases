...
> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security, Audit &middot; **Status:** Draft

*We use this to protect -memory data stores that sometimes hold serialized sessions or personal data from unauthorized access.*

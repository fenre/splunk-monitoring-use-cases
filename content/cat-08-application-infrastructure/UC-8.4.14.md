<!-- AUTO-GENERATED from UC-8.4.14.json — DO NOT EDIT -->
...
*We watch for signs that unusual volume of requests per key or key used from many distinct /countries in short window.*
...
- `stats` rolls up events into metrics; results are split **by credential_id, _time** so each row reflects one combination of those dimensions.

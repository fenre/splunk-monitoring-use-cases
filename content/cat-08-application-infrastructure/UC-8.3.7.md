<!-- AUTO-GENERATED from UC-8.3.7.json — DO NOT EDIT -->

---
id: "8.3.7"
title: "Topic/Queue Creation Audit"
criticality: "medium"
...
> **Criticality:** Medium &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Configuration

*We watch for signs that uncontrolled topic/queue creation can lead to resource sprawl.*

---

## Description

Uncontrolled topic/queue creation can lead to resource sprawl. Audit trail supports governance and cleanup.
...
Table (created topics with details), Timeline (creation events), Bar chart (topics created per week).

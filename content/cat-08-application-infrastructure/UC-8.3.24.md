...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Security &middot; **Type:** Security &middot; **Status:** Draft

*We watch for signs that preserves cryptographic hygiene for zero-trust and mutual secure connections designs.*
...
Short-lived or staging certificates, planned rotations, and CA delays can look like an imminent outage. Certificates approaching expiry should trigger renewal; alerts before the renewal date are expected.

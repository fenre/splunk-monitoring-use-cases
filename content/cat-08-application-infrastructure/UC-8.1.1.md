<!-- AUTO-GENERATED from UC-8.1.1.json — DO NOT EDIT -->
...
*We watch for signs that rising error rates signal application issues, backend failures, or attacks.*
...
5xx errors spike during deployment rollouts, restart sequences, or backend service maintenance. 4xx spikes from web crawlers, scanners, or after URL routing changes. We split 4xx and 5xx when the story differs for triage.

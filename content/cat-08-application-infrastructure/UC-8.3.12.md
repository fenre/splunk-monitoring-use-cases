<!-- AUTO-GENERATED from UC-8.3.12.json — DO NOT EDIT -->
...
*We watch for signs that leader election state, outstanding requests, and watch count indicate ZooKeeper stability.*

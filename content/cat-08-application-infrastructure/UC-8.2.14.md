<!-- AUTO-GENERATED from UC-8.2.14.json — DO NOT EDIT -->
...
*We watch for signs that stop-the-world pause duration percentiles from unified GC logs (G1, ZGC) drive service promises breaches before heap % alerts fire.*

...
> **Criticality:** Medium &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Fault, Performance &middot; **Status:** Draft

*We use this to stops hard-to-reproduce mobile and crawler failures that harm SEO and conversion funnels.*
...
Long 301/302 chains can come from CDNs, locale negotiation, or A/B tools. We tune on client and path.

...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Performance, Fault &middot; **Status:** Verified

*We use this to shortens diagnosis of intermittent messaging latency during DB maintenance, connection pool exhaustion, or data drift on message tables.*

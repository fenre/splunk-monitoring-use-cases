...
> **Criticality:** Critical &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Capacity, Availability &middot; **Status:** Verified

*We help you prevent catastrophic messaging outages during storage sprawl or mis-sized data volumes by alerting while the broker can still shed load or expand disk.*

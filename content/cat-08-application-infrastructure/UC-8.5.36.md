...
> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Change, Availability &middot; **Status:** Verified

*We use this to make hub-and-spoke or mesh broker layouts observable from the canonical broker log stream without relying on ad-hoc grep during incidents.*

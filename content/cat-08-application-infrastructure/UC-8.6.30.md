...
> **Criticality:** Critical &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Fault &middot; **Status:** Draft

*We use this to stops extended data corruption incidents from spreading across consumers and guides engineers to the offending topic/partition quickly.*

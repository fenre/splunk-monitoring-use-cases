<!-- AUTO-GENERATED from UC-8.2.17.json — DO NOT EDIT -->
...
*We watch for signs that gunicorn/uWSGI, and worker kills indicate saturation or slow upstream (DB).*
...
- `stats` rolls up events into metrics; results are split **by host, app_name** so each row reflects one combination of those dimensions.

...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Availability, Performance

*We watch for signs that simulated multi-step user journeys with timing per step validate end-to-end availability and detect degradation before users report issues.*

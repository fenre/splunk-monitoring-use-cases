<!-- AUTO-GENERATED from UC-8.2.12.json — DO NOT EDIT -->
...
*We watch for signs that connector thread pool busy percentage and rejected connections indicate Tomcat capacity limits.*

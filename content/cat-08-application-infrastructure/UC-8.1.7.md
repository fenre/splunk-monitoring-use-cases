<!-- AUTO-GENERATED from UC-8.1.7.json — DO NOT EDIT -->
...
*We watch for signs that bot traffic inflates metrics and consumes resources.*
...
- `stats` rolls up events into metrics; results are split **by is_bot** so each row reflects one combination of those dimensions.

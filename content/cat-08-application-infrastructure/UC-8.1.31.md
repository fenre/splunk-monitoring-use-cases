...
> **Criticality:** High &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Performance &middot; **Status:** Draft

*We catch ineffective consumption early — before only queue depth alarms fire — so teams can fix consumer code, scaling, or prefetch settings.*

<!-- AUTO-GENERATED from UC-8.6.11.json — DO NOT EDIT -->
...
*We watch for signs that vault health, auto-unseal events, and token creation rate indicate secrets management availability.*

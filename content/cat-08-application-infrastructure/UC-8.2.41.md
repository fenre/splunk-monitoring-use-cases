...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Capacity, Performance &middot; **Status:** Draft

*We watch for signs that aligns hardware, IIS application pool settings, and observed worker footprint before outages force emergency scale-up.*

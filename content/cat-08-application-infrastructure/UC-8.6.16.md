...
*We watch for signs that stratum jumps or large offset indicate bad upstream clock or local drift — affects Kerberos, secure connections, and distributed logs.*

...
> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Fault &middot; **Status:** Draft

*We use this to surfaces flaky consumers and retry storms that waste broker resources and inflate end-to-end latency.*

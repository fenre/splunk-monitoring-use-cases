...
*We use this to shortens MTTR for send-timeouts and thread pileups in producers by proving the broker deliberately slowed publishers rather than a vague network fault.*

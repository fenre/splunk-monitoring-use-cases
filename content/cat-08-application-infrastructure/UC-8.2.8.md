<!-- AUTO-GENERATED from UC-8.2.8.json — DO NOT EDIT -->
...
*We watch for signs that cLR performance issues (high GC, exceptions, thread starvation) directly impact.NET application performance.*

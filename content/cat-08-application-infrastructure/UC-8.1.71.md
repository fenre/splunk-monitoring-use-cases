...
> **Criticality:** Medium &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Performance, Capacity &middot; **Status:** Draft

*We watch for signs that informs NIC upgrades, placement, and batching changes before packet drops appear only at the switch.*

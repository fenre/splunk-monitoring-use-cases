...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Availability, Performance &middot; **Status:** Verified

*We use this to protect multi-site messaging topologies from partial outages that otherwise show up only as mysterious queue growth on downstream vhosts.*

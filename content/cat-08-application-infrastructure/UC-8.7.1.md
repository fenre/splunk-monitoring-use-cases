...
*We watch for signs that daily or weekly active session counts show adoption, campaign effects, and capacity needs before saturation.*
...
Session counts move with campaigns, holidays, and launches. A jump is often expected; we compare to the business calendar before treating as capacity trouble.

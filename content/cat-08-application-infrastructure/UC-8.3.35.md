...
> **Criticality:** High &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Security &middot; **Status:** Draft

*We use this to surfaces authentication outages that manifest as mysterious client disconnects and supports security investigations into credential abuse.*

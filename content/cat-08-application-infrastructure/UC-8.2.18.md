<!-- AUTO-GENERATED from UC-8.2.18.json — DO NOT EDIT -->
...
*We watch for signs that session explosion may indicate bot traffic, session fixation abuse, or missing session TTL.*
...
- `eventstats` rolls up events into metrics; results are split **by context_path** so each row reflects one combination of those dimensions.

<!-- AUTO-GENERATED from UC-11.3.35.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by call_path, origCallingPartyNumber, finalCalledPartyNumber** so each row reflects one combination of those dimensions.
...
Complex transfers, call forwarding, and hunt overflow paths that are valid but hard to read.

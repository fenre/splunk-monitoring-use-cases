<!-- AUTO-GENERATED from UC-11.3.36.json — DO NOT EDIT -->

---
id: "11.3.36"
title: "CUCM CMR Call Quality Heatmap"
criticality: "high"
...
- `stats` rolls up events into metrics; results are split **by site_pair** so each row reflects one combination of those dimensions.
...
Heatmap (origin site × destination site, colored by avg MOS), Table (site-pairs with worst quality), Line chart (avg MOS per site-pair over 7 days), Gauge (overall fleet MOS).

## Known False Positives

Site-specific issues during local outages; heatmaps need geographic context before escalation.

<!-- AUTO-GENERATED from UC-11.3.55.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by alarm_category, alarm_id** so each row reflects one combination of those dimensions.
...
Known benign alarms after upgrades; some alerts self-clear on service restart during maintenance.

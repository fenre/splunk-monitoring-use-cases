...
*We watch transport queues, so a stuck pile of mail is not the first time we hear from angry users.*
...
Backlog during planned transport maintenance, storm patches, or large mailing bursts.

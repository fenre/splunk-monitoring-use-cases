...
*We use path tests to see where voice and meeting traffic get ugly, so we can tell cloud issues from a bad home connection.*
...
Wi-Fi, VPN, and last-mile quality issues that affect MOS but are outside your PBX.

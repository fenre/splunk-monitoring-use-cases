<!-- AUTO-GENERATED from UC-11.3.56.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by call_direction, destination_alias** so each row reflects one combination of those dimensions.
...
Interop tests, gateway migrations, and legacy H.323 islands during transition.

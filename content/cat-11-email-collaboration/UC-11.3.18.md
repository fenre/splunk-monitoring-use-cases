<!-- AUTO-GENERATED from UC-11.3.18.json — DO NOT EDIT -->
...
*We watch file checks in Webex spaces, so blocked or approved files match what the business expects for sensitive data.*
...
- `stats` rolls up events into metrics; results are split **by actorEmail, spaceName** so each row reflects one combination of those dimensions.
...
DLP false positives, default-approved paths, and large meetings with many file shares at once.

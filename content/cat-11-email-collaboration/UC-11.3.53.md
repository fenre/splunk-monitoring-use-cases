<!-- AUTO-GENERATED from UC-11.3.53.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Capacity, Availability
...
- `stats` rolls up events into metrics; results are split **by _time, node** so each row reflects one combination of those dimensions.
...
Elastic scaling events and regional spikes that stay within node headroom; compare to license tier.

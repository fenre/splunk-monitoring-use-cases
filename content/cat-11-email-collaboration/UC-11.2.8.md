...
*We track big Google admin actions, so we know when accounts, policies, or roles change outside normal work.*
...
Security setting changes from scheduled hardening, pen-test follow-ups, or compliance projects.

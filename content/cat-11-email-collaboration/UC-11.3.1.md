<!-- AUTO-GENERATED from UC-11.3.1.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by origDeviceName, destDeviceName** so each row reflects one combination of those dimensions.
...
Transcoding, codec negotiation, and remote worker Wi-Fi; short dips during handoffs are often benign.

<!-- AUTO-GENERATED from UC-11.2.17.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by rule_name, severity, actor_email, data_source** so each row reflects one combination of those dimensions.
...
Rule tuning, new sensitive types, and monitor-only policy phases that create extra incidents.

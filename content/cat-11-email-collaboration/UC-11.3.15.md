<!-- AUTO-GENERATED from UC-11.3.15.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by callingLineId, direction** so each row reflects one combination of those dimensions.
...
After-hours on-call, callback queues, and test calls in lab dial plans.

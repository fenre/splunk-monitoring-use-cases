<!-- AUTO-GENERATED from UC-11.1.10.json — DO NOT EDIT -->
...
*We track license burn against seats, so we are not overbuying or hitting a hard block during a peak.*
...
- `stats` rolls up events into metrics; results are split **by sku_name** so each row reflects one combination of those dimensions.
...
True-up and license true-down windows; co-existence of trial or dev tenants can shift utilization.

...
*We log important Microsoft 365 admin changes, so we can prove who changed what and catch surprise privilege moves.*
...
```spl
index=o365 sourcetype="o365:management:activity" RecordType=1
...
Planned break-glass access, helpdesk changes, and vendor maintenance accounts during migrations.

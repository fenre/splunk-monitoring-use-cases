<!-- AUTO-GENERATED from UC-11.5.11.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by device_id, product, room_name, building** so each row reflects one combination of those dimensions.
...
Firmware updates, cable swaps, and known vendor incidents with a published advisory.

...
*We see when hunt groups overflow or abandon calls pile up, so staffing and call routing can be fixed before service suffers.*
...
Overflows during campaigns and seasonal peaks when hunt settings are working as designed.

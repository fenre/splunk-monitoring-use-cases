...
*We watch Meet call quality, so we can tell a bad call from a bad day on the public Internet.*
...
Regional ISP issues and home Wi-Fi problems that mirror Meet quality dips without a Google outage.

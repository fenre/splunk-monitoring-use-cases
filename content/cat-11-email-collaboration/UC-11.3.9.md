<!-- AUTO-GENERATED from UC-11.3.9.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by user, mailbox_type** so each row reflects one combination of those dimensions.
...
Archive projects, large mailbox migrations, and journal mailboxes that sit near quota by design.

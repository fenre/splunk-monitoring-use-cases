...
*We watch file sharing and guest links, so we know when data leaves the company more than we expect.*
...
```spl
index=o365 sourcetype="o365:management:activity" Workload="SharePoint" Operation IN ("SharingSet","AnonymousLinkCreated","CompanyLinkCreated")
...
Anonymous links for guest collaboration, public document sharing, or temporary file transfers.

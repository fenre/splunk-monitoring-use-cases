...
*We watch large data exports, so a mass download lines up with a person leaving or a real need instead of a surprise.*
...
Legal exports, employee data requests, and offboarding that legitimately use Takeout at volume.

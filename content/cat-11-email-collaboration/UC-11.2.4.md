<!-- AUTO-GENERATED from UC-11.2.4.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by actor.email, ip_address** so each row reflects one combination of those dimensions.
...
Travel, VPN, and new device sign-ins that look new but are routine for mobile staff.

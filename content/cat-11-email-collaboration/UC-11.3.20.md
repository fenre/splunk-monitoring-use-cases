<!-- AUTO-GENERATED from UC-11.3.20.json — DO NOT EDIT -->
...
*We track collaboration license use, so we buy only what we need and still have seats when everyone jumps on a call.*
...
- `stats` rolls up events into metrics; results are split **by licenseName** so each row reflects one combination of those dimensions.
...
True-up, trial SKUs, and site consolidations; adoption swings after mergers.

...
• `stats` rolls up events into metrics; results are split **by chassis_id, psu_slot, oper_state, redundancy_state** so each row reflects one combination of those dimensions.

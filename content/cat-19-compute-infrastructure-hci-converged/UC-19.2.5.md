...
• `stats` rolls up events into metrics; results are split **by cluster_name, node, disk_id, disk_serial** so each row reflects one combination of those dimensions.

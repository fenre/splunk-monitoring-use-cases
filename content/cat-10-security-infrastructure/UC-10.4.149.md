<!-- AUTO-GENERATED from UC-10.4.149.json — DO NOT EDIT -->
...
# UC-10.4.149 · Windows Exchange Autodiscover SSRF Abuse
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to host or system entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Windows IIS ingested and CIM-normalized.
...
- [https://splunk.github.io/splunk-add-on-for-microsoft-iis/](https://splunk.github.io/splunk-add-on-for-microsoft-iis/)

<!-- AUTO-GENERATED from UC-10.7.705.json — DO NOT EDIT -->
...
# UC-10.7.705 · SMB Traffic Spike

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on spikes in Server Message Block (SMB) traffic connections, which are used for sharing files and resources between computers so unusual activity is visible early — before it spreads or hides in normal noise.*

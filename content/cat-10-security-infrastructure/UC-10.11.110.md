<!-- AUTO-GENERATED from UC-10.11.110.json — DO NOT EDIT -->

---
id: "10.11.110"
title: "VMware Carbon Black Enterprise EDR Search Audit"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.11.110 · VMware Carbon Black Enterprise EDR Search Audit

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use Carbon Black data and alerts to stay ahead of the risks described in "VMware Carbon Black Enterprise EDR Search Audit". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

EDR search auditing protects sensitive hunt activity from insider misuse.
...
- `stats` rolls up events into metrics; results are split **by query, analyst** so each row reflects one combination of those dimensions.
...
Table (queries), Timeline.

## Known False Positives

Carbon Black alerts from new endpoint agents, patch cycles, or legitimate admin, developer, and IT automation tools; use asset groups and allowlists to narrow noise.

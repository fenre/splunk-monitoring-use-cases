<!-- AUTO-GENERATED from UC-10.3.300.json — DO NOT EDIT -->
...
# UC-10.3.300 · Rundll32 CreateRemoteThread In Browser

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Rundll32 CreateRemoteThread In Browser” so we can see attacker-style moves—not only a one-off file or password mistake.*

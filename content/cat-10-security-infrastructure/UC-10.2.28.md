<!-- AUTO-GENERATED from UC-10.2.28.json — DO NOT EDIT -->
...
# UC-10.2.28 · GCP Detect gcploit framework

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot the use of the GCPloit exploitation framework within Google Cloud Platform (GCP) — so we know when protection is off, out of date, or bypassed.*

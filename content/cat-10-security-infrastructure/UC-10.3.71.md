<!-- AUTO-GENERATED from UC-10.3.71.json — DO NOT EDIT -->
...
# UC-10.3.71 · Detect Regasm with no Command Line Arguments

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Detect Regasm with no Command Line Arguments” so we can see attacker-style moves—not only a one-off file or password mistake.*

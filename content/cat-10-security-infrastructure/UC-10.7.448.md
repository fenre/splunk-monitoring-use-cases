<!-- AUTO-GENERATED from UC-10.7.448.json — DO NOT EDIT -->
...
# UC-10.7.448 · Windows AD DSRM Account Changes

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows DSRM Account Changes" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

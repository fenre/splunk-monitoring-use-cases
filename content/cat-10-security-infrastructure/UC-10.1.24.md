<!-- AUTO-GENERATED from UC-10.1.24.json — DO NOT EDIT -->
...
# UC-10.1.24 · Allow Inbound Traffic By Firewall Rule Registry

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects suspicious modifications to firewall rule registry settings that allow inbound traffic on specific ports with a public profile — so we know when protection is off, out of date, or bypassed.*
...
- [https://learn.microsoft.com/en-us/powershell/module/netsecurity/new-netfirewallrule?view=windowsserver2019-ps](https://learn.microsoft.com/en-us/powershell/module/netsecurity/new-netfirewallrule?view=windowsserver2019-ps)

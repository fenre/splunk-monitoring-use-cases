<!-- AUTO-GENERATED from UC-10.6.172.json — DO NOT EDIT -->
...
# UC-10.6.172 · JetBrains TeamCity Limited Auth Bypass Suricata CVE-2024-27199

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies attempts to exploit, a critical vulnerability in JetBrains TeamCity web server, allowing unauthenticated access to specific endpoints, and we use Splunk so the team can see it early and act.*

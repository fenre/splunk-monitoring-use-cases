<!-- AUTO-GENERATED from UC-10.2.25.json — DO NOT EDIT -->
...
# UC-10.2.25 · Detect AWS Console Login by User from New Region

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot AWS console login attempts by users from a new region — so we know when protection is off, out of date, or bypassed.*

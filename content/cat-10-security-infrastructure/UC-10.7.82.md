<!-- AUTO-GENERATED from UC-10.7.82.json — DO NOT EDIT -->

---
id: "10.7.82"
title: "ASL AWS ECR Container Upload Outside Business Hours"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.82 · ASL AWS ECR Container Upload Outside Business Hours
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to user account entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires ASL AWS CloudTrail ingested and CIM-normalized.

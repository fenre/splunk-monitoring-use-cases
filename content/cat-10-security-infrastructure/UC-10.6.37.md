<!-- AUTO-GENERATED from UC-10.6.37.json — DO NOT EDIT -->

---
id: "10.6.37"
title: "Cisco Isovalent - Pods Running Offensive Tools"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.6.37 · Cisco Isovalent - Pods Running Offensive Tools

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects execution of known offensive tooling from within Kubernetes pods, including network scanners and post-exploitation frameworks (nmap, masscan, zmap, impacket-*, hashcat, john, SharpHound, kube-hunter, peirates), and we use Splunk so the team can see it early and act.*

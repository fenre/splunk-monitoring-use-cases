<!-- AUTO-GENERATED from UC-10.3.342.json — DO NOT EDIT -->
...
# UC-10.3.342 · Suspicious mshta spawn

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Suspicious mshta spawn”, so we catch real tradecraft and not just noise from everyday work.*

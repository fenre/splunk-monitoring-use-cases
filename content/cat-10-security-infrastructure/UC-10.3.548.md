<!-- AUTO-GENERATED from UC-10.3.548.json — DO NOT EDIT -->
...
# UC-10.3.548 · Windows MSIExec Spawn Discovery Command

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows MSIExec Spawn Discovery Command”, so we catch real tradecraft and not just noise from everyday work.*

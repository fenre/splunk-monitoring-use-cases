<!-- AUTO-GENERATED from UC-10.3.77.json — DO NOT EDIT -->
...
# UC-10.3.77 · Detect RTLO In Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Detect RTLO In Process” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.7.458.json — DO NOT EDIT -->
...
# UC-10.7.458 · Windows AD Replication Request Initiated from Unsanctioned Location

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Replication Request Initiated from Unsanctioned L" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

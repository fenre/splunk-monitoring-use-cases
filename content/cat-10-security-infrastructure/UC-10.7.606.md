<!-- AUTO-GENERATED from UC-10.7.606.json — DO NOT EDIT -->
...
# UC-10.7.606 · Windows Rasautou DLL Execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Rasautou DLL Execution" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

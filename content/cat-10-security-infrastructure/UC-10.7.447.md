<!-- AUTO-GENERATED from UC-10.7.447.json — DO NOT EDIT -->
...
# UC-10.7.447 · Windows AD Domain Root ACL Modification

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Domain Root ACL Modification" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

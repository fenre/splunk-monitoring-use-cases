<!-- AUTO-GENERATED from UC-10.7.149.json — DO NOT EDIT -->
...
# UC-10.7.149 · Azure AD Multiple Users Failing To Authenticate From Ip

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD Multiple Users Failing To Authenticate From Ip so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

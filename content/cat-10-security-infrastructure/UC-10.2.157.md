<!-- AUTO-GENERATED from UC-10.2.157.json — DO NOT EDIT -->
...
# UC-10.2.157 · Windows Unsigned DLL Side-Loading In Same Process Path

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot unsigned DLLs loaded through DLL side-loading with same file path with the process loaded the DLL, a technique observed in DarkGate malware — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.7.240.json — DO NOT EDIT -->
...
# UC-10.7.240 · Kubernetes Shell Running on Worker Node with CPU Activity

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use this 'Kubernetes Shell Running on Worker Node with CPU Activity' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*
...
Cluster churn, HPA, node cycling, and metrics gaps during upgrades can look like traffic or process anomalies; compare to the cluster timeline.

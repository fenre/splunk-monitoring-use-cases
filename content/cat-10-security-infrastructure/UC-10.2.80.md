<!-- AUTO-GENERATED from UC-10.2.80.json — DO NOT EDIT -->
...
*We catch the execution of wmic.exe with parameters to spawn a process on a remote system — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.1.33.json — DO NOT EDIT -->
...
# UC-10.1.33 · Windows Delete or Modify System Firewall

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies 'netsh' processes that delete or modify firewall configurations — so we know when protection is off, out of date, or bypassed.*

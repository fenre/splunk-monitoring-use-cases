<!-- AUTO-GENERATED from UC-10.7.674.json — DO NOT EDIT -->
...
# UC-10.7.674 · 3CX Supply Chain Attack Network Indicators

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "3CX Supply Chain Attack Network Indicators" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.2.111.json — DO NOT EDIT -->
...
# UC-10.2.111 · Windows Default Group Policy Object Modified with GPME

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch modifications to default Group Policy Objects (GPOs) using the Group Policy Management Editor (GPME) — so we know when protection is off, out of date, or bypassed.*

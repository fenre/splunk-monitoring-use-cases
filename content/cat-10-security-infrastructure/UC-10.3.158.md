<!-- AUTO-GENERATED from UC-10.3.158.json — DO NOT EDIT -->
...
*We use endpoint and security-agent signals around “Linux Add User Account” so we can see attacker-style moves—not only a one-off file or password mistake.*

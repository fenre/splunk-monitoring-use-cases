<!-- AUTO-GENERATED from UC-10.2.24.json — DO NOT EDIT -->
...
# UC-10.2.24 · Cloud Compute Instance Created With Previously Unseen Image

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the creation of cloud compute instances using previously unseen image — so we know when protection is off, out of date, or bypassed.*

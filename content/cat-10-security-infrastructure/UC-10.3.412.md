<!-- AUTO-GENERATED from UC-10.3.412.json — DO NOT EDIT -->
...
# UC-10.3.412 · Windows Cisco Secure Endpoint Stop Immunet Service Via Sfc

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Cisco Secure Endpoint Stop Immunet Service Via Sfc”, so we catch real tradecraft and not just noise from everyday work.*

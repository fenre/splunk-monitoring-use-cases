<!-- AUTO-GENERATED from UC-10.7.457.json — DO NOT EDIT -->
...
# UC-10.7.457 · Windows AD Replication Request Initiated by User Account

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Replication Request Initiated by User Account" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.3.417.json — DO NOT EDIT -->
...
# UC-10.3.417 · Windows Command Shell DCRat ForkBomb Payload

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Command Shell DCRat ForkBomb Payload”, so we catch real tradecraft and not just noise from everyday work.*

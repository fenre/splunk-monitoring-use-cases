<!-- AUTO-GENERATED from UC-10.7.322.json — DO NOT EDIT -->
...
# UC-10.7.322 · GetNetTcpconnection with PowerShell Script Block

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use this 'GetNetTcpconnection with PowerShell Script Block' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*

<!-- AUTO-GENERATED from UC-10.7.297.json — DO NOT EDIT -->
...
# UC-10.7.297 · Detect RTLO In File Name

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Detect RTLO In File Name so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

---

## Description

This detection identifies Detect RTLO In File Name. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

<!-- AUTO-GENERATED from UC-10.6.184.json — DO NOT EDIT -->
...
# UC-10.6.184 · VMware Server Side Template Injection Hunt

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies potential server-side template injection attempts related to, and we use Splunk so the team can see it early and act.*

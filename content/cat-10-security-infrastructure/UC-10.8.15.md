<!-- AUTO-GENERATED from UC-10.8.15.json — DO NOT EDIT -->
...
# UC-10.8.15 · Linux Impair Defenses Process Kill

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies the execution of the 'pkill' command, which is used to terminate processes on a Linux system — so we know when protection is off, out of date, or bypassed.*

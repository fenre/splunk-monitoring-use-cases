<!-- AUTO-GENERATED from UC-10.3.571.json — DO NOT EDIT -->
...
# UC-10.3.571 · Windows Office Product Loading VBE7 DLL

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Office Product Loading VBE7 DLL”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.4.22.json — DO NOT EDIT -->
...
# UC-10.4.22 · Suspicious Email Attachment Extensions
...
| tstats `summariesonly` count
  ...
  where isnotnull(All_Email.file_name)
  by All_Email.src_user All_Email.file_name All_Email.recipient span=1h
| sort -count
```
...
Uncommon but valid extensions in engineering, data science, and creative workflows (for example .iso for images, or compressed archives) from trusted internal tools and partner exchanges.

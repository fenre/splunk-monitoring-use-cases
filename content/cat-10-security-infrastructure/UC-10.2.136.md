<!-- AUTO-GENERATED from UC-10.2.136.json — DO NOT EDIT -->
...
# UC-10.2.136 · Windows Rapid Authentication On Multiple Hosts

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch a source computer authenticating to 30 or more remote endpoints within a 5-minute timespan using Event ID 4624 — so we know when protection is off, out of date, or bypassed.*

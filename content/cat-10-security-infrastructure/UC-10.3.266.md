<!-- AUTO-GENERATED from UC-10.3.266.json — DO NOT EDIT -->
...
# UC-10.3.266 · Permission Modification using Takeown App

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Permission Modification using Takeown App” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.2.91.json — DO NOT EDIT -->
...
# UC-10.2.91 · Services LOLBAS Execution Process Spawn

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot spawning a LOLBAS (Living Off the Land Binaries and Scripts) execution process — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.3.152.json — DO NOT EDIT -->
...
# UC-10.3.152 · High Process Termination Frequency

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “High Process Termination Frequency” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to host or system entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Sysmon EventID 5 ingested and CIM-normalized.

<!-- AUTO-GENERATED from UC-10.3.93.json — DO NOT EDIT -->
...
# UC-10.3.93 · Disable Schedule Task

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Disable Schedule Task” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.7.441.json — DO NOT EDIT -->
...
# UC-10.7.441 · Windows AD Dangerous User ACL Modification

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Dangerous User ACL Modification" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

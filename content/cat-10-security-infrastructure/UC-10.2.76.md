<!-- AUTO-GENERATED from UC-10.2.76.json — DO NOT EDIT -->
...
# UC-10.2.76 · Remote Process Instantiation via DCOM and PowerShell Script Block

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of PowerShell commands that initiate a process on a remote endpoint using the DCOM protocol — so we know when protection is off, out of date, or bypassed.*

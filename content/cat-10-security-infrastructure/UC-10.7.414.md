<!-- AUTO-GENERATED from UC-10.7.414.json — DO NOT EDIT -->
...
# UC-10.7.414 · Powershell Remote Services Add TrustedHost

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Powershell Remote Services Add TrustedHost" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

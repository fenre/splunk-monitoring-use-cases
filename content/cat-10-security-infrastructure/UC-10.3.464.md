<!-- AUTO-GENERATED from UC-10.3.464.json — DO NOT EDIT -->
...
# UC-10.3.464 · Windows Get-AdComputer Unconstrained Delegation Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Get-AdComputer Unconstrained Delegation Discovery”, so we catch real tradecraft and not just noise from everyday work.*
...
- [https://learn.microsoft.com/en-us/defender-for-identity/cas-isp-unconstrained-kerberos](https://learn.microsoft.com/en-us/defender-for-identity/cas-isp-unconstrained-kerberos)

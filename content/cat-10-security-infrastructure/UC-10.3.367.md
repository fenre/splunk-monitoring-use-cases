<!-- AUTO-GENERATED from UC-10.3.367.json — DO NOT EDIT -->
...
# UC-10.3.367 · Unknown Process Using The Kerberos Protocol

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Unknown Process Using The Kerberos Protocol”, so we catch real tradecraft and not just noise from everyday work.*

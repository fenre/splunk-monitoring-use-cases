<!-- AUTO-GENERATED from UC-10.3.595.json — DO NOT EDIT -->
...
# UC-10.3.595 · Windows Raw Access To Disk Volume Partition

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Raw Access To Disk Volume Partition”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.3.452.json — DO NOT EDIT -->
...
# UC-10.3.452 · Windows Enable Win32 ScheduledJob via Registry

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Enable Win32 ScheduledJob via Registry”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.7.561.json — DO NOT EDIT -->
...
# UC-10.7.561 · Windows Multiple Accounts Deleted

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Multiple Accounts Deleted" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.3.40.json — DO NOT EDIT -->
...
# UC-10.3.40 · Clop Common Exec Parameter

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Clop Common Exec Parameter” so we can see attacker-style moves—not only a one-off file or password mistake.*

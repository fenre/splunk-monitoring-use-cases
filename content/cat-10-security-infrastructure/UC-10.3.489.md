<!-- AUTO-GENERATED from UC-10.3.489.json — DO NOT EDIT -->
...
# UC-10.3.489 · Windows Impair Defenses Disable Auto Logger Session

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Impair Defenses Disable Auto Logger Session”, so we catch real tradecraft and not just noise from everyday work.*
...
- [https://isc.sans.edu/diary/rss/28628](https://isc.sans.edu/diary/rss/28628)
...
- [https://learn.microsoft.com/en-us/windows/win32/etw/configuring-and-starting-an-autologger-session](https://learn.microsoft.com/en-us/windows/win32/etw/configuring-and-starting-an-autologger-session)

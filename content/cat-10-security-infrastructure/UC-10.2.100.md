<!-- AUTO-GENERATED from UC-10.2.100.json — DO NOT EDIT -->
...
# UC-10.2.100 · Wermgr Process Spawned CMD Or Powershell Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the spawning of cmd or PowerShell processes by the wermgr.exe process — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.3.600.json — DO NOT EDIT -->
...
# UC-10.3.600 · Windows Registry Modification for Safe Mode Persistence

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Registry Modification for Safe Mode Persistence”, so we catch real tradecraft and not just noise from everyday work.*

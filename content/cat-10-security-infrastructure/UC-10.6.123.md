<!-- AUTO-GENERATED from UC-10.6.123.json — DO NOT EDIT -->
...
# UC-10.6.123 · Winhlp32 Spawning a Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects winhlp32.exe spawning a child process that loads a file from appdata, programdata, or temp directories, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.6.95.json — DO NOT EDIT -->
...
# UC-10.6.95 · Windows Impair Defense Configure App Install Control

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects modifications to the Windows registry that disable the Windows Defender SmartScreen App Install Control feature, and we use Splunk so the team can see it early and act.*

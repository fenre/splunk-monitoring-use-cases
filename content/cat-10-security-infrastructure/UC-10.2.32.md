<!-- AUTO-GENERATED from UC-10.2.32.json — DO NOT EDIT -->
...
# UC-10.2.32 · Detect Excessive User Account Lockouts

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot user accounts experiencing an excessive number of lockouts within a short timeframe — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.7.258.json — DO NOT EDIT -->

---
id: "10.7.258"
title: "Cisco Isovalent - Potential Escape to Host"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.258 · Cisco Isovalent - Potential Escape to Host

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Cisco Isovalent - Potential Escape to Host so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

---

## Description

This detection identifies Cisco Isovalent - Potential Escape to Host. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

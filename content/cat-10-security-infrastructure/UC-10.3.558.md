...
*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows New Default File Association Value Set”, so we catch real tradecraft and not just noise from everyday work.*

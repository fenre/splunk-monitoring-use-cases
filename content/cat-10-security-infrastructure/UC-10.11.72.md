<!-- AUTO-GENERATED from UC-10.11.72.json — DO NOT EDIT -->

---
id: "10.11.72"
title: "Tenable Compliance Scan Results"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.11.72 · Tenable Compliance Scan Results

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use Tenable data and alerts to stay ahead of the risks described in "Tenable Compliance Scan Results". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

Compliance scans prove configuration alignment to CIS and regulatory frameworks.
...
- `stats` rolls up events into metrics; results are split **by benchmark, status** so each row reflects one combination of those dimensions.
...
Bar chart (failed controls), Table (assets).

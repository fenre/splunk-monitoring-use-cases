<!-- AUTO-GENERATED from UC-10.3.353.json — DO NOT EDIT -->
...
# UC-10.3.353 · Suspicious SearchProtocolHost no Command Line Arguments

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Suspicious SearchProtocolHost no Command Line Arguments”, so we catch real tradecraft and not just noise from everyday work.*

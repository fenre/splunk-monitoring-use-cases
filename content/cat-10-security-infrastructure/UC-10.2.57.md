<!-- AUTO-GENERATED from UC-10.2.57.json — DO NOT EDIT -->
...
# UC-10.2.57 · Linux SSH Remote Services Script Execute

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the use of remote login to move laterally and execute a script or file on a remote host — so we know when protection is off, out of date, or bypassed.*

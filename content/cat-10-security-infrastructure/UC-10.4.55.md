<!-- AUTO-GENERATED from UC-10.4.55.json — DO NOT EDIT -->
...
# UC-10.4.55 · O365 Email Hard Delete Excessive Volume
...
```spl
`o365_management_activity` Workload=Exchange (Operation IN ("HardDelete") AND Folder.Path IN ("\\Sent Items","\\Recoverable Items\\Deletions")) AND UserId = "$user$
```
...
Bulk mailbox cleanup, retention jobs, and migration projects that perform mass deletes. Confirm against change windows and the Microsoft 365 purview/activity that initiated the deletions.

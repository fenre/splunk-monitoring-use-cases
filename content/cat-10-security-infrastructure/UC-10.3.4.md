...
*We lean on behavior-based rules on the endpoint to catch fileless and living-off-the-land tricks, not only a known-bad file name.*
...
Fileless and behavior rules can fire on admin scripts, patch tools, and developer workflows; line up alerts to the same technique in the console and to your change calendar.

<!-- AUTO-GENERATED from UC-10.3.657.json — DO NOT EDIT -->
...
# UC-10.3.657 · Windows User Execution Malicious URL Shortcut File

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows User Execution Malicious URL Shortcut File”, so we catch real tradecraft and not just noise from everyday work.*

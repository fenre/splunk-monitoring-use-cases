<!-- AUTO-GENERATED from UC-10.3.339.json — DO NOT EDIT -->
...
# UC-10.3.339 · Suspicious msbuild path

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Suspicious msbuild path” so we can see attacker-style moves—not only a one-off file or password mistake.*

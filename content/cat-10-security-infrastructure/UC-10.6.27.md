<!-- AUTO-GENERATED from UC-10.6.27.json — DO NOT EDIT -->
...
*The following analytic identifies unauthenticated requests to Kubernetes cluster pods, and we use Splunk so the team can see it early and act.*

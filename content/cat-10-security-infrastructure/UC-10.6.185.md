<!-- AUTO-GENERATED from UC-10.6.185.json — DO NOT EDIT -->
...
# UC-10.6.185 · VMware Workspace ONE Freemarker Server-side Template Injection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects server-side template injection attempts related to in VMware Workspace ONE, and we use Splunk so the team can see it early and act.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to host or system entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Palo Alto Network Threat ingested and CIM-normalized.
...
- [https://attackerkb.com/topics/BDXyTqY1ld/cve-2022-22954](https://attackerkb.com/topics/BDXyTqY1ld/cve-2022-22954)

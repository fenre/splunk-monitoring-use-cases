<!-- AUTO-GENERATED from UC-10.7.323.json — DO NOT EDIT -->
...
# UC-10.7.323 · GetWmiObject Ds Computer with PowerShell Script Block

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for GetWmiObject Ds Computer with PowerShell Script Block so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

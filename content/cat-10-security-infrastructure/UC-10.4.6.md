...
*We watch for unusual mail volume to and from users and systems, so sudden spikes from compromise, harvesting, or misconfiguration stand out from normal business traffic.*
...
High-volume senders from CRM campaigns (for example Salesforce Marketing Cloud), system notifications, or legitimate transactional blasts to large distribution lists; seasonal events can shift baselines.

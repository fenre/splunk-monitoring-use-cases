<!-- AUTO-GENERATED from UC-10.3.56.json — DO NOT EDIT -->
...
# UC-10.3.56 · Deleting Shadow Copies

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Deleting Shadow Copies” so we can see attacker-style moves—not only a one-off file or password mistake.*

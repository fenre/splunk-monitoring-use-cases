<!-- AUTO-GENERATED from UC-10.7.577.json — DO NOT EDIT -->
...
# UC-10.7.577 · Windows PowerShell Disable HTTP Logging

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows PowerShell Disable HTTP Logging" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.4.58.json — DO NOT EDIT -->
...
# UC-10.4.58 · O365 Email Receive and Hard Delete Takeover Behavior
...
```spl
`o365_messagetrace` subject IN ("*banking*","*direct deposit*","*pay-to*","*password *","*passcode *","*OTP *","*MFA *","*Account Recovery*") AND RecipientAddress = "$user$
```
...
Legitimate high-volume move-to-folder or triage after mailbox imports and PST ingest; check whether the account had an active migration or shared recovery session.

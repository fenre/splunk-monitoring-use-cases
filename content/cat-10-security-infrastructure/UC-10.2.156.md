<!-- AUTO-GENERATED from UC-10.2.156.json — DO NOT EDIT -->
...
# UC-10.2.156 · Windows Unsigned DLL Side-Loading

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the creation of potentially malicious unsigned DLLs in the c:\windows\system32 or c:\windows\syswow64 folders — so we know when protection is off, out of date, or bypassed.*

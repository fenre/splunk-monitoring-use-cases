<!-- AUTO-GENERATED from UC-10.3.69.json — DO NOT EDIT -->
...
# UC-10.3.69 · Detect RClone Command-Line Usage

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Detect RClone Command-Line Usage” so we can see attacker-style moves—not only a one-off file or password mistake.*

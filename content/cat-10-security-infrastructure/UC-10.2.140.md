<!-- AUTO-GENERATED from UC-10.2.140.json — DO NOT EDIT -->
...
# UC-10.2.140 · Windows Replication Through Removable Media

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the creation or dropping of executable or script files in the root directory of a removable drive — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.7.527.json — DO NOT EDIT -->
...
# UC-10.7.527 · Windows Exfiltration Over C2 Via Invoke RestMethod

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Exfiltration Over C2 Via Invoke RestMethod" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

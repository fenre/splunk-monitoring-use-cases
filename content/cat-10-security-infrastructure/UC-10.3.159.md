<!-- AUTO-GENERATED from UC-10.3.159.json — DO NOT EDIT -->
...
# UC-10.3.159 · Linux Adding Crontab Using List Parameter

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Adding Crontab Using List Parameter” so we can see attacker-style moves—not only a one-off file or password mistake.*

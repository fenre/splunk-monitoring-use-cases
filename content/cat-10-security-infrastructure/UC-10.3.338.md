<!-- AUTO-GENERATED from UC-10.3.338.json — DO NOT EDIT -->
...
# UC-10.3.338 · Suspicious microsoft workflow compiler usage

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Suspicious microsoft workflow compiler usage” so we can see attacker-style moves—not only a one-off file or password mistake.*

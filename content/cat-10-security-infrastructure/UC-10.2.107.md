<!-- AUTO-GENERATED from UC-10.2.107.json — DO NOT EDIT -->

---
id: "10.2.107"
title: "Windows ComputerDefaults Spawning a Process"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.2.107 · Windows ComputerDefaults Spawning a Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the spawning of ComputerDefaults.exe, a Windows system process used to manage default application associations — so we know when protection is off, out of date, or bypassed.*
...
IT packaging, GPO updates, and endpoint agents spawn many of the same process and logon patterns as real attacks—filter by business role and software inventory.

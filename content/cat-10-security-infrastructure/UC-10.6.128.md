<!-- AUTO-GENERATED from UC-10.6.128.json — DO NOT EDIT -->
...
# UC-10.6.128 · Detect Windows DNS SIGRed via Splunk Stream

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit the SIGRed vulnerability in Windows servers, and we use Splunk so the team can see it early and act.*

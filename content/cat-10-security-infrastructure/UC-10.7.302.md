<!-- AUTO-GENERATED from UC-10.7.302.json — DO NOT EDIT -->
...
# UC-10.7.302 · DLLHost with no Command Line Arguments with Network

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for DLLHost with no Command Line Arguments with Network so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

---

## Description

This detection identifies DLLHost with no Command Line Arguments with Network. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

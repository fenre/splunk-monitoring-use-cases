<!-- AUTO-GENERATED from UC-10.7.684.json — DO NOT EDIT -->
...
# UC-10.7.684 · Detect ARP Poisoning

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on aRP Poisoning attacks by monitoring for Dynamic ARP Inspection (DAI) errors on Cisco network devices so unusual activity is visible early — before it spreads or hides in normal noise.*

<!-- AUTO-GENERATED from UC-10.3.245.json — DO NOT EDIT -->
...
# UC-10.3.245 · MacOS - Re-opened Applications

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “MacOS - Re-opened Applications” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.3.395.json — DO NOT EDIT -->

---
id: "10.3.395"
title: "Windows Audit Policy Excluded Category via Auditpol"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.395 · Windows Audit Policy Excluded Category via Auditpol

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Audit Policy Excluded Category via Auditpol”, so we catch real tradecraft and not just noise from everyday work.*
...
- [https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/auditpol-set](https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/auditpol-set)

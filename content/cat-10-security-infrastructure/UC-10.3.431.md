<!-- AUTO-GENERATED from UC-10.3.431.json — DO NOT EDIT -->
...
# UC-10.3.431 · Windows Defender ASR Audit Events

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Defender ASR Audit Events”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.7.600.json — DO NOT EDIT -->
...
# UC-10.7.600 · Windows Process Injection into Notepad

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Process Injection into Notepad" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

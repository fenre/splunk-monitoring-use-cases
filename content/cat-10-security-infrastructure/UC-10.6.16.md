<!-- AUTO-GENERATED from UC-10.6.16.json — DO NOT EDIT -->
...
# UC-10.6.16 · Ollama Possible RCE via Model Loading

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch Ollama server errors and failures during model loading operations that may indicate malicious model injection, path traversal attempts, or exploitation of model loading mechanisms to achieve remote code execution, and we use Splunk so the team can see it early and act.*

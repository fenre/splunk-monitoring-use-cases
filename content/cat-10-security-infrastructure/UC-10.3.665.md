<!-- AUTO-GENERATED from UC-10.3.665.json — DO NOT EDIT -->
...
# UC-10.3.665 · Wmic NonInteractive App Uninstallation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Wmic NonInteractive App Uninstallation”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.3.643.json — DO NOT EDIT -->
...
# UC-10.3.643 · Windows System Shutdown CommandLine

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows System Shutdown CommandLine”, so we catch real tradecraft and not just noise from everyday work.*

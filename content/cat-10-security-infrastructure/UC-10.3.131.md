<!-- AUTO-GENERATED from UC-10.3.131.json — DO NOT EDIT -->
...
# UC-10.3.131 · Get DomainPolicy with Powershell

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Get DomainPolicy with Powershell” so we can see attacker-style moves—not only a one-off file or password mistake.*

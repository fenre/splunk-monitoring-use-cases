<!-- AUTO-GENERATED from UC-10.7.613.json — DO NOT EDIT -->
...
# UC-10.7.613 · Windows RDP Server Registry Entry Created

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows RDP Server Registry Entry Created" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.7.431.json — DO NOT EDIT -->
...
*We keep an eye on a process attempting to access winlogon.exe to duplicate its handle so unusual activity is visible early — before it spreads or hides in normal noise.*

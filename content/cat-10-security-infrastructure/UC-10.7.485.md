<!-- AUTO-GENERATED from UC-10.7.485.json — DO NOT EDIT -->

---
id: "10.7.485"
title: "Windows Chrome Enable Extension Loading via Command-Line"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.485 · Windows Chrome Enable Extension Loading via Command-Line

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Chrome Enable Extension Loading via Command-Line" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

---

## Description

This detection identifies Windows Chrome Enable Extension Loading via Command-Line. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

<!-- AUTO-GENERATED from UC-10.6.92.json — DO NOT EDIT -->
...
# UC-10.6.92 · Windows IIS Components Module Failed to Load

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects when an IIS Module DLL fails to load due to a configuration problem, identified by EventCode 2282, and we use Splunk so the team can see it early and act.*

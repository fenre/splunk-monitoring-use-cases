<!-- AUTO-GENERATED from UC-10.3.223.json — DO NOT EDIT -->
...
# UC-10.3.223 · Linux Possible Append Command To Profile Config File

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Possible Append Command To Profile Config File” so we can see attacker-style moves—not only a one-off file or password mistake.*

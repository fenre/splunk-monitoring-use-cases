<!-- AUTO-GENERATED from UC-10.3.423.json — DO NOT EDIT -->
...
# UC-10.3.423 · Windows Credentials from Password Stores Creation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Credentials from Password Stores Creation”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.8.23.json — DO NOT EDIT -->
...
# UC-10.8.23 · Windows Registry Certificate Added

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the installation of a root CA certificate by monitoring specific registry paths for SetValue events — so we know when protection is off, out of date, or bypassed.*

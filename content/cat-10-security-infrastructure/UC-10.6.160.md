<!-- AUTO-GENERATED from UC-10.6.160.json — DO NOT EDIT -->
...
*The following analytic detects potential exploitation attempts of the Log4Shell vulnerability by analyzing HTTP headers for specific patterns, and we use Splunk so the team can see it early and act.*

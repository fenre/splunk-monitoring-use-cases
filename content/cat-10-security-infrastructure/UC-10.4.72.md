<!-- AUTO-GENERATED from UC-10.4.72.json — DO NOT EDIT -->
...
# UC-10.4.72 · O365 Exfiltration via File Sync Download
...
```spl
`o365_management_activity` Operation IN ("filesyncdownload*") UserId="$UserId$
```

<!-- AUTO-GENERATED from UC-10.7.384.json — DO NOT EDIT -->
...
# UC-10.7.384 · Linux Persistence and Privilege Escalation Risk Behavior

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Linux Persistence and Privilege Escalation Risk Behavior" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.3.374.json — DO NOT EDIT -->
...
# UC-10.3.374 · Vbscript Execution Using Wscript App

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Vbscript Execution Using Wscript App”, so we catch real tradecraft and not just noise from everyday work.*

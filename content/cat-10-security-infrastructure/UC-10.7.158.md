<!-- AUTO-GENERATED from UC-10.7.158.json — DO NOT EDIT -->
...
# UC-10.7.158 · Azure AD Privileged Role Assigned

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD Privileged Role Assigned so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*
...
- [https://learn.microsoft.com/en-us/azure/active-directory/roles/concept-understand-roles](https://learn.microsoft.com/en-us/azure/active-directory/roles/concept-understand-roles)

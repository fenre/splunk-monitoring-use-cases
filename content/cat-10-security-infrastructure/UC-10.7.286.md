<!-- AUTO-GENERATED from UC-10.7.286.json — DO NOT EDIT -->
...
# UC-10.7.286 · Detect Empire with PowerShell Script Block Logging

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Detect Empire with PowerShell Script Block Logging so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

<!-- AUTO-GENERATED from UC-10.6.180.json — DO NOT EDIT -->
...
# UC-10.6.180 · Tomcat Session Deserialization Attempt

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This detection identifies potential exploitation of in Apache Tomcat through the second stage of the attack, and we use Splunk so the team can see it early and act.*
...
```spl
| from datamodel Web.Web | search http_method=GET AND cookie="*JSESSIONID=.*" src=$src$ | table src dest http_method uri_path http_user_agent status
```
...
- [https://nvd.nist.gov/vuln/detail/CVE-2025-24813](https://nvd.nist.gov/vuln/detail/CVE-2025-24813)
- [https://github.com/vulhub/vulhub/tree/master/tomcat/CVE-2025-24813](https://github.com/vulhub/vulhub/tree/master/tomcat/CVE-2025-24813)
- [https://www.rapid7.com/db/vulnerabilities/apache-tomcat-cve-2025-24813/](https://www.rapid7.com/db/vulnerabilities/apache-tomcat-cve-2025-24813/)
- [https://gist.github.com/MHaggis/e106367f6649fbb09ab27e7b4a01cf73](https://gist.github.com/MHaggis/e106367f6649fbb09ab27e7b4a01cf73)

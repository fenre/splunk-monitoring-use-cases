<!-- AUTO-GENERATED from UC-10.8.13.json — DO NOT EDIT -->

---
id: "10.8.13"
title: "Linux Auditd Private Keys and Certificate Enumeration"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.8.13 · Linux Auditd Private Keys and Certificate Enumeration

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects suspicious attempts to find private keys, which may indicate an attacker's effort to access sensitive cryptographic information — so we know when protection is off, out of date, or bypassed.*

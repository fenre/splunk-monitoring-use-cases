<!-- AUTO-GENERATED from UC-10.7.333.json — DO NOT EDIT -->
...
# UC-10.7.333 · Kerberoasting spn request with RC4 encryption

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Kerberoasting spn request with RC4 encryption so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*
...
Kerberoasting and DCSync-style indicators from authorized red team exercises, security tool training, or detection rule testing.

<!-- AUTO-GENERATED from UC-10.1.63.json — DO NOT EDIT -->
...
# UC-10.1.63 · Cisco Secure Firewall - Privileged Command Execution via HTTP
...
This detection identifies Cisco Secure Firewall - Privileged Command Execution via HTTP. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

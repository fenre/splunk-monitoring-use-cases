<!-- AUTO-GENERATED from UC-10.7.369.json — DO NOT EDIT -->
...
# UC-10.7.369 · Linux Auditd Setuid Using Chmod Utility

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Linux Auditd Setuid Using Chmod Utility" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

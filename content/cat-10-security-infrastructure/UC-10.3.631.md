<!-- AUTO-GENERATED from UC-10.3.631.json — DO NOT EDIT -->
...
# UC-10.3.631 · Windows SQL Spawning CertUtil

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows SQL Spawning CertUtil”, so we catch real tradecraft and not just noise from everyday work.*

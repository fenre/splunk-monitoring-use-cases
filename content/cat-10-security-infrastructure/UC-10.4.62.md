<!-- AUTO-GENERATED from UC-10.4.62.json — DO NOT EDIT -->

---
id: "10.4.62"
title: "O365 Email Send and Hard Delete Exfiltration Behavior"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.4.62 · O365 Email Send and Hard Delete Exfiltration Behavior
...
```spl
`o365_management_activity` Workload=Exchange (Operation IN ("Send")) OR (Operation IN ("HardDelete") AND Folder.Path IN ("\\Sent Items","\\Recoverable Items\\Deletions")) AND UserId = "$user$
```
...
Exfil heuristics that capture legitimate mailbox exports for legal hold, eDiscovery, or offboarding under IT control. Review eDiscovery and admin roles for the time window.

<!-- AUTO-GENERATED from UC-10.7.104.json — DO NOT EDIT -->
...
# UC-10.7.104 · AWS Defense Evasion Stop Logging Cloudtrail
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to IP address entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires AWS CloudTrail StopLogging ingested and CIM-normalized.

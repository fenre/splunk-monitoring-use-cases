<!-- AUTO-GENERATED from UC-10.7.715.json — DO NOT EDIT -->
...
# UC-10.7.715 · PaperCut NG Remote Web Access Attempt

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "PaperCut NG Remote Web Access Attempt" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

---

## Description

This detection identifies PaperCut NG Remote Web Access Attempt. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

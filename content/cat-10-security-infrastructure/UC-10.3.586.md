<!-- AUTO-GENERATED from UC-10.3.586.json — DO NOT EDIT -->
...
# UC-10.3.586 · Windows Process Injection In Non-Service SearchIndexer

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Process Injection In Non-Service SearchIndexer”, so we catch real tradecraft and not just noise from everyday work.*

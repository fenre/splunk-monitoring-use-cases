<!-- AUTO-GENERATED from UC-10.3.493.json — DO NOT EDIT -->
...
# UC-10.3.493 · Windows Indicator Removal Via Rmdir

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Indicator Removal Via Rmdir”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.8.7.json — DO NOT EDIT -->
...
# UC-10.8.7 · Attempt To Add Certificate To Untrusted Store

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This detection identifies Attempt To Add Certificate To Untrusted Store — so we know when protection is off, out of date, or bypassed.*

---

## Description

This detection identifies Attempt To Add Certificate To Untrusted Store. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

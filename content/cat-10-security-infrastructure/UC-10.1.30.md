<!-- AUTO-GENERATED from UC-10.1.30.json — DO NOT EDIT -->
...
# UC-10.1.30 · Linux Iptables Firewall Modification

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects suspicious command-line activity that modifies the iptables firewall settings on a Linux machine — so we know when protection is off, out of date, or bypassed.*

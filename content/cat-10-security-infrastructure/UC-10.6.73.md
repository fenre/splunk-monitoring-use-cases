<!-- AUTO-GENERATED from UC-10.6.73.json — DO NOT EDIT -->
...
# UC-10.6.73 · Suspicious Computer Account Name Change

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects a suspicious computer account name change in Active Directory, and we use Splunk so the team can see it early and act.*

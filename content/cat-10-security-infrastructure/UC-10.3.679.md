<!-- AUTO-GENERATED from UC-10.3.679.json — DO NOT EDIT -->
...
# UC-10.3.679 · High Volume of Bytes Out to Url

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “High Volume of Bytes Out to Url”, so we catch real tradecraft and not just noise from everyday work.*

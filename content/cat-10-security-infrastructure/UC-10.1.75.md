<!-- AUTO-GENERATED from UC-10.1.75.json — DO NOT EDIT -->
...
# UC-10.1.75 · Detect Traffic Mirroring

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the initiation of traffic mirroring sessions on Cisco network devices — so we know when protection is off, out of date, or bypassed.*

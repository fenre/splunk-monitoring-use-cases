<!-- AUTO-GENERATED from UC-10.3.369.json — DO NOT EDIT -->
...
# UC-10.3.369 · Unusually Long Command Line

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Unusually Long Command Line”, so we catch real tradecraft and not just noise from everyday work.*

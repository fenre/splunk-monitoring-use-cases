<!-- AUTO-GENERATED from UC-10.7.437.json — DO NOT EDIT -->
...
# UC-10.7.437 · Windows AD AdminSDHolder ACL Modified

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows AdminSDHolder ACL Modified" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

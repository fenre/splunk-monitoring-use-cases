<!-- AUTO-GENERATED from UC-10.7.649.json — DO NOT EDIT -->
...
# UC-10.7.649 · True Positive Test

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on a source user failing to authenticate with multiple users using explicit credentials on a host so unusual activity is visible early — before it spreads or hides in normal noise.*

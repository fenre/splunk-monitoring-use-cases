<!-- AUTO-GENERATED from UC-10.3.312.json — DO NOT EDIT -->
...
# UC-10.3.312 · Schedule Task with Rundll32 Command Trigger

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Schedule Task with Rundll32 Command Trigger” so we can see attacker-style moves—not only a one-off file or password mistake.*

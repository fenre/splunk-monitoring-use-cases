...
*We track blocked web categories at the secure web gateway so policy gaps, user behavior, and attack spikes are visible.*
...
```spl
index=proxy sourcetype="cisco:umbrella:proxy" action="Blocked"
| top limit=20 categories
```

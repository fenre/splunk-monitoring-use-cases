<!-- AUTO-GENERATED from UC-10.7.631.json — DO NOT EDIT -->

---
id: "10.7.631"
title: "Windows SnappyBee Create Test Registry"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.631 · Windows SnappyBee Create Test Registry

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows SnappyBee Create Test Registry" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

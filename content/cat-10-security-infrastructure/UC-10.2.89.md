<!-- AUTO-GENERATED from UC-10.2.89.json — DO NOT EDIT -->
...
# UC-10.2.89 · Schtasks Run Task On Demand

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of a Windows Scheduled Task on demand using the shell or command line — so we know when protection is off, out of date, or bypassed.*

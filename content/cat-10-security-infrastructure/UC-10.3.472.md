<!-- AUTO-GENERATED from UC-10.3.472.json — DO NOT EDIT -->
...
# UC-10.3.472 · Windows IIS Components Add New Module

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows IIS Components Add New Module”, so we catch real tradecraft and not just noise from everyday work.*

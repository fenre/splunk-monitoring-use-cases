<!-- AUTO-GENERATED from UC-10.3.474.json — DO NOT EDIT -->
...
# UC-10.3.474 · Windows Impair Defense Change Win Defender Throttle Rate

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Impair Defense Change Win Defender Throttle Rate”, so we catch real tradecraft and not just noise from everyday work.*

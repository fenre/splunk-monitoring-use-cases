<!-- AUTO-GENERATED from UC-10.6.98.json — DO NOT EDIT -->
...
# UC-10.6.98 · Windows Impair Defense Disable Win Defender Scan On Update

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects modifications to the Windows registry that disable the Windows Defender Scan On Update feature, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.7.363.json — DO NOT EDIT -->
...
# UC-10.7.363 · Linux Auditd Possible Access To Credential Files

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Linux Auditd Possible Access To Credential Files" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

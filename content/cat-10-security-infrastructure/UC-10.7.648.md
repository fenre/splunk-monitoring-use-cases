<!-- AUTO-GENERATED from UC-10.7.648.json — DO NOT EDIT -->
...
# UC-10.7.648 · Windows UAC Bypass Suspicious Escalation Behavior

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows UAC Bypass Suspicious Escalation Behavior" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.2.40.json — DO NOT EDIT -->
...
# UC-10.2.40 · Enable RDP In Other Port Number

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch modifications to the registry that enable remote desktop on a machine using a non-default port number — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.3.589.json — DO NOT EDIT -->
...
# UC-10.3.589 · Windows Process With NetExec Command Line Parameters

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Process With NetExec Command Line Parameters”, so we catch real tradecraft and not just noise from everyday work.*
...
- [https://www.johnvictorwolfe.com/2024/07/21/the-successor-to-crackmapexec/](https://www.johnvictorwolfe.com/2024/07/21/the-successor-to-crackmapexec/)
- [https://attack.mitre.org/software/S0488/](https://attack.mitre.org/software/S0488/)

<!-- AUTO-GENERATED from UC-10.3.482.json — DO NOT EDIT -->
...
# UC-10.3.482 · Windows Impair Defense Disable PUA Protection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Impair Defense Disable PUA Protection”, so we catch real tradecraft and not just noise from everyday work.*

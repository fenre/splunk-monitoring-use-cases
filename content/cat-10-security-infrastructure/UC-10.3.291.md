<!-- AUTO-GENERATED from UC-10.3.291.json — DO NOT EDIT -->
...
# UC-10.3.291 · Regsvr32 Silent and Install Param Dll Loading

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Regsvr32 Silent and Install Param Dll Loading” so we can see attacker-style moves—not only a one-off file or password mistake.*

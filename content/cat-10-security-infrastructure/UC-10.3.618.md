<!-- AUTO-GENERATED from UC-10.3.618.json — DO NOT EDIT -->
...
# UC-10.3.618 · Windows Security Support Provider Reg Query

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Security Support Provider Reg Query”, so we catch real tradecraft and not just noise from everyday work.*

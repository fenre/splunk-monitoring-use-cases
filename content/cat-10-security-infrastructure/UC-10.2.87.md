<!-- AUTO-GENERATED from UC-10.2.87.json — DO NOT EDIT -->
...
# UC-10.2.87 · Scheduled Task Creation on Remote Endpoint using At

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the creation of scheduled tasks on remote Windows endpoints using the at.exe command — so we know when protection is off, out of date, or bypassed.*
...
- [https://learn.microsoft.com/en-us/windows/win32/cimwin32prov/win32-scheduledjob?redirectedfrom=MSDN](https://learn.microsoft.com/en-us/windows/win32/cimwin32prov/win32-scheduledjob?redirectedfrom=MSDN)

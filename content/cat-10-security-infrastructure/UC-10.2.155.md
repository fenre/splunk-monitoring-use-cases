<!-- AUTO-GENERATED from UC-10.2.155.json — DO NOT EDIT -->
...
# UC-10.2.155 · Windows UAC Bypass Suspicious Child Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch when an executable known for User Account Control (UAC) bypass exploitation spawns a child process in a user-controlled location or a command shell executable (cmd.exe, powershell.exe) — so we know when protection is off, out of date, or bypassed.*

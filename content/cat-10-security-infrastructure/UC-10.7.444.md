<!-- AUTO-GENERATED from UC-10.7.444.json — DO NOT EDIT -->
...
# UC-10.7.444 · Windows AD Domain Controller Promotion

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Domain Controller Promotion" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

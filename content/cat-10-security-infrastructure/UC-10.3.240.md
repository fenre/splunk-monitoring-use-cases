<!-- AUTO-GENERATED from UC-10.3.240.json — DO NOT EDIT -->
...
# UC-10.3.240 · Linux System Reboot Via System Request Key

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux System Reboot Via System Request Key” so we can see attacker-style moves—not only a one-off file or password mistake.*

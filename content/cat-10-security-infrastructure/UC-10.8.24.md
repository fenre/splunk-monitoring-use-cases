<!-- AUTO-GENERATED from UC-10.8.24.json — DO NOT EDIT -->
...
# UC-10.8.24 · Windows Steal Authentication Certificates - ESC1 Abuse

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects when a new certificate is requested or granted against Active Directory Certificate Services (AD CS) using a Subject Alternative Name (SAN) — so we know when protection is off, out of date, or bypassed.*

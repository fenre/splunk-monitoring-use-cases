<!-- AUTO-GENERATED from UC-10.3.319.json — DO NOT EDIT -->
...
# UC-10.3.319 · SearchProtocolHost with no Command Line with Network

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “SearchProtocolHost with no Command Line with Network” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
| tstats `summariesonly` count
  ...
  by Ports.dest Ports.dest_port span=1h
| where count>0
| sort -count
```

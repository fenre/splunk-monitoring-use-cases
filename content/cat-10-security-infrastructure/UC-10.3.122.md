<!-- AUTO-GENERATED from UC-10.3.122.json — DO NOT EDIT -->
...
# UC-10.3.122 · Excessive Usage Of Taskkill

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Excessive Usage Of Taskkill” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.7.326.json — DO NOT EDIT -->
...
# UC-10.7.326 · GetWmiObject User Account with PowerShell Script Block

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use this 'GetWmiObject User Account with PowerShell Script Block' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*

...
*We use this for False Positive Rate Tracking so leadership can see trends and the SOC can see workload and quality over time.*
...
FPR changes when tuning rules, onboarding new data, or running quality initiatives; a temporary rise can mean better classification, not worse detections.

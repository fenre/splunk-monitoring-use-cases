...
*We use baselines to flag rare host-to-host paths that can show lateral movement when someone hops outside their usual neighborhood.*
...
First-seen host pairs can be new application rollouts, cloud hops, or jump-box redesigns that are boring but new to the model — use change records.

<!-- AUTO-GENERATED from UC-10.2.98.json — DO NOT EDIT -->
...
# UC-10.2.98 · Unusual Number of Remote Endpoint Authentication Events

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot an unusual number of remote authentication attempts from a single source by leveraging Windows Event ID 4624, which logs successful account logons — so we know when protection is off, out of date, or bypassed.*
...
ESCU Hunting detection — not designed for automated alerting. Run ad-hoc or on a low-frequency schedule from Splunk Enterprise Security for analyst-driven investigation. Requires Windows Event Log Security 4624 ingested and CIM-normalized.

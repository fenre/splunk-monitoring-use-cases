<!-- AUTO-GENERATED from UC-10.6.13.json — DO NOT EDIT -->
...
# UC-10.6.13 · MCP Prompt Injection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This detection identifies potential prompt injection attempts within MCP (Model Context Protocol) communications by monitoring for known malicious phrases and patterns commonly used to manipulate AI assistants, and we use Splunk so the team can see it early and act.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to host or system entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires MCP Server ingested and CIM-normalized.
...
- [https://www.tenable.com/blog/mcp-prompt-injection-not-just-for-evil](https://www.tenable.com/blog/mcp-prompt-injection-not-just-for-evil)

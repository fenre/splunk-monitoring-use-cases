<!-- AUTO-GENERATED from UC-10.11.57.json — DO NOT EDIT -->

---
id: "10.11.57"
title: "ZIA Sandbox Analysis Results"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.11.57 · ZIA Sandbox Analysis Results

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use Zscaler data and alerts to stay ahead of the risks described in "ZIA Sandbox Analysis Results". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

ZIA sandbox catches unknown files before they reach the browser or endpoint.
...
- `stats` rolls up events into metrics; results are split **by verdict, file_type** so each row reflects one combination of those dimensions.
...
Table (malicious files), Bar chart (verdicts).

## Known False Positives

Zscaler blocks from category misclassifications, new SaaS rollouts, or short policy-tightening windows; triage with app owners and DLP before assuming compromise.

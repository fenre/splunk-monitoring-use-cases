<!-- AUTO-GENERATED from UC-10.7.624.json — DO NOT EDIT -->
...
*We keep an eye on the creation of scheduled tasks designed to execute commands using native Windows shells like PowerShell, Cmd, Wscript, or Cscript or from public folders such as Users, Temp, or ProgramData so unusual activity is visible early — before it spreads or hides in normal noise.*

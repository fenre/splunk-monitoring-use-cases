<!-- AUTO-GENERATED from UC-10.7.270.json — DO NOT EDIT -->

---
id: "10.7.270"
title: "Cisco NVM - Suspicious Network Connection From Process With No Args"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.270 · Cisco NVM - Suspicious Network Connection From Process With No Args

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Cisco NVM - Suspicious Network Connection From Process With No Args so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

---

## Description

This detection identifies Cisco NVM - Suspicious Network Connection From Process With No Args. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

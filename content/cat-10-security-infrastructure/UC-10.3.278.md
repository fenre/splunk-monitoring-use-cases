<!-- AUTO-GENERATED from UC-10.3.278.json — DO NOT EDIT -->
...
# UC-10.3.278 · PowerShell WebRequest Using Memory Stream

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “PowerShell WebRequest Using Memory Stream” so we can see attacker-style moves—not only a one-off file or password mistake.*

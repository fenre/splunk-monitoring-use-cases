<!-- AUTO-GENERATED from UC-10.3.168.json — DO NOT EDIT -->

---
id: "10.3.168"
title: "Linux Auditd Hidden Files And Directories Creation"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.168 · Linux Auditd Hidden Files And Directories Creation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Auditd Hidden Files And Directories Creation” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to host or system entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Linux Auditd Execve ingested and CIM-normalized.
...
Legitimate admin work, change windows, and maintenance can mirror attacker moves; line up the hit to a ticket, the same host in the console, and history before a major call.

## References

- [https://www.splunk.com/en_us/blog/security/deep-dive-on-persistence-privilege-escalation-technique-and-detection-in-linux-platform.html](https://www.splunk.com/en_us/blog/security/deep-dive-on-persistence-privilege-escalation-technique-and-detection-in-linux-platform.html)

<!-- AUTO-GENERATED from UC-10.7.429.json — DO NOT EDIT -->
...
# UC-10.7.429 · Web or Application Server Spawning a Shell

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Web or Application Server Spawning a Shell" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

---

## Description

This detection identifies Web or Application Server Spawning a Shell. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

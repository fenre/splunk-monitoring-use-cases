<!-- AUTO-GENERATED from UC-10.4.44.json — DO NOT EDIT -->
...
# UC-10.4.44 · O365 BEC Email Hiding Rule Created
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to detection signature entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Various ingested and CIM-normalized.
...
- [https://attack.mitre.org/techniques/T1564/008/](https://attack.mitre.org/techniques/T1564/008/)

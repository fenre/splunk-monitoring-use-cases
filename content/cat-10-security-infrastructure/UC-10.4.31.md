<!-- AUTO-GENERATED from UC-10.4.31.json — DO NOT EDIT -->
...
# UC-10.4.31 · Gsuite Email Suspicious Subject With Attachment
...
```spl
# Shared SPL: intentional — see UC-10.4.30
...
| tstats `summariesonly` count
  ...
  by All_Email.src_user All_Email.subject All_Email.file_name span=1h
| sort -count
```
...
Heuristic subject/attachment rules may flag urgent internal project titles and file names. Compare with Workspace pre–delivery and admin mail logs before treating as a campaign.

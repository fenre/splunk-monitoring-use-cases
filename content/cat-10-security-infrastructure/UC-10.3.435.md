<!-- AUTO-GENERATED from UC-10.3.435.json — DO NOT EDIT -->
...
# UC-10.3.435 · Windows Defender Exclusion Registry Entry

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Defender Exclusion Registry Entry”, so we catch real tradecraft and not just noise from everyday work.*

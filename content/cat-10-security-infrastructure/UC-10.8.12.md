<!-- AUTO-GENERATED from UC-10.8.12.json — DO NOT EDIT -->
...
# UC-10.8.12 · Detect Certipy File Modifications

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the use of the Certipy tool to enumerate Active Directory Certificate Services (AD CS) environments by identifying unique file modifications — so we know when protection is off, out of date, or bypassed.*
...
Compare with your CT log source or a public log viewer (e.g. crt.sh) for the same certificate or issuer, and confirm parsing in Splunk.
...
New certificates from cloud autoscaling, automated ACME, or load-balancer scale-outs; high churn is not automatically an incident.

...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Security &middot; **Type:** Availability

*We compare the full list of company machines to who actually has a working sensor so we are not comforted by a green dashboard when real devices are not reporting.*
...
Lab gear, kiosks, and build servers may be off the standard agent on purpose; reconcile the gap list to the asset owner and the CMDB, not the alert count alone.

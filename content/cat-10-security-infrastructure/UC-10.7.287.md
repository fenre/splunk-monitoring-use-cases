<!-- AUTO-GENERATED from UC-10.7.287.json — DO NOT EDIT -->
...
# UC-10.7.287 · Detect New Local Admin account

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Detect New Local Admin account so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

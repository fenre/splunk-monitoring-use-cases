<!-- AUTO-GENERATED from UC-10.3.12.json — DO NOT EDIT -->
...
# UC-10.3.12 · Ollama Excessive API Requests

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Ollama Excessive API Requests” so we can see attacker-style moves—not only a one-off file or password mistake.*

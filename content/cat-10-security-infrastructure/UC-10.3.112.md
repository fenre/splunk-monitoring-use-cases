...
*We use endpoint and security-agent signals around “Drop IcedID License dat” so we can see attacker-style moves—not only a one-off file or password mistake.*

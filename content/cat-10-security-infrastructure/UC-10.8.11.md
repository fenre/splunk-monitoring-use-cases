<!-- AUTO-GENERATED from UC-10.8.11.json — DO NOT EDIT -->
...
# UC-10.8.11 · Detect Certify With PowerShell Script Block Logging

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the use of the Certify tool using-memory PowerShell function to enumerate Active Directory Certificate Services (AD CS) environments — so we know when protection is off, out of date, or bypassed.*

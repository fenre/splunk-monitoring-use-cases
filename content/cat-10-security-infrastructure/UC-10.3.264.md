<!-- AUTO-GENERATED from UC-10.3.264.json — DO NOT EDIT -->
...
# UC-10.3.264 · Ntdsutil Export NTDS

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Ntdsutil Export NTDS” so we can see attacker-style moves—not only a one-off file or password mistake.*

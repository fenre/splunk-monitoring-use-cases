<!-- AUTO-GENERATED from UC-10.3.409.json — DO NOT EDIT -->

---
id: "10.3.409"
title: "Windows Chromium process Launched with Disable Popup Blocking"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.409 · Windows Chromium process Launched with Disable Popup Blocking

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Chromium process Launched with Disable Popup Blocking”, so we catch real tradecraft and not just noise from everyday work.*

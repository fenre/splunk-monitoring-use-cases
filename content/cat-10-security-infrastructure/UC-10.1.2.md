...
*We read Wildfire sandbox verdicts so we catch malicious and suspicious files at the network edge before they spread inside.*
...
Verdicts from internal security testing, custom executables that are later whitelisted, or false-positive ML or sandbox results that you approve by policy.

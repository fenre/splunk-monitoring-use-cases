<!-- AUTO-GENERATED from UC-10.7.496.json — DO NOT EDIT -->
...
# UC-10.7.496 · Windows Credential Access From Browser Password Store

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Credential Access From Browser Password Store" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

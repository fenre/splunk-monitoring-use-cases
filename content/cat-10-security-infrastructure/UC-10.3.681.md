<!-- AUTO-GENERATED from UC-10.3.681.json — DO NOT EDIT -->
...
# UC-10.3.681 · Plain HTTP POST Exfiltrated Data

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Plain HTTP POST Exfiltrated Data”, so we catch real tradecraft and not just noise from everyday work.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to host or system entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Splunk Stream HTTP ingested and CIM-normalized.
...
Known false positives for this detection: Large HTTP posts from backup tools, cloud sync, and misrouted app traffic; tune on URL, size, and destination reputation.
...
Large HTTP posts from backup tools, cloud sync, and misrouted app traffic; tune on URL, size, and destination reputation.

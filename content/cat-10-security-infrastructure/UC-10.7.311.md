<!-- AUTO-GENERATED from UC-10.7.311.json — DO NOT EDIT -->
...
# UC-10.7.311 · First Time Seen Running Windows Service

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use this 'First Time Seen Running Windows Service' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*
...
Benign and operational activity can resemble this 'First Time Seen Running Windows Service' pattern; validate in the vendor console, IdP, or EDR as appropriate.

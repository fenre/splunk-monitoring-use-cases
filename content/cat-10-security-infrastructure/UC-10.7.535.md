<!-- AUTO-GENERATED from UC-10.7.535.json — DO NOT EDIT -->
...
# UC-10.7.535 · Windows Forest Discovery with GetForestDomain

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Forest Discovery with GetForestDomain" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.1.40.json — DO NOT EDIT -->
...
# UC-10.1.40 · Windows Modify System Firewall with Notable Process Path

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects suspicious modifications to system firewall rules, specifically allowing execution of applications from notable and potentially malicious file paths — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.6.192.json — DO NOT EDIT -->
...
# UC-10.6.192 · WordPress Bricks Builder plugin RCE

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies potential exploitation of the WordPress Bricks Builder plugin RCE vulnerability, and we use Splunk so the team can see it early and act.*

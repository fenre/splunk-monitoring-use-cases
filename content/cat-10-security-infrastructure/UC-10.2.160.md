...
*We catch instances of Winlogon.exe, a critical Windows process, connecting to public IP addresses — so we know when protection is off, out of date, or bypassed.*

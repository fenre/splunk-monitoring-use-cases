<!-- AUTO-GENERATED from UC-10.7.512.json — DO NOT EDIT -->
...
# UC-10.7.512 · Windows Domain Account Discovery Via Get-NetComputer

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Domain Account Discovery Via Get-NetComputer" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

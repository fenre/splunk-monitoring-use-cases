<!-- AUTO-GENERATED from UC-10.3.432.json — DO NOT EDIT -->
...
# UC-10.3.432 · Windows Defender ASR Block Events

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Defender ASR Block Events”, so we catch real tradecraft and not just noise from everyday work.*

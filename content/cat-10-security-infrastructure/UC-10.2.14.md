<!-- AUTO-GENERATED from UC-10.2.14.json — DO NOT EDIT -->
...
*We catch the successful deletion of a group within AWS access control, leveraging CloudTrail access control events — so we know when protection is off, out of date, or bypassed.*

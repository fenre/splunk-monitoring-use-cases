<!-- AUTO-GENERATED from UC-10.15.1.json — DO NOT EDIT -->
...
*We use learning models to see whose sign-on pattern suddenly breaks from their workmates’ so stolen or misused accounts stand out earlier than a flat rule allows.*
...
- `eventstats` rolls up events into metrics; results are split **by bunit, _time** so each row reflects one combination of those dimensions.
...
Peer-group “odd” logon counts can be legitimate during quarter-end, sales pushes, or after org reshuffles when many people temporarily behave alike — we compare to HR and shift calendars.

<!-- AUTO-GENERATED from UC-10.11.10.json — DO NOT EDIT -->
...
*We use FortiGate data and alerts to stay ahead of the risks described in "FortiManager Configuration Compliance". We help the team notice trouble early, while a situation is still small and containable.*
...
- `stats` rolls up events into metrics; results are split **by adom, device_name** so each row reflects one combination of those dimensions.

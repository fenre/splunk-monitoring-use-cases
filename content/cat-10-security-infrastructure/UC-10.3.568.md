<!-- AUTO-GENERATED from UC-10.3.568.json — DO NOT EDIT -->
...
# UC-10.3.568 · Windows Odbcconf Load DLL

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Odbcconf Load DLL”, so we catch real tradecraft and not just noise from everyday work.*

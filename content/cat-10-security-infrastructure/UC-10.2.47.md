<!-- AUTO-GENERATED from UC-10.2.47.json — DO NOT EDIT -->
...
# UC-10.2.47 · Get-ForestTrust with PowerShell Script Block

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of the Get-ForestTrust command from PowerSploit using PowerShell Script Block Logging (EventCode=4104) — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.6.44.json — DO NOT EDIT -->

---
id: "10.6.44"
title: "Crowdstrike User Weak Password Policy"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.6.44 · Crowdstrike User Weak Password Policy

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects CrowdStrike alerts for weak password policy violations, identifying instances where passwords do not meet the required security standards, and we use Splunk so the team can see it early and act.*

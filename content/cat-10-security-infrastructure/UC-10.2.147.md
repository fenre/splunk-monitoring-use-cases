<!-- AUTO-GENERATED from UC-10.2.147.json — DO NOT EDIT -->

---
id: "10.2.147"
title: "Windows Service Execution RemCom"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.2.147 · Windows Service Execution RemCom

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot the execution of RemCom.exe, an open-source alternative to PsExec, used for lateral movement and remote command execution — so we know when protection is off, out of date, or bypassed.*

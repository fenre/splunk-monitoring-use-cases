<!-- AUTO-GENERATED from UC-10.3.269.json — DO NOT EDIT -->
...
# UC-10.3.269 · Potentially malicious code on commandline

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Potentially malicious code on commandline” so we can see attacker-style moves—not only a one-off file or password mistake.*

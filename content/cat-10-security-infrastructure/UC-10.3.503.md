<!-- AUTO-GENERATED from UC-10.3.503.json — DO NOT EDIT -->
...
# UC-10.3.503 · Windows Kerberos Local Successful Logon

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Kerberos Local Successful Logon”, so we catch real tradecraft and not just noise from everyday work.*

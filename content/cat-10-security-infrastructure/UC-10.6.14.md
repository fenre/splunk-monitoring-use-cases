<!-- AUTO-GENERATED from UC-10.6.14.json — DO NOT EDIT -->
...
*The following analytic identifies Windows endpoints that have not generated an event indicating a successful Windows update in the last 60 days, and we use Splunk so the team can see it early and act.*

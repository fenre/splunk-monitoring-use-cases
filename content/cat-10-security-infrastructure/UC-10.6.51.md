<!-- AUTO-GENERATED from UC-10.6.51.json — DO NOT EDIT -->
...
# UC-10.6.51 · Execute Javascript With Jscript COM CLSID

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the execution of JavaScript using the JScript.Encode CLSID (COM Object) by cscript.exe, and we use Splunk so the team can see it early and act.*

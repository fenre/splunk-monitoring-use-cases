...
*We look for High Number of Login Failures from a single source so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

...
*We use endpoint and security-agent signals around “Linux Kworker Process In Writable Process Path” so we can see attacker-style moves—not only a one-off file or password mistake.*

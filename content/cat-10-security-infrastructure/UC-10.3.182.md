<!-- AUTO-GENERATED from UC-10.3.182.json — DO NOT EDIT -->
...
# UC-10.3.182 · Linux Curl Upload File

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Curl Upload File” so we can see attacker-style moves—not only a one-off file or password mistake.*

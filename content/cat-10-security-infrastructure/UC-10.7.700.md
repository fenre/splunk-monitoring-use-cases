<!-- AUTO-GENERATED from UC-10.7.700.json — DO NOT EDIT -->

---
id: "10.7.700"
title: "HTTP RMM User Agent"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.700 · HTTP RMM User Agent

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "HTTP RMM User Agent" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to HTTP user agent entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Suricata ingested and CIM-normalized.

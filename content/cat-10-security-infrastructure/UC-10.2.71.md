<!-- AUTO-GENERATED from UC-10.2.71.json — DO NOT EDIT -->
...
# UC-10.2.71 · Processes launching netsh

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot processes launching netsh.exe, a command-line utility used to modify network configurations — so we know when protection is off, out of date, or bypassed.*

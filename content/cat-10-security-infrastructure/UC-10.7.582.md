<!-- AUTO-GENERATED from UC-10.7.582.json — DO NOT EDIT -->
...
# UC-10.7.582 · Windows PowerShell Invoke-RestMethod IP Information Collection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows PowerShell Invoke-RestMethod IP Information Collecti" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
- [https://securityintelligence.com/posts/new-threat-actor-water-gamayun-targets-telecom-finance/](https://securityintelligence.com/posts/new-threat-actor-water-gamayun-targets-telecom-finance/)
- [https://www.ncsc.gov.uk/report/weekly-threat-report-12th-april-2024](https://www.ncsc.gov.uk/report/weekly-threat-report-12th-april-2024)

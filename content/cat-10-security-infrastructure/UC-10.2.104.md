<!-- AUTO-GENERATED from UC-10.2.104.json — DO NOT EDIT -->
...
# UC-10.2.104 · Windows Archive Collected Data via Rar

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot the execution of RAR utilities to archive files on a system — so we know when protection is off, out of date, or bypassed.*

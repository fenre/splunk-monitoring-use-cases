<!-- AUTO-GENERATED from UC-10.3.649.json — DO NOT EDIT -->
...
# UC-10.3.649 · True Positive Test

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for a single address trying many disabled accounts over Kerberos in a few minutes, so we catch password-spray style activity against ghost accounts before it widens.*

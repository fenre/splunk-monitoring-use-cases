<!-- AUTO-GENERATED from UC-10.3.162.json — DO NOT EDIT -->
...
# UC-10.3.162 · Linux At Application Execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux At Application Execution” so we can see attacker-style moves—not only a one-off file or password mistake.*

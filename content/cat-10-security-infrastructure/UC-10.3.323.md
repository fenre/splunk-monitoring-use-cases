<!-- AUTO-GENERATED from UC-10.3.323.json — DO NOT EDIT -->
...
# UC-10.3.323 · Shim Database Installation With Suspicious Parameters

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Shim Database Installation With Suspicious Parameters” so we can see attacker-style moves—not only a one-off file or password mistake.*

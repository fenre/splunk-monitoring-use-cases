<!-- AUTO-GENERATED from UC-10.7.463.json — DO NOT EDIT -->
...
# UC-10.7.463 · Windows AD Short Lived Domain Controller SPN Attribute

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Short Lived Domain Controller SPN Attribute" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

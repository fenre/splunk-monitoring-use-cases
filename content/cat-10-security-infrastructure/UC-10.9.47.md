...
*We use our security program’s detections to catch activity tied to “Scattered Spider social engineering tactics” when someone tries that attacker move in our environment, so we can respond before the damage spreads.*

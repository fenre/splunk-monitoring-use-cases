<!-- AUTO-GENERATED from UC-10.5.19.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by normalized_risk_object** so each row reflects one combination of those dimensions.

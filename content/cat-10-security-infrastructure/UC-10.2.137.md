<!-- AUTO-GENERATED from UC-10.2.137.json — DO NOT EDIT -->
...
# UC-10.2.137 · Windows RDP Bitmap Cache File Creation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot the creation of Remote Desktop Protocol (remote desktop) bitmap cache files on a Windows system, typically located in the user’s profile under the Terminal Server Client cache directory — so we know when protection is off, out of date, or bypassed.*

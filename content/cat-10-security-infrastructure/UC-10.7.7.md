<!-- AUTO-GENERATED from UC-10.7.7.json — DO NOT EDIT -->
...
*We use this 'AWS Defense Evasion Delete CloudTrail' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*
...
Suspicious AWS API call patterns from infrastructure-as-code, security scanners, and cloud operations pipelines; confirm the caller role in the console.

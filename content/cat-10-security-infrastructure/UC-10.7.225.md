<!-- AUTO-GENERATED from UC-10.7.225.json — DO NOT EDIT -->
...
# UC-10.7.225 · Kubernetes Create or Update Privileged Pod

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Kubernetes Create or Update Privileged Pod so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

<!-- AUTO-GENERATED from UC-10.3.648.json — DO NOT EDIT -->
...
# UC-10.3.648 · Windows Time Based Evasion via Choice Exec

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Time Based Evasion via Choice Exec”, so we catch real tradecraft and not just noise from everyday work.*

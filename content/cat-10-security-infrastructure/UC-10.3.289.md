<!-- AUTO-GENERATED from UC-10.3.289.json — DO NOT EDIT -->
...
# UC-10.3.289 · Registry Keys Used For Persistence

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Registry Keys Used For Persistence” so we can see attacker-style moves—not only a one-off file or password mistake.*

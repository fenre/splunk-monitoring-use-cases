<!-- AUTO-GENERATED from UC-10.7.425.json — DO NOT EDIT -->
...
# UC-10.7.425 · Suspicious Copy on System32

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Suspicious Copy on System32" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

---

## Description

This detection identifies Suspicious Copy on System32. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

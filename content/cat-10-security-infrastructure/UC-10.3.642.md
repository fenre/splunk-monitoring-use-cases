<!-- AUTO-GENERATED from UC-10.3.642.json — DO NOT EDIT -->
...
# UC-10.3.642 · Windows System Script Proxy Execution Syncappvpublishingserver

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows System Script Proxy Execution Syncappvpublishingserver”, so we catch real tradecraft and not just noise from everyday work.*

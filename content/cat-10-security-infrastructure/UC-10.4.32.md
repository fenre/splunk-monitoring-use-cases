<!-- AUTO-GENERATED from UC-10.4.32.json — DO NOT EDIT -->
...
# UC-10.4.32 · Gsuite Email With Known Abuse Web Service Link
...
| tstats `summariesonly` count
  ...
  by All_Email.recipient All_Email.url All_Email.src_user span=1h
| sort -count
```
...
Legitimate use of public URL shorteners, collaboration links, and marketing redirectors. Confirm category in your gateway and Workspace security reports.

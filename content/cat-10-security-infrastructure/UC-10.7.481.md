<!-- AUTO-GENERATED from UC-10.7.481.json — DO NOT EDIT -->
...
# UC-10.7.481 · Windows Browser Process Launched with Unusual Flags

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Browser Process Launched with Unusual Flags" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
- [https://www.recordedfuture.com/research/from-castleloader-to-castlerat-tag-150-advances-operations](https://www.recordedfuture.com/research/from-castleloader-to-castlerat-tag-150-advances-operations)

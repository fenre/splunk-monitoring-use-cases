<!-- AUTO-GENERATED from UC-10.3.546.json — DO NOT EDIT -->
...
# UC-10.3.546 · Windows Mshta Execution In Registry

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Mshta Execution In Registry”, so we catch real tradecraft and not just noise from everyday work.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to user account entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Sysmon EventID 13 ingested and CIM-normalized.
...
Mshta, rundll32, and similar hosts can be driven by old IT packages, helpdesk workarounds, and signed vendor installers; review command line and parent.

<!-- AUTO-GENERATED from UC-10.3.242.json — DO NOT EDIT -->
...
# UC-10.3.242 · Linux Visudo Utility Execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Visudo Utility Execution” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.3.277.json — DO NOT EDIT -->
...
# UC-10.3.277 · PowerShell Start or Stop Service

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “PowerShell Start or Stop Service” so we can see attacker-style moves—not only a one-off file or password mistake.*

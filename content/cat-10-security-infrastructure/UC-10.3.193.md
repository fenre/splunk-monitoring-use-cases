<!-- AUTO-GENERATED from UC-10.3.193.json — DO NOT EDIT -->
...
# UC-10.3.193 · Linux File Creation In Init Boot Directory

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux File Creation In Init Boot Directory” so we can see attacker-style moves—not only a one-off file or password mistake.*

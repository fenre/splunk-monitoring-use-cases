<!-- AUTO-GENERATED from UC-10.7.596.json — DO NOT EDIT -->
...
# UC-10.7.596 · Windows Process Executed From Removable Media

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on this analytic is used to identify when a removable media device is attached to a machine and then a process is executed from the same drive letter assigned to the removable media device so unusual activity is visible early — before it spreads or hides in normal noise.*
...
```spl
| from datamodel:Endpoint.Processes | search dest=$dest$ process_current_directory=$object_handle$*
```
...
- [https://www.bleepingcomputer.com/news/security/fbi-hackers-use-badusb-to-target-defense-firms-with-ransomware/](https://www.bleepingcomputer.com/news/security/fbi-hackers-use-badusb-to-target-defense-firms-with-ransomware/)

<!-- AUTO-GENERATED from UC-10.3.637.json — DO NOT EDIT -->
...
*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows System File on Disk”, so we catch real tradecraft and not just noise from everyday work.*
...
New or modified files from IDE builds, package managers, and patch staging directories; require hash and signer review.

<!-- AUTO-GENERATED from UC-10.3.164.json — DO NOT EDIT -->

---
id: "10.3.164"
title: "Linux Auditd At Application Execution"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.164 · Linux Auditd At Application Execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Auditd At Application Execution” so we can see attacker-style moves—not only a one-off file or password mistake.*

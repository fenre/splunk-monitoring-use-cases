<!-- AUTO-GENERATED from UC-10.3.130.json — DO NOT EDIT -->
...
# UC-10.3.130 · Get ADUserResultantPasswordPolicy with Powershell

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Get ADUserResultantPasswordPolicy with Powershell” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
- [https://learn.microsoft.com/en-us/powershell/module/activedirectory/get-aduserresultantpasswordpolicy?view=windowsserver2019-ps](https://learn.microsoft.com/en-us/powershell/module/activedirectory/get-aduserresultantpasswordpolicy?view=windowsserver2019-ps)

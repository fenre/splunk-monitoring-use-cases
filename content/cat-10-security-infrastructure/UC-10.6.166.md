<!-- AUTO-GENERATED from UC-10.6.166.json — DO NOT EDIT -->
...
# UC-10.6.166 · Ivanti EPMM Remote Unauthenticated API Access CVE-2023-35082

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects potential unauthorized access attempts exploiting within Ivanti's software products, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.8.30.json — DO NOT EDIT -->
...
# UC-10.8.30 · Windows Steal Authentication Certificates CS Backup

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies the backup of the Active Directory Certificate Services (AD CS) store, detected using Event ID 4876 — so we know when protection is off, out of date, or bypassed.*

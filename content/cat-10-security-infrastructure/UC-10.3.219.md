<!-- AUTO-GENERATED from UC-10.3.219.json — DO NOT EDIT -->
...
# UC-10.3.219 · Linux Possible Access Or Modification Of sshd Config File

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Possible Access Or Modification Of sshd Config File” so we can see attacker-style moves—not only a one-off file or password mistake.*

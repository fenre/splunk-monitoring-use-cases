<!-- AUTO-GENERATED from UC-10.7.174.json — DO NOT EDIT -->
...
# UC-10.7.174 · Cloud Compute Instance Created By Previously Unseen User

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Cloud Compute Instance Created By Previously Unseen User so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

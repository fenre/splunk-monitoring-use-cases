<!-- AUTO-GENERATED from UC-10.3.587.json — DO NOT EDIT -->
...
# UC-10.3.587 · Windows Process Injection Of Wermgr to Known Browser

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Process Injection Of Wermgr to Known Browser”, so we catch real tradecraft and not just noise from everyday work.*

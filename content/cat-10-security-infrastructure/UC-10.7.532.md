<!-- AUTO-GENERATED from UC-10.7.532.json — DO NOT EDIT -->
...
# UC-10.7.532 · Windows File Share Discovery With Powerview

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows File Share Discovery With Powerview" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.7.540.json — DO NOT EDIT -->
...
# UC-10.7.540 · Windows IIS Components New Module Added

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows IIS Components New Module Added" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to host or system entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Windows IIS 29 ingested and CIM-normalized.

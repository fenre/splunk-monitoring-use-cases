<!-- AUTO-GENERATED from UC-10.3.344.json — DO NOT EDIT -->
...
# UC-10.3.344 · Suspicious PlistBuddy Usage via OSquery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Suspicious PlistBuddy Usage via OSquery”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.7.251.json — DO NOT EDIT -->
...
# UC-10.7.251 · Add or Set Windows Defender Exclusion

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Add or Set Windows Defender Exclusion so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

---

## Description

This detection identifies Add or Set Windows Defender Exclusion. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.
...
- [https://learn.microsoft.com/en-us/powershell/module/defender/add-mppreference?view=windowsserver2025-ps](https://learn.microsoft.com/en-us/powershell/module/defender/add-mppreference?view=windowsserver2025-ps)

<!-- AUTO-GENERATED from UC-10.3.91.json — DO NOT EDIT -->
...
# UC-10.3.91 · Disable Logs Using WevtUtil

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Disable Logs Using WevtUtil” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.7.159.json — DO NOT EDIT -->
...
# UC-10.7.159 · Azure AD Privileged Role Assigned to Service Principal

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD Privileged Role Assigned to Service Principal so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

<!-- AUTO-GENERATED from UC-10.3.276.json — DO NOT EDIT -->
...
# UC-10.3.276 · PowerShell Start-BitsTransfer

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “PowerShell Start-BitsTransfer” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
- [https://learn.microsoft.com/en-us/windows/win32/bits/using-windows-powershell-to-create-bits-transfer-jobs](https://learn.microsoft.com/en-us/windows/win32/bits/using-windows-powershell-to-create-bits-transfer-jobs)

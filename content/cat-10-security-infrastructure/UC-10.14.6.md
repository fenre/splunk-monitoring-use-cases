...
*We flag control-zone gear that should not have a path to the open internet, because that is an easy on-ramp for bad actors.*
...
NAT, mis-tagged assets, and jump-hosts with dual-homed design can look “internet reachable” in logs without an exposure incident — compare to network diagrams.

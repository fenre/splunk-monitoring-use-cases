<!-- AUTO-GENERATED from UC-10.4.70.json — DO NOT EDIT -->
...
# UC-10.4.70 · O365 Exfiltration via File Access
...
```spl
`o365_management_activity` Operation IN ("fileaccessed") UserId="$UserId$
```

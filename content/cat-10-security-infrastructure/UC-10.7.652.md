<!-- AUTO-GENERATED from UC-10.7.652.json — DO NOT EDIT -->

---
id: "10.7.652"
title: "Windows Unusual FileZilla XML Config Access"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.652 · Windows Unusual FileZilla XML Config Access

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Unusual FileZilla XML Config Access" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
- [https://www.trendmicro.com/en_us/research/18/k/trickbot-shows-off-new-trick-password-grabber-module.html](https://www.trendmicro.com/en_us/research/18/k/trickbot-shows-off-new-trick-password-grabber-module.html)

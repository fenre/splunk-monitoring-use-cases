<!-- AUTO-GENERATED from UC-10.8.37.json — DO NOT EDIT -->
...
*Attackers often disable or exclude /AV to evade detection — so we know when protection is off, out of date, or bypassed.*

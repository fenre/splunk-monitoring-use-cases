<!-- AUTO-GENERATED from UC-10.3.222.json — DO NOT EDIT -->
...
# UC-10.3.222 · Linux Possible Append Command To At Allow Config File

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Possible Append Command To At Allow Config File” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.6.38.json — DO NOT EDIT -->
...
# UC-10.6.38 · ConnectWise ScreenConnect Path Traversal

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit the ConnectWise ScreenConnect vulnerability, which allows path traversal attacks by manipulating file_path and file_name parameters in the URL, and we use Splunk so the team can see it early and act.*

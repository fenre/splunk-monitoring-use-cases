<!-- AUTO-GENERATED from UC-10.7.534.json — DO NOT EDIT -->
...
# UC-10.7.534 · Windows Find Interesting ACL with FindInterestingDomainAcl

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Find Interesting ACL with FindInterestingDomainAcl" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

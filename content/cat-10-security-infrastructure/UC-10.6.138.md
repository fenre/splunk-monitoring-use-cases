<!-- AUTO-GENERATED from UC-10.6.138.json — DO NOT EDIT -->
...
# UC-10.6.138 · Adobe ColdFusion Access Control Bypass

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects potential exploitation attempts against Adobe ColdFusion vulnerabilities and, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.7.591.json — DO NOT EDIT -->
...
# UC-10.7.591 · Windows PowerView Kerberos Service Ticket Request

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows PowerView Kerberos Service Ticket Request" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

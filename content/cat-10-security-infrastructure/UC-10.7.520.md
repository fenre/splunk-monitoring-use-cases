<!-- AUTO-GENERATED from UC-10.7.520.json — DO NOT EDIT -->
...
*We keep an eye on the creation or modification of Image File Execution Options (IFEO) registry keys, detected via EventCode 3000 in the Application channel so unusual activity is visible early — before it spreads or hides in normal noise.*

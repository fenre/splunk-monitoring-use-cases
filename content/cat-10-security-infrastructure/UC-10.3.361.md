<!-- AUTO-GENERATED from UC-10.3.361.json — DO NOT EDIT -->
...
# UC-10.3.361 · System User Discovery With Query

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “System User Discovery With Query”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.7.309.json — DO NOT EDIT -->

---
id: "10.7.309"
title: "Executables Or Script Creation In Temp Path"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.309 · Executables Or Script Creation In Temp Path

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Executables Or Script Creation In Temp Path so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

---

## Description

This detection identifies Executables Or Script Creation In Temp Path. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

<!-- AUTO-GENERATED from UC-10.6.147.json — DO NOT EDIT -->
...
# UC-10.6.147 · Confluence Unauthenticated Remote Code Execution CVE-2022-26134

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit, an unauthenticated remote code execution vulnerability in Confluence, and we use Splunk so the team can see it early and act.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to IP address entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Palo Alto Network Threat ingested and CIM-normalized.

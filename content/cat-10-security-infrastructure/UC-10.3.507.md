<!-- AUTO-GENERATED from UC-10.3.507.json — DO NOT EDIT -->
...
# UC-10.3.507 · Windows Local Administrator Credential Stuffing

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Local Administrator Credential Stuffing”, so we catch real tradecraft and not just noise from everyday work.*
...
```spl
# Shared SPL: intentional — see UC-10.2.103

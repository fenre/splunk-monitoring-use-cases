<!-- AUTO-GENERATED from UC-10.7.68.json — DO NOT EDIT -->

---
id: "10.7.68"
title: "Zoom Rare Input Devices"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.68 · Zoom Rare Input Devices

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use this 'Zoom Rare Input Devices' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*
...
New cameras, mics, and speakers from hardware refreshes, hotdesks, and guest participants; not every rare label is a takeover.

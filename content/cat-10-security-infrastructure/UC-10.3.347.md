<!-- AUTO-GENERATED from UC-10.3.347.json — DO NOT EDIT -->
...
# UC-10.3.347 · Suspicious Regsvr32 Register Suspicious Path

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Suspicious Regsvr32 Register Suspicious Path”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.3.542.json — DO NOT EDIT -->
...
# UC-10.3.542 · Windows Modify Registry ValleyRat PWN Reg Entry

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Modify Registry ValleyRat PWN Reg Entry”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.7.194.json — DO NOT EDIT -->
...
# UC-10.7.194 · GCP Multiple Failed MFA Requests For User

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for GCP Multiple Failed MFA Requests For User so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

<!-- AUTO-GENERATED from UC-10.3.207.json — DO NOT EDIT -->
...
# UC-10.3.207 · Linux Install Kernel Module Using Modprobe Utility

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Install Kernel Module Using Modprobe Utility” so we can see attacker-style moves—not only a one-off file or password mistake.*

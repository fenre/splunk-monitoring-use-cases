<!-- AUTO-GENERATED from UC-10.3.384.json — DO NOT EDIT -->
...
# UC-10.3.384 · Windows Apache Benchmark Binary

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Apache Benchmark Binary”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.7.103.json — DO NOT EDIT -->
...
*We use this 'AWS Defense Evasion PutBucketLifecycle' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*

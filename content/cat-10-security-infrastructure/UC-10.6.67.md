<!-- AUTO-GENERATED from UC-10.6.67.json — DO NOT EDIT -->
...
# UC-10.6.67 · Shim Database File Creation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the creation of shim database files (.sdb) in default directories using the sdbinst.exe application, and we use Splunk so the team can see it early and act.*

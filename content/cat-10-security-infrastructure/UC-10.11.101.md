<!-- AUTO-GENERATED from UC-10.11.101.json — DO NOT EDIT -->
...
*We use CrowdStrike data and alerts to stay ahead of the risks described in "CrowdStrike Identity Protection Risk Scores". We help the team notice trouble early, while a situation is still small and containable.*
...
- `stats` rolls up events into metrics; results are split **by user_principal** so each row reflects one combination of those dimensions.

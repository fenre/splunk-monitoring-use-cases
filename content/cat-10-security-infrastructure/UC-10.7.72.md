<!-- AUTO-GENERATED from UC-10.7.72.json — DO NOT EDIT -->
...
*We look for the behavior in “Abnormally High Number Of Cloud Instances Launched” using the same log fields the detection already uses, so the team can act before impact spreads.*

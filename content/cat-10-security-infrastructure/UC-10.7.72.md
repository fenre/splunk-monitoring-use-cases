...
*We look for the behavior in “Abnormally High Number Of Cloud Instances Launched” using the same CIM-backed fields as the detection, so the team can act before impact spreads.*

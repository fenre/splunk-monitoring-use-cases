<!-- AUTO-GENERATED from UC-10.2.50.json — DO NOT EDIT -->
...
# UC-10.2.50 · Impacket Lateral Movement Commandline Parameters

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot the use of suspicious command-line parameters associated with Impacket tools, such as, and, which are used for lateral movement and remote code execution — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.3.282.json — DO NOT EDIT -->
...
# UC-10.3.282 · Process Kill Base On File Path

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Process Kill Base On File Path” so we can see attacker-style moves—not only a one-off file or password mistake.*

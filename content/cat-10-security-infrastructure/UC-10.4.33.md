<!-- AUTO-GENERATED from UC-10.4.33.json — DO NOT EDIT -->
...
| tstats `summariesonly` count
  ...
  by All_Email.src_user All_Email.recipient All_Email.file_name span=1h
| sort -count
```
...
Large outbound one-to-many messages with attachments to customer domains from sales or support, especially at quarter end. Validate with sender behavior baselines in Workspace or your SEG.

<!-- AUTO-GENERATED from UC-10.3.230.json — DO NOT EDIT -->
...
# UC-10.3.230 · Linux Service File Created In Systemd Directory

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Service File Created In Systemd Directory” so we can see attacker-style moves—not only a one-off file or password mistake.*

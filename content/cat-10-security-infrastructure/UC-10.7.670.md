<!-- AUTO-GENERATED from UC-10.7.670.json — DO NOT EDIT -->
...
# UC-10.7.670 · WMI Permanent Event Subscription

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on the creation of permanent event subscriptions using Windows Management Instrumentation (WMI) so unusual activity is visible early — before it spreads or hides in normal noise.*

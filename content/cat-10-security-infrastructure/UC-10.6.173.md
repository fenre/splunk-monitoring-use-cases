<!-- AUTO-GENERATED from UC-10.6.173.json — DO NOT EDIT -->
...
# UC-10.6.173 · JetBrains TeamCity RCE Attempt

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit the vulnerability in JetBrains TeamCity On-Premises, and we use Splunk so the team can see it early and act.*
...
- [https://attackerkb.com/topics/1XEEEkGHzt/cve-2023-42793](https://attackerkb.com/topics/1XEEEkGHzt/cve-2023-42793)

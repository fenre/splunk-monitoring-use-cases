<!-- AUTO-GENERATED from UC-10.2.45.json — DO NOT EDIT -->
...
# UC-10.2.45 · Get-DomainTrust with PowerShell

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot the execution of the Get-DomainTrust command from PowerView using PowerShell, which is used to gather domain trust information — so we know when protection is off, out of date, or bypassed.*

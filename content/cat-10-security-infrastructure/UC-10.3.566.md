<!-- AUTO-GENERATED from UC-10.3.566.json — DO NOT EDIT -->
...
# UC-10.3.566 · Windows Obfuscated Files or Information via RAR SFX

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Obfuscated Files or Information via RAR SFX”, so we catch real tradecraft and not just noise from everyday work.*

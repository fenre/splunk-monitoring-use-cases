<!-- AUTO-GENERATED from UC-10.7.709.json — DO NOT EDIT -->
...
# UC-10.7.709 · Windows AD Rogue Domain Controller Network Activity

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on unauthorized replication RPC calls from non-domain controller devices so unusual activity is visible early — before it spreads or hides in normal noise.*

...
*We watch whether quarantine and block steps actually run so malware is not still running because a fix action failed quietly in the background.*
...
Analyst-allowed files, sandbox tests, and vendor samples can show as “allowed” or not quarantined; check the EDR case and the same file hash in the console.

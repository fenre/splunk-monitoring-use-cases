<!-- AUTO-GENERATED from UC-10.3.147.json — DO NOT EDIT -->
...
# UC-10.3.147 · GetWmiObject User Account with PowerShell

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “GetWmiObject User Account with PowerShell” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.3.68.json — DO NOT EDIT -->
...
# UC-10.3.68 · Detect PsExec With accepteula Flag

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Detect PsExec With accepteula Flag” so we can see attacker-style moves—not only a one-off file or password mistake.*

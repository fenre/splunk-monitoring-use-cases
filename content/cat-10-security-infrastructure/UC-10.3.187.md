<!-- AUTO-GENERATED from UC-10.3.187.json — DO NOT EDIT -->
...
# UC-10.3.187 · Linux Deletion Of Cron Jobs

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Deletion Of Cron Jobs” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.7.717.json — DO NOT EDIT -->
...
# UC-10.7.717 · SQL Injection with Long URLs

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on long URLs containing multiple SQL commands, indicating a potential SQL injection attack so unusual activity is visible early — before it spreads or hides in normal noise.*

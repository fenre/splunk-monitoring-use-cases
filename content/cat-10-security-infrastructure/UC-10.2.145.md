<!-- AUTO-GENERATED from UC-10.2.145.json — DO NOT EDIT -->
...
# UC-10.2.145 · Windows Service Created with Suspicious Service Path

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the creation of a Windows Service with a binary path located in uncommon directories, using Windows Event ID 7045 — so we know when protection is off, out of date, or bypassed.*

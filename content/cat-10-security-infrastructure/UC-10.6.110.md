<!-- AUTO-GENERATED from UC-10.6.110.json — DO NOT EDIT -->
...
# UC-10.6.110 · Windows Rundll32 WebDav With Network Connection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the execution of rundll32.exe with command-line arguments loading davclnt.dll and the davsetcookie function to access a remote WebDav instance, and we use Splunk so the team can see it early and act.*

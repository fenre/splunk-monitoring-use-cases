<!-- AUTO-GENERATED from UC-10.3.654.json — DO NOT EDIT -->
...
# UC-10.3.654 · Windows USBSTOR Registry Key Modification

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows USBSTOR Registry Key Modification”, so we catch real tradecraft and not just noise from everyday work.*
...
```spl
| from datamodel:Endpoint.Registry | search dest=$dest$ registry_path IN ("HKLM\\System\\CurrentControlSet\\Enum\\USBSTOR\\*")
```

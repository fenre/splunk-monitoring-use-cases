<!-- AUTO-GENERATED from UC-10.3.573.json — DO NOT EDIT -->
...
# UC-10.3.573 · Windows Office Product Spawned MSDT

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Office Product Spawned MSDT”, so we catch real tradecraft and not just noise from everyday work.*

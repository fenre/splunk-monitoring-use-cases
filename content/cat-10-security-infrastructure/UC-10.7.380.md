<!-- AUTO-GENERATED from UC-10.7.380.json — DO NOT EDIT -->
...
# UC-10.7.380 · Linux File Created In Kernel Driver Directory

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Linux File Created In Kernel Driver Directory" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

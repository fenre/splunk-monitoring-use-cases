<!-- AUTO-GENERATED from UC-10.3.590.json — DO NOT EDIT -->
...
*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Process Writing File to World Writable Path”, so we catch real tradecraft and not just noise from everyday work.*

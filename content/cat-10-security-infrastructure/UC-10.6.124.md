<!-- AUTO-GENERATED from UC-10.6.124.json — DO NOT EDIT -->
...
# UC-10.6.124 · WinRAR Spawning Shell Application

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the execution of Windows shell processes initiated by WinRAR, such as "cmd.exe", "powershell.exe", "certutil.exe", "mshta.exe", or "bitsadmin.exe", and we use Splunk so the team can see it early and act.*

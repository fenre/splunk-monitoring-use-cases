<!-- AUTO-GENERATED from UC-10.7.691.json — DO NOT EDIT -->
...
# UC-10.7.691 · Detect Port Security Violation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on port security violations on Cisco switches so unusual activity is visible early — before it spreads or hides in normal noise.*

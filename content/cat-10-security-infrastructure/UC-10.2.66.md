<!-- AUTO-GENERATED from UC-10.2.66.json — DO NOT EDIT -->
...
# UC-10.2.66 · Powershell Enable SMB1Protocol Feature

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the enabling of the SMB1 protocol using — so we know when protection is off, out of date, or bypassed.*

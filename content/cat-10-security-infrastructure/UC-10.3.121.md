<!-- AUTO-GENERATED from UC-10.3.121.json — DO NOT EDIT -->
...
# UC-10.3.121 · Excessive Usage Of SC Service Utility

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Excessive Usage Of SC Service Utility” so we can see attacker-style moves—not only a one-off file or password mistake.*

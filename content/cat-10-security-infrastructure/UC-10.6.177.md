<!-- AUTO-GENERATED from UC-10.6.177.json — DO NOT EDIT -->
...
# UC-10.6.177 · Microsoft SharePoint Server Elevation of Privilege

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects potential exploitation attempts against Microsoft SharePoint Server vulnerability, and we use Splunk so the team can see it early and act.*

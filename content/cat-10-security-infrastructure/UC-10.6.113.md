<!-- AUTO-GENERATED from UC-10.6.113.json — DO NOT EDIT -->
...
# UC-10.6.113 · Windows Shell Process from CrushFTP

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies instances where CrushFTP's service process (crushftpservice.exe) spawns shell processes like cmd.exe or powershell.exe, and we use Splunk so the team can see it early and act.*

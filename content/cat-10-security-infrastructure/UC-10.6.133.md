<!-- AUTO-GENERATED from UC-10.6.133.json — DO NOT EDIT -->

---
id: "10.6.133"
title: "Internal Horizontal Port Scan"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.6.133 · Internal Horizontal Port Scan

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This analytic identifies instances where an internal host has attempted to communicate with 250 or more destination IP addresses using the same port and protocol, and we use Splunk so the team can see it early and act.*

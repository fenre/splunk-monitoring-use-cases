<!-- AUTO-GENERATED from UC-10.3.238.json — DO NOT EDIT -->
...
# UC-10.3.238 · Linux Stop Services

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Stop Services” so we can see attacker-style moves—not only a one-off file or password mistake.*

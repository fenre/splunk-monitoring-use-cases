<!-- AUTO-GENERATED from UC-10.7.1.json — DO NOT EDIT -->
...
*We use this for Alert Volume Trending so leadership can see trends and the SOC can see workload and quality over time.*
...
### Step 3 — Validate
Review the ES Incident Review queue, correlation source names, and time ranges. Compare volume shifts to new rule rollouts, hunt campaigns, and major incident or change windows. Verify your search can read the `notable` index and the fields the panels expect.
...
Volume changes during planned test cycles, new correlation rules, incident response surges, or data onboarding, not just attacks.

<!-- AUTO-GENERATED from UC-10.7.650.json — DO NOT EDIT -->
...
# UC-10.7.650 · True Positive Test

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on a source process failing to authenticate multiple users, potentially indicating a Password Spraying attack so unusual activity is visible early — before it spreads or hides in normal noise.*

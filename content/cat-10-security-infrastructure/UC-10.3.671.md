<!-- AUTO-GENERATED from UC-10.3.671.json — DO NOT EDIT -->

---
id: "10.3.671"
title: "HTTP Malware User Agent"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.671 · HTTP Malware User Agent

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “HTTP Malware User Agent”, so we catch real tradecraft and not just noise from everyday work.*

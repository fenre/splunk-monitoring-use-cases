<!-- AUTO-GENERATED from UC-10.8.36.json — DO NOT EDIT -->
...
*We watch certificate transparency and issuance patterns so unexpected or fraudulent certificates are noticed early.*
...
- `stats` rolls up events into metrics; results are split **by domain, cn** so each row reflects one combination of those dimensions.

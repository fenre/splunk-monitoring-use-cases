<!-- AUTO-GENERATED from UC-10.7.289.json — DO NOT EDIT -->
...
# UC-10.7.289 · Detect Password Spray Attack Behavior On User

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Detect Password Spray Attack Behavior On User so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

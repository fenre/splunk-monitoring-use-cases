<!-- AUTO-GENERATED from UC-10.11.58.json — DO NOT EDIT -->
...
*We use Zscaler data and alerts to stay ahead of the risks described in "Zscaler Cloud Firewall Rule Hit Analysis". We help the team notice trouble early, while a situation is still small and containable.*
...
- `stats` rolls up events into metrics; results are split **by rule_label, action, dest_country** so each row reflects one combination of those dimensions.

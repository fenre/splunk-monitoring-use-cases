<!-- AUTO-GENERATED from UC-10.7.186.json — DO NOT EDIT -->
...
*We use this 'Detect GCP Storage access from a new IP' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*
...
New IPs and IAM changes from migrations, data science, and multi-region work; use GCP audit and bucket policies to confirm intent.

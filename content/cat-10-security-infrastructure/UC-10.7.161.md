<!-- AUTO-GENERATED from UC-10.7.161.json — DO NOT EDIT -->
...
# UC-10.7.161 · Azure AD Service Principal Enumeration

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD Service Principal Enumeration so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

---

## Description

Detects enumeration of Azure AD service principals via Microsoft Graph API activity logs. Excessive enumeration of service principals may indicate reconnaissance activity by an attacker seeking to identify privileged applications and automation accounts for lateral movement or privilege escalation.

<!-- AUTO-GENERATED from UC-10.7.305.json — DO NOT EDIT -->
...
# UC-10.7.305 · Elevated Group Discovery with PowerView

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use this 'Elevated Group Discovery with PowerView' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*

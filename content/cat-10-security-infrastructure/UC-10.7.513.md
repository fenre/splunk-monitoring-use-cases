<!-- AUTO-GENERATED from UC-10.7.513.json — DO NOT EDIT -->
...
# UC-10.7.513 · Windows Domain Admin Impersonation Indicator

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Domain Admin Impersonation Indicator" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.2.52.json — DO NOT EDIT -->
...
# UC-10.2.52 · Impacket Lateral Movement WMIExec Commandline Parameters

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the use of Impacket's tool for lateral movement by identifying specific command-line parameters — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.7.426.json — DO NOT EDIT -->
...
# UC-10.7.426 · UAC Bypass MMC Load Unsigned Dll

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "UAC Bypass MMC Load Unsigned Dll" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

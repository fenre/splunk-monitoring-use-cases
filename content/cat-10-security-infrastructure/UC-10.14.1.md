<!-- AUTO-GENERATED from UC-10.14.1.json — DO NOT EDIT -->
...
> **Criticality:** Medium &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Availability, Compliance

*We keep an eye on the tools that watch the plant so our safety and attack detections in OT do not quietly stop running.*
...
- `stats` rolls up events into metrics; results are split **by savedsearch_name, status** so each row reflects one combination of those dimensions.
...
Scheduler noise from platform upgrades, search migration, or intentionally disabled test searches can look like “failed OT content” when the add-on is fine — confirm against maintenance windows and named searches.

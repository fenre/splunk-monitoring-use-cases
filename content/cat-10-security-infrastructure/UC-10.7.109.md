<!-- AUTO-GENERATED from UC-10.7.109.json — DO NOT EDIT -->
...
# UC-10.7.109 · AWS ECR Container Upload Outside Business Hours
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to IP address entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires AWS CloudTrail PutImage ingested and CIM-normalized.

<!-- AUTO-GENERATED from UC-10.6.72.json — DO NOT EDIT -->
...
# UC-10.6.72 · Spoolsv Writing a DLL - Sysmon

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects writing a file, which is unusual behavior and may indicate exploitation of vulnerabilities like (PrintNightmare), and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.3.292.json — DO NOT EDIT -->
...
# UC-10.3.292 · Regsvr32 with Known Silent Switch Cmdline

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Regsvr32 with Known Silent Switch Cmdline” so we can see attacker-style moves—not only a one-off file or password mistake.*

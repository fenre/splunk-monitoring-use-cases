<!-- AUTO-GENERATED from UC-10.7.143.json — DO NOT EDIT -->
...
*We look for Azure AD High Number Of Failed Authentications From Ip so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

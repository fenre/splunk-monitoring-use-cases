<!-- AUTO-GENERATED from UC-10.7.589.json — DO NOT EDIT -->
...
# UC-10.7.589 · Windows PowerSploit GPP Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows PowerSploit GPP Discovery" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

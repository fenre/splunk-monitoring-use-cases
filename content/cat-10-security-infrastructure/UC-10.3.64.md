<!-- AUTO-GENERATED from UC-10.3.64.json — DO NOT EDIT -->
...
# UC-10.3.64 · Detect mshta renamed

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Detect mshta renamed” so we can see attacker-style moves—not only a one-off file or password mistake.*

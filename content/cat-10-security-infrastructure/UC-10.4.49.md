<!-- AUTO-GENERATED from UC-10.4.49.json — DO NOT EDIT -->
...
# UC-10.4.49 · O365 Concurrent Sessions From Different Ips
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to user account entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires O365 UserLoggedIn ingested and CIM-normalized.

<!-- AUTO-GENERATED from UC-10.3.273.json — DO NOT EDIT -->
...
# UC-10.3.273 · Powershell Remote Thread To Known Windows Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Powershell Remote Thread To Known Windows Process” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.8.8.json — DO NOT EDIT -->
...
# UC-10.8.8 · Certutil exe certificate extraction

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies the use of certutil.exe with arguments indicating the manipulation or extraction of certificates — so we know when protection is off, out of date, or bypassed.*

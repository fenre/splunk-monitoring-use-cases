<!-- AUTO-GENERATED from UC-10.2.108.json — DO NOT EDIT -->
...
# UC-10.2.108 · Windows Create Local Account

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the creation of a new local user account on a Windows system — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.6.18.json — DO NOT EDIT -->
...
# UC-10.6.18 · Amazon EKS Kubernetes cluster scan detection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects unauthenticated requests to an Amazon clusters Kubernetes cluster, specifically identifying actions by the "system:anonymous" user, and we use Splunk so the team can see it early and act.*

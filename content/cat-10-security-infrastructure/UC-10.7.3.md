...
*We use this for MTTD and MTTR Tracking so leadership can see trends and the SOC can see workload and quality over time.*
...
Metric steps during major incidents, postmortems, and automation rollouts; exclude scheduled drills when benchmarking.

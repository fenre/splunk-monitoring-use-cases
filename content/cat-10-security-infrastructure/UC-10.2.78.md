<!-- AUTO-GENERATED from UC-10.2.78.json — DO NOT EDIT -->
...
# UC-10.2.78 · Remote Process Instantiation via WinRM and PowerShell Script Block

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of PowerShell commands that use the cmdlet to start a process on a remote endpoint using the WinRM protocol — so we know when protection is off, out of date, or bypassed.*

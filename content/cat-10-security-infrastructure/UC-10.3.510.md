<!-- AUTO-GENERATED from UC-10.3.510.json — DO NOT EDIT -->
...
# UC-10.3.510 · Windows Masquerading Msdtc Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Masquerading Msdtc Process”, so we catch real tradecraft and not just noise from everyday work.*

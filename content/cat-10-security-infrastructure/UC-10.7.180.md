<!-- AUTO-GENERATED from UC-10.7.180.json — DO NOT EDIT -->
...
# UC-10.7.180 · Cloud Provisioning Activity From Previously Unseen IP Address

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Cloud Provisioning Activity From Previously Unseen IP Address so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to IP address entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires AWS CloudTrail ingested and CIM-normalized.

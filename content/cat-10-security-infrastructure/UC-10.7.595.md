<!-- AUTO-GENERATED from UC-10.7.595.json — DO NOT EDIT -->
...
# UC-10.7.595 · True Positive Test

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "True Positive Test" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

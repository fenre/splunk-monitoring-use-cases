<!-- AUTO-GENERATED from UC-10.7.465.json — DO NOT EDIT -->
...
# UC-10.7.465 · Windows AD SID History Attribute Modified

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows SID History Attribute Modified" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

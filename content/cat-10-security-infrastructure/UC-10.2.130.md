<!-- AUTO-GENERATED from UC-10.2.130.json — DO NOT EDIT -->

---
id: "10.2.130"
title: "Windows Net System Service Discovery"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.2.130 · Windows Net System Service Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the enumeration of Windows services using the net start command, which is a built-in utility that lists all running services on a system — so we know when protection is off, out of date, or bypassed.*

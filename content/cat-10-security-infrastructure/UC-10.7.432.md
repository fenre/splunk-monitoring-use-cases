<!-- AUTO-GENERATED from UC-10.7.432.json — DO NOT EDIT -->
...
# UC-10.7.432 · Windows Access Token Winlogon Duplicate Handle In Uncommon Path

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Access Token Winlogon Duplicate Handle In Uncommon P" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

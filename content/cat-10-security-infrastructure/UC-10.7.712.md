<!-- AUTO-GENERATED from UC-10.7.712.json — DO NOT EDIT -->
...
# UC-10.7.712 · HTTP Duplicated Header

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "HTTP Duplicated Header" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

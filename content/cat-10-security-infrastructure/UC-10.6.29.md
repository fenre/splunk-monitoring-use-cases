<!-- AUTO-GENERATED from UC-10.6.29.json — DO NOT EDIT -->
...
# UC-10.6.29 · GitHub Organizations Disable Dependabot

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects when a user disables Dependabot security features within a GitHub repository, and we use Splunk so the team can see it early and act.*

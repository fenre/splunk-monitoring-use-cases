<!-- AUTO-GENERATED from UC-10.3.567.json — DO NOT EDIT -->
...
*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Odbcconf Hunting”, so we catch real tradecraft and not just noise from everyday work.*

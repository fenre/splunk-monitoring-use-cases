<!-- AUTO-GENERATED from UC-10.7.546.json — DO NOT EDIT -->
...
# UC-10.7.546 · Windows InstallUtil Credential Theft

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows InstallUtil Credential Theft" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

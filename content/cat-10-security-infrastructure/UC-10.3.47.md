<!-- AUTO-GENERATED from UC-10.3.47.json — DO NOT EDIT -->
...
# UC-10.3.47 · Conti Common Exec parameter

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Conti Common Exec parameter” so we can see attacker-style moves—not only a one-off file or password mistake.*

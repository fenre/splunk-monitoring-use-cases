<!-- AUTO-GENERATED from UC-10.3.118.json — DO NOT EDIT -->
...
# UC-10.3.118 · Excessive distinct processes from Windows Temp

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Excessive distinct processes from Windows Temp” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.3.463.json — DO NOT EDIT -->

---
id: "10.3.463"
title: "Windows Gdrive Binary Activity"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.463 · Windows Gdrive Binary Activity

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Gdrive Binary Activity”, so we catch real tradecraft and not just noise from everyday work.*

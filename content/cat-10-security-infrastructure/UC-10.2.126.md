<!-- AUTO-GENERATED from UC-10.2.126.json — DO NOT EDIT -->
...
# UC-10.2.126 · Windows Modify Show Compress Color And Info Tip Registry

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch suspicious modifications to the Windows registry keys related to file compression color and information tips — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.6.78.json — DO NOT EDIT -->

---
id: "10.6.78"
title: "Windows Cisco Secure Endpoint Uninstall Immunet Service Via Sfc"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.6.78 · Windows Cisco Secure Endpoint Uninstall Immunet Service Via Sfc

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the use of the sfc.exe utility with the "-u" parameter, which is part of the Cisco Secure Endpoint installation, and we use Splunk so the team can see it early and act.*

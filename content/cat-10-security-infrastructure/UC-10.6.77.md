<!-- AUTO-GENERATED from UC-10.6.77.json — DO NOT EDIT -->
...
# UC-10.6.77 · Windows Account Discovery With NetUser PreauthNotRequire

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the execution of the PowerView PowerShell cmdlet Get-NetUser with-PreauthNotRequire parameter, leveraging Event ID 4104, and we use Splunk so the team can see it early and act.*

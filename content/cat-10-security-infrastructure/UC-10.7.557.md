<!-- AUTO-GENERATED from UC-10.7.557.json — DO NOT EDIT -->
...
# UC-10.7.557 · Windows MSHTA Writing to World Writable Path

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows MSHTA Writing to World Writable Path" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.4.127.json — DO NOT EDIT -->
...
# UC-10.4.127 · Windows Mail Protocol In Non-Common Process Path
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to host or system entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Sysmon EventID 3 ingested and CIM-normalized.

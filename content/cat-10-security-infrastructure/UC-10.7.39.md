<!-- AUTO-GENERATED from UC-10.7.39.json — DO NOT EDIT -->
...
*We use this 'MCP Filesystem Server Suspicious Extension Write' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*
...
MCP file writes and database queries from approved automation, build agents, and developer IDEs; scope to known hosts and service accounts.

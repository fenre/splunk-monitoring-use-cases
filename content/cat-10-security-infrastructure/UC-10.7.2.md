<!-- AUTO-GENERATED from UC-10.7.2.json — DO NOT EDIT -->
...
*We use this for Analyst Workload Distribution so leadership can see trends and the SOC can see workload and quality over time.*
...
### Step 3 — Validate
Review the ES Incident Review queue for owner and closure fields against the search output. Compare uneven workload to shift patterns, on-call rosters, and one-off high-severity incidents. Verify field extractions and index access for the `notable` macro.
...
Uneven distribution can reflect shift schedules, on-call rosters, or one-off high-severity cases; use for capacity planning, not as a stand-alone health metric.

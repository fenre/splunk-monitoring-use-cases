<!-- AUTO-GENERATED from UC-10.7.467.json — DO NOT EDIT -->
...
# UC-10.7.467 · Windows AI Platform DNS Query

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows AI Platform Query" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

---

## Description

This detection identifies Windows AI Platform DNS Query. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to process entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Sysmon EventID 22 ingested and CIM-normalized.
...
- [https://cert.gov.ua/article/6284730](https://cert.gov.ua/article/6284730)

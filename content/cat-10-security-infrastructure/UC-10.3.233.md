...
*We use endpoint and security-agent signals around “Linux Setuid Using Chmod Utility” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.3.457.json — DO NOT EDIT -->
...
# UC-10.3.457 · Windows Exfiltration Over C2 Via Powershell UploadString

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Exfiltration Over C2 Via Powershell UploadString”, so we catch real tradecraft and not just noise from everyday work.*

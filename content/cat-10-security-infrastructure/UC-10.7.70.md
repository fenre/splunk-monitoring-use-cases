<!-- AUTO-GENERATED from UC-10.7.70.json — DO NOT EDIT -->
...
# UC-10.7.70 · Abnormally High Number Of Cloud Infrastructure API Calls

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Abnormally High Number Of Cloud Infrastructure API Calls so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

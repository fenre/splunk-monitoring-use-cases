<!-- AUTO-GENERATED from UC-10.7.676.json — DO NOT EDIT -->

---
id: "10.7.676"
title: "Cisco IOS Suspicious Privileged Account Creation"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.676 · Cisco IOS Suspicious Privileged Account Creation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Cisco IOS Suspicious Privileged Account Creation" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to command entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Cisco IOS Logs ingested and CIM-normalized.
...
- [https://www.cisco.com/c/en/us/td/docs/ios-xml/ios/security/a1/sec-a1-cr-book/sec-cr-a2.html#wp3796044403](https://www.cisco.com/c/en/us/td/docs/ios-xml/ios/security/a1/sec-a1-cr-book/sec-cr-a2.html#wp3796044403)

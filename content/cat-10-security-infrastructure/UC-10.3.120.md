<!-- AUTO-GENERATED from UC-10.3.120.json — DO NOT EDIT -->
...
# UC-10.3.120 · Excessive Usage of NSLOOKUP App

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Excessive Usage of NSLOOKUP App” so we can see attacker-style moves—not only a one-off file or password mistake.*

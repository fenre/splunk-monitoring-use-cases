<!-- AUTO-GENERATED from UC-10.2.43.json — DO NOT EDIT -->
...
# UC-10.2.43 · Excessive number of taskhost processes

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot an excessive number of taskhost.exe and taskhostex.exe processes running within a short time frame — so we know when protection is off, out of date, or bypassed.*

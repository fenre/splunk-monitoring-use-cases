<!-- AUTO-GENERATED from UC-10.2.22.json — DO NOT EDIT -->
...
# UC-10.2.22 · Azure AD Unusual Number of Failed Authentications From Ip

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot a single source IP failing to authenticate with multiple valid users, potentially indicating a Password Spraying attack against an Azure Active Directory tenant — so we know when protection is off, out of date, or bypassed.*
...
SaaS sync tools, new hire onboarding, guest invites, and partner B2B flows can resemble suspicious Entra or Azure AD activity—map directory changes to change management.

<!-- AUTO-GENERATED from UC-10.3.429.json — DO NOT EDIT -->
...
# UC-10.3.429 · Windows Defacement Modify Transcodedwallpaper File

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Defacement Modify Transcodedwallpaper File”, so we catch real tradecraft and not just noise from everyday work.*

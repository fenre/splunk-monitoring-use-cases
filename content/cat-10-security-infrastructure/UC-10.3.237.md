<!-- AUTO-GENERATED from UC-10.3.237.json — DO NOT EDIT -->
...
# UC-10.3.237 · Linux SSH Authorized Keys Modification

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux SSH Authorized Keys Modification” so we can see attacker-style moves—not only a one-off file or password mistake.*

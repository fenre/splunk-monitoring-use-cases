<!-- AUTO-GENERATED from UC-10.2.42.json — DO NOT EDIT -->
...
# UC-10.2.42 · Excessive number of service control start as disabled

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch an excessive number of processes launched with the command line argument within a short period — so we know when protection is off, out of date, or bypassed.*

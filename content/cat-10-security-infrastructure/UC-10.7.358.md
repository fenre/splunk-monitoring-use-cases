<!-- AUTO-GENERATED from UC-10.7.358.json — DO NOT EDIT -->
...
# UC-10.7.358 · Linux Auditd Kernel Module Enumeration

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Linux Auditd Kernel Module Enumeration so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

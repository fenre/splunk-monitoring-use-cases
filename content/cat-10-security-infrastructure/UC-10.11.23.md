<!-- AUTO-GENERATED from UC-10.11.23.json — DO NOT EDIT -->
...
*We use Palo Alto Networks firewall data and alerts to stay ahead of the risks described in "Palo Alto Data Filtering Policy Violations". We help the team notice trouble early, while a situation is still small and containable.*
...
- `stats` rolls up events into metrics; results are split **by filter, file_type, user** so each row reflects one combination of those dimensions.

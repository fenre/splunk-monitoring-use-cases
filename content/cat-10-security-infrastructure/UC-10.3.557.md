<!-- AUTO-GENERATED from UC-10.3.557.json — DO NOT EDIT -->

---
id: "10.3.557"
title: "Windows New Custom Security Descriptor Set On EventLog Channel"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.557 · Windows New Custom Security Descriptor Set On EventLog Channel

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows New Custom Security Descriptor Set On EventLog Channel”, so we catch real tradecraft and not just noise from everyday work.*
...
- [https://learn.microsoft.com/en-us/troubleshoot/windows-server/group-policy/set-event-log-security-locally-or-via-group-policy](https://learn.microsoft.com/en-us/troubleshoot/windows-server/group-policy/set-event-log-security-locally-or-via-group-policy)

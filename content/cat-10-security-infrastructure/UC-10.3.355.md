<!-- AUTO-GENERATED from UC-10.3.355.json — DO NOT EDIT -->
...
# UC-10.3.355 · Suspicious WAV file in Appdata Folder

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Suspicious WAV file in Appdata Folder”, so we catch real tradecraft and not just noise from everyday work.*

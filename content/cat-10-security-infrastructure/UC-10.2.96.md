<!-- AUTO-GENERATED from UC-10.2.96.json — DO NOT EDIT -->
...
# UC-10.2.96 · Svchost LOLBAS Execution Process Spawn

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch instances of 'svchost.exe' spawning Living Off The Land Binaries and Scripts (LOLBAS) processes — so we know when protection is off, out of date, or bypassed.*

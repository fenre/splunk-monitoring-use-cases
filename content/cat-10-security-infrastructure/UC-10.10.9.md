...
*We wire YARA match lines into the SIEM and alert on real hits so file-level malware sweeps are not an offline spreadsheet.*
...
YARA hits from authorized security research samples (EICAR, malware lab files), incident response forensics, or detection rule testing.

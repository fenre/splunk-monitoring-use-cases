<!-- AUTO-GENERATED from UC-10.7.580.json — DO NOT EDIT -->
...
# UC-10.7.580 · Windows Powershell History File Deletion

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Powershell History File Deletion" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

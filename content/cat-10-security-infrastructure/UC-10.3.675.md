<!-- AUTO-GENERATED from UC-10.3.675.json — DO NOT EDIT -->
...
# UC-10.3.675 · Wermgr Process Connecting To IP Check Web Services

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Wermgr Process Connecting To IP Check Web Services”, so we catch real tradecraft and not just noise from everyday work.*

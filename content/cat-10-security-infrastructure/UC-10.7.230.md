<!-- AUTO-GENERATED from UC-10.7.230.json — DO NOT EDIT -->
...
*We use this 'Kubernetes newly seen UDP edge' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*

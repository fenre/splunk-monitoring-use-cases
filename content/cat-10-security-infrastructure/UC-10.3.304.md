<!-- AUTO-GENERATED from UC-10.3.304.json — DO NOT EDIT -->
...
# UC-10.3.304 · Rundll32 with no Command Line Arguments with Network

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Rundll32 with no Command Line Arguments with Network” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.3.299.json — DO NOT EDIT -->
...
# UC-10.3.299 · Rundll32 Create Remote Thread To A Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Rundll32 Create Remote Thread To A Process” so we can see attacker-style moves—not only a one-off file or password mistake.*

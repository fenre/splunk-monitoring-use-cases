<!-- AUTO-GENERATED from UC-10.7.491.json — DO NOT EDIT -->
...
# UC-10.7.491 · Windows ClipBoard Data via Get-ClipBoard

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows ClipBoard Data via Get-ClipBoard" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

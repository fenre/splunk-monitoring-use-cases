<!-- AUTO-GENERATED from UC-10.3.49.json — DO NOT EDIT -->
...
# UC-10.3.49 · Create Remote Thread In Shell Application

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Create Remote Thread In Shell Application” so we can see attacker-style moves—not only a one-off file or password mistake.*

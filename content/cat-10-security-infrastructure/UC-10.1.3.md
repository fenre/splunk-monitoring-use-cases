...
*We watch for C2-style traffic at the firewall so we can contain active compromise while there is time to respond.*
...
Shared threat signatures (vulnerability scanners, admin tools) and lab traffic can match; correlate with change records and asset role before treating as a live attack.

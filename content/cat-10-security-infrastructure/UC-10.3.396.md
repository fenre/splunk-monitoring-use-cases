<!-- AUTO-GENERATED from UC-10.3.396.json — DO NOT EDIT -->
...
# UC-10.3.396 · Windows Audit Policy Restored via Auditpol

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Audit Policy Restored via Auditpol”, so we catch real tradecraft and not just noise from everyday work.*
...
- [https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/auditpol-restore](https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/auditpol-restore)

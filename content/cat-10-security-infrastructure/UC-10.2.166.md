<!-- AUTO-GENERATED from UC-10.2.166.json — DO NOT EDIT -->
...
# UC-10.2.166 · Detect Outbound SMB Traffic

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch outbound SMB (Server Message Block) connections from internal hosts to external servers — so we know when protection is off, out of date, or bypassed.*

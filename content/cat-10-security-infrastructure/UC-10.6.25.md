<!-- AUTO-GENERATED from UC-10.6.25.json — DO NOT EDIT -->
...
# UC-10.6.25 · Azure AD Privileged Graph API Permission Assigned

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the assignment of high-risk Graph permissions in Azure AD, specifically Application.ReadWrite.All, AppRoleAssignment.ReadWrite.All, and RoleManagement.ReadWrite.Directory, and we use Splunk so the team can see it early and act.*

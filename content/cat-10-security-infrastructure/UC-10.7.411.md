<!-- AUTO-GENERATED from UC-10.7.411.json — DO NOT EDIT -->
...
# UC-10.7.411 · Powershell Load Module in Meterpreter

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Powershell Load Module in Meterpreter" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.7.339.json — DO NOT EDIT -->

---
id: "10.7.339"
title: "Linux Auditd Auditd Daemon Abort"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.339 · Linux Auditd Auditd Daemon Abort

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Linux Auditd Auditd Daemon Abort so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to host or system entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Linux Auditd Daemon Abort ingested and CIM-normalized.

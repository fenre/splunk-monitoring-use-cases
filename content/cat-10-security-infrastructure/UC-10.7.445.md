<!-- AUTO-GENERATED from UC-10.7.445.json — DO NOT EDIT -->
...
# UC-10.7.445 · Windows AD Domain Replication ACL Addition

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Domain Replication ACL Addition" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

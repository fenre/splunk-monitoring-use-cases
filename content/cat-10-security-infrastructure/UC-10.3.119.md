<!-- AUTO-GENERATED from UC-10.3.119.json — DO NOT EDIT -->
...
# UC-10.3.119 · Excessive File Deletion In WinDefender Folder

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Excessive File Deletion In WinDefender Folder” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
Known false positives for this detection: Tampering alerts from authorized AV migration, EDR sensor uninstall during planned changes, or scheduled product upgrades.
...
Tampering alerts from authorized AV migration, EDR sensor uninstall during planned changes, or scheduled product upgrades.

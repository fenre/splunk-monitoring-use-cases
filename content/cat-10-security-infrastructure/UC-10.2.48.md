...
*We catch the use of the command executed using PowerShell to enumerate local groups on an endpoint — so we know when protection is off, out of date, or bypassed.*

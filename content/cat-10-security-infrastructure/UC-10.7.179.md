<!-- AUTO-GENERATED from UC-10.7.179.json — DO NOT EDIT -->
...
# UC-10.7.179 · Cloud Provisioning Activity From Previously Unseen Country

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Cloud Provisioning Activity From Previously Unseen Country so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

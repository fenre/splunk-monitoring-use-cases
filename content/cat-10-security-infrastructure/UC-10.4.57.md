<!-- AUTO-GENERATED from UC-10.4.57.json — DO NOT EDIT -->
...
# UC-10.4.57 · O365 Email Password and Payroll Compromise Behavior
...
```spl
`o365_messagetrace` subject IN ("*banking*","*direct deposit*","*password*","*passcode*") RecipientAddress = "$user$
```
...
| tstats `summariesonly` count
  ...
  by All_Email.src_user All_Email.recipient All_Email.signature span=1h
| sort -count
```
...
Compromise heuristics that overlap with helpdesk or payroll–related legitimate bursts during bonus cycles, reorgs, and fiscal close; correlate with user risk policies and case tickets.

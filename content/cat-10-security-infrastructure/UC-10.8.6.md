<!-- AUTO-GENERATED from UC-10.8.6.json — DO NOT EDIT -->
...
# UC-10.8.6 · Azure AD Service Principal New Client Credentials

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the addition of new credentials to Service Principals and Applications in Azure AD — so we know when protection is off, out of date, or bypassed.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to user account entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Azure Active Directory ingested and CIM-normalized.

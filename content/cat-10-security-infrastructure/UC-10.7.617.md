<!-- AUTO-GENERATED from UC-10.7.617.json — DO NOT EDIT -->

---
id: "10.7.617"
title: "Windows Remote Host Computer Management Access"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.617 · Windows Remote Host Computer Management Access

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Remote Host Computer Management Access" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

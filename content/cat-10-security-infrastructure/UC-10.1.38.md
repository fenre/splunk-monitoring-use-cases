<!-- AUTO-GENERATED from UC-10.1.38.json — DO NOT EDIT -->
...
# UC-10.1.38 · Windows Modify Registry Delete Firewall Rules

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects a potential deletion of firewall rules, indicating a possible security breach or unauthorized access attempt — so we know when protection is off, out of date, or bypassed.*

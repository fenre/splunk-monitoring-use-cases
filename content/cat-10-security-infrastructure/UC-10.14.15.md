...
*We enforce the rule that IT-style traffic is not allowed straight into the plant without the right hop and approval.*
...
OT firewall denies from authorized engineering access, vendor remote support, or scheduled maintenance VPN sessions can look like policy violations in raw logs when the slot was actually approved — compare to the change ticket time box.

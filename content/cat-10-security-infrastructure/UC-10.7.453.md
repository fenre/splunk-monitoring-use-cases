<!-- AUTO-GENERATED from UC-10.7.453.json — DO NOT EDIT -->
...
# UC-10.7.453 · Windows AD Hidden OU Creation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Hidden OU Creation" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

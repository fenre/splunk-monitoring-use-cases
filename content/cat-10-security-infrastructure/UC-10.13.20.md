<!-- AUTO-GENERATED from UC-10.13.20.json — DO NOT EDIT -->
...
*We use the same kind of check described for "IDS Alert Severity Trending" once our data is shaped in a common, repeatable way across products. We help the team see trouble early, compare different tools fairly, and avoid building a one-off report for every vendor.*

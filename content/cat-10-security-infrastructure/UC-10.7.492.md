<!-- AUTO-GENERATED from UC-10.7.492.json — DO NOT EDIT -->
...
# UC-10.7.492 · Windows Command and Scripting Interpreter Hunting Path Traversal

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on Windows Command and Scripting Interpreter Hunting Path Traversal so unusual activity is visible early — before it spreads or hides in normal noise.*

---

## Description

This detection identifies Windows Command and Scripting Interpreter Hunting Path Traversal. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

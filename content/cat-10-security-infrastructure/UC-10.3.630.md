<!-- AUTO-GENERATED from UC-10.3.630.json — DO NOT EDIT -->
...
# UC-10.3.630 · Windows SOAPHound Binary Execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows SOAPHound Binary Execution”, so we catch real tradecraft and not just noise from everyday work.*

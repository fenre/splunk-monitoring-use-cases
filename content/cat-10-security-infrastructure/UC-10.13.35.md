<!-- AUTO-GENERATED from UC-10.13.35.json — DO NOT EDIT -->

---
id: "10.13.35"
title: "HTTP Response Code Trending"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.13.35 · HTTP Response Code Trending

> **Criticality:** High &middot; **Difficulty:** Beginner &middot; **Pillar:** Security &middot; **Type:** Performance

*We use the same kind of check described for "HTTP Response Code Trending" once our data is shaped in a common, repeatable way across products. We help the team see trouble early, compare different tools fairly, and avoid building a one-off report for every vendor.*

---

## Description

5xx and 4xx rates from CIM `status` for SLO dashboards.
...
Line chart (5xx/4xx), Single value (error rate).

<!-- AUTO-GENERATED from UC-10.11.99.json — DO NOT EDIT -->

---
id: "10.11.99"
title: "Check Point Threat Prevention Extraction Blocks"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.11.99 · Check Point Threat Prevention Extraction Blocks

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use Check Point data and alerts to stay ahead of the risks described in "Check Point Threat Prevention Extraction Blocks". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

Threat prevention blocks show inline protection value across blades.
...
- `stats` rolls up events into metrics; results are split **by protection_type, severity** so each row reflects one combination of those dimensions.

<!-- AUTO-GENERATED from UC-10.3.176.json — DO NOT EDIT -->
...
# UC-10.3.176 · Linux Change File Owner To Root

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Change File Owner To Root” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.3.330.json — DO NOT EDIT -->
...
# UC-10.3.330 · Sunburst Correlation DLL and Network Event

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Sunburst Correlation DLL and Network Event” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
Known false positives for this detection: DNS to unusual names from research tools, test labs, or new SaaS; confirm the business owner before you call it malicious.
...
DNS to unusual names from research tools, test labs, or new SaaS; confirm the business owner before you call it malicious.

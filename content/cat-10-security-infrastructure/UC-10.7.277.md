<!-- AUTO-GENERATED from UC-10.7.277.json — DO NOT EDIT -->
...
# UC-10.7.277 · CrowdStrike Falcon Stream Alerts

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use this 'CrowdStrike Falcon Stream Alerts' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to file hash entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires CrowdStrike Falcon Stream Alert ingested and CIM-normalized.
...
```spl
index=crowdstrike sourcetype="CrowdStrike:Event:Streams:JSON" event_simpleName IN ("DetectionSummaryEvent", "IdpDetectionSummaryEvent")
...
EDR can duplicate noisy categories during sensor updates, hunting sessions, and benign tools; use Falcon’s containment and process tree to confirm.

## References

- [https://www.crowdstrike.com/en-us/resources/guides/crowdstrike-falcon-event-streams-add-on-for-splunk-guide-v3/](https://www.crowdstrike.com/en-us/resources/guides/crowdstrike-falcon-event-streams-add-on-for-splunk-guide-v3/)
- [https://splunkbase.splunk.com/app/5082](https://splunkbase.splunk.com/app/5082)

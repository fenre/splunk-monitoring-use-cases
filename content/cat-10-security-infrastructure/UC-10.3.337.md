...
*We use endpoint and security-agent signals around “Suspicious microsoft workflow compiler rename” so we can see attacker-style moves—not only a one-off file or password mistake.*

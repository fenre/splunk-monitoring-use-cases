<!-- AUTO-GENERATED from UC-10.7.157.json — DO NOT EDIT -->
...
# UC-10.7.157 · Azure AD Privileged Authentication Administrator Role Assigned

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD Privileged Authentication Administrator Role Assigned so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

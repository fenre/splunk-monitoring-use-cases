<!-- AUTO-GENERATED from UC-10.6.22.json — DO NOT EDIT -->
...
# UC-10.6.22 · AWS ECR Container Scanning Findings Medium

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies medium-severity findings from AWS Elastic Container Registry (ECR) image scans, and we use Splunk so the team can see it early and act.*

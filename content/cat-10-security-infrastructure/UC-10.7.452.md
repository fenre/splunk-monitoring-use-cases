<!-- AUTO-GENERATED from UC-10.7.452.json — DO NOT EDIT -->
...
# UC-10.7.452 · Windows AD GPO New CSE Addition

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows GPO New CSE Addition" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
- [https://learn.microsoft.com/en-gb/archive/blogs/mempson/group-policy-client-side-extension-list](https://learn.microsoft.com/en-gb/archive/blogs/mempson/group-policy-client-side-extension-list)

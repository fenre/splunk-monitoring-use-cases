<!-- AUTO-GENERATED from UC-10.7.430.json — DO NOT EDIT -->
...
# UC-10.7.430 · Windows Access Token Manipulation SeDebugPrivilege

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Access Token Manipulation SeDebugPrivilege" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

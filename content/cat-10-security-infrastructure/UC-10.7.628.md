<!-- AUTO-GENERATED from UC-10.7.628.json — DO NOT EDIT -->
...
# UC-10.7.628 · Windows Service Creation Using Registry Entry

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Service Creation Using Registry Entry" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

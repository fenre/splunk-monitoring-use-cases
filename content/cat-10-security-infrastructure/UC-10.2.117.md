<!-- AUTO-GENERATED from UC-10.2.117.json — DO NOT EDIT -->
...
# UC-10.2.117 · Windows Get Local Admin with FindLocalAdminAccess

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of the cmdlet using PowerShell Script Block Logging (EventCode=4104) — so we know when protection is off, out of date, or bypassed.*

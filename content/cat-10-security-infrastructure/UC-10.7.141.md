<!-- AUTO-GENERATED from UC-10.7.141.json — DO NOT EDIT -->
...
# UC-10.7.141 · Azure AD Global Administrator Role Assigned

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD Global Administrator Role Assigned so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*
...
- [https://learn.microsoft.com/en-us/azure/active-directory/roles/security-planning](https://learn.microsoft.com/en-us/azure/active-directory/roles/security-planning)
- [https://learn.microsoft.com/en-us/azure/role-based-access-control/elevate-access-global-admin](https://learn.microsoft.com/en-us/azure/role-based-access-control/elevate-access-global-admin)

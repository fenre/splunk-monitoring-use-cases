<!-- AUTO-GENERATED from UC-10.3.511.json — DO NOT EDIT -->
...
# UC-10.3.511 · Windows Mimikatz Binary Execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Mimikatz Binary Execution”, so we catch real tradecraft and not just noise from everyday work.*
...
Known false positives for this detection: Mimikatz strings from authorized red team exercises, security tool training, or detection rule testing.
...
Mimikatz strings from authorized red team exercises, security tool training, or detection rule testing.

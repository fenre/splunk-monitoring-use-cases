<!-- AUTO-GENERATED from UC-10.3.107.json — DO NOT EDIT -->
...
# UC-10.3.107 · Domain Account Discovery with Dsquery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Domain Account Discovery with Dsquery” so we can see attacker-style moves—not only a one-off file or password mistake.*

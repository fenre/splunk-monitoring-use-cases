<!-- AUTO-GENERATED from UC-10.3.662.json — DO NOT EDIT -->

---
id: "10.3.662"
title: "Windows WMIC Shadowcopy Delete"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.662 · Windows WMIC Shadowcopy Delete

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows WMIC Shadowcopy Delete”, so we catch real tradecraft and not just noise from everyday work.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to process entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Sysmon EventID 1 ingested and CIM-normalized.
...
- [https://any.run/malware-trends/cactus](https://any.run/malware-trends/cactus)

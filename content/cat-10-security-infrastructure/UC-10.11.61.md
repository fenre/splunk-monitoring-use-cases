<!-- AUTO-GENERATED from UC-10.11.61.json — DO NOT EDIT -->

---
id: "10.11.61"
title: "Zscaler Browser Isolation Usage"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.11.61 · Zscaler Browser Isolation Usage

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use Zscaler data and alerts to stay ahead of the risks described in "Zscaler Browser Isolation Usage". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

Browser isolation usage shows adoption of zero-trust browsing for untrusted sites.
...
- `stats` rolls up events into metrics; results are split **by user, url_category** so each row reflects one combination of those dimensions.
...
Bar chart (categories), Table (users).

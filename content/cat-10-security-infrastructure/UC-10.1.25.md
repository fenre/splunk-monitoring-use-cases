<!-- AUTO-GENERATED from UC-10.1.25.json — DO NOT EDIT -->
...
# UC-10.1.25 · Allow Inbound Traffic In Firewall Rule

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects a suspicious PowerShell command that allows inbound traffic to a specific local port within the public profile — so we know when protection is off, out of date, or bypassed.*

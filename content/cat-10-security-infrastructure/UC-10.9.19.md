<!-- AUTO-GENERATED from UC-10.9.19.json — DO NOT EDIT -->

---
id: "10.9.19"
title: "Shadow AI service detection"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.9.19 · Shadow AI service detection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use our security program’s detections to catch activity tied to “Shadow AI service detection” when someone tries that attacker move in our environment, so we can respond before the damage spreads.*

---

## Description

This detection aligns with ESCU 2025–2026 analytic story coverage for: Shadow AI service detection. Identifies unsanctioned SaaS AI tools or self-hosted models via DNS, TLS SNI, or expense signals.
...
ESCU Hunting detection — not designed for automated alerting. Run ad-hoc or on a low-frequency schedule from Splunk Enterprise Security for analyst-driven investigation. Requires DNS, proxy, CASB, firewall ingested and CIM-normalized.

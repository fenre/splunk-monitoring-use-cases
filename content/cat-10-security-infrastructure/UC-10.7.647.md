<!-- AUTO-GENERATED from UC-10.7.647.json — DO NOT EDIT -->

---
id: "10.7.647"
title: "Windows TOR Client Execution"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.647 · Windows TOR Client Execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows TOR Client Execution" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

---

## Description

This detection identifies Windows TOR Client Execution. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.
...
- [https://unit42.paloaltonetworks.com/tor-traffic-enterprise-networks/](https://unit42.paloaltonetworks.com/tor-traffic-enterprise-networks/)

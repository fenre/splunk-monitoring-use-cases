<!-- AUTO-GENERATED from UC-10.6.85.json — DO NOT EDIT -->
...
# UC-10.6.85 · Windows Driver Load Non-Standard Path

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the loading of new Kernel Mode Drivers from non-standard paths using Windows EventCode 7045, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.6.57.json — DO NOT EDIT -->
...
*This detection identifies attempts to authenticate with an empty public key fingerprint in Progress MOVEit Transfer, which is a key indicator of potential exploitation of the vulnerability, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.3.674.json — DO NOT EDIT -->
...
# UC-10.3.674 · Suspicious Process With Discord DNS Query

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Suspicious Process With Discord DNS Query”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.3.80.json — DO NOT EDIT -->
...
# UC-10.3.80 · Detect SharpHound Usage

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Detect SharpHound Usage” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.6.164.json — DO NOT EDIT -->
...
# UC-10.6.164 · Ivanti EPM SQL Injection Remote Code Execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This detection identifies potential exploitation of a critical SQL injection vulnerability in Ivanti Endpoint Manager (EPM), identified as, and we use Splunk so the team can see it early and act.*
...
- [https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-29824](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-29824)
- [https://github.com/projectdiscovery/nuclei-templates/pull/10020/files](https://github.com/projectdiscovery/nuclei-templates/pull/10020/files)

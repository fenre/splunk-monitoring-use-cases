<!-- AUTO-GENERATED from UC-10.3.680.json — DO NOT EDIT -->

---
id: "10.3.680"
title: "HTTP Scripting Tool User Agent"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.680 · HTTP Scripting Tool User Agent

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “HTTP Scripting Tool User Agent”, so we catch real tradecraft and not just noise from everyday work.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to IP address entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Nginx Access ingested and CIM-normalized.
...
Risk and correlation noise during purple-team tests; tune risk weight and entity allowlists so benign bulk activity does not dominate.

## References

- [https://portswigger.net/web-security/request-smuggling](https://portswigger.net/web-security/request-smuggling)
- [https://portswigger.net/research/http1-must-die](https://portswigger.net/research/http1-must-die)
- [https://www.vaadata.com/blog/what-is-http-request-smuggling-exploitations-and-security-best-practices/](https://www.vaadata.com/blog/what-is-http-request-smuggling-exploitations-and-security-best-practices/)
- [https://www.securityweek.com/new-http-request-smuggling-attacks-impacted-cdns-major-orgs-millions-of-websites/](https://www.securityweek.com/new-http-request-smuggling-attacks-impacted-cdns-major-orgs-millions-of-websites/)
- [https://github.com/SigmaHQ/sigma/blob/master/rules/web/proxy_generic/proxy_ua_hacktool.yml](https://github.com/SigmaHQ/sigma/blob/master/rules/web/proxy_generic/proxy_ua_hacktool.yml)
- [https://help.aikido.dev/zen-firewall/miscellaneous/bot-protection-details](https://help.aikido.dev/zen-firewall/miscellaneous/bot-protection-details)

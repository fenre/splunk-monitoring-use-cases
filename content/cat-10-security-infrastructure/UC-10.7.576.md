<!-- AUTO-GENERATED from UC-10.7.576.json — DO NOT EDIT -->
...
# UC-10.7.576 · Windows PowerShell Add Module to Global Assembly Cache

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows PowerShell Add Module to Global Assembly Cache" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

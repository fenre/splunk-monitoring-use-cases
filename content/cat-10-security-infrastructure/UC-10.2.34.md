<!-- AUTO-GENERATED from UC-10.2.34.json — DO NOT EDIT -->
...
# UC-10.2.34 · Detect Regsvcs with No Command Line Arguments

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch instances of regsvcs.exe running without command line arguments — so we know when protection is off, out of date, or bypassed.*

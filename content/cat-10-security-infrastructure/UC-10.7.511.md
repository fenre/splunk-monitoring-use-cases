<!-- AUTO-GENERATED from UC-10.7.511.json — DO NOT EDIT -->
...
# UC-10.7.511 · Windows DnsAdmins New Member Added

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows DnsAdmins New Member Added" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

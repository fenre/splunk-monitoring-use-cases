<!-- AUTO-GENERATED from UC-10.2.103.json — DO NOT EDIT -->
...
# UC-10.2.103 · Windows Administrative Shares Accessed On Multiple Hosts

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch a source computer accessing Windows administrative shares (C$, Admin$, IPC$) on 30 or more remote endpoints within a 5-minute window — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.3.261.json — DO NOT EDIT -->
...
# UC-10.3.261 · Nishang PowershellTCPOneLine

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Nishang PowershellTCPOneLine” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.3.678.json — DO NOT EDIT -->
...
# UC-10.3.678 · Windows Multi hop Proxy TOR Website Query

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Multi hop Proxy TOR Website Query”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.6.45.json — DO NOT EDIT -->
...
# UC-10.6.45 · Detect Baron Samedit CVE-2021-3156

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit the Baron Samedit vulnerability by identifying the use of the "sudoedit -s \\" command, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.7.416.json — DO NOT EDIT -->
...
# UC-10.7.416 · Powershell Windows Defender Exclusion Commands

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Powershell Windows Defender Exclusion Commands" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.9.43.json — DO NOT EDIT -->

---
id: "10.9.43"
title: "Ransomware ESXi targeting"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.9.43 · Ransomware ESXi targeting

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use our security program’s detections to catch activity tied to “Ransomware ESXi targeting” when someone tries that attacker move in our environment, so we can respond before the damage spreads.*

---

## Description

This detection aligns with ESCU 2025–2026 analytic story coverage for: Ransomware ESXi targeting. ESXi-specific encryption and locker deployment behaviors.
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires VMware ESXi logs, storage, EDR ingested and CIM-normalized.

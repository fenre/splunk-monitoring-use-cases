<!-- AUTO-GENERATED from UC-10.7.220.json — DO NOT EDIT -->
...
# UC-10.7.220 · Kubernetes Anomalous Inbound Outbound Network IO

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use this 'Kubernetes Anomalous Inbound Outbound Network IO' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*

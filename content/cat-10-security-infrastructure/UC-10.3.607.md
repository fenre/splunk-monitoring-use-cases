<!-- AUTO-GENERATED from UC-10.3.607.json — DO NOT EDIT -->
...
# UC-10.3.607 · Windows Remote Services Rdp Enable

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Remote Services Rdp Enable”, so we catch real tradecraft and not just noise from everyday work.*

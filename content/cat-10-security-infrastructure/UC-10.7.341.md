<!-- AUTO-GENERATED from UC-10.7.341.json — DO NOT EDIT -->

---
id: "10.7.341"
title: "Linux Auditd Auditd Daemon Start"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.341 · Linux Auditd Auditd Daemon Start

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Linux Auditd Auditd Daemon Start so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to host or system entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Linux Auditd Daemon Start ingested and CIM-normalized.

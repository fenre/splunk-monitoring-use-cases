<!-- AUTO-GENERATED from UC-10.9.50.json — DO NOT EDIT -->

---
id: "10.9.50"
title: "Earth Alux zero-day exploitation"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.9.50 · Earth Alux zero-day exploitation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use our security program’s detections to catch activity tied to “Earth Alux zero-day exploitation” when someone tries that attacker move in our environment, so we can respond before the damage spreads.*

---

## Description

This detection aligns with ESCU 2025–2026 analytic story coverage for: Earth Alux zero-day exploitation. Surfaces exploitation of zero-days in Earth Alux targeting chains.
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires EDR, WAF, IPS/IDS ingested and CIM-normalized.

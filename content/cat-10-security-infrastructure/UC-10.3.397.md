<!-- AUTO-GENERATED from UC-10.3.397.json — DO NOT EDIT -->
...
# UC-10.3.397 · Windows Audit Policy Security Descriptor Tampering via Auditpol

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Audit Policy Security Descriptor Tampering via Auditpol”, so we catch real tradecraft and not just noise from everyday work.*

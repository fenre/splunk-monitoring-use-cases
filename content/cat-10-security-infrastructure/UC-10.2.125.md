<!-- AUTO-GENERATED from UC-10.2.125.json — DO NOT EDIT -->
...
# UC-10.2.125 · Windows Modify Registry Utilize ProgIDs

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch modifications to the Windows Registry specifically targeting Programmatic Identifier associations to bypass User Account Control (UAC) Windows OS feature — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.2.105.json — DO NOT EDIT -->
...
# UC-10.2.105 · Windows Computer Account Created by Computer Account

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot a computer account creating a new computer account with a specific Service Principal Name (SPN) "RestrictedKrbHost" — so we know when protection is off, out of date, or bypassed.*
...
Cluster services, misconfigured application accounts, and legacy systems create unusual Kerberos patterns; validate against Active Directory support before assuming forgery.

## References

- [https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-kile/445e4499-7e49-4f2a-8d82-aaf2d1ee3c47](https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-kile/445e4499-7e49-4f2a-8d82-aaf2d1ee3c47)

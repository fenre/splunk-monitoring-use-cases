...
*We compare our asset list to recent scan activity so we are not blind to whole systems that never got checked for known weaknesses.*
...
Coverage gaps from new asset onboarding, IP changes, or assets in maintenance mode. Lab or decommissioned hosts may look "unscanned" on purpose.

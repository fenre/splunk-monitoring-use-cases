<!-- AUTO-GENERATED from UC-10.3.32.json — DO NOT EDIT -->
...
# UC-10.3.32 · BCDEdit Failure Recovery Modification

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “BCDEdit Failure Recovery Modification” so we can see attacker-style moves—not only a one-off file or password mistake.*

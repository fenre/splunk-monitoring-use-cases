<!-- AUTO-GENERATED from UC-10.2.69.json — DO NOT EDIT -->
...
# UC-10.2.69 · PowerShell Invoke WmiExec Usage

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of the Invoke-WMIExec utility within PowerShell Script Block Logging (EventCode 4104) — so we know when protection is off, out of date, or bypassed.*

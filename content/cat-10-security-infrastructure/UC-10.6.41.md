<!-- AUTO-GENERATED from UC-10.6.41.json — DO NOT EDIT -->

---
id: "10.6.41"
title: "Crowdstrike Admin Weak Password Policy"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.6.41 · Crowdstrike Admin Weak Password Policy

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects CrowdStrike alerts for admin weak password policy violations, identifying instances where administrative passwords do not meet security standards, and we use Splunk so the team can see it early and act.*

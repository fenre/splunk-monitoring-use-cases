<!-- AUTO-GENERATED from UC-10.7.692.json — DO NOT EDIT -->
...
# UC-10.7.692 · Detect Rogue DHCP Server

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on the presence of unauthorized DHCP servers on the network so unusual activity is visible early — before it spreads or hides in normal noise.*

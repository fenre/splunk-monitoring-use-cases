<!-- AUTO-GENERATED from UC-10.11.8.json — DO NOT EDIT -->
...
*We use FortiGate data and alerts to stay ahead of the risks described in "FortiGate HA Failover Events". We help the team notice trouble early, while a situation is still small and containable.*
...
- `stats` rolls up events into metrics; results are split **by action, group_id** so each row reflects one combination of those dimensions.

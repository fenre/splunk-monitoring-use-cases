<!-- AUTO-GENERATED from UC-10.3.560.json — DO NOT EDIT -->

---
id: "10.3.560"
title: "Windows New EventLog ChannelAccess Registry Value Set"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.560 · Windows New EventLog ChannelAccess Registry Value Set

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows New EventLog ChannelAccess Registry Value Set”, so we catch real tradecraft and not just noise from everyday work.*
...
- [https://web.archive.org/web/20220710181255/https://blog.minerva-labs.com/lockbit-3.0-aka-lockbit-black-is-here-with-a-new-icon-new-ransom-note-new-wallpaper-but-less-evasiveness](https://web.archive.org/web/20220710181255/https://blog.minerva-labs.com/lockbit-3.0-aka-lockbit-black-is-here-with-a-new-icon-new-ransom-note-new-wallpaper-but-less-evasiveness)

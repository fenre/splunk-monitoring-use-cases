<!-- AUTO-GENERATED from UC-10.7.350.json — DO NOT EDIT -->
...
# UC-10.7.350 · Linux Auditd Edit Cron Table Parameter

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Linux Auditd Edit Cron Table Parameter so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

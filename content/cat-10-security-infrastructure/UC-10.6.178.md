<!-- AUTO-GENERATED from UC-10.6.178.json — DO NOT EDIT -->
...
# UC-10.6.178 · Nginx ConnectWise ScreenConnect Authentication Bypass

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit the ConnectWise ScreenConnect vulnerability, which allows attackers to bypass authentication using alternate paths or channels, and we use Splunk so the team can see it early and act.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to host or system entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Nginx Access ingested and CIM-normalized.

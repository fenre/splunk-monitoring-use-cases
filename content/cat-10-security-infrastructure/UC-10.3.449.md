<!-- AUTO-GENERATED from UC-10.3.449.json — DO NOT EDIT -->
...
# UC-10.3.449 · Windows DISM Remove Defender

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows DISM Remove Defender”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.3.363.json — DO NOT EDIT -->
...
# UC-10.3.363 · Time Provider Persistence Registry

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Time Provider Persistence Registry”, so we catch real tradecraft and not just noise from everyday work.*

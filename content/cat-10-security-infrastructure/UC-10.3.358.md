<!-- AUTO-GENERATED from UC-10.3.358.json — DO NOT EDIT -->
...
# UC-10.3.358 · System Info Gathering Using Dxdiag Application

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “System Info Gathering Using Dxdiag Application”, so we catch real tradecraft and not just noise from everyday work.*

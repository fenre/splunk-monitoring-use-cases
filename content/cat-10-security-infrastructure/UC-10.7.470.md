<!-- AUTO-GENERATED from UC-10.7.470.json — DO NOT EDIT -->
...
# UC-10.7.470 · Windows Anonymous Pipe Activity

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Anonymous Pipe Activity" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

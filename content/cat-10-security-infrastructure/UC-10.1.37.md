<!-- AUTO-GENERATED from UC-10.1.37.json — DO NOT EDIT -->
...
# UC-10.1.37 · Windows Impair Defense Disable Defender Firewall And Network

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects modifications in the Windows registry to disable firewall and network protection settings within Windows Defender Security Center — so we know when protection is off, out of date, or bypassed.*

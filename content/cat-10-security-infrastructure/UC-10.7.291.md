<!-- AUTO-GENERATED from UC-10.7.291.json — DO NOT EDIT -->
...
# UC-10.7.291 · Detect Regasm with Network Connection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Detect Regasm with Network Connection so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

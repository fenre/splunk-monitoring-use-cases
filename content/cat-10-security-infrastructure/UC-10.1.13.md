<!-- AUTO-GENERATED from UC-10.1.13.json — DO NOT EDIT -->
...
# UC-10.1.13 · Cisco ASA - Logging Message Suppression

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This detection identifies Cisco ASA - Logging Message Suppression — so we know when protection is off, out of date, or bypassed.*

---

## Description

This detection identifies Cisco ASA - Logging Message Suppression. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

<!-- AUTO-GENERATED from UC-10.2.139.json — DO NOT EDIT -->
...
# UC-10.2.139 · Windows Remote Create Service

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot the creation of a new service on a remote endpoint using sc.exe — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.8.27.json — DO NOT EDIT -->
...
# UC-10.8.27 · Windows Steal Authentication Certificates Certificate Request

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects when a new certificate is requested from Certificate Services - AD CS — so we know when protection is off, out of date, or bypassed.*

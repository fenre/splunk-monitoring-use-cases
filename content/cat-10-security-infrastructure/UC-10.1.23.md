<!-- AUTO-GENERATED from UC-10.1.23.json — DO NOT EDIT -->
...
# UC-10.1.23 · Allow File And Printing Sharing In Firewall

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the modification of firewall settings to allow file and printer sharing — so we know when protection is off, out of date, or bypassed.*

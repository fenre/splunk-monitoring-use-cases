<!-- AUTO-GENERATED from UC-10.7.579.json — DO NOT EDIT -->
...
# UC-10.7.579 · Windows PowerShell Get CIMInstance Remote Computer

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for the detection that watches PowerShell pulling system details from a remote computer, so the team can spot abuse early without getting lost in one-off alerts that lack context.*

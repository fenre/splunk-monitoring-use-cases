...
*We add these signals to the risk story for "Windows PowerShell Get CIMInstance Remote Computer" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

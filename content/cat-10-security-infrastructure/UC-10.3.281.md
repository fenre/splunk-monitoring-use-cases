<!-- AUTO-GENERATED from UC-10.3.281.json — DO NOT EDIT -->
...
# UC-10.3.281 · Process Deleting Its Process File Path

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Process Deleting Its Process File Path” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.4.64.json — DO NOT EDIT -->

---
id: "10.4.64"
title: "O365 Email Send Attachments Excessive Volume"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.4.64 · O365 Email Send Attachments Excessive Volume
...
```spl
`o365_management_activity` Workload=Exchange (Operation IN ("Send*")) AND Item.Attachments=* AND UserId = "$user$
```
...
Broadcast mailers and system accounts sending the same file to many recipients; confirm against marketing and notification baselines and Safe Attachments or sandbox results.

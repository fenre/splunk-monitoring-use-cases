<!-- AUTO-GENERATED from UC-10.8.19.json — DO NOT EDIT -->
...
# UC-10.8.19 · Windows Mimikatz Crypto Export File Extensions

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the creation of files with extensions commonly associated with the Mimikatz Crypto module — so we know when protection is off, out of date, or bypassed.*

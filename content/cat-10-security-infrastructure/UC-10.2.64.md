<!-- AUTO-GENERATED from UC-10.2.64.json — DO NOT EDIT -->
...
# UC-10.2.64 · Possible Lateral Movement PowerShell Spawn

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the spawning of a PowerShell process as a child or grandchild of commonly abused processes like services.exe, wmiprvse.exe, svchost.exe, wsmprovhost.exe, and mmc.exe — so we know when protection is off, out of date, or bypassed.*

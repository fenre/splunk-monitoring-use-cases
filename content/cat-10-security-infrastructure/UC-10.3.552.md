<!-- AUTO-GENERATED from UC-10.3.552.json — DO NOT EDIT -->
...
# UC-10.3.552 · True Positive Test

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for a single address failing many user logons that should not be active, so we catch guessing against stale identities.*

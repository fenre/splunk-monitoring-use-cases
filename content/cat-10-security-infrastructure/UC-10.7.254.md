<!-- AUTO-GENERATED from UC-10.7.254.json — DO NOT EDIT -->
...
*We use this 'Cisco Isovalent - Kprobe Spike' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*
...
ebpf and process telemetry noise during agent upgrades and kernel changes; use Cilium or workload identity for the pod and namespace.

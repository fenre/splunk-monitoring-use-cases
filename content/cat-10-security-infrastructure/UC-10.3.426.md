<!-- AUTO-GENERATED from UC-10.3.426.json — DO NOT EDIT -->

---
id: "10.3.426"
title: "Windows Credentials from Web Browsers Saved in TEMP Folder"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.426 · Windows Credentials from Web Browsers Saved in TEMP Folder

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Credentials from Web Browsers Saved in TEMP Folder”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.3.469.json — DO NOT EDIT -->
...
# UC-10.3.469 · Windows Hijack Execution Flow Version Dll Side Load

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Hijack Execution Flow Version Dll Side Load”, so we catch real tradecraft and not just noise from everyday work.*
...
Known false positives for this detection: DLL sideloading detections from legitimate apps with renamed or relocated DLLs, or vendor signing chain issues.
...
DLL sideloading detections from legitimate apps with renamed or relocated DLLs, or vendor signing chain issues.

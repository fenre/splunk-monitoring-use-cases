<!-- AUTO-GENERATED from UC-10.2.17.json — DO NOT EDIT -->
...
# UC-10.2.17 · AWS S3 Exfiltration Behavior Identified

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot potential AWS cloud storage exfiltration behavior by correlating multiple risk events related to Collection and Exfiltration techniques — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.2.152.json — DO NOT EDIT -->
...
# UC-10.2.152 · Windows Special Privileged Logon On Multiple Hosts

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch a user authenticating with special privileges on 30 or more remote endpoints within a 5-minute window — so we know when protection is off, out of date, or bypassed.*

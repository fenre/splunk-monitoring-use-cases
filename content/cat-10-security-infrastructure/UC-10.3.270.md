<!-- AUTO-GENERATED from UC-10.3.270.json — DO NOT EDIT -->
...
# UC-10.3.270 · PowerShell - Connect To Internet With Hidden Window

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “PowerShell - Connect To Internet With Hidden Window” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
PowerShell from sysadmin scripts, Configuration Manager (SCCM), or vendor management tools (Tenable agent, vendor diagnostic scripts) and ad hoc admin work that matches your runbook.

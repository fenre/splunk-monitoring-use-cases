<!-- AUTO-GENERATED from UC-10.2.143.json — DO NOT EDIT -->
...
# UC-10.2.143 · Windows Service Create SliverC2

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the creation of a Windows service named "Sliver" with the description "Sliver Implant," indicative of SliverC2 lateral movement using the PsExec module — so we know when protection is off, out of date, or bypassed.*

...
*We look for default or shared logins on control gear so a generic password is not a skeleton key to the process.*
...
Default or shared *accounts* in lab, OEM, or jump-box setups can be legitimate in tightly controlled enclaves — map to asset class before escalating.

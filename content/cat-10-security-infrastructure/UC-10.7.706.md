<!-- AUTO-GENERATED from UC-10.7.706.json — DO NOT EDIT -->
...
# UC-10.7.706 · Suspicious Process DNS Query Known Abuse Web Services

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Suspicious Process Query Known Abuse Web Services" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

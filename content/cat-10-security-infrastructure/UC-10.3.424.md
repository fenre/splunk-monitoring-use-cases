<!-- AUTO-GENERATED from UC-10.3.424.json — DO NOT EDIT -->
...
# UC-10.3.424 · Windows Credentials from Password Stores Deletion

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Credentials from Password Stores Deletion”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.3.262.json — DO NOT EDIT -->
...
# UC-10.3.262 · Non Firefox Process Access Firefox Profile Dir

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Non Firefox Process Access Firefox Profile Dir” so we can see attacker-style moves—not only a one-off file or password mistake.*

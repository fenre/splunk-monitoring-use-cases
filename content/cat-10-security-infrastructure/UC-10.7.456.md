<!-- AUTO-GENERATED from UC-10.7.456.json — DO NOT EDIT -->

---
id: "10.7.456"
title: "Windows AD Privileged Group Modification"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.456 · Windows AD Privileged Group Modification

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Privileged Group Modification" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

---

## Description

This detection identifies Windows AD Privileged Group Modification. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.
...
- [https://splunkbase.splunk.com/app/6853](https://splunkbase.splunk.com/app/6853)

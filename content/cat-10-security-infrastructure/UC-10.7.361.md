<!-- AUTO-GENERATED from UC-10.7.361.json — DO NOT EDIT -->

---
id: "10.7.361"
title: "Linux Auditd Osquery Service Stop"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.361 · Linux Auditd Osquery Service Stop

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Linux Auditd Osquery Service Stop" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to host or system entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Linux Auditd Service Stop ingested and CIM-normalized.

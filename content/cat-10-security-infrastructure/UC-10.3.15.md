<!-- AUTO-GENERATED from UC-10.3.15.json — DO NOT EDIT -->
...
# UC-10.3.15 · ASL AWS Disable Bucket Versioning

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use cloud account activity to see mis-steps and misuse early so security and cloud teams are not the last to know.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to IP address entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires ASL AWS CloudTrail ingested and CIM-normalized.
...
Benign or expected activity from misconfiguration, access testing, and vendor maintenance; line up the event to the same record in the vendor console and your change calendar.

<!-- AUTO-GENERATED from UC-10.7.505.json — DO NOT EDIT -->
...
# UC-10.7.505 · Windows Default Rdp File Unhidden

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Default Rdp File Unhidden" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

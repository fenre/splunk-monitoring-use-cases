<!-- AUTO-GENERATED from UC-10.7.469.json — DO NOT EDIT -->
...
# UC-10.7.469 · Windows Alternate DataStream - Process Execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Alternate DataStream - Process Execution" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

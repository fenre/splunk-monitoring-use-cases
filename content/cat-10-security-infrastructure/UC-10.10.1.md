<!-- AUTO-GENERATED from UC-10.10.1.json — DO NOT EDIT -->
...
*We track how often our rules cry wolf versus hit real issues so we can tune detections and give leadership honest numbers on quality.*
...
### Step 3 — Validate
Compare the chart to **detection health exports** or your metrics store for the same week. Reconcile a day where you know a tuning exercise relabeled notables, and check that the false-positive ratio moves the way you expect.
...
False-positive rates swing when we retune rules, re-label old closed notables, run purple-team exercises, or onboard new data feeds — the math moves even when the control is still sound.

<!-- AUTO-GENERATED from UC-10.2.73.json — DO NOT EDIT -->
...
*We catch the installation of a Windows Service with a suspicious, high-entropy name, indicating potential malicious activity — so we know when protection is off, out of date, or bypassed.*

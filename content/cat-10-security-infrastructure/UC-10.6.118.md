<!-- AUTO-GENERATED from UC-10.6.118.json — DO NOT EDIT -->
...
# UC-10.6.118 · Windows Suspicious VMWare Tools Child Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies child processes spawned by vmtoolsd.exe, the VMWare Tools service in Windows, which typically runs with SYSTEM privileges, and we use Splunk so the team can see it early and act.*
...
Although unlikely, some legitimate Administrative scripts may utilize VMWare Tools to execute commands on virtual machines.

## References

- [https://cloud.google.com/blog/topics/threat-intelligence/vmware-esxi-zero-day-bypass/](https://cloud.google.com/blog/topics/threat-intelligence/vmware-esxi-zero-day-bypass/)

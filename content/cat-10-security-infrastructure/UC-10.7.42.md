<!-- AUTO-GENERATED from UC-10.7.42.json — DO NOT EDIT -->

---
id: "10.7.42"
title: "Okta IDP Lifecycle Modifications"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.42 · Okta IDP Lifecycle Modifications

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We watch Okta and IdP events that match this issue so we can see account takeover, token abuse, or credential problems before they spread.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to IP address entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Okta ingested and CIM-normalized.
...
- [https://www.obsidiansecurity.com/blog/behind-the-breach-cross-tenant-impersonation-in-okta/](https://www.obsidiansecurity.com/blog/behind-the-breach-cross-tenant-impersonation-in-okta/)

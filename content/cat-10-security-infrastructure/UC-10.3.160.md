<!-- AUTO-GENERATED from UC-10.3.160.json — DO NOT EDIT -->
...
# UC-10.3.160 · Linux APT Privilege Escalation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux APT Privilege Escalation” so we can see attacker-style moves—not only a one-off file or password mistake.*

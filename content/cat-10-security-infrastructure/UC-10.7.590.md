<!-- AUTO-GENERATED from UC-10.7.590.json — DO NOT EDIT -->
...
# UC-10.7.590 · Windows PowerView AD Access Control List Enumeration

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows PowerView Access Control List Enumeration" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

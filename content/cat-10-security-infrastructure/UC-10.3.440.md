<!-- AUTO-GENERATED from UC-10.3.440.json — DO NOT EDIT -->
...
# UC-10.3.440 · Windows Disable Notification Center

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Disable Notification Center”, so we catch real tradecraft and not just noise from everyday work.*

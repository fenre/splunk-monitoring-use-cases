<!-- AUTO-GENERATED from UC-10.3.400.json — DO NOT EDIT -->
...
# UC-10.3.400 · Windows BitLocker Suspicious Command Usage

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows BitLocker Suspicious Command Usage”, so we catch real tradecraft and not just noise from everyday work.*
...
```spl
| from datamodel Endpoint.Processes | search process_name = $process_name$ AND dest = "$dest$
```
...
Legitimate dev tools, installers, and system maintenance binaries can match; validate parent process, path, and signer.

## References

- [https://attack.mitre.org/techniques/T1486/](https://attack.mitre.org/techniques/T1486/)
- [https://www.nccgroup.com/us/research-blog/nameless-and-shameless-ransomware-encryption-via-bitlocker/](https://www.nccgroup.com/us/research-blog/nameless-and-shameless-ransomware-encryption-via-bitlocker/)
- [https://www.bitdefender.com/en-us/blog/businessinsights/shrinklocker-decryptor-from-friend-to-foe-and-back-again](https://www.bitdefender.com/en-us/blog/businessinsights/shrinklocker-decryptor-from-friend-to-foe-and-back-again)
- [https://www.bleepingcomputer.com/news/security/new-shrinklocker-ransomware-uses-bitlocker-to-encrypt-your-files/](https://www.bleepingcomputer.com/news/security/new-shrinklocker-ransomware-uses-bitlocker-to-encrypt-your-files/)

<!-- AUTO-GENERATED from UC-10.7.460.json — DO NOT EDIT -->
...
# UC-10.7.460 · Windows AD Self DACL Assignment

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Self DACL Assignment" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

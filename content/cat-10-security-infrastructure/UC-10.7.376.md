<!-- AUTO-GENERATED from UC-10.7.376.json — DO NOT EDIT -->
...
# UC-10.7.376 · Linux Auditd Whoami User Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Linux Auditd Whoami User Discovery" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to host or system entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Linux Auditd Syscall ingested and CIM-normalized.

<!-- AUTO-GENERATED from UC-10.3.562.json — DO NOT EDIT -->
...
# UC-10.3.562 · Windows New Service Security Descriptor Set Via Sc.EXE

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows New Service Security Descriptor Set Via Sc.EXE”, so we catch real tradecraft and not just noise from everyday work.*
...
Known false positives for this detection: Services from vendor agent installs, database setup, web server roles, and backup or monitoring pushes.
...
| tstats `summariesonly` count
  ...
  by Services.dest Services.name Services.action span=1h
| sort -count
```
...
Services from vendor agent installs, database setup, web server roles, and backup or monitoring pushes.

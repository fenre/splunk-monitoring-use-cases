<!-- AUTO-GENERATED from UC-10.3.109.json — DO NOT EDIT -->
...
# UC-10.3.109 · Domain Controller Discovery with Wmic

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Domain Controller Discovery with Wmic” so we can see attacker-style moves—not only a one-off file or password mistake.*

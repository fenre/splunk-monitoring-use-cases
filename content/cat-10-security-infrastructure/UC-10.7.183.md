...
*We look for the behavior in “Detect AWS Console Login by New User” using the same CIM-backed fields as the detection, so the team can act before impact spreads.*

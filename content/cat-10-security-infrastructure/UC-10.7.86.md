<!-- AUTO-GENERATED from UC-10.7.86.json — DO NOT EDIT -->
...
# UC-10.7.86 · ASL AWS IAM Delete Policy

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use this 'ASL AWS IAM Delete Policy' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*

<!-- AUTO-GENERATED from UC-10.2.62.json — DO NOT EDIT -->
...
# UC-10.2.62 · Network Share Discovery Via Dir Command

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch access to Windows administrative SMB shares (Admin$, IPC$, C$) using the 'dir' command — so we know when protection is off, out of date, or bypassed.*

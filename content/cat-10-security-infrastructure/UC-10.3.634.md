<!-- AUTO-GENERATED from UC-10.3.634.json — DO NOT EDIT -->
...
# UC-10.3.634 · Windows System Binary Proxy Execution Compiled HTML File Decompile

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows System Binary Proxy Execution Compiled HTML File Decompile”, so we catch real tradecraft and not just noise from everyday work.*
...
- [https://learn.microsoft.com/en-us/windows/win32/api/htmlhelp/nf-htmlhelp-htmlhelpa](https://learn.microsoft.com/en-us/windows/win32/api/htmlhelp/nf-htmlhelp-htmlhelpa)

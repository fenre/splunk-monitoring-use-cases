<!-- AUTO-GENERATED from UC-10.1.28.json — DO NOT EDIT -->
...
# UC-10.1.28 · Firewall Allowed Program Enable

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the modification of a firewall rule to allow the execution of a specific application — so we know when protection is off, out of date, or bypassed.*

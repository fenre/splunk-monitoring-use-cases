<!-- AUTO-GENERATED from UC-10.11.35.json — DO NOT EDIT -->

---
id: "10.11.35"
title: "Check Point Gateway CPU and Memory Health"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.11.35 · Check Point Gateway CPU and Memory Health

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use Check Point data and alerts to stay ahead of the risks described in "Check Point Gateway CPU and Memory Health". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

Gateway health prevents inspection bypass under load and connection drops.
...
- `stats` rolls up events into metrics; results are split **by gw_name** so each row reflects one combination of those dimensions.
...
Single value, Line chart (CPU/mem), Table (top gateways).

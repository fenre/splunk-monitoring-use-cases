<!-- AUTO-GENERATED from UC-10.7.163.json — DO NOT EDIT -->
...
# UC-10.7.163 · Azure AD Service Principal Privilege Escalation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD Service Principal Privilege Escalation so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*
...
- [https://splunkbase.splunk.com/app/3110](https://splunkbase.splunk.com/app/3110)
- [https://splunk.github.io/splunk-add-on-for-microsoft-cloud-services/Install/](https://splunk.github.io/splunk-add-on-for-microsoft-cloud-services/Install/)

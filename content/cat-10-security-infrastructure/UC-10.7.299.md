<!-- AUTO-GENERATED from UC-10.7.299.json — DO NOT EDIT -->
...
# UC-10.7.299 · Disabled Kerberos Pre-Authentication Discovery With Get-ADUser

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Disabled Kerberos Pre-Authentication Discovery With Get-ADUser so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

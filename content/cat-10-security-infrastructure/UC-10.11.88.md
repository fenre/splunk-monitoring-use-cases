<!-- AUTO-GENERATED from UC-10.11.88.json — DO NOT EDIT -->

---
id: "10.11.88"
title: "FortiGate Botnet C2 Command Detection"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.11.88 · FortiGate Botnet C2 Command Detection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use FortiGate data and alerts to stay ahead of the risks described in "FortiGate Botnet C2 Command Detection". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

Botnet signature hits often indicate compromised hosts participating in C2.
...
- `stats` rolls up events into metrics; results are split **by src, attack** so each row reflects one combination of those dimensions.
...
Table (sources), Line chart (events).

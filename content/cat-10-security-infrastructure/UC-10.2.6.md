<!-- AUTO-GENERATED from UC-10.2.6.json — DO NOT EDIT -->
...
# UC-10.2.6 · Detect New Login Attempts to Routers

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot new login attempts to routers — so we know when protection is off, out of date, or bypassed.*
...
New or scripted admin sessions, automated backups pulling configs, and maintenance windows on network gear can look like first-time or unusual access. Confirm change tickets and on-call work.

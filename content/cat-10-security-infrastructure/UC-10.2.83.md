<!-- AUTO-GENERATED from UC-10.2.83.json — DO NOT EDIT -->
...
# UC-10.2.83 · Remote WMI Command Attempt

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of with the switch, indicating an attempt to spawn a local or remote process — so we know when protection is off, out of date, or bypassed.*

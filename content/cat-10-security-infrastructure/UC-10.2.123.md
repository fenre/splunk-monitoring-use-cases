<!-- AUTO-GENERATED from UC-10.2.123.json — DO NOT EDIT -->
...
# UC-10.2.123 · Windows Masquerading Explorer As Child Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot instances where explorer.exe is spawned by unusual parent processes such as cmd.exe, powershell.exe, or regsvr32.exe — so we know when protection is off, out of date, or bypassed.*

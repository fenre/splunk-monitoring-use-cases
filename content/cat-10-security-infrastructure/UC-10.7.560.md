<!-- AUTO-GENERATED from UC-10.7.560.json — DO NOT EDIT -->
...
# UC-10.7.560 · Windows Multiple Account Passwords Changed

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Multiple Account Passwords Changed" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.2.101.json — DO NOT EDIT -->
...
# UC-10.2.101 · Windows Account Discovery for Sam Account Name

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of the PowerView PowerShell cmdlet Get-NetUser, specifically querying for "samaccountname" and "pwdlastset" attributes — so we know when protection is off, out of date, or bypassed.*

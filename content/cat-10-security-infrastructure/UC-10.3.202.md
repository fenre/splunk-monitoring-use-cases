<!-- AUTO-GENERATED from UC-10.3.202.json — DO NOT EDIT -->
...
# UC-10.3.202 · Linux Indicator Removal Clear Cache

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Indicator Removal Clear Cache” so we can see attacker-style moves—not only a one-off file or password mistake.*

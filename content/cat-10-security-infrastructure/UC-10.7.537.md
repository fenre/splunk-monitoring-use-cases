<!-- AUTO-GENERATED from UC-10.7.537.json — DO NOT EDIT -->
...
# UC-10.7.537 · Windows Handle Duplication in Known UAC-Bypass Binaries

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Handle Duplication in Known UAC-Bypass Binaries" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

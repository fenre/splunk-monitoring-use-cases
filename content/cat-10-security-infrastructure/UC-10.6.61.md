<!-- AUTO-GENERATED from UC-10.6.61.json — DO NOT EDIT -->
...
# UC-10.6.61 · PetitPotam Suspicious Kerberos TGT Request

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects a suspicious Kerberos Ticket Granting Ticket (TGT) request, identified by Event Code 4768, and we use Splunk so the team can see it early and act.*

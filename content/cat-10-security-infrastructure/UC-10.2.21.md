<!-- AUTO-GENERATED from UC-10.2.21.json — DO NOT EDIT -->
...
# UC-10.2.21 · Azure AD Service Principal Authentication

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot authentication events of service principals in Azure Active Directory — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.6.88.json — DO NOT EDIT -->

---
id: "10.6.88"
title: "Windows ESX Admins Group Creation via PowerShell"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.6.88 · Windows ESX Admins Group Creation via PowerShell

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This analytic detects attempts to create an "ESX Admins" group using PowerShell commands, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.7.243.json — DO NOT EDIT -->
...
# UC-10.7.243 · Microsoft Intune Device Health Scripts

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use this 'Microsoft Intune Device Health Scripts' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*

---

## Description

Detects creation or modification of Intune Device Health Scripts, which could be abused for lateral movement from Azure to on-premises Active Directory.
...
```spl
`azure_monitor_aad` operationName="Create deviceHealthScript" OR operationName="Patch deviceHealthScript"

<!-- AUTO-GENERATED from UC-10.3.35.json — DO NOT EDIT -->
...
# UC-10.3.35 · CertUtil With Decode Argument

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “CertUtil With Decode Argument” so we can see attacker-style moves—not only a one-off file or password mistake.*

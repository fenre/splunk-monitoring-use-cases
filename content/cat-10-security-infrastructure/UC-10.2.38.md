<!-- AUTO-GENERATED from UC-10.2.38.json — DO NOT EDIT -->
...
# UC-10.2.38 · DSQuery Domain Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of "dsquery.exe" with arguments targeting queries directly from the command line — so we know when protection is off, out of date, or bypassed.*

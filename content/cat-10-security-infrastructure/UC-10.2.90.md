<!-- AUTO-GENERATED from UC-10.2.90.json — DO NOT EDIT -->
...
# UC-10.2.90 · Schtasks scheduling job on remote system

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the use of 'schtasks.exe' to create a scheduled task on a remote system, indicating potential lateral movement or remote code execution — so we know when protection is off, out of date, or bypassed.*

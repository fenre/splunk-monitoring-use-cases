<!-- AUTO-GENERATED from UC-10.3.177.json — DO NOT EDIT -->
...
# UC-10.3.177 · Linux Clipboard Data Copy

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Clipboard Data Copy” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
- [https://man.archlinux.org/man/xclip.1](https://man.archlinux.org/man/xclip.1)

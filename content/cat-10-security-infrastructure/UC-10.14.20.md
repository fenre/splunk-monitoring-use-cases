...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Security &middot; **Type:** Security, Change

*We compare how the network usually behaves in the plant to today so a creeping change in traffic or talkers rings a bell early.*
...
Baseline drift can be seasonal production, a new line brought online, or a monitoring blind spot (lost tap) — compare to plant schedule and data feeds before a hunt.

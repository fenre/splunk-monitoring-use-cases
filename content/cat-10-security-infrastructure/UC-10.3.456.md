<!-- AUTO-GENERATED from UC-10.3.456.json — DO NOT EDIT -->
...
# UC-10.3.456 · Windows Execute Arbitrary Commands with MSDT

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Execute Arbitrary Commands with MSDT”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.3.579.json — DO NOT EDIT -->
...
# UC-10.3.579 · Windows Powershell Import Applocker Policy

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Powershell Import Applocker Policy”, so we catch real tradecraft and not just noise from everyday work.*

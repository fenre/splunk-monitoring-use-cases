<!-- AUTO-GENERATED from UC-10.7.707.json — DO NOT EDIT -->
...
# UC-10.7.707 · Windows Abused Web Services

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Abused Web Services" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

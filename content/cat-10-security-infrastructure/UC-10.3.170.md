<!-- AUTO-GENERATED from UC-10.3.170.json — DO NOT EDIT -->

---
id: "10.3.170"
title: "Linux Auditd Shred Overwrite Command"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.170 · Linux Auditd Shred Overwrite Command

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Auditd Shred Overwrite Command” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.2.158.json — DO NOT EDIT -->
...
# UC-10.2.158 · Windows Unsigned MS DLL Side-Loading

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot potential DLL side-loading instances involving unsigned DLLs mimicking Microsoft signatures — so we know when protection is off, out of date, or bypassed.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to file entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Sysmon EventID 7 ingested and CIM-normalized.

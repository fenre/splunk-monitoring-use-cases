<!-- AUTO-GENERATED from UC-10.2.35.json — DO NOT EDIT -->
...
# UC-10.2.35 · Detect Renamed PSExec

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot instances where has been renamed and executed on an endpoint — so we know when protection is off, out of date, or bypassed.*

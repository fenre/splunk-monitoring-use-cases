<!-- AUTO-GENERATED from UC-10.7.524.json — DO NOT EDIT -->
...
# UC-10.7.524 · Windows Excessive Disabled Services Event

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Excessive Disabled Services Event" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

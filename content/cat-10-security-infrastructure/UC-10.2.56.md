<!-- AUTO-GENERATED from UC-10.2.56.json — DO NOT EDIT -->

---
id: "10.2.56"
title: "Linux Auditd System Network Configuration Discovery"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.2.56 · Linux Auditd System Network Configuration Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch suspicious system network configuration discovery activities, which may indicate an adversary's attempt to gather information about the network environment — so we know when protection is off, out of date, or bypassed.*

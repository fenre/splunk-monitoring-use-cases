<!-- AUTO-GENERATED from UC-10.3.248.json — DO NOT EDIT -->
...
# UC-10.3.248 · Malicious PowerShell Process - Execution Policy Bypass

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Malicious PowerShell Process - Execution Policy Bypass” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.3.279.json — DO NOT EDIT -->
...
# UC-10.3.279 · Prevent Automatic Repair Mode using Bcdedit

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Prevent Automatic Repair Mode using Bcdedit” so we can see attacker-style moves—not only a one-off file or password mistake.*

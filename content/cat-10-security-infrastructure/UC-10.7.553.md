<!-- AUTO-GENERATED from UC-10.7.553.json — DO NOT EDIT -->
...
# UC-10.7.553 · Windows LOLBAS Executed Outside Expected Path

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows LOLBAS Executed Outside Expected Path" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

---

## Description

This detection identifies Windows LOLBAS Executed Outside Expected Path. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

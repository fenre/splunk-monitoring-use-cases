<!-- AUTO-GENERATED from UC-10.6.35.json — DO NOT EDIT -->
...
# UC-10.6.35 · Attacker Tools On Endpoint

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the execution of tools commonly exploited by cybercriminals, such as those used for unauthorized access, network scanning, or data exfiltration, and we use Splunk so the team can see it early and act.*

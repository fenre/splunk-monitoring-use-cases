<!-- AUTO-GENERATED from UC-10.6.24.json — DO NOT EDIT -->
...
# UC-10.6.24 · Azure AD AzureHound UserAgent Detected

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This detection identifies the presence of the default AzureHound user-agent string within Microsoft Graph Activity logs and NonInteractive SignIn Logs, and we use Splunk so the team can see it early and act.*

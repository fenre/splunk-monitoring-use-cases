<!-- AUTO-GENERATED from UC-10.3.476.json — DO NOT EDIT -->
...
# UC-10.3.476 · Windows Impair Defense Define Win Defender Threat Action

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Impair Defense Define Win Defender Threat Action”, so we catch real tradecraft and not just noise from everyday work.*

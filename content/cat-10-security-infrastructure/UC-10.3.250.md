<!-- AUTO-GENERATED from UC-10.3.250.json — DO NOT EDIT -->
...
# UC-10.3.250 · Mimikatz PassTheTicket CommandLine Parameters

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Mimikatz PassTheTicket CommandLine Parameters” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
Known false positives for this detection: PsExec usage from sysadmin remote management, software deployment, or sanctioned IT troubleshooting.
...
PsExec usage from sysadmin remote management, software deployment, or sanctioned IT troubleshooting.

<!-- AUTO-GENERATED from UC-10.7.421.json — DO NOT EDIT -->
...
# UC-10.7.421 · Rubeus Kerberos Ticket Exports Through Winlogon Access

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Rubeus Kerberos Ticket Exports Through Winlogon Access" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

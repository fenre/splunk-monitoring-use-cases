<!-- AUTO-GENERATED from UC-10.2.37.json — DO NOT EDIT -->
...
# UC-10.2.37 · Domain Account Discovery with Wmic

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of with command-line arguments used to query for domain users — so we know when protection is off, out of date, or bypassed.*

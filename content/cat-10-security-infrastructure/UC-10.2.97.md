<!-- AUTO-GENERATED from UC-10.2.97.json — DO NOT EDIT -->
...
*We spot an unusual number of computer service ticket requests from a single source, leveraging Event ID 4769, "A Kerberos service ticket was requested." It uses statistical analysis, including standard deviation and the 3-sigma rule, to detect anomalies in service ticket requests — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.3.286.json — DO NOT EDIT -->
...
# UC-10.3.286 · Recursive Delete of Directory In Batch CMD

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Recursive Delete of Directory In Batch CMD” so we can see attacker-style moves—not only a one-off file or password mistake.*

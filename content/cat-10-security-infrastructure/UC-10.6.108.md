<!-- AUTO-GENERATED from UC-10.6.108.json — DO NOT EDIT -->
...
# UC-10.6.108 · Windows Query Registry UnInstall Program List

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects an access request on the uninstall registry key, and we use Splunk so the team can see it early and act.*
...
To successfully implement this search, you must ingest Windows Security Event logs and track event code 4663. For Event code 4663, enable the "Audit Object Access" in Group Policy. Then check the two boxes listed for both "Success" and "Failure.

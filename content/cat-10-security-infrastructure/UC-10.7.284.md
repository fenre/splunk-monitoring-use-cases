<!-- AUTO-GENERATED from UC-10.7.284.json — DO NOT EDIT -->
...
# UC-10.7.284 · Detect Copy of ShadowCopy with Script Block Logging

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Detect Copy of ShadowCopy with Script Block Logging so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

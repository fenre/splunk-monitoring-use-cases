<!-- AUTO-GENERATED from UC-10.6.63.json — DO NOT EDIT -->
...
# UC-10.6.63 · Print Spooler Failed to Load a Plug-in

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects driver load errors in the Windows PrintService Admin logs, specifically identifying issues related to (PrintNightmare), and we use Splunk so the team can see it early and act.*

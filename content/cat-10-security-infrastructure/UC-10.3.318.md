<!-- AUTO-GENERATED from UC-10.3.318.json — DO NOT EDIT -->
...
# UC-10.3.318 · Sdelete Application Execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Sdelete Application Execution” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.6.76.json — DO NOT EDIT -->
...
# UC-10.6.76 · Unloading AMSI via Reflection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the tampering of AMSI (Antimalware Scan Interface) using PowerShell reflection, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.3.362.json — DO NOT EDIT -->
...
# UC-10.3.362 · System User Discovery With Whoami

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “System User Discovery With Whoami”, so we catch real tradecraft and not just noise from everyday work.*

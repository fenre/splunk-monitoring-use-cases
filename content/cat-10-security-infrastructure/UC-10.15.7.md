<!-- AUTO-GENERATED from UC-10.15.7.json — DO NOT EDIT -->
...
*We use models to order notables by true urgency so the team works the right ticket next when everything seems loud.*
...
Prioritization models inherit analyst bias in historical labels — the queue can favor past habits over true severity until retrained.

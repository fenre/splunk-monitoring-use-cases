<!-- AUTO-GENERATED from UC-10.6.140.json — DO NOT EDIT -->
...
# UC-10.6.140 · Cisco IOS XE Implant Access

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies the potential exploitation of a vulnerability in the Web User Interface of Cisco IOS XE software, and we use Splunk so the team can see it early and act.*

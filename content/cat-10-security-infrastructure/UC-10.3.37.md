<!-- AUTO-GENERATED from UC-10.3.37.json — DO NOT EDIT -->
...
# UC-10.3.37 · CHCP Command Execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “CHCP Command Execution” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.3.48.json — DO NOT EDIT -->
...
# UC-10.3.48 · Create or delete windows shares using net exe

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Create or delete windows shares using net exe” so we can see attacker-style moves—not only a one-off file or password mistake.*

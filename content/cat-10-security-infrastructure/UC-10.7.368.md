<!-- AUTO-GENERATED from UC-10.7.368.json — DO NOT EDIT -->

---
id: "10.7.368"
title: "Linux Auditd Service Started"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.368 · Linux Auditd Service Started

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Linux Auditd Service Started" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to host or system entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Linux Auditd Proctitle ingested and CIM-normalized.

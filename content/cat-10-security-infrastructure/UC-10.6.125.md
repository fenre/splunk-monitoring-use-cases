<!-- AUTO-GENERATED from UC-10.6.125.json — DO NOT EDIT -->
...
# UC-10.6.125 · WinRM Spawning a Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects suspicious processes spawned by WinRM (wsmprovhost.exe), and we use Splunk so the team can see it early and act.*
...
No false positives have been identified at this time. system management software may spawn processes from `wsmprovhost.exe`.

<!-- AUTO-GENERATED from UC-10.7.327.json — DO NOT EDIT -->

---
id: "10.7.327"
title: "GitHub Workflow File Creation or Modification"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.327 · GitHub Workflow File Creation or Modification

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We watch for unexpected add or change to GitHub Actions workflow files, because that is a common way to sneak a supply-chain or secret-theft step into the pipeline, and we want the team to catch it while it is still reviewable.*

---

## Description

This detection identifies GitHub Workflow File Creation or Modification. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.
...
ESCU Hunting detection — not designed for automated alerting. Run ad-hoc or on a low-frequency schedule from Splunk Enterprise Security for analyst-driven investigation. Requires Sysmon for Linux EventID 11, Sysmon EventID 11 ingested and CIM-normalized.
...
```spl
| tstats summariesonly=t count from datamodel=Endpoint.Filesystem by Filesystem.dest, Filesystem.file_name, Filesystem.user
```
...
CI/CD and developer edits to .github workflow YAML during normal release work; map hits to a repo and merge request before treating as a supply-chain issue.

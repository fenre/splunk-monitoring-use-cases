<!-- AUTO-GENERATED from UC-10.7.552.json — DO NOT EDIT -->
...
# UC-10.7.552 · Windows LOLBAS Executed As Renamed File

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows LOLBAS Executed As Renamed File" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

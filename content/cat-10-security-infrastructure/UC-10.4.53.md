<!-- AUTO-GENERATED from UC-10.4.53.json — DO NOT EDIT -->
...
# UC-10.4.53 · O365 Elevated Mailbox Permission Assigned
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to user account entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires O365 Add-MailboxPermission ingested and CIM-normalized.
...
- [https://learn.microsoft.com/en-us/powershell/module/exchange/add-mailboxpermission](https://learn.microsoft.com/en-us/powershell/module/exchange/add-mailboxpermission)
- [https://learn.microsoft.com/en-us/exchange/recipients/mailbox-permissions?view=exchserver-2019](https://learn.microsoft.com/en-us/exchange/recipients/mailbox-permissions?view=exchserver-2019)

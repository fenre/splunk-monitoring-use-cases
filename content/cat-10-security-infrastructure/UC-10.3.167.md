<!-- AUTO-GENERATED from UC-10.3.167.json — DO NOT EDIT -->

---
id: "10.3.167"
title: "Linux Auditd Hardware Addition Swapoff"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.167 · Linux Auditd Hardware Addition Swapoff

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Auditd Hardware Addition Swapoff” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.7.472.json — DO NOT EDIT -->
...
# UC-10.7.472 · Windows AppLocker Block Events

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows AppLocker Block Events" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.11.123.json — DO NOT EDIT -->

---
id: "10.11.123"
title: "Check Point Quantum IoT Protect Device Discovery"
criticality: "medium"
splunkPillar: "Security"
---

# UC-10.11.123 · Check Point Quantum IoT Protect Device Discovery

> **Criticality:** Medium &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use Check Point data and alerts to stay ahead of the risks described in "Check Point Quantum IoT Protect Device Discovery". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

IoT Protect uses network fingerprinting to automatically discover and classify IoT/OT devices on the network and apply micro-segmentation policies. Tracking discovered device types and policy assignments validates that IoT assets are protected and not bypassing security.
...
- `stats` rolls up events into metrics; results are split **by policy_name, action** so each row reflects one combination of those dimensions.
...
Table (discovered devices), Pie chart (device types), Bar chart (policies applied), Line chart (discovery trend).

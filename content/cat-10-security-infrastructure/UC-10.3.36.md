<!-- AUTO-GENERATED from UC-10.3.36.json — DO NOT EDIT -->
...
# UC-10.3.36 · Change To Safe Mode With Network Config

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Change To Safe Mode With Network Config” so we can see attacker-style moves—not only a one-off file or password mistake.*

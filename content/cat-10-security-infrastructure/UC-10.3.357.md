<!-- AUTO-GENERATED from UC-10.3.357.json — DO NOT EDIT -->
...
# UC-10.3.357 · Suspicious writes to windows Recycle Bin

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Suspicious writes to windows Recycle Bin”, so we catch real tradecraft and not just noise from everyday work.*

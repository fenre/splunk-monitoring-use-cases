<!-- AUTO-GENERATED from UC-10.4.89.json — DO NOT EDIT -->
...
# UC-10.4.89 · O365 Multiple OS Vendors Authenticating From User
...
```spl
`o365_management_activity` Operation IN (UserLoginFailed,UserLoggedIn) "$user$
```
...
- [https://sra.io/blog/msspray-wait-how-many-endpoints-dont-have-mfa/](https://sra.io/blog/msspray-wait-how-many-endpoints-dont-have-mfa/)
- [https://github.com/dafthack/MFASweep/tree/master](https://github.com/dafthack/MFASweep/tree/master)

<!-- AUTO-GENERATED from UC-10.3.470.json — DO NOT EDIT -->
...
# UC-10.3.470 · Windows HTTP Network Communication From MSIExec

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows HTTP Network Communication From MSIExec”, so we catch real tradecraft and not just noise from everyday work.*

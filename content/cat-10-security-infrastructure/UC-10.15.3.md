...
*We use machine learning to notice connections that are too regular in time, a hint of bot-like command and control when human browsing is messier.*
...
Regular beacon-like timing can be health checks, NTP, software updates, or mis-counted long flows — we exclude known infrastructure before calling C2.

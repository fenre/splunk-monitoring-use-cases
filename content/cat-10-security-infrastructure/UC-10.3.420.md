<!-- AUTO-GENERATED from UC-10.3.420.json — DO NOT EDIT -->
...
# UC-10.3.420 · Windows ConHost with Headless Argument

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows ConHost with Headless Argument”, so we catch real tradecraft and not just noise from everyday work.*

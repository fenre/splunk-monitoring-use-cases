<!-- AUTO-GENERATED from UC-10.3.206.json — DO NOT EDIT -->
...
# UC-10.3.206 · Linux Insert Kernel Module Using Insmod Utility

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Insert Kernel Module Using Insmod Utility” so we can see attacker-style moves—not only a one-off file or password mistake.*

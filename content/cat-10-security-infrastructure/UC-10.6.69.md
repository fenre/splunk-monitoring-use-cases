<!-- AUTO-GENERATED from UC-10.6.69.json — DO NOT EDIT -->
...
# UC-10.6.69 · Spoolsv Suspicious Loaded Modules

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the suspicious loading of DLLs by spoolsv.exe, potentially indicating PrintNightmare exploitation, and we use Splunk so the team can see it early and act.*

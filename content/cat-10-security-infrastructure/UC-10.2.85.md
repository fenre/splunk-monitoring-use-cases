<!-- AUTO-GENERATED from UC-10.2.85.json — DO NOT EDIT -->
...
*We catch the use of Rubeus command line parameters, a toolset for Kerberos attacks within Active Directory environments — so we know when protection is off, out of date, or bypassed.*

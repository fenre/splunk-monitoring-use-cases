<!-- AUTO-GENERATED from UC-10.3.255.json — DO NOT EDIT -->
...
# UC-10.3.255 · MSBuild Suspicious Spawned By Script Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “MSBuild Suspicious Spawned By Script Process” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.7.399.json — DO NOT EDIT -->
...
# UC-10.7.399 · Non Chrome Process Accessing Chrome Default Dir

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Non Chrome Process Accessing Chrome Default Dir" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.2.116.json — DO NOT EDIT -->
...
# UC-10.2.116 · Windows Find Domain Organizational Units with GetDomainOU

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of the cmdlet, a part of the PowerView toolkit used for Windows domain enumeration — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.9.58.json — DO NOT EDIT -->

---
id: "10.9.58"
title: "Kimsuky credential phishing"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.9.58 · Kimsuky credential phishing

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use our security program’s detections to catch activity tied to “Kimsuky credential phishing” when someone tries that attacker move in our environment, so we can respond before the damage spreads.*

---

## Description

This detection aligns with ESCU 2025–2026 analytic story coverage for: Kimsuky credential phishing. Phishing and macro tradecraft associated with Kimsuky.
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Email gateway, EDR ingested and CIM-normalized.

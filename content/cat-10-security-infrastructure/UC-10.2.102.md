<!-- AUTO-GENERATED from UC-10.2.102.json — DO NOT EDIT -->
...
# UC-10.2.102 · Windows AD Privileged Object Access Activity

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch access attempts to privileged Active Directory objects, such as Domain Admins or Enterprise Admins — so we know when protection is off, out of date, or bypassed.*

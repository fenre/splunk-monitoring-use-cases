<!-- AUTO-GENERATED from UC-10.3.226.json — DO NOT EDIT -->
...
# UC-10.3.226 · Linux Proxy Socks Curl

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Proxy Socks Curl” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
- [https://reqbin.com/req/c-ddxflki5/curl-proxy-server#:~:text=To%20use%20a%20proxy%20with](https://reqbin.com/req/c-ddxflki5/curl-proxy-server#:~:text=To%20use%20a%20proxy%20with)

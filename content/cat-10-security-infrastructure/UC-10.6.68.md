<!-- AUTO-GENERATED from UC-10.6.68.json — DO NOT EDIT -->
...
# UC-10.6.68 · Spoolsv Spawning Rundll32

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the spawning of without command-line arguments by, which is unusual and potentially indicative of exploitation attempts like (PrintNightmare), and we use Splunk so the team can see it early and act.*

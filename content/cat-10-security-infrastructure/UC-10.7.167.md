<!-- AUTO-GENERATED from UC-10.7.167.json — DO NOT EDIT -->
...
# UC-10.7.167 · Azure AD User Consent Blocked for Risky Application

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD User Consent Blocked for Risky Application so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

<!-- AUTO-GENERATED from UC-10.7.419.json — DO NOT EDIT -->
...
# UC-10.7.419 · Recon Using WMI Class

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Recon Using WMI Class" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

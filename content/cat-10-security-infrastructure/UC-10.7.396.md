<!-- AUTO-GENERATED from UC-10.7.396.json — DO NOT EDIT -->
...
# UC-10.7.396 · Malicious Powershell Executed As A Service

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Malicious Powershell Executed As A Service" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.14.9.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Advanced &middot; **Pillar:** Security &middot; **Type:** Security, Change, Compliance

*We alert on surprise firmware or program uploads to field devices so malware or mis-uploads do not land on real gear.*
...
- `stats` rolls up events into metrics; results are split **by device_id, user, src** so each row reflects one combination of those dimensions.
...
Planned controller updates, golden-image restores, and OEM firmware refreshes can look like surprise uploads when they are change-controlled — use maintenance tickets to validate.

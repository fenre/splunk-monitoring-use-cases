<!-- AUTO-GENERATED from UC-10.7.296.json — DO NOT EDIT -->
...
# UC-10.7.296 · Detect Renamed 7-Zip

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for the behavior in “Detect Renamed 7-Zip” using the same log fields the detection already uses, so the team can act before impact spreads.*
...
Renamed or side-loaded 7-Zip from app packaging, software deployment tools, and portable admin kits; reconcile with software inventory and parent process.

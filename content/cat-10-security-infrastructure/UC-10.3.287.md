<!-- AUTO-GENERATED from UC-10.3.287.json — DO NOT EDIT -->
...
# UC-10.3.287 · Reg exe Manipulating Windows Services Registry Keys

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Reg exe Manipulating Windows Services Registry Keys” so we can see attacker-style moves—not only a one-off file or password mistake.*

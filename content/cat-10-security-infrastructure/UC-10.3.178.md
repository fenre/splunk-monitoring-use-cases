<!-- AUTO-GENERATED from UC-10.3.178.json — DO NOT EDIT -->
...
# UC-10.3.178 · Linux Common Process For Elevation Control

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Common Process For Elevation Control” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.3.641.json — DO NOT EDIT -->

---
id: "10.3.641"
title: "Windows System Remote Discovery With Query"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.641 · Windows System Remote Discovery With Query

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows System Remote Discovery With Query”, so we catch real tradecraft and not just noise from everyday work.*
...
```spl
| from datamodel:Endpoint.Processes | search dest=$dest$ process_name = $process_name|s$
```

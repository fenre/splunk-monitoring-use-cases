<!-- AUTO-GENERATED from UC-10.6.148.json — DO NOT EDIT -->
...
# UC-10.6.148 · ConnectWise ScreenConnect Authentication Bypass

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit the ConnectWise ScreenConnect vulnerability, which allows attackers to bypass authentication using an alternate path or channel, and we use Splunk so the team can see it early and act.*

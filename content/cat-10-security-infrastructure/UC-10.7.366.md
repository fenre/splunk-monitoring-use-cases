<!-- AUTO-GENERATED from UC-10.7.366.json — DO NOT EDIT -->

---
id: "10.7.366"
title: "Linux Auditd Preload Hijack Via Preload File"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.366 · Linux Auditd Preload Hijack Via Preload File

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Linux Auditd Preload Hijack Via Preload File" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

---

## Description

This detection identifies Linux Auditd Preload Hijack Via Preload File. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

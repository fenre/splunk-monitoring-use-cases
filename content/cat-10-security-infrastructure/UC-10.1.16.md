<!-- AUTO-GENERATED from UC-10.1.16.json — DO NOT EDIT -->
...
# UC-10.1.16 · Cisco ASA - Reconnaissance Command Activity

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This detection identifies Cisco ASA - Reconnaissance Command Activity — so we know when protection is off, out of date, or bypassed.*

---

## Description

This detection identifies Cisco ASA - Reconnaissance Command Activity. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.
...
- [https://www.cisco.com/c/en/us/td/docs/security/asa/asa-cli-reference/S/asa-command-ref-S/sa-shov-commands.html](https://www.cisco.com/c/en/us/td/docs/security/asa/asa-cli-reference/S/asa-command-ref-S/sa-shov-commands.html)

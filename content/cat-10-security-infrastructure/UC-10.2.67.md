<!-- AUTO-GENERATED from UC-10.2.67.json — DO NOT EDIT -->
...
# UC-10.2.67 · PowerShell Get LocalGroup Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot the use of the command executed using PowerShell or cmd.exe to enumerate local groups on an endpoint — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.7.440.json — DO NOT EDIT -->
...
# UC-10.7.440 · Windows AD Dangerous Group ACL Modification

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Dangerous Group ACL Modification" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
- [https://learn.microsoft.com/en-us/windows/win32/secauthz/ace-strings](https://learn.microsoft.com/en-us/windows/win32/secauthz/ace-strings)

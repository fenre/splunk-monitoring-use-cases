...
*We track patch and hardening work on critical systems so we can show the board and the regulator the real backlog, not a guess.*
...
Patch compliance percentages dip during freeze windows, vendor slip on OT gear, and emergency break-fix — the trend matters more than a single point.

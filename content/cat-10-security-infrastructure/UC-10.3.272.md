<!-- AUTO-GENERATED from UC-10.3.272.json — DO NOT EDIT -->
...
# UC-10.3.272 · Powershell Execute COM Object

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Powershell Execute COM Object” so we can see attacker-style moves—not only a one-off file or password mistake.*

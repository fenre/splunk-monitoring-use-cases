<!-- AUTO-GENERATED from UC-10.3.368.json — DO NOT EDIT -->
...
# UC-10.3.368 · Unload Sysmon Filter Driver

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Unload Sysmon Filter Driver”, so we catch real tradecraft and not just noise from everyday work.*

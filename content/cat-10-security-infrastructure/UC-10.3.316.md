<!-- AUTO-GENERATED from UC-10.3.316.json — DO NOT EDIT -->
...
# UC-10.3.316 · Script Execution via WMI

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Script Execution via WMI” so we can see attacker-style moves—not only a one-off file or password mistake.*

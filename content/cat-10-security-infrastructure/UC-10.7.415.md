<!-- AUTO-GENERATED from UC-10.7.415.json — DO NOT EDIT -->
...
# UC-10.7.415 · Powershell Using memory As Backing Store

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Powershell Using memory As Backing Store" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

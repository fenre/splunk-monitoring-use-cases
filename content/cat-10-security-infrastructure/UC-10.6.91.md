<!-- AUTO-GENERATED from UC-10.6.91.json — DO NOT EDIT -->
...
*The following analytic identifies the execution of the PowerShell cmdlet Get-WebGlobalModule, which lists all IIS Modules installed on a system, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.6.93.json — DO NOT EDIT -->
...
# UC-10.6.93 · Windows Impair Defense Change Win Defender Health Check Intervals

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects modifications to the Windows registry that change the health check interval of Windows Defender, and we use Splunk so the team can see it early and act.*

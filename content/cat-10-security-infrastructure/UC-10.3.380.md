<!-- AUTO-GENERATED from UC-10.3.380.json — DO NOT EDIT -->
...
# UC-10.3.380 · Windows Admon Default Group Policy Object Modified

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Admon Default Group Policy Object Modified”, so we catch real tradecraft and not just noise from everyday work.*
...
- [https://help.splunk.com/en/splunk-cloud-platform/get-started/get-data-in/9.3.2411/get-windows-data/monitor-active-directory](https://help.splunk.com/en/splunk-cloud-platform/get-started/get-data-in/9.3.2411/get-windows-data/monitor-active-directory)

<!-- AUTO-GENERATED from UC-10.3.488.json — DO NOT EDIT -->
...
# UC-10.3.488 · Windows Impair Defense Set Win Defender Smart Screen Level To Warn

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Impair Defense Set Win Defender Smart Screen Level To Warn”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.3.302.json — DO NOT EDIT -->
...
# UC-10.3.302 · Rundll32 Process Creating Exe Dll Files

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Rundll32 Process Creating Exe Dll Files” so we can see attacker-style moves—not only a one-off file or password mistake.*

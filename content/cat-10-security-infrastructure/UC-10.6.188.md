<!-- AUTO-GENERATED from UC-10.6.188.json — DO NOT EDIT -->
...
# UC-10.6.188 · Web Spring4Shell HTTP Request Class Module

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects HTTP requests containing payloads related to the Spring4Shell vulnerability, and we use Splunk so the team can see it early and act.*

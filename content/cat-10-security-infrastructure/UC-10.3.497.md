<!-- AUTO-GENERATED from UC-10.3.497.json — DO NOT EDIT -->
...
# UC-10.3.497 · Windows Ingress Tool Transfer Using Explorer

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Ingress Tool Transfer Using Explorer”, so we catch real tradecraft and not just noise from everyday work.*

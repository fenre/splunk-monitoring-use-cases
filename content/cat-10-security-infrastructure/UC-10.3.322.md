<!-- AUTO-GENERATED from UC-10.3.322.json — DO NOT EDIT -->
...
# UC-10.3.322 · Services Escalate Exe

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Services Escalate Exe” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.7.257.json — DO NOT EDIT -->

---
id: "10.7.257"
title: "Cisco Isovalent - Nsenter Usage in Kubernetes Pod"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.257 · Cisco Isovalent - Nsenter Usage in Kubernetes Pod

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Cisco Isovalent - Nsenter Usage in Kubernetes Pod so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

---

## Description

This detection identifies Cisco Isovalent - Nsenter Usage in Kubernetes Pod. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.
...
- [https://isovalent.com/blog/post/2021-11-container-escape/](https://isovalent.com/blog/post/2021-11-container-escape/)
- [https://kubehound.io/reference/attacks/CE_NSENTER/](https://kubehound.io/reference/attacks/CE_NSENTER/)

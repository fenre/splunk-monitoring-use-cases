<!-- AUTO-GENERATED from UC-10.3.260.json — DO NOT EDIT -->
...
# UC-10.3.260 · Network Connection Discovery With Netstat

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Network Connection Discovery With Netstat” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.3.500.json — DO NOT EDIT -->
...
# UC-10.3.500 · Windows InstallUtil Uninstall Option

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows InstallUtil Uninstall Option”, so we catch real tradecraft and not just noise from everyday work.*

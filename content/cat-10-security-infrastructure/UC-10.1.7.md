<!-- AUTO-GENERATED from UC-10.1.7.json — DO NOT EDIT -->
...
# UC-10.1.7 · Cisco ASA - AAA Policy Tampering

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This detection identifies Cisco ASA - AAA Policy Tampering — so we know when protection is off, out of date, or bypassed.*

---

## Description

This detection identifies Cisco ASA - AAA Policy Tampering. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.
...
- [https://www.cisco.com/c/en/us/td/docs/security/asa/asa-cli-reference/A-H/asa-command-ref-A-H/aa-ac-commands.html](https://www.cisco.com/c/en/us/td/docs/security/asa/asa-cli-reference/A-H/asa-command-ref-A-H/aa-ac-commands.html)

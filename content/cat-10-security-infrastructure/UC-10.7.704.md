<!-- AUTO-GENERATED from UC-10.7.704.json — DO NOT EDIT -->
...
# UC-10.7.704 · Protocols passing authentication in cleartext

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Protocols passing authentication in cleartext" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

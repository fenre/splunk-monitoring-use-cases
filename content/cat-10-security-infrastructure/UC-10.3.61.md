<!-- AUTO-GENERATED from UC-10.3.61.json — DO NOT EDIT -->
...
# UC-10.3.61 · Detect HTML Help URL in Command Line

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Detect HTML Help URL in Command Line” so we can see attacker-style moves—not only a one-off file or password mistake.*

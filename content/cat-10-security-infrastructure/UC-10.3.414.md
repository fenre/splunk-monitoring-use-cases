<!-- AUTO-GENERATED from UC-10.3.414.json — DO NOT EDIT -->
...
# UC-10.3.414 · Windows Cmdline Tool Execution From Non-Shell Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Cmdline Tool Execution From Non-Shell Process”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.7.245.json — DO NOT EDIT -->

---
id: "10.7.245"
title: "Microsoft Intune Manual Device Management"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.245 · Microsoft Intune Manual Device Management

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use this 'Microsoft Intune Manual Device Management' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*

---

## Description

Detects manual device management actions in Microsoft Intune such as wipe, retire, or restart, which could indicate an attacker or insider abusing device management capabilities to disrupt endpoints.
...
```spl
`azure_monitor_aad` operationName="wipe managedDevice" OR operationName="retire managedDevice" OR operationName="shutdown managedDevice" OR operationName="rebootNow managedDevice"
...
Intune and Entra device actions during fleet refresh, wipe, and policy pushes; require owner confirmation for high-impact actions.

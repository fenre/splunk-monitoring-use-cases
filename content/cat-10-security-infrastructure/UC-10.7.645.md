<!-- AUTO-GENERATED from UC-10.7.645.json — DO NOT EDIT -->
...
# UC-10.7.645 · Windows Symlink Evaluation Change via Fsutil

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Symlink Evaluation Change via Fsutil" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

---

## Description

This detection identifies Windows Symlink Evaluation Change via Fsutil. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.
...
- [https://learn.microsoft.com/windows-server/administration/windows-commands/fsutil-behavior](https://learn.microsoft.com/windows-server/administration/windows-commands/fsutil-behavior)
- [https://www.group-ib.com/blog/blackcat/](https://www.group-ib.com/blog/blackcat/)

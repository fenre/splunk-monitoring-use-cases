<!-- AUTO-GENERATED from UC-10.3.327.json — DO NOT EDIT -->
...
# UC-10.3.327 · SLUI Spawning a Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “SLUI Spawning a Process” so we can see attacker-style moves—not only a one-off file or password mistake.*

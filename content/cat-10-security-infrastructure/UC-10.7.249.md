<!-- AUTO-GENERATED from UC-10.7.249.json — DO NOT EDIT -->
...
# UC-10.7.249 · Access LSASS Memory for Dump Creation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Access LSASS Memory for Dump Creation so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

<!-- AUTO-GENERATED from UC-10.7.667.json — DO NOT EDIT -->
...
# UC-10.7.667 · WinEvent Scheduled Task Created to Spawn Shell

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "WinEvent Scheduled Task Created to Spawn Shell" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

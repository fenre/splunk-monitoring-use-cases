<!-- AUTO-GENERATED from UC-10.2.44.json — DO NOT EDIT -->
...
# UC-10.2.44 · Executable File Written in Administrative SMB Share

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch executable files (.exe or.dll) being written to Windows administrative SMB shares (Admin$, IPC$, C$) — so we know when protection is off, out of date, or bypassed.*

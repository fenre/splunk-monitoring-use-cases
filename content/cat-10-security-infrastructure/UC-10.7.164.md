<!-- AUTO-GENERATED from UC-10.7.164.json — DO NOT EDIT -->
...
*We look for Azure AD Successful PowerShell Authentication so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

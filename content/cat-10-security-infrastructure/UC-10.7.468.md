<!-- AUTO-GENERATED from UC-10.7.468.json — DO NOT EDIT -->
...
# UC-10.7.468 · Windows Alternate DataStream - Executable Content

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Alternate DataStream - Executable Content" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.7.166.json — DO NOT EDIT -->
...
*We look for Azure AD Tenant Wide Admin Consent Granted so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

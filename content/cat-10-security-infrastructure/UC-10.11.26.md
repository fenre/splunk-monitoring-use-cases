<!-- AUTO-GENERATED from UC-10.11.26.json — DO NOT EDIT -->

---
id: "10.11.26"
title: "Palo Alto User-ID Mapping Failures"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.11.26 · Palo Alto User-ID Mapping Failures

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use Palo Alto Networks firewall data and alerts to stay ahead of the risks described in "Palo Alto User-ID Mapping Failures". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

User-ID gaps weaken policy enforcement and logging attribution for investigations.
...
- `stats` rolls up events into metrics; results are split **by datasource, ip, message** so each row reflects one combination of those dimensions.

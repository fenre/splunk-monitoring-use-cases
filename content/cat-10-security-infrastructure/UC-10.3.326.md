<!-- AUTO-GENERATED from UC-10.3.326.json — DO NOT EDIT -->
...
# UC-10.3.326 · SLUI RunAs Elevated

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “SLUI RunAs Elevated” so we can see attacker-style moves—not only a one-off file or password mistake.*

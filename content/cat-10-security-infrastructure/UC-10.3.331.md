<!-- AUTO-GENERATED from UC-10.3.331.json — DO NOT EDIT -->
...
# UC-10.3.331 · Suspicious Curl Network Connection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Suspicious Curl Network Connection” so we can see attacker-style moves—not only a one-off file or password mistake.*

...
*We use endpoint security telemetry to stay ahead of the behavior this rule calls “User Discovery With Env Vars PowerShell Script Block”, so we catch real tradecraft and not just noise from everyday work.*

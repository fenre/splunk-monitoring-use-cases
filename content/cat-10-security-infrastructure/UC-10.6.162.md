<!-- AUTO-GENERATED from UC-10.6.162.json — DO NOT EDIT -->
...
# UC-10.6.162 · Ivanti Connect Secure SSRF in SAML Component

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies POST requests targeting endpoints vulnerable to the SSRF issue in Ivanti's products, and we use Splunk so the team can see it early and act.*
...
- [https://attackerkb.com/topics/FGlK1TVnB2/cve-2024-21893](https://attackerkb.com/topics/FGlK1TVnB2/cve-2024-21893)

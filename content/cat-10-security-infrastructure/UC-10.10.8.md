<!-- AUTO-GENERATED from UC-10.10.8.json — DO NOT EDIT -->
...
*We measure how long it takes a human to own a triaged item so we can staff and fix bottlenecks with data.*
...
### Step 3 — Validate
Compare a handful of notables in **Incident Review** to the raw `notable` events and timestamps used in the search so triage seconds match the analyst story you remember.
...
Triage time can blow out during shift handoffs, holiday weekends, or large incident bursts — that is an operations effect, not always a bad detection.

<!-- AUTO-GENERATED from UC-10.2.23.json — DO NOT EDIT -->
...
# UC-10.2.23 · Circle CI Disable Security Job

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the disabling of security jobs in CircleCI pipelines — so we know when protection is off, out of date, or bypassed.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to user account entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires CircleCI ingested and CIM-normalized.

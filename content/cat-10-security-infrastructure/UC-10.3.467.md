<!-- AUTO-GENERATED from UC-10.3.467.json — DO NOT EDIT -->
...
# UC-10.3.467 · Windows Hidden Schedule Task Settings

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Hidden Schedule Task Settings”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.3.145.json — DO NOT EDIT -->
...
# UC-10.3.145 · GetWmiObject Ds Group with PowerShell

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “GetWmiObject Ds Group with PowerShell” so we can see attacker-style moves—not only a one-off file or password mistake.*

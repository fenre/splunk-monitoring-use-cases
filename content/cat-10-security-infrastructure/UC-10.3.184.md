<!-- AUTO-GENERATED from UC-10.3.184.json — DO NOT EDIT -->
...
# UC-10.3.184 · Linux DD File Overwrite

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux DD File Overwrite” so we can see attacker-style moves—not only a one-off file or password mistake.*

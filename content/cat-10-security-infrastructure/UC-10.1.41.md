<!-- AUTO-GENERATED from UC-10.1.41.json — DO NOT EDIT -->
...
# UC-10.1.41 · Windows Remote Services Allow Rdp In Firewall

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects modifications to the Windows firewall to enable Remote Desktop Protocol (remote desktop) on a targeted machine — so we know when protection is off, out of date, or bypassed.*

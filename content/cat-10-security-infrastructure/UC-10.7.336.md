<!-- AUTO-GENERATED from UC-10.7.336.json — DO NOT EDIT -->
...
# UC-10.7.336 · Kerberos Service Ticket Request Using RC4 Encryption

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Kerberos Service Ticket Request Using RC4 Encryption so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

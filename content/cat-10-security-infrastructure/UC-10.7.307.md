<!-- AUTO-GENERATED from UC-10.7.307.json — DO NOT EDIT -->
...
# UC-10.7.307 · Excessive Usage Of Cacls App

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Excessive Usage Of Cacls App so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

---

## Description

This detection identifies Excessive Usage Of Cacls App. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

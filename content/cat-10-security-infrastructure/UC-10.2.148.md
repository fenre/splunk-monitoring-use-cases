<!-- AUTO-GENERATED from UC-10.2.148.json — DO NOT EDIT -->
...
# UC-10.2.148 · Windows Service Initiation on Remote Endpoint

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of with command-line arguments used to start a Windows Service on a remote endpoint — so we know when protection is off, out of date, or bypassed.*

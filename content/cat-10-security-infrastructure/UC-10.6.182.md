<!-- AUTO-GENERATED from UC-10.6.182.json — DO NOT EDIT -->
...
# UC-10.6.182 · Unusually Long Content-Type Length

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies unusually long strings in the Content-Type HTTP header sent by the client to the server, and we use Splunk so the team can see it early and act.*
...
```spl
`stream_http` | eval cs_content_type_length = len(cs_content_type)

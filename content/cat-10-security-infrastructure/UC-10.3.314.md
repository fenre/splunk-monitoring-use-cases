<!-- AUTO-GENERATED from UC-10.3.314.json — DO NOT EDIT -->
...
# UC-10.3.314 · Schtasks used for forcing a reboot

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Schtasks used for forcing a reboot” so we can see attacker-style moves—not only a one-off file or password mistake.*

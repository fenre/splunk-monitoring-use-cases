<!-- AUTO-GENERATED from UC-10.10.6.json — DO NOT EDIT -->
...
*We compare our home-built rules to the shipped baseline so we do not double-pay effort or miss what the community already fixed.*
...
### Step 3 — Validate
Pick one rule that exists in both custom and shipped form and **diff schedules, data scope, and naming** in Content Management so the comparison is really apples to apples.
...
Side-by-side mismatches from different schedules, dev-only copies, or renamed rules can look worse than the real health of custom versus baseline content when time ranges or scopes do not line up.

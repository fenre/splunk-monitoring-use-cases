<!-- AUTO-GENERATED from UC-10.11.94.json — DO NOT EDIT -->

---
id: "10.11.94"
title: "Palo Alto Log Forwarding and SIEM Connectivity"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.11.94 · Palo Alto Log Forwarding and SIEM Connectivity

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use Palo Alto Networks firewall data and alerts to stay ahead of the risks described in "Palo Alto Log Forwarding and SIEM Connectivity". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

Log forwarding health ensures NGFW events reach Splunk without silent drops.
...
- `stats` rolls up events into metrics; results are split **by profile, destination** so each row reflects one combination of those dimensions.
...
Table (destinations), Timeline.

## Known False Positives

Palo Alto matches from certificate-pinned clients, health checks, or SSL-decryption exception paths that are expected under your policy; verify against Panorama and change tickets.

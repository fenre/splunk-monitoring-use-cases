<!-- AUTO-GENERATED from UC-10.7.162.json — DO NOT EDIT -->
...
# UC-10.7.162 · Azure AD Service Principal Owner Added

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD Service Principal Owner Added so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

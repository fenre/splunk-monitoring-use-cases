<!-- AUTO-GENERATED from UC-10.6.134.json — DO NOT EDIT -->

---
id: "10.6.134"
title: "Internal Horizontal Port Scan NMAP Top 20"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.6.134 · Internal Horizontal Port Scan NMAP Top 20

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This analytic identifies instances where an internal host has attempted to communicate with 250 or more destination IP addresses using on of the NMAP top 20 ports, and we use Splunk so the team can see it early and act.*

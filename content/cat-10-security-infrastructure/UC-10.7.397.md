<!-- AUTO-GENERATED from UC-10.7.397.json — DO NOT EDIT -->
...
# UC-10.7.397 · MS Scripting Process Loading Ldap Module

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "MS Scripting Process Loading Ldap Module" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

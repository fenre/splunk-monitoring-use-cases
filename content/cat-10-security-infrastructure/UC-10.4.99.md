<!-- AUTO-GENERATED from UC-10.4.99.json — DO NOT EDIT -->
...
# UC-10.4.99 · O365 OAuth App Mailbox Access via Graph API
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to user account entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires O365 MailItemsAccessed ingested and CIM-normalized.

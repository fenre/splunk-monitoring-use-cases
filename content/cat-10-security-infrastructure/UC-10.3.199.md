<!-- AUTO-GENERATED from UC-10.3.199.json — DO NOT EDIT -->
...
# UC-10.3.199 · Linux Hardware Addition SwapOff

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Hardware Addition SwapOff” so we can see attacker-style moves—not only a one-off file or password mistake.*

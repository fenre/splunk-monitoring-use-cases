<!-- AUTO-GENERATED from UC-10.3.208.json — DO NOT EDIT -->
...
# UC-10.3.208 · Linux Kernel Module Enumeration

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Kernel Module Enumeration” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
- [https://man.archlinux.org/man/kmod.8](https://man.archlinux.org/man/kmod.8)

<!-- AUTO-GENERATED from UC-10.7.464.json — DO NOT EDIT -->
...
# UC-10.7.464 · Windows AD Short Lived Server Object

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Short Lived Server Object" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

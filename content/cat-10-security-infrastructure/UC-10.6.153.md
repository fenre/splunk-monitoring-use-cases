<!-- AUTO-GENERATED from UC-10.6.153.json — DO NOT EDIT -->
...
# UC-10.6.153 · Detect malicious requests to exploit JBoss servers

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies malicious HTTP requests targeting the jmx-console in JBoss servers, and we use Splunk so the team can see it early and act.*

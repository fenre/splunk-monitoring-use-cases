<!-- AUTO-GENERATED from UC-10.9.11.json — DO NOT EDIT -->
...
# UC-10.9.11 · LLM API key exposure

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use our security program’s detections to catch activity tied to “LLM API key exposure” when someone tries that attacker move in our environment, so we can respond before the damage spreads.*

---

## Description

This detection aligns with ESCU 2025–2026 analytic story coverage for: LLM API key exposure. Correlates secrets scanners or repo events with LLM provider API key patterns.
...
ESCU Hunting detection — not designed for automated alerting. Run ad-hoc or on a low-frequency schedule from Splunk Enterprise Security for analyst-driven investigation. Requires Secret scanning, Git, CI/CD, cloud IAM ingested and CIM-normalized.

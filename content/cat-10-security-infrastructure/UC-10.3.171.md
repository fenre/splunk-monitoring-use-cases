...
*We use endpoint and security-agent signals around “Linux Auditd Stop Services” so we can see attacker-style moves—not only a one-off file or password mistake.*

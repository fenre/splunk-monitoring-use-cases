<!-- AUTO-GENERATED from UC-10.3.235.json — DO NOT EDIT -->
...
# UC-10.3.235 · Linux Shred Overwrite Command

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Shred Overwrite Command” so we can see attacker-style moves—not only a one-off file or password mistake.*

...
*We watch DLP on web and upload paths so sensitive data is not exfiltrated inappropriately and compliance has evidence.*
...
DLP hits from authorized exports, scheduled finance or HR reports, or template e-mails with test PII; correlate with the data owner and business process.

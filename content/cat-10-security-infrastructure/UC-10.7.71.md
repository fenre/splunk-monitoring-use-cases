<!-- AUTO-GENERATED from UC-10.7.71.json — DO NOT EDIT -->
...
# UC-10.7.71 · Abnormally High Number Of Cloud Instances Destroyed

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for the behavior in “Abnormally High Number Of Cloud Instances Destroyed” using the same log fields the detection already uses, so the team can act before impact spreads.*
...
ESCU detection using the Change CIM and accelerated data model summaries. Enable in Content Management, enable DMA for the referenced dataset, and tune scope for your environment.
...
Autoscaling, spot fleet churn, and service accounts in CI pipelines can create bursts of create or destroy; filter known automation roles and use business hours baselines.

...
*We use endpoint and security-agent signals around “Network Connection Discovery With Arp” so we can see attacker-style moves—not only a one-off file or password mistake.*

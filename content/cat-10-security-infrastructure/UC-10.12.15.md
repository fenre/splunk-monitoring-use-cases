<!-- AUTO-GENERATED from UC-10.12.15.json — DO NOT EDIT -->

---
id: "10.12.15"
title: "PCI Scope Validation"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.12.15 · PCI Scope Validation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Compliance

*In Financial Services, we pay close attention to "PCI Scope Validation" in our day-to-day work so that fraud, waste, and compliance issues do not slip by quietly. We help teams focus on the few situations that need a person, not every routine blip in the data.*

---

## Description

Confirms only in-scope networks and flows touch CHD; catches scope creep from misrouted traffic.
...
Sankey (zone flows), Table (out-of-scope hits), Map (external sources).

## Known False Positives

PCI scoping from legacy Netflow or duplicate assets can distort counts; re-baseline when network segments and tags are updated.

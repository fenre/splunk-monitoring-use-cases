<!-- AUTO-GENERATED from UC-10.3.157.json — DO NOT EDIT -->
...
# UC-10.3.157 · Linux Add Files In Known Crontab Directories

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Add Files In Known Crontab Directories” so we can see attacker-style moves—not only a one-off file or password mistake.*

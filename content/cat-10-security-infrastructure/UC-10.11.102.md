<!-- AUTO-GENERATED from UC-10.11.102.json — DO NOT EDIT -->

---
id: "10.11.102"
title: "CrowdStrike File Integrity Monitoring Alerts"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.11.102 · CrowdStrike File Integrity Monitoring Alerts

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use CrowdStrike data and alerts to stay ahead of the risks described in "CrowdStrike File Integrity Monitoring Alerts". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

FIM alerts catch persistence and tampering on servers and domain controllers.
...
- `stats` rolls up events into metrics; results are split **by path, hostname** so each row reflects one combination of those dimensions.

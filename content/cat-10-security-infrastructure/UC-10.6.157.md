<!-- AUTO-GENERATED from UC-10.6.157.json — DO NOT EDIT -->
...
# UC-10.6.157 · Fortinet Appliance Auth bypass

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit, a Fortinet appliance authentication bypass vulnerability, and we use Splunk so the team can see it early and act.*
...
- [https://attackerkb.com/topics/QWOxGIKkGx/cve-2022-40684](https://attackerkb.com/topics/QWOxGIKkGx/cve-2022-40684)

<!-- AUTO-GENERATED from UC-10.11.21.json — DO NOT EDIT -->
...
*We use Palo Alto Networks firewall data and alerts to stay ahead of the risks described in "Palo Alto Zone-Based Firewall Violations". We help the team notice trouble early, while a situation is still small and containable.*
...
- `stats` rolls up events into metrics; results are split **by src_zone, dst_zone, rule** so each row reflects one combination of those dimensions.

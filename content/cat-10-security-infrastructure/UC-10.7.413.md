<!-- AUTO-GENERATED from UC-10.7.413.json — DO NOT EDIT -->
...
# UC-10.7.413 · Powershell Processing Stream Of Data

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Powershell Processing Stream Of Data" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

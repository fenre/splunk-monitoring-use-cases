<!-- AUTO-GENERATED from UC-10.7.386.json — DO NOT EDIT -->
...
# UC-10.7.386 · Linux Possible Ssh Key File Creation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Linux Possible Ssh Key File Creation" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

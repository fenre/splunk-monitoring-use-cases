<!-- AUTO-GENERATED from UC-10.7.701.json — DO NOT EDIT -->
...
# UC-10.7.701 · Large Volume of DNS ANY Queries

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on a large volume of ANY queries, which may indicate a amplification attack so unusual activity is visible early — before it spreads or hides in normal noise.*

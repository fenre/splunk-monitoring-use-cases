<!-- AUTO-GENERATED from UC-10.12.12.json — DO NOT EDIT -->
...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Security &middot; **Type:** Compliance, Trading

*In Financial Services, we pay close attention to "Order Execution Anomaly Detection" in our day-to-day work so that fraud, waste, and compliance issues do not slip by quietly. We help teams focus on the few situations that need a person, not every routine blip in the data.*
...
Order-throttling and circuit-breaker traffic during volatility, auction opens, and algorithm tuning; expected under risk committee rules.

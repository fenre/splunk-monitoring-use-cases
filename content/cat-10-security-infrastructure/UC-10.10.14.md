...
*We watch scan run-time and success so a broken agent or full disk does not look like a clean bill of health.*
...
Scan time spikes on large images, first full baselines, storage contention, or maintenance windows can look like a broken scanner when the system is just doing more work.

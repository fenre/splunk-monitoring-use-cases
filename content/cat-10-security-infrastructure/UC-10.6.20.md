<!-- AUTO-GENERATED from UC-10.6.20.json — DO NOT EDIT -->
...
# UC-10.6.20 · AWS ECR Container Scanning Findings High

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies high-severity findings from AWS Elastic Container Registry (ECR) image scans, and we use Splunk so the team can see it early and act.*

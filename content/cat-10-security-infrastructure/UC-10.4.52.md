<!-- AUTO-GENERATED from UC-10.4.52.json — DO NOT EDIT -->
...
# UC-10.4.52 · O365 DLP Rule Triggered
...
| tstats `summariesonly` count
  ...
  by All_Email.recipient All_Email.signature span=1h
| sort -count
```
...
DLP from legitimate finance, HR, and legal data movement to approved vendors, partners, and regulators; migrations to cloud DLP in ‘audit only’ before enforcement can also spike volume.

## References

- [https://learn.microsoft.com/en-us/purview/dlp-learn-about-dlp](https://learn.microsoft.com/en-us/purview/dlp-learn-about-dlp)

...
*We look for the behavior in “Detect Distributed Password Spray Attempts” using the same log fields the detection already uses, so the team can act before impact spreads.*
...
Legitimate failed authentication spikes on shift starts, help desk work, and password change days; compare baselines and exclude known noisy subnets.

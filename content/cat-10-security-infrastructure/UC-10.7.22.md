...
*We look for the behavior in “Detect Distributed Password Spray Attempts” using the same CIM-backed fields as the detection, so the team can act before impact spreads.*

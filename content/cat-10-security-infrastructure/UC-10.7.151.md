<!-- AUTO-GENERATED from UC-10.7.151.json — DO NOT EDIT -->
...
# UC-10.7.151 · Azure AD New Federated Domain Added

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD New Federated Domain Added so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

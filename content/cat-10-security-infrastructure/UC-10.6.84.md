<!-- AUTO-GENERATED from UC-10.6.84.json — DO NOT EDIT -->
...
# UC-10.6.84 · Windows DLL Side-Loading Process Child Of Calc

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies suspicious child processes spawned by calc.exe, indicative of a potential DLL side-loading technique, and we use Splunk so the team can see it early and act.*

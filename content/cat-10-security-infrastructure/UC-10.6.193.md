<!-- AUTO-GENERATED from UC-10.6.193.json — DO NOT EDIT -->
...
# UC-10.6.193 · WS FTP Remote Code Execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects potential Remote Code Execution (RCE) attempts exploiting in WS_FTP software, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.7.449.json — DO NOT EDIT -->
...
# UC-10.7.449 · Windows AD DSRM Password Reset

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows DSRM Password Reset" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

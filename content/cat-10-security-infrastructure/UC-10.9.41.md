<!-- AUTO-GENERATED from UC-10.9.41.json — DO NOT EDIT -->
...
# UC-10.9.41 · Ransomware shadow copy deletion

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use our security program’s detections to catch activity tied to “Ransomware shadow copy deletion” when someone tries that attacker move in our environment, so we can respond before the damage spreads.*

---

## Description

This detection aligns with ESCU 2025–2026 analytic story coverage for: Ransomware shadow copy deletion. Detects vssadmin/bcdedit/cipher abuse to remove recovery points.
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires EDR, Sysmon ingested and CIM-normalized.

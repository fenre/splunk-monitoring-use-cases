<!-- AUTO-GENERATED from UC-10.9.59.json — DO NOT EDIT -->

---
id: "10.9.59"
title: "Lazarus cryptocurrency targeting"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.9.59 · Lazarus cryptocurrency targeting

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use our security program’s detections to catch activity tied to “Lazarus cryptocurrency targeting” when someone tries that attacker move in our environment, so we can respond before the damage spreads.*

---

## Description

This detection aligns with ESCU 2025–2026 analytic story coverage for: Lazarus cryptocurrency targeting. Detects wallet interaction and infrastructure tied to Lazarus crypto operations.
...
ESCU Hunting detection — not designed for automated alerting. Run ad-hoc or on a low-frequency schedule from Splunk Enterprise Security for analyst-driven investigation. Requires Blockchain analytics exports, proxy, EDR ingested and CIM-normalized.

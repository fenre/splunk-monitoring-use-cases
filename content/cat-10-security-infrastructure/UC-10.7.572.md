<!-- AUTO-GENERATED from UC-10.7.572.json — DO NOT EDIT -->
...
# UC-10.7.572 · Windows Non-System Account Targeting Lsass

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Non-System Account Targeting Lsass" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

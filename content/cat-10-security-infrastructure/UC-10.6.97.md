<!-- AUTO-GENERATED from UC-10.6.97.json — DO NOT EDIT -->
...
# UC-10.6.97 · Windows Impair Defense Disable Win Defender Network Protection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects modifications to the Windows registry that disable Windows Defender Network Protection, and we use Splunk so the team can see it early and act.*

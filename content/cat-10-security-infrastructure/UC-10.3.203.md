<!-- AUTO-GENERATED from UC-10.3.203.json — DO NOT EDIT -->
...
# UC-10.3.203 · Linux Indicator Removal Service File Deletion

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Indicator Removal Service File Deletion” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to user account entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Sysmon for Linux EventID 1 ingested and CIM-normalized.

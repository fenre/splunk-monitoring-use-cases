<!-- AUTO-GENERATED from UC-10.6.9.json — DO NOT EDIT -->
...
# UC-10.6.9 · CrushFTP Server Side Template Injection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This analytic is designed to identify attempts to exploit a server-side template injection vulnerability in CrushFTP, designated as, and we use Splunk so the team can see it early and act.*

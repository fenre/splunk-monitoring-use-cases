<!-- AUTO-GENERATED from UC-10.3.232.json — DO NOT EDIT -->
...
# UC-10.3.232 · Linux Service Started Or Enabled

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Service Started Or Enabled” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.7.566.json — DO NOT EDIT -->
...
# UC-10.7.566 · True Positive Test

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on a source host failing to authenticate against a remote host with 30 unique users so unusual activity is visible early — before it spreads or hides in normal noise.*

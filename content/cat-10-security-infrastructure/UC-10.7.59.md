<!-- AUTO-GENERATED from UC-10.7.59.json — DO NOT EDIT -->
...
# UC-10.7.59 · Ollama Abnormal Service Crash Availability Attack

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Ollama Abnormal Service Crash Availability Attack so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

<!-- AUTO-GENERATED from UC-10.7.627.json — DO NOT EDIT -->
...
# UC-10.7.627 · Windows Screen Capture Via Powershell

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Screen Capture Via Powershell" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

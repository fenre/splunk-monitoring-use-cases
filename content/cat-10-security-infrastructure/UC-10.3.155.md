<!-- AUTO-GENERATED from UC-10.3.155.json — DO NOT EDIT -->
...
# UC-10.3.155 · Kerberos User Enumeration

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Kerberos User Enumeration” so we can see attacker-style moves—not only a one-off file or password mistake.*

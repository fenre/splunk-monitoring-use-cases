<!-- AUTO-GENERATED from UC-10.7.538.json — DO NOT EDIT -->
...
# UC-10.7.538 · Windows Hunting System Account Targeting Lsass

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on processes attempting to access Lsass.exe, which may indicate credential dumping or applications needing credential access so unusual activity is visible early — before it spreads or hides in normal noise.*
...
ESCU Hunting detection — not designed for automated alerting. Run ad-hoc or on a low-frequency schedule from Splunk Enterprise Security for analyst-driven investigation. Requires Sysmon EventID 10 ingested and CIM-normalized.
...
IT automation, RMM/Management agents, software deployment, and admin toolkits (PsExec, curl, script hosts) are frequent benign matches. Add approved publisher and path allowlists; exclude trusted patch cycles.
...
- [https://learn.microsoft.com/en-us/windows/win32/api/minidumpapiset/nf-minidumpapiset-minidumpwritedump](https://learn.microsoft.com/en-us/windows/win32/api/minidumpapiset/nf-minidumpapiset-minidumpwritedump)
...
- [https://learn.microsoft.com/en-us/windows/win32/procthread/process-security-and-access-rights?redirectedfrom=MSDN](https://learn.microsoft.com/en-us/windows/win32/procthread/process-security-and-access-rights?redirectedfrom=MSDN)

<!-- AUTO-GENERATED from UC-10.7.184.json — DO NOT EDIT -->
...
# UC-10.7.184 · Detect AWS Console Login by User from New City

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for the behavior in “Detect AWS Console Login by User from New City” using the same log fields the detection already uses, so the team can act before impact spreads.*

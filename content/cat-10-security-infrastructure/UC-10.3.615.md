<!-- AUTO-GENERATED from UC-10.3.615.json — DO NOT EDIT -->

---
id: "10.3.615"
title: "Windows Screen Capture in TEMP folder"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.615 · Windows Screen Capture in TEMP folder

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Screen Capture in TEMP folder”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.4.36.json — DO NOT EDIT -->
...
# UC-10.4.36 · Kubernetes Pod With Host Network Attachment
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to IP address entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Kubernetes Audit ingested and CIM-normalized.

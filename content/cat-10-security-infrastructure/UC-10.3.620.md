<!-- AUTO-GENERATED from UC-10.3.620.json — DO NOT EDIT -->
...
# UC-10.3.620 · Windows Sensitive Registry Hive Dump Via CommandLine

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Sensitive Registry Hive Dump Via CommandLine”, so we catch real tradecraft and not just noise from everyday work.*

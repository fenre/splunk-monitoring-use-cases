<!-- AUTO-GENERATED from UC-10.3.50.json — DO NOT EDIT -->
...
# UC-10.3.50 · Creation of Shadow Copy

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Creation of Shadow Copy” so we can see attacker-style moves—not only a one-off file or password mistake.*

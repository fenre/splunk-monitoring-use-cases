<!-- AUTO-GENERATED from UC-10.11.43.json — DO NOT EDIT -->
...
*We use CrowdStrike data and alerts to stay ahead of the risks described in "CrowdStrike Falcon Discover Asset Inventory Drift". We help the team notice trouble early, while a situation is still small and containable.*
...
- `stats` rolls up events into metrics; results are split **by hostname, aid** so each row reflects one combination of those dimensions.

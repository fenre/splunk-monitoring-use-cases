<!-- AUTO-GENERATED from UC-10.7.137.json — DO NOT EDIT -->
...
*We look for Azure AD Admin Consent Bypassed by Service Principal so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

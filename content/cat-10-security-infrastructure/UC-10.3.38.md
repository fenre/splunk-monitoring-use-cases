<!-- AUTO-GENERATED from UC-10.3.38.json — DO NOT EDIT -->
...
# UC-10.3.38 · Check Elevated CMD using whoami

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Check Elevated CMD using whoami” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.1.8.json — DO NOT EDIT -->
...
*This detection identifies Cisco ASA - Core Syslog Message Volume Drop — so we know when protection is off, out of date, or bypassed.*

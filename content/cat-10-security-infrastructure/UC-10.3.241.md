<!-- AUTO-GENERATED from UC-10.3.241.json — DO NOT EDIT -->
...
# UC-10.3.241 · Linux Unix Shell Enable All SysRq Functions

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Unix Shell Enable All SysRq Functions” so we can see attacker-style moves—not only a one-off file or password mistake.*

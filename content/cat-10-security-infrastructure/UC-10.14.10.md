...
> **Criticality:** Critical &middot; **Difficulty:** Advanced &middot; **Pillar:** Security &middot; **Type:** Security, Change

*We look for HMI or operator-screen tampering that could hide a bad process state or trick operators during an incident.*
...
HMI changes from operator preferences, screen layout updates, or planned upgrades can match tampering heuristics when they are business-as-usual — confirm with operations.

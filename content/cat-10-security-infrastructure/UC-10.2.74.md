<!-- AUTO-GENERATED from UC-10.2.74.json — DO NOT EDIT -->
...
# UC-10.2.74 · Remote Desktop Process Running On System

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of the remote desktop process (mstsc.exe) on systems where it is not typically run — so we know when protection is off, out of date, or bypassed.*

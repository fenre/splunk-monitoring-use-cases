<!-- AUTO-GENERATED from UC-10.9.1.json — DO NOT EDIT -->

---
id: "10.9.1"
title: "Suspicious Ollama process execution"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.9.1 · Suspicious Ollama process execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use our security program’s detections to catch activity tied to “Suspicious Ollama process execution” when someone tries that attacker move in our environment, so we can respond before the damage spreads.*

---

## Description

This detection aligns with ESCU 2025–2026 analytic story coverage for: Suspicious Ollama process execution. Detects unexpected ollama or llama runtime processes outside approved paths, consistent with local LLM abuse or cryptomining.

<!-- AUTO-GENERATED from UC-10.7.389.json — DO NOT EDIT -->
...
# UC-10.7.389 · Living Off The Land Detection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Living Off The Land Detection" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

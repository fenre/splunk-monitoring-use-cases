<!-- AUTO-GENERATED from UC-10.3.522.json — DO NOT EDIT -->
...
# UC-10.3.522 · Windows Modify Registry Disable WinDefender Notifications

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Modify Registry Disable WinDefender Notifications”, so we catch real tradecraft and not just noise from everyday work.*

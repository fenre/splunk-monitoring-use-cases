<!-- AUTO-GENERATED from UC-10.7.462.json — DO NOT EDIT -->
...
# UC-10.7.462 · Windows AD Short Lived Domain Account ServicePrincipalName

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Short Lived Domain Account ServicePrincipalName" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

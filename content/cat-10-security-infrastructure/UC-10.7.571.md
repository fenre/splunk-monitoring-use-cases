<!-- AUTO-GENERATED from UC-10.7.571.json — DO NOT EDIT -->
...
# UC-10.7.571 · Windows Non Discord App Access Discord LevelDB

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Non Discord App Access Discord LevelDB" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

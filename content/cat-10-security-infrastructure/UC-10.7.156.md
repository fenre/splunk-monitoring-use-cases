<!-- AUTO-GENERATED from UC-10.7.156.json — DO NOT EDIT -->
...
# UC-10.7.156 · Azure AD PIM Role Assignment Activated

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD PIM Role Assignment Activated so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

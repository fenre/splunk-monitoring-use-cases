<!-- AUTO-GENERATED from UC-10.6.17.json — DO NOT EDIT -->
...
# UC-10.6.17 · Suspicious Java Classes

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies suspicious Java classes often used for remote command execution exploits in Java frameworks like Apache Struts, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.6.39.json — DO NOT EDIT -->
...
# UC-10.6.39 · ConnectWise ScreenConnect Path Traversal Windows SACL

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit the ConnectWise ScreenConnect vulnerability using Windows SACL EventCode 4663, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.6.96.json — DO NOT EDIT -->
...
# UC-10.6.96 · Windows Impair Defense Disable Win Defender Compute File Hashes

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects modifications to the Windows registry that disable Windows Defender's file hash computation by setting the EnableFileHashComputation value to 0, and we use Splunk so the team can see it early and act.*

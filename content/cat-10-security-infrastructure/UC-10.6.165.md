<!-- AUTO-GENERATED from UC-10.6.165.json — DO NOT EDIT -->
...
# UC-10.6.165 · Ivanti EPMM Remote Unauthenticated API Access CVE-2023-35078

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit, a vulnerability in Ivanti Endpoint Manager Mobile (EPMM) versions up to 11.4, and we use Splunk so the team can see it early and act.*

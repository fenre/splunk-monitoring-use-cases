<!-- AUTO-GENERATED from UC-10.7.702.json — DO NOT EDIT -->
...
# UC-10.7.702 · Ngrok Reverse Proxy on Network

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Ngrok Reverse Proxy on Network" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

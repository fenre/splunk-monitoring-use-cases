...
*We use language models to triage likely phishing in the mail stream so the front of the human queue is worth reading first.*
...
Language models can misfire on internal jargon, news-heavy subjects, and multilingual mail — we keep humans in the loop for quarantine.

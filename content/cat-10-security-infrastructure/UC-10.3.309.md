<!-- AUTO-GENERATED from UC-10.3.309.json — DO NOT EDIT -->
...
# UC-10.3.309 · Sc exe Manipulating Windows Services

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Sc exe Manipulating Windows Services” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.7.477.json — DO NOT EDIT -->
...
*We keep an eye on attempts to install unsigned MSIX/AppX packages using the -AllowUnsigned parameter so unusual activity is visible early — before it spreads or hides in normal noise.*

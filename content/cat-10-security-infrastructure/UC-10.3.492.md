<!-- AUTO-GENERATED from UC-10.3.492.json — DO NOT EDIT -->
...
# UC-10.3.492 · Windows Impair Defenses Disable Win Defender Auto Logging

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Impair Defenses Disable Win Defender Auto Logging”, so we catch real tradecraft and not just noise from everyday work.*

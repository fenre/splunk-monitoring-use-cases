<!-- AUTO-GENERATED from UC-10.3.512.json — DO NOT EDIT -->

---
id: "10.3.512"
title: "Windows MMC Loaded Script Engine DLL"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.512 · Windows MMC Loaded Script Engine DLL

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows MMC Loaded Script Engine DLL”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.7.451.json — DO NOT EDIT -->
...
# UC-10.7.451 · Windows AD GPO Disabled

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows GPO Disabled" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

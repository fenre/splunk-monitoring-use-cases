<!-- AUTO-GENERATED from UC-10.3.628.json — DO NOT EDIT -->
...
# UC-10.3.628 · Windows Snake Malware Kernel Driver Comadmin

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Snake Malware Kernel Driver Comadmin”, so we catch real tradecraft and not just noise from everyday work.*

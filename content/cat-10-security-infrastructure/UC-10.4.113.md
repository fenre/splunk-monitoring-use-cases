<!-- AUTO-GENERATED from UC-10.4.113.json — DO NOT EDIT -->

---
id: "10.4.113"
title: "O365 Threat Intelligence Suspicious File Detected"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.4.113 · O365 Threat Intelligence Suspicious File Detected

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We watch mail flow, attachments, and policy outcomes in normalized email data, so threats and data-loss events tied to messages are easier to see across gateways and inboxes in one place.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to file entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Office 365 Universal Audit Log ingested and CIM-normalized.
...
| tstats `summariesonly` count
  ...
  where (All_Email.file_name!="" OR isnotnull(All_Email.file_name))
  by All_Email.src_user All_Email.file_name span=1h
| sort -count
```
...
Legitimate but uncommon attachment types in partner exchanges and engineering builds. Validate against Defender and sandbox file verdicts and known internal campaigns.

## References

- [https://learn.microsoft.com/en-us/microsoft-365/security/office-365-security/threat-explorer-real-time-detections-about?view=o365-worldwide](https://learn.microsoft.com/en-us/microsoft-365/security/office-365-security/threat-explorer-real-time-detections-about?view=o365-worldwide)
- [https://learn.microsoft.com/en-us/microsoft-365/security/office-365-security/anti-malware-protection-for-spo-odfb-teams-about?view=o365-worldwide](https://learn.microsoft.com/en-us/microsoft-365/security/office-365-security/anti-malware-protection-for-spo-odfb-teams-about?view=o365-worldwide)

<!-- AUTO-GENERATED from UC-10.3.602.json — DO NOT EDIT -->
...
# UC-10.3.602 · Windows Regsvr32 Renamed Binary

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Regsvr32 Renamed Binary”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.7.686.json — DO NOT EDIT -->
...
# UC-10.7.686 · Detect DNS Data Exfiltration using pretrained model in DSDL

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on potential data exfiltration using a pre-trained deep learning model so unusual activity is visible early — before it spreads or hides in normal noise.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to domain entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Various ingested and CIM-normalized.

<!-- AUTO-GENERATED from UC-10.7.328.json — DO NOT EDIT -->
...
# UC-10.7.328 · Headless Browser Mockbin or Mocky Request

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Headless Browser Mockbin or Mocky Request so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*
...
- [https://github.com/Kong/mockbin](https://github.com/Kong/mockbin)

<!-- AUTO-GENERATED from UC-10.7.374.json — DO NOT EDIT -->
...
# UC-10.7.374 · Linux Auditd Unload Module Via Modprobe

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Linux Auditd Unload Module Via Modprobe" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

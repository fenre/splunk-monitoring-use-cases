...
*We see how long it takes to fix reported flaws so we can tell when remediation is healthy, when a team is stuck, or when an approved exception explains the delay.*
...
Lag from approved exception, application compatibility testing, or planned phased rollouts. Long times-to-fix on assets with documented risk acceptance or vendor patch delays are not always control failures.

<!-- AUTO-GENERATED from UC-10.7.378.json — DO NOT EDIT -->
...
# UC-10.7.378 · Linux Deletion Of Services

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Linux Deletion Of Services" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

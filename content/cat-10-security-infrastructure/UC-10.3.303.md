<!-- AUTO-GENERATED from UC-10.3.303.json — DO NOT EDIT -->
...
# UC-10.3.303 · Rundll32 Shimcache Flush

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Rundll32 Shimcache Flush” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.7.564.json — DO NOT EDIT -->
...
# UC-10.7.564 · True Positive Test

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on a source user failing to authenticate with 30 unique users using explicit credentials on a host so unusual activity is visible early — before it spreads or hides in normal noise.*
...
- [https://learn.microsoft.com/en-us/windows/security/threat-protection/auditing/event-4648](https://learn.microsoft.com/en-us/windows/security/threat-protection/auditing/event-4648)
- [https://learn.microsoft.com/en-us/windows/security/threat-protection/auditing/basic-audit-logon-events](https://learn.microsoft.com/en-us/windows/security/threat-protection/auditing/basic-audit-logon-events)

<!-- AUTO-GENERATED from UC-10.10.5.json — DO NOT EDIT -->
...
*We map our coverage to attacker techniques so we see blind spots in the matrix before a reviewer does.*
...
### Step 3 — Validate
Spot-check a few **MITRE** technique rows in the panel against the underlying notable or data-model tags in the same time range so what you see in the table matches raw events.
...
Technique gaps in dashboards often reflect unmapped custom rules, legacy naming, or out-of-date technique tags rather than a complete absence of detective controls in the org.

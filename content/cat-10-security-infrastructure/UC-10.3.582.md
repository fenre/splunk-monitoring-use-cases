<!-- AUTO-GENERATED from UC-10.3.582.json — DO NOT EDIT -->
...
# UC-10.3.582 · Windows PowerView Constrained Delegation Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows PowerView Constrained Delegation Discovery”, so we catch real tradecraft and not just noise from everyday work.*

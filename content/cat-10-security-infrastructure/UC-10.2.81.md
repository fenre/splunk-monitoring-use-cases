<!-- AUTO-GENERATED from UC-10.2.81.json — DO NOT EDIT -->
...
# UC-10.2.81 · Remote Process Instantiation via WMI and PowerShell

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of using the cmdlet to start a process on a remote endpoint using WMI — so we know when protection is off, out of date, or bypassed.*

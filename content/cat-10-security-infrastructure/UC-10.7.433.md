<!-- AUTO-GENERATED from UC-10.7.433.json — DO NOT EDIT -->
...
# UC-10.7.433 · Windows Account Access Removal via Logoff Exec

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Account Access Removal via Logoff Exec" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
- [https://devblogs.microsoft.com/scripting/automating-quser-through-powershell/](https://devblogs.microsoft.com/scripting/automating-quser-through-powershell/)

<!-- AUTO-GENERATED from UC-10.3.96.json — DO NOT EDIT -->
...
# UC-10.3.96 · Disable UAC Remote Restriction
...
| tstats `summariesonly` count
  ...
  by All_Changes.object All_Changes.action All_Changes.user span=1h
| where count>0
| sort -count
```

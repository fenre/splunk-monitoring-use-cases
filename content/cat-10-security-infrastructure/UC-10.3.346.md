<!-- AUTO-GENERATED from UC-10.3.346.json — DO NOT EDIT -->
...
# UC-10.3.346 · Suspicious Reg exe Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Suspicious Reg exe Process”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.4.56.json — DO NOT EDIT -->
...
# UC-10.4.56 · O365 Email New Inbox Rule Created
...
```spl
`o365_management_activity` Workload=Exchange AND (Operation=New-InboxRule OR Operation=Set-InboxRule) AND UserId = "$user$
```

<!-- AUTO-GENERATED from UC-10.3.154.json — DO NOT EDIT -->
...
# UC-10.3.154 · Jscript Execution Using Cscript App

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Jscript Execution Using Cscript App” so we can see attacker-style moves—not only a one-off file or password mistake.*

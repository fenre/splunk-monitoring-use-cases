<!-- AUTO-GENERATED from UC-10.2.15.json — DO NOT EDIT -->
...
# UC-10.2.15 · AWS Concurrent Sessions From Different Ips

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot an AWS access control account with concurrent sessions originating from more than one unique IP address within a 5-minute window — so we know when protection is off, out of date, or bypassed.*

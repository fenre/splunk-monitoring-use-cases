<!-- AUTO-GENERATED from UC-10.7.588.json — DO NOT EDIT -->
...
# UC-10.7.588 · Windows PowerShell WMI Win32 ScheduledJob

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows PowerShell WMI Win32 ScheduledJob" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

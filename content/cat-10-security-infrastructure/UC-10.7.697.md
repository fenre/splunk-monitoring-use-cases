<!-- AUTO-GENERATED from UC-10.7.697.json — DO NOT EDIT -->
...
# UC-10.7.697 · DNS Query Length With High Standard Deviation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for " Query Length With High Standard Deviation" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to URL entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Sysmon EventID 22 ingested and CIM-normalized.

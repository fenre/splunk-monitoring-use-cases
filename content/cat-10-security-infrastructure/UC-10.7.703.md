<!-- AUTO-GENERATED from UC-10.7.703.json — DO NOT EDIT -->
...
# UC-10.7.703 · Prohibited Network Traffic Allowed

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Prohibited Network Traffic Allowed" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

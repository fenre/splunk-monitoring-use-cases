<!-- AUTO-GENERATED from UC-10.3.320.json — DO NOT EDIT -->
...
# UC-10.3.320 · SecretDumps Offline NTDS Dumping Tool

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “SecretDumps Offline NTDS Dumping Tool” so we can see attacker-style moves—not only a one-off file or password mistake.*

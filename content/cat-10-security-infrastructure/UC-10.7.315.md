<!-- AUTO-GENERATED from UC-10.7.315.json — DO NOT EDIT -->
...
# UC-10.7.315 · Get DomainPolicy with Powershell Script Block

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Get DomainPolicy with Powershell Script Block so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

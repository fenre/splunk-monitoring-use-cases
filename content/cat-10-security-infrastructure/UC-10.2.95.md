<!-- AUTO-GENERATED from UC-10.2.95.json — DO NOT EDIT -->
...
# UC-10.2.95 · Suspicious MSBuild Spawn

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot instances where wmiprvse.exe spawns msbuild.exe, which is unusual and indicative of potential misuse of a COM object — so we know when protection is off, out of date, or bypassed.*

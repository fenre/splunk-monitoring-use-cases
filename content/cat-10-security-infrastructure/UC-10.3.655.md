<!-- AUTO-GENERATED from UC-10.3.655.json — DO NOT EDIT -->

---
id: "10.3.655"
title: "Windows User Disabled Via Net"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.655 · Windows User Disabled Via Net

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows User Disabled Via Net”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.9.29.json — DO NOT EDIT -->

---
id: "10.9.29"
title: "BlackBasta new variant indicators"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.9.29 · BlackBasta new variant indicators

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use our security program’s detections to catch activity tied to “BlackBasta new variant indicators” when someone tries that attacker move in our environment, so we can respond before the damage spreads.*

---

## Description

This detection aligns with ESCU 2025–2026 analytic story coverage for: BlackBasta new variant indicators. Tracks updated IOCs and behaviors for emerging BlackBasta variants.
...
ESCU Hunting detection — not designed for automated alerting. Run ad-hoc or on a low-frequency schedule from Splunk Enterprise Security for analyst-driven investigation. Requires EDR, network IDS, threat intel ingested and CIM-normalized.

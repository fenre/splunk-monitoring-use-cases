...
*We use endpoint and security-agent signals around “Domain Group Discovery With Wmic” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.3.34.json — DO NOT EDIT -->
...
# UC-10.3.34 · BITSAdmin Download File

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “BITSAdmin Download File” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
- [https://learn.microsoft.com/en-us/windows/win32/bits/bitsadmin-tool](https://learn.microsoft.com/en-us/windows/win32/bits/bitsadmin-tool)

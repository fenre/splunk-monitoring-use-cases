<!-- AUTO-GENERATED from UC-10.3.639.json — DO NOT EDIT -->
...
# UC-10.3.639 · Windows System Network Config Discovery Display DNS

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows System Network Config Discovery Display DNS”, so we catch real tradecraft and not just noise from everyday work.*

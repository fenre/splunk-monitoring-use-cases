<!-- AUTO-GENERATED from UC-10.3.458.json — DO NOT EDIT -->
...
# UC-10.3.458 · Windows File Download Via CertUtil

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows File Download Via CertUtil”, so we catch real tradecraft and not just noise from everyday work.*
...
- [https://learn.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/cc732443(v=ws.11)#-verifyctl](https://learn.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/cc732443(v=ws.11)#-verifyctl)

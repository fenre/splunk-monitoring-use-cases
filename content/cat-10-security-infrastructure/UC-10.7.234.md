<!-- AUTO-GENERATED from UC-10.7.234.json — DO NOT EDIT -->
...
# UC-10.7.234 · Kubernetes Pod Created in Default Namespace

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Kubernetes Pod Created in Default Namespace so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

<!-- AUTO-GENERATED from UC-10.7.196.json — DO NOT EDIT -->
...
# UC-10.7.196 · GCP Successful Single-Factor Authentication

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for GCP Successful Single-Factor Authentication so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

<!-- AUTO-GENERATED from UC-10.2.30.json — DO NOT EDIT -->
...
# UC-10.2.30 · Active Directory Lateral Movement Identified

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot potential lateral movement activities within an organization's Active Directory (AD) environment — so we know when protection is off, out of date, or bypassed.*
...
Lateral movement detections are often tripped by patch management, backup software, jump boxes, and automation that legitimately use remote execution and admin shares.

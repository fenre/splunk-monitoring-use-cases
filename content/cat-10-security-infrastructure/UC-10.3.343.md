<!-- AUTO-GENERATED from UC-10.3.343.json — DO NOT EDIT -->
...
# UC-10.3.343 · Suspicious PlistBuddy Usage

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Suspicious PlistBuddy Usage”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.2.161.json — DO NOT EDIT -->
...
# UC-10.2.161 · Wmic Group Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot the use of to enumerate local groups on an endpoint — so we know when protection is off, out of date, or bypassed.*

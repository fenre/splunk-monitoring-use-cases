<!-- AUTO-GENERATED from UC-10.7.334.json — DO NOT EDIT -->
...
# UC-10.7.334 · Kerberos Pre-Authentication Flag Disabled in UserAccountControl

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Kerberos Pre-Authentication Flag Disabled in UserAccountControl so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

<!-- AUTO-GENERATED from UC-10.7.325.json — DO NOT EDIT -->
...
# UC-10.7.325 · GetWmiObject DS User with PowerShell Script Block

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for GetWmiObject DS User with PowerShell Script Block so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*
...
- [https://learn.microsoft.com/en-us/windows/win32/wmisdk/describing-the-ldap-namespace](https://learn.microsoft.com/en-us/windows/win32/wmisdk/describing-the-ldap-namespace)

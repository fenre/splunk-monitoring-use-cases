<!-- AUTO-GENERATED from UC-10.4.150.json — DO NOT EDIT -->

---
id: "10.4.150"
title: "Zscaler Phishing Activity Threat Blocked"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.4.150 · Zscaler Phishing Activity Threat Blocked

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We watch the web filter for URLs tagged as phishing, so we can jump on credential-theft pages even before they show up in email reports alone.*
...
Security awareness and marketing redirectors, broken URL rewrites, and web-filter categorization changes. Compare the user, URL category, and policy decision in the Zscaler or proxy console before escalation.

## References

- [https://help.zscaler.com/zia/nss-feed-output-format-web-logs](https://help.zscaler.com/zia/nss-feed-output-format-web-logs)

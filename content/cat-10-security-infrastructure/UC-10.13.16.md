<!-- AUTO-GENERATED from UC-10.13.16.json — DO NOT EDIT -->
...
> **Criticality:** High &middot; **Difficulty:** Beginner &middot; **Pillar:** Security &middot; **Type:** Operations

*We use the same kind of check described for "Quarantine Success Rate" once our data is shaped in a common, repeatable way across products. We help the team see trouble early, compare different tools fairly, and avoid building a one-off report for every vendor.*

<!-- AUTO-GENERATED from UC-10.6.149.json — DO NOT EDIT -->
...
# UC-10.6.149 · CrushFTP Authentication Bypass Exploitation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects potential exploitation of the CrushFTP authentication bypass vulnerability, and we use Splunk so the team can see it early and act.*

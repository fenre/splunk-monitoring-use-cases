<!-- AUTO-GENERATED from UC-10.6.174.json — DO NOT EDIT -->
...
# UC-10.6.174 · Juniper Networks Remote Code Execution Exploit Detection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit a remote code execution vulnerability in Juniper Networks devices, and we use Splunk so the team can see it early and act.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to URL entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Suricata ingested and CIM-normalized.

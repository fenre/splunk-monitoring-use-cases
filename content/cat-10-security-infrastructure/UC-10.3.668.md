<!-- AUTO-GENERATED from UC-10.3.668.json — DO NOT EDIT -->
...
# UC-10.3.668 · XSL Script Execution With WMIC

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “XSL Script Execution With WMIC”, so we catch real tradecraft and not just noise from everyday work.*

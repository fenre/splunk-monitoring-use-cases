<!-- AUTO-GENERATED from UC-10.7.148.json — DO NOT EDIT -->
...
# UC-10.7.148 · Azure AD Multiple Service Principals Created by User

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD Multiple Service Principals Created by User so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

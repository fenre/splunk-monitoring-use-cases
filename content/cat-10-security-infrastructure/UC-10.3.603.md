<!-- AUTO-GENERATED from UC-10.3.603.json — DO NOT EDIT -->
...
# UC-10.3.603 · Windows Remote Access Software RMS Registry

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Remote Access Software RMS Registry”, so we catch real tradecraft and not just noise from everyday work.*

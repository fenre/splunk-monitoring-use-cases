<!-- AUTO-GENERATED from UC-10.7.605.json — DO NOT EDIT -->
...
# UC-10.7.605 · Windows Query Registry Browser List Application

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Query Registry Browser List Application" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

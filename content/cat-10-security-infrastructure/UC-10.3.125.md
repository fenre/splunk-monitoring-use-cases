<!-- AUTO-GENERATED from UC-10.3.125.json — DO NOT EDIT -->
...
# UC-10.3.125 · First Time Seen Child Process of Zoom

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “First Time Seen Child Process of Zoom” so we can see attacker-style moves—not only a one-off file or password mistake.*

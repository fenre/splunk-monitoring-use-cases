<!-- AUTO-GENERATED from UC-10.3.647.json — DO NOT EDIT -->
...
# UC-10.3.647 · Windows Time Based Evasion

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Time Based Evasion”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.3.52.json — DO NOT EDIT -->
...
# UC-10.3.52 · Credential Dumping via Copy Command from Shadow Copy

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Credential Dumping via Copy Command from Shadow Copy” so we can see attacker-style moves—not only a one-off file or password mistake.*

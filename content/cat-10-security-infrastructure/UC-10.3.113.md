<!-- AUTO-GENERATED from UC-10.3.113.json — DO NOT EDIT -->
...
# UC-10.3.113 · Elevated Group Discovery With Wmic

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Elevated Group Discovery With Wmic” so we can see attacker-style moves—not only a one-off file or password mistake.*

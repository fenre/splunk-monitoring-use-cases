<!-- AUTO-GENERATED from UC-10.3.126.json — DO NOT EDIT -->
...
# UC-10.3.126 · FodHelper UAC Bypass

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “FodHelper UAC Bypass” so we can see attacker-style moves—not only a one-off file or password mistake.*

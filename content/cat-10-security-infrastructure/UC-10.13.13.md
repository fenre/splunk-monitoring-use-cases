<!-- AUTO-GENERATED from UC-10.13.13.json — DO NOT EDIT -->

---
id: "10.13.13"
title: "DNS Query Volume (CIM)"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.13.13 · DNS Query Volume (CIM)

> **Criticality:** High &middot; **Difficulty:** Beginner &middot; **Pillar:** Security &middot; **Type:** Security

*We use the same kind of check described for "DNS Query Volume" once our data is shaped in a common, repeatable way across products. We help the team see trouble early, compare different tools fairly, and avoid building a one-off report for every vendor.*

---

## Description

DNS tunneling and malware generate high `query` counts per `src` — normalized in `DNS` CIM model.
...
Line chart (queries by src), Single value (peak factor).

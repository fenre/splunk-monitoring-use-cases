<!-- AUTO-GENERATED from UC-10.3.175.json — DO NOT EDIT -->
...
# UC-10.3.175 · Linux c99 Privilege Escalation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux c99 Privilege Escalation” so we can see attacker-style moves—not only a one-off file or password mistake.*

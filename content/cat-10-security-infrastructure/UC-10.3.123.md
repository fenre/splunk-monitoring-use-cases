<!-- AUTO-GENERATED from UC-10.3.123.json — DO NOT EDIT -->
...
# UC-10.3.123 · Execution of File with Multiple Extensions

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Execution of File with Multiple Extensions” so we can see attacker-style moves—not only a one-off file or password mistake.*

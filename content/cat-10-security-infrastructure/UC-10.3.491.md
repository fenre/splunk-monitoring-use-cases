<!-- AUTO-GENERATED from UC-10.3.491.json — DO NOT EDIT -->
...
# UC-10.3.491 · Windows Impair Defenses Disable HVCI

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Impair Defenses Disable HVCI”, so we catch real tradecraft and not just noise from everyday work.*

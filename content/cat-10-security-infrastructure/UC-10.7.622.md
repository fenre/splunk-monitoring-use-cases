<!-- AUTO-GENERATED from UC-10.7.622.json — DO NOT EDIT -->
...
# UC-10.7.622 · Windows RunMRU Registry Key or Value Deleted

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows RunMRU Registry Key or Value Deleted" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.3.383.json — DO NOT EDIT -->
...
# UC-10.3.383 · Windows Alternate DataStream - Base64 Content

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Alternate DataStream - Base64 Content”, so we catch real tradecraft and not just noise from everyday work.*

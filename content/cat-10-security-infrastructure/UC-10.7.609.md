<!-- AUTO-GENERATED from UC-10.7.609.json — DO NOT EDIT -->
...
# UC-10.7.609 · Windows RDP Cache File Deletion

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows RDP Cache File Deletion" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

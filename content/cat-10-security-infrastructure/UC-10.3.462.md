<!-- AUTO-GENERATED from UC-10.3.462.json — DO NOT EDIT -->
...
# UC-10.3.462 · Windows Gather Victim Host Information Camera

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Gather Victim Host Information Camera”, so we catch real tradecraft and not just noise from everyday work.*

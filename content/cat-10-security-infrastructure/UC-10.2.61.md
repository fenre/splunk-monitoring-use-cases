<!-- AUTO-GENERATED from UC-10.2.61.json — DO NOT EDIT -->
...
# UC-10.2.61 · Network Discovery Using Route Windows App

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of the Windows application, commonly used for network discovery — so we know when protection is off, out of date, or bypassed.*

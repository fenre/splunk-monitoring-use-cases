<!-- AUTO-GENERATED from UC-10.9.33.json — DO NOT EDIT -->

---
id: "10.9.33"
title: "LockBit successor indicators"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.9.33 · LockBit successor indicators

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use our security program’s detections to catch activity tied to “LockBit successor indicators” when someone tries that attacker move in our environment, so we can respond before the damage spreads.*

---

## Description

This detection aligns with ESCU 2025–2026 analytic story coverage for: LockBit successor indicators. Hunting content for post-LockBit ecosystem behaviors and rebrands.
...
ESCU Hunting detection — not designed for automated alerting. Run ad-hoc or on a low-frequency schedule from Splunk Enterprise Security for analyst-driven investigation. Requires EDR, intel feeds, dark web scrapes (where permitted) ingested and CIM-normalized.

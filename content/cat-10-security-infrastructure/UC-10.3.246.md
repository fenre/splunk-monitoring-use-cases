<!-- AUTO-GENERATED from UC-10.3.246.json — DO NOT EDIT -->
...
# UC-10.3.246 · Malicious InProcServer32 Modification

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Malicious InProcServer32 Modification” so we can see attacker-style moves—not only a one-off file or password mistake.*

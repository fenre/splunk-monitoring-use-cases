<!-- AUTO-GENERATED from UC-10.12.42.json — DO NOT EDIT -->
...
*In our line of business, we pay close attention to "CAC Authentication Monitoring" in our day-to-day work so that fraud, waste, and compliance issues do not slip by quietly. We help teams focus on the few situations that need a person, not every routine blip in the data.*
...
Smart-card and CAC noise from workstation imaging, PIV reissuance, and visiting contractor machines; use physical access and HSPD-12 records.

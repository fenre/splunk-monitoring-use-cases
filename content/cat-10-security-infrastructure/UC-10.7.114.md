<!-- AUTO-GENERATED from UC-10.7.114.json — DO NOT EDIT -->
...
# UC-10.7.114 · AWS Exfiltration via DataSync Task
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to IP address entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires AWS CloudTrail CreateTask ingested and CIM-normalized.

<!-- AUTO-GENERATED from UC-10.7.275.json — DO NOT EDIT -->
...
# UC-10.7.275 · Creation of lsass Dump with Taskmgr

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Creation of lsass Dump with Taskmgr so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

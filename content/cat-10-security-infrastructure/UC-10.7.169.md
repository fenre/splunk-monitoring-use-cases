<!-- AUTO-GENERATED from UC-10.7.169.json — DO NOT EDIT -->
...
# UC-10.7.169 · Azure AD User Enabled And Password Reset

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD User Enabled And Password Reset so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

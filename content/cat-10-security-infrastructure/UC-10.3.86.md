<!-- AUTO-GENERATED from UC-10.3.86.json — DO NOT EDIT -->
...
# UC-10.3.86 · Disable Defender Enhanced Notification

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Disable Defender Enhanced Notification” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.2.51.json — DO NOT EDIT -->
...
# UC-10.2.51 · Impacket Lateral Movement smbexec CommandLine Parameters

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot suspicious command-line parameters associated with the use of Impacket's smbexec.py for lateral movement — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.7.187.json — DO NOT EDIT -->
...
# UC-10.7.187 · Detect New Open GCP Storage Buckets

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use this 'Detect New Open GCP Storage Buckets' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*

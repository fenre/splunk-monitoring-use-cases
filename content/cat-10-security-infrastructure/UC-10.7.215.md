<!-- AUTO-GENERATED from UC-10.7.215.json — DO NOT EDIT -->
...
# UC-10.7.215 · Kubernetes Abuse of Secret by Unusual Location

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Kubernetes Abuse of Secret by Unusual Location so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

<!-- AUTO-GENERATED from UC-10.3.484.json — DO NOT EDIT -->
...
# UC-10.3.484 · Windows Impair Defense Disable Win Defender App Guard

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Impair Defense Disable Win Defender App Guard”, so we catch real tradecraft and not just noise from everyday work.*

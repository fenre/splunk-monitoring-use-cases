<!-- AUTO-GENERATED from UC-10.3.205.json — DO NOT EDIT -->
...
# UC-10.3.205 · Linux Ingress Tool Transfer with Curl

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Ingress Tool Transfer with Curl” so we can see attacker-style moves—not only a one-off file or password mistake.*

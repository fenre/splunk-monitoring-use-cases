<!-- AUTO-GENERATED from UC-10.6.59.json — DO NOT EDIT -->
...
# UC-10.6.59 · Outbound Network Connection from Java Using Default Ports

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects outbound network connections from Java processes to default ports used by and RMI protocols, which may indicate exploitation of-Log4j vulnerability, and we use Splunk so the team can see it early and act.*

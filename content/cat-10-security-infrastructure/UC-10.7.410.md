<!-- AUTO-GENERATED from UC-10.7.410.json — DO NOT EDIT -->
...
# UC-10.7.410 · PowerShell Invoke CIMMethod CIMSession

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for the detection that watches PowerShell opening a remote management session and running commands through it, so the team can spot abuse early without getting lost in one-off alerts that lack context.*

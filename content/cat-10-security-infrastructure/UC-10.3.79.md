<!-- AUTO-GENERATED from UC-10.3.79.json — DO NOT EDIT -->
...
# UC-10.3.79 · Detect SharpHound File Modifications
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to user account entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Sysmon EventID 11 ingested and CIM-normalized.

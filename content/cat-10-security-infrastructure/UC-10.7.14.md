<!-- AUTO-GENERATED from UC-10.7.14.json — DO NOT EDIT -->
...
# UC-10.7.14 · Cisco Duo Policy Allow Devices Without Screen Lock

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for unusual Cisco Duo admin sign-in patterns described in the title so we notice possible stolen or misused admin sessions early.*

---

## Description

This detection identifies Cisco Duo Policy Allow Devices Without Screen Lock. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to user account entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Cisco Duo Administrator ingested and CIM-normalized.
...
First-time or rare context logins during travel, new devices, and contractor access; use Duo device and policy context before treating as incident.

## References

- [https://splunkbase.splunk.com/app/7404](https://splunkbase.splunk.com/app/7404)

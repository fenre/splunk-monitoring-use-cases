<!-- AUTO-GENERATED from UC-10.3.382.json — DO NOT EDIT -->
...
# UC-10.3.382 · Windows Advanced Installer MSIX with AI_STUBS Execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Advanced Installer MSIX with AI_STUBS Execution”, so we catch real tradecraft and not just noise from everyday work.*

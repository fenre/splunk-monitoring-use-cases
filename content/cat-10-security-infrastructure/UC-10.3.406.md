<!-- AUTO-GENERATED from UC-10.3.406.json — DO NOT EDIT -->
...
# UC-10.3.406 · Windows CAB File on Disk

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows CAB File on Disk”, so we catch real tradecraft and not just noise from everyday work.*

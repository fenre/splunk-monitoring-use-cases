<!-- AUTO-GENERATED from UC-10.2.63.json — DO NOT EDIT -->
...
# UC-10.2.63 · NLTest Domain Trust Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot the execution of with command-line arguments or to query Domain Trust information — so we know when protection is off, out of date, or bypassed.*

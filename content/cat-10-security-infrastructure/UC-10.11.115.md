<!-- AUTO-GENERATED from UC-10.11.115.json — DO NOT EDIT -->
...
*We use Tenable data and alerts to stay ahead of the risks described in "Tenable.io Agent and Linked Scanner Health". We help the team notice trouble early, while a situation is still small and containable.*
...
- `stats` rolls up events into metrics; results are split **by agent_uuid** so each row reflects one combination of those dimensions.

<!-- AUTO-GENERATED from UC-10.7.140.json — DO NOT EDIT -->
...
# UC-10.7.140 · Azure AD External Guest User Invited

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD External Guest User Invited so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

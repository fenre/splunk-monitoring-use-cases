<!-- AUTO-GENERATED from UC-10.7.471.json — DO NOT EDIT -->
...
# UC-10.7.471 · Windows Application Whitelisting Bypass Attempt via Rundll32

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Application Whitelisting Bypass Attempt via Rundll32" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

---

## Description

This detection identifies Windows Application Whitelisting Bypass Attempt via Rundll32. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.
...
- [https://lolbas-project.github.io/lolbas/Libraries/Ieadvpack/](https://lolbas-project.github.io/lolbas/Libraries/Ieadvpack/)

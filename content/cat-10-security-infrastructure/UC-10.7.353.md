<!-- AUTO-GENERATED from UC-10.7.353.json — DO NOT EDIT -->
...
# UC-10.7.353 · Linux Auditd File Permissions Modification Via Chattr

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Linux Auditd File Permissions Modification Via Chattr so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

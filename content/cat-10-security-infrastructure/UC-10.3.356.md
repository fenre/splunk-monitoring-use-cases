<!-- AUTO-GENERATED from UC-10.3.356.json — DO NOT EDIT -->
...
# UC-10.3.356 · Suspicious wevtutil Usage

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Suspicious wevtutil Usage”, so we catch real tradecraft and not just noise from everyday work.*

...
*We spot a spike in the number of AWS Security Hub alerts for an AWS access control User within a 4-hour interval — so we know when protection is off, out of date, or bypassed.*

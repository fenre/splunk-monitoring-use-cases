<!-- AUTO-GENERATED from UC-10.16.2.json — DO NOT EDIT -->
...
*We watch how many raw alerts turn into real tracked incidents so we know whether we are just noisy or actually closing the loop.*
...
### Step 3 — Validate
Reconcile a week’s notables in **ES Incident Review** to your incident ticketing export so the ratio in Splunk matches the ticket system’s story.
...
The ratio of alerts to formal incidents changes when we tighten ticket discipline, on-board a SOAR, or reclassify noise — it is a process signal as much as a threat signal.

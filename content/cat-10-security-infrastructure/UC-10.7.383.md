<!-- AUTO-GENERATED from UC-10.7.383.json — DO NOT EDIT -->
...
# UC-10.7.383 · Linux Medusa Rootkit

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Linux Medusa Rootkit" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

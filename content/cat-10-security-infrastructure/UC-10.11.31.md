<!-- AUTO-GENERATED from UC-10.11.31.json — DO NOT EDIT -->
...
*We use Check Point data and alerts to stay ahead of the risks described in "Check Point SandBlast Threat Emulation Results". We help the team notice trouble early, while a situation is still small and containable.*
...
- `stats` rolls up events into metrics; results are split **by verdict, file_type, md5** so each row reflects one combination of those dimensions.

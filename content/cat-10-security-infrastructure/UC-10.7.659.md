<!-- AUTO-GENERATED from UC-10.7.659.json — DO NOT EDIT -->
...
# UC-10.7.659 · Windows Unusual SysWOW64 Process Run System32 Executable

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Unusual SysWOW64 Process Run System32 Executable" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

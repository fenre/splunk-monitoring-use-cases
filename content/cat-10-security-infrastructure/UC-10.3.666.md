<!-- AUTO-GENERATED from UC-10.3.666.json — DO NOT EDIT -->
...
# UC-10.3.666 · Wscript Or Cscript Suspicious Child Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Wscript Or Cscript Suspicious Child Process”, so we catch real tradecraft and not just noise from everyday work.*

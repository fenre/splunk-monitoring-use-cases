<!-- AUTO-GENERATED from UC-10.3.33.json — DO NOT EDIT -->
...
# UC-10.3.33 · BITS Job Persistence

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “BITS Job Persistence” so we can see attacker-style moves—not only a one-off file or password mistake.*

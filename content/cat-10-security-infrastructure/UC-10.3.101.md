<!-- AUTO-GENERATED from UC-10.3.101.json — DO NOT EDIT -->
...
# UC-10.3.101 · Disabling Defender Services

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Disabling Defender Services” so we can see attacker-style moves—not only a one-off file or password mistake.*

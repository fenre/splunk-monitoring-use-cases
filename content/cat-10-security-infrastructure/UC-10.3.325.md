<!-- AUTO-GENERATED from UC-10.3.325.json — DO NOT EDIT -->
...
# UC-10.3.325 · Single Letter Process On Endpoint

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Single Letter Process On Endpoint” so we can see attacker-style moves—not only a one-off file or password mistake.*

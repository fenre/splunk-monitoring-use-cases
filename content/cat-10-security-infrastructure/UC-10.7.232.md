<!-- AUTO-GENERATED from UC-10.7.232.json — DO NOT EDIT -->
...
# UC-10.7.232 · Kubernetes Nginx Ingress RFI

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Kubernetes Nginx Ingress RFI so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

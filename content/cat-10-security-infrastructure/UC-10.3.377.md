<!-- AUTO-GENERATED from UC-10.3.377.json — DO NOT EDIT -->
...
# UC-10.3.377 · Wermgr Process Create Executable File

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Wermgr Process Create Executable File”, so we catch real tradecraft and not just noise from everyday work.*

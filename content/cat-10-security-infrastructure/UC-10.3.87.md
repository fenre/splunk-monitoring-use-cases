<!-- AUTO-GENERATED from UC-10.3.87.json — DO NOT EDIT -->
...
# UC-10.3.87 · Disable Defender MpEngine Registry

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Disable Defender MpEngine Registry” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.7.517.json — DO NOT EDIT -->
...
*We keep an eye on when a Windows service is modified from a start type to disabled so unusual activity is visible early — before it spreads or hides in normal noise.*

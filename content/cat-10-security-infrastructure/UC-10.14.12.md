...
*We look for hidden VPNs or tunnels into the plant that bypass the path we want every remote session to use.*
...
OT firewall denies from authorized engineering access, vendor remote support, or scheduled maintenance VPN sessions can look like tunnel abuse — compare to the approved slot and source identity.

<!-- AUTO-GENERATED from UC-10.3.83.json — DO NOT EDIT -->
...
# UC-10.3.83 · Detection of tools built by NirSoft

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Detection of tools built by NirSoft” so we can see attacker-style moves—not only a one-off file or password mistake.*

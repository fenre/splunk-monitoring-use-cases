<!-- AUTO-GENERATED from UC-10.7.640.json — DO NOT EDIT -->
...
# UC-10.7.640 · Windows Suspicious C2 Named Pipe

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Suspicious C2 Named Pipe" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

---

## Description

This detection identifies Windows Suspicious C2 Named Pipe. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

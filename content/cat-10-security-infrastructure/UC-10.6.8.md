<!-- AUTO-GENERATED from UC-10.6.8.json — DO NOT EDIT -->

---
id: "10.6.8"
title: "Cisco Duo Policy Allow Old Flash"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.6.8 · Cisco Duo Policy Allow Old Flash

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies instances where a Duo administrator creates or updates a policy to allow the use of outdated Flash components, specifically by detecting policy changes with the flash_remediation=no remediation attribute, and we use Splunk so the team can see it early and act.*

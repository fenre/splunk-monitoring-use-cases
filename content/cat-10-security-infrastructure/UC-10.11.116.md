<!-- AUTO-GENERATED from UC-10.11.116.json — DO NOT EDIT -->

---
id: "10.11.116"
title: "Tenable WAS Remediation Verification Scans"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.11.116 · Tenable WAS Remediation Verification Scans

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use Tenable data and alerts to stay ahead of the risks described in "Tenable WAS Remediation Verification Scans". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

Verification scans prove web fixes before production promotion.
...
- `stats` rolls up events into metrics; results are split **by finding_id, status** so each row reflects one combination of those dimensions.
...
Table (open findings), Line chart.

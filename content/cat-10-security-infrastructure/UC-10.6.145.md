<!-- AUTO-GENERATED from UC-10.6.145.json — DO NOT EDIT -->
...
# UC-10.6.145 · Confluence Data Center and Server Privilege Escalation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies potential exploitation attempts on a known vulnerability in Atlassian Confluence, specifically targeting the /setup/*.action* URL pattern, and we use Splunk so the team can see it early and act.*
...
- [https://attackerkb.com/topics/Q5f0ItSzw5/cve-2023-22515](https://attackerkb.com/topics/Q5f0ItSzw5/cve-2023-22515)

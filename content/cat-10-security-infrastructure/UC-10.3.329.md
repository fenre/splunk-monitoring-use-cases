<!-- AUTO-GENERATED from UC-10.3.329.json — DO NOT EDIT -->
...
# UC-10.3.329 · Sqlite Module In Temp Folder

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Sqlite Module In Temp Folder” so we can see attacker-style moves—not only a one-off file or password mistake.*

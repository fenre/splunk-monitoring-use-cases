<!-- AUTO-GENERATED from UC-10.6.53.json — DO NOT EDIT -->
...
# UC-10.6.53 · Linux pkexec Privilege Escalation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the execution of without any command-line arguments, and we use Splunk so the team can see it early and act.*
...
- [https://man.archlinux.org/man/pkexec.1](https://man.archlinux.org/man/pkexec.1)

...
*We add these signals to the risk story for "Windows File and Directory Permissions Enable Inheritance" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.3.621.json — DO NOT EDIT -->
...
# UC-10.3.621 · Windows Server Software Component GACUtil Install to GAC

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Server Software Component GACUtil Install to GAC”, so we catch real tradecraft and not just noise from everyday work.*

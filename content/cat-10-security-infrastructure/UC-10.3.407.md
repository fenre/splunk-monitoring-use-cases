<!-- AUTO-GENERATED from UC-10.3.407.json — DO NOT EDIT -->
...
# UC-10.3.407 · Windows Cached Domain Credentials Reg Query

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Cached Domain Credentials Reg Query”, so we catch real tradecraft and not just noise from everyday work.*

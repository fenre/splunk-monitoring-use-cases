<!-- AUTO-GENERATED from UC-10.6.40.json — DO NOT EDIT -->
...
# UC-10.6.40 · Control Loading from World Writable Directory

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies instances of control.exe loading.cpl or.inf file from a writable directory, which is related to, and we use Splunk so the team can see it early and act.*

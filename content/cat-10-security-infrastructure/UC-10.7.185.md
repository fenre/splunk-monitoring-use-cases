<!-- AUTO-GENERATED from UC-10.7.185.json — DO NOT EDIT -->
...
# UC-10.7.185 · Detect AWS Console Login by User from New Country

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for the behavior in “Detect AWS Console Login by User from New Country” using the same log fields the detection already uses, so the team can act before impact spreads.*
...
First-time or rare console and region context during travel, new laptops, and MSP access; map to the IAM user in the console.

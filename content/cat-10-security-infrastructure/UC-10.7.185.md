...
*We look for the behavior in “Detect AWS Console Login by User from New Country” using the same CIM-backed fields as the detection, so the team can act before impact spreads.*

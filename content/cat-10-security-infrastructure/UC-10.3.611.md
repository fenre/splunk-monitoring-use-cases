<!-- AUTO-GENERATED from UC-10.3.611.json — DO NOT EDIT -->
...
# UC-10.3.611 · Windows Scheduled Task DLL Module Loaded

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Scheduled Task DLL Module Loaded”, so we catch real tradecraft and not just noise from everyday work.*
...
Known false positives for this detection: Tasks created by software installers, OS patch manager, or scheduled config sync.
...
Tasks created by software installers, OS patch manager, or scheduled config sync.

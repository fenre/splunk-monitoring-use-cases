<!-- AUTO-GENERATED from UC-10.3.527.json — DO NOT EDIT -->
...
# UC-10.3.527 · Windows Modify Registry DisAllow Windows App

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Modify Registry DisAllow Windows App”, so we catch real tradecraft and not just noise from everyday work.*

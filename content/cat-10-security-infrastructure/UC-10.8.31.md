<!-- AUTO-GENERATED from UC-10.8.31.json — DO NOT EDIT -->
...
# UC-10.8.31 · Windows Steal Authentication Certificates Export Certificate

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the use of the PowerShell cmdlet 'export-certificate' executed using the command line, indicating an attempt to export a certificate from the local Windows Certificate Store — so we know when protection is off, out of date, or bypassed.*

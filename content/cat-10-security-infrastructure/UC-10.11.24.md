<!-- AUTO-GENERATED from UC-10.11.24.json — DO NOT EDIT -->

---
id: "10.11.24"
title: "Palo Alto DNS Sinkhole Hits"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.11.24 · Palo Alto DNS Sinkhole Hits

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use Palo Alto Networks firewall data and alerts to stay ahead of the risks described in "Palo Alto DNS Sinkhole Hits". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

Sinkhole hits are high-fidelity indicators of compromised clients resolving malicious domains.
...
- `stats` rolls up events into metrics; results are split **by src, fqdn** so each row reflects one combination of those dimensions.
...
Table (hosts hitting sinkhole), Map (src).

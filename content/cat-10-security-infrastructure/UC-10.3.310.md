<!-- AUTO-GENERATED from UC-10.3.310.json — DO NOT EDIT -->
...
# UC-10.3.310 · SchCache Change By App Connect And Create ADSI Object

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “SchCache Change By App Connect And Create ADSI Object” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
Bulk file modifications from backup software (CrashPlan, Code42), DLP scanning, AV full scans, OS patching, or VDI image refresh.

## References

- [https://learn.microsoft.com/en-us/windows/win32/adsi/adsi-and-uac](https://learn.microsoft.com/en-us/windows/win32/adsi/adsi-and-uac)

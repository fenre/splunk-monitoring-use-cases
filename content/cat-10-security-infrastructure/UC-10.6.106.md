<!-- AUTO-GENERATED from UC-10.6.106.json — DO NOT EDIT -->
...
# UC-10.6.106 · Windows Office Product Spawned Uncommon Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects a Microsoft Office product spawning uncommon processes, and we use Splunk so the team can see it early and act.*

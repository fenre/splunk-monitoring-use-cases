<!-- AUTO-GENERATED from UC-10.3.418.json — DO NOT EDIT -->
...
# UC-10.3.418 · Windows Compatibility Telemetry Suspicious Child Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Compatibility Telemetry Suspicious Child Process”, so we catch real tradecraft and not just noise from everyday work.*
...
```spl
| from datamodel Endpoint.Processes | search dest = "$dest$" AND process_name = "$process_name$
```

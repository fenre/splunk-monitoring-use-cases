<!-- AUTO-GENERATED from UC-10.6.26.json — DO NOT EDIT -->
...
# UC-10.6.26 · Circle CI Disable Security Step

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the disablement of security steps in a CircleCI pipeline, and we use Splunk so the team can see it early and act.*

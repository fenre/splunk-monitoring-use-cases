<!-- AUTO-GENERATED from UC-10.6.175.json — DO NOT EDIT -->
...
# UC-10.6.175 · Log4Shell JNDI Payload Injection Attempt

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies attempts to inject Log4Shell JNDI payloads using web calls, and we use Splunk so the team can see it early and act.*

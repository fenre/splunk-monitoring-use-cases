...
*We use this 'Correlation Search Performance' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*
...
One-off long runs when enabling many rules, rebuilding summaries, or during data backfills; compare to search load and content pushes.

...
*We track how many network-threat alerts fire at each severity over time, so we can spot surges, noisy rules, and attack campaigns that need analyst attention or tuning.*
...
Authorized vulnerability scanners (Tenable, Qualys, Rapid7) and penetration or red team exercises often drive surges in high-severity signature counts. Newly pushed rule sets, noisy campaigns, and SSL inspection can also spike volume without a material incident.

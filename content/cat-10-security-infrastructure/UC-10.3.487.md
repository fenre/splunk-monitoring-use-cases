<!-- AUTO-GENERATED from UC-10.3.487.json — DO NOT EDIT -->
...
# UC-10.3.487 · Windows Impair Defense Override SmartScreen Prompt

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Impair Defense Override SmartScreen Prompt”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.6.171.json — DO NOT EDIT -->
...
# UC-10.6.171 · JetBrains TeamCity Authentication Bypass Suricata CVE-2024-27198

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit the vulnerability in JetBrains TeamCity on-premises servers, which allows attackers to bypass authentication mechanisms, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.7.310.json — DO NOT EDIT -->
...
# UC-10.7.310 · File Download or Read to Pipe Execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for File Download or Read to Pipe Execution so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

---

## Description

This detection identifies File Download or Read to Pipe Execution. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.
...
- [https://github.com/MHaggis/notes/blob/master/utilities/warp_pipe_tester.py](https://github.com/MHaggis/notes/blob/master/utilities/warp_pipe_tester.py)
...
- [https://securelist.com/bad-magic-apt/109087/](https://securelist.com/bad-magic-apt/109087/)

<!-- AUTO-GENERATED from UC-10.2.59.json — DO NOT EDIT -->
...
# UC-10.2.59 · Microsoft Defender ATP Alerts

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*Is to leverage alerts from Microsoft Defender ATP Alerts — so we know when protection is off, out of date, or bypassed.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to URL entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires MS Defender ATP Alerts ingested and CIM-normalized.
...
Build pipelines, secret rotation, and config agents touch credentials constantly; false positives are common without pipeline and service-account context.

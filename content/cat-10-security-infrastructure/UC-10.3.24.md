<!-- AUTO-GENERATED from UC-10.3.24.json — DO NOT EDIT -->
...
# UC-10.3.24 · 7zip CommandLine To SMB Share Path

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “7zip CommandLine To SMB Share Path” so we can see attacker-style moves—not only a one-off file or password mistake.*

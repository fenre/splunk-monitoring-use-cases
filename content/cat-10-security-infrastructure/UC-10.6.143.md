<!-- AUTO-GENERATED from UC-10.6.143.json — DO NOT EDIT -->
...
# UC-10.6.143 · Citrix ShareFile Exploitation CVE-2023-24489

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects potentially malicious file upload attempts to Citrix ShareFile using specific suspicious URLs and the HTTP POST method, and we use Splunk so the team can see it early and act.*

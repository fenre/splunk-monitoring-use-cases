<!-- AUTO-GENERATED from UC-10.6.62.json — DO NOT EDIT -->
...
# UC-10.6.62 · Print Spooler Adding A Printer Driver

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the addition of new printer drivers by monitoring Windows PrintService operational logs, specifically EventCode 316, and we use Splunk so the team can see it early and act.*

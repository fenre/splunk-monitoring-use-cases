<!-- AUTO-GENERATED from UC-10.3.622.json — DO NOT EDIT -->
...
# UC-10.3.622 · Windows Service Create Kernel Mode Driver

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Service Create Kernel Mode Driver”, so we catch real tradecraft and not just noise from everyday work.*
...
- [https://whiteknightlabs.com/2025/11/25/discreet-driver-loading-in-windows/](https://whiteknightlabs.com/2025/11/25/discreet-driver-loading-in-windows/)
- [https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/sc-config](https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/sc-config)

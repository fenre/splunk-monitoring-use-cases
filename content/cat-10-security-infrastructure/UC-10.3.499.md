<!-- AUTO-GENERATED from UC-10.3.499.json — DO NOT EDIT -->
...
# UC-10.3.499 · Windows InstallUtil Remote Network Connection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows InstallUtil Remote Network Connection”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.7.381.json — DO NOT EDIT -->
...
# UC-10.7.381 · Linux File Creation In Profile Directory

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Linux File Creation In Profile Directory" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

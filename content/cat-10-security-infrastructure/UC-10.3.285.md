<!-- AUTO-GENERATED from UC-10.3.285.json — DO NOT EDIT -->
...
# UC-10.3.285 · Recon AVProduct Through Pwh or WMI

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Recon AVProduct Through Pwh or WMI” so we can see attacker-style moves—not only a one-off file or password mistake.*

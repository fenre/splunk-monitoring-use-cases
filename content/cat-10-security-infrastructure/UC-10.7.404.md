<!-- AUTO-GENERATED from UC-10.7.404.json — DO NOT EDIT -->
...
# UC-10.7.404 · Powershell COM Hijacking InprocServer32 Modification

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Powershell COM Hijacking InprocServer32 Modification" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.7.65.json — DO NOT EDIT -->

---
id: "10.7.65"
title: "Splunk AppDynamics Secure Application Alerts"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.7.65 · Splunk AppDynamics Secure Application Alerts

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Splunk AppDynamics Secure Application Alerts so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

---

## Description

This detection identifies Splunk AppDynamics Secure Application Alerts. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.
...
- [https://docs.appdynamics.com/appd/24.x/latest/en/application-security-monitoring/integrate-cisco-secure-application-with-splunk](https://docs.appdynamics.com/appd/24.x/latest/en/application-security-monitoring/integrate-cisco-secure-application-with-splunk)

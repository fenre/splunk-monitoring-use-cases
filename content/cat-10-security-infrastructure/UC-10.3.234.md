<!-- AUTO-GENERATED from UC-10.3.234.json — DO NOT EDIT -->
...
# UC-10.3.234 · Linux Setuid Using Setcap Utility

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Setuid Using Setcap Utility” so we can see attacker-style moves—not only a one-off file or password mistake.*

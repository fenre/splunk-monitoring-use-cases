<!-- AUTO-GENERATED from UC-10.7.190.json — DO NOT EDIT -->
...
# UC-10.7.190 · Detect S3 access from a new IP

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use this 'Detect S3 access from a new IP' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*
...
First-seen S3 access from new batch jobs, partner feeds, and analytics clusters; use bucket policy and app owners for context.

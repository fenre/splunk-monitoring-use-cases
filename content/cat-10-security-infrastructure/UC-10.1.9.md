<!-- AUTO-GENERATED from UC-10.1.9.json — DO NOT EDIT -->
...
# UC-10.1.9 · Cisco ASA - Device File Copy Activity

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This detection identifies Cisco ASA - Device File Copy Activity — so we know when protection is off, out of date, or bypassed.*

---

## Description

This detection identifies Cisco ASA - Device File Copy Activity. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

<!-- AUTO-GENERATED from UC-10.2.159.json — DO NOT EDIT -->

---
id: "10.2.159"
title: "Windows User Deletion Via Net"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.2.159 · Windows User Deletion Via Net

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the use of net.exe or net1.exe command-line to delete a user account on a system — so we know when protection is off, out of date, or bypassed.*

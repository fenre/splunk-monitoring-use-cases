<!-- AUTO-GENERATED from UC-10.3.606.json — DO NOT EDIT -->
...
# UC-10.3.606 · Windows Remote Services Allow Remote Assistance

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Remote Services Allow Remote Assistance”, so we catch real tradecraft and not just noise from everyday work.*

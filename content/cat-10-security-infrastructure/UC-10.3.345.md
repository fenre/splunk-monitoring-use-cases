<!-- AUTO-GENERATED from UC-10.3.345.json — DO NOT EDIT -->
...
# UC-10.3.345 · Suspicious Process Executed From Container File

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Suspicious Process Executed From Container File”, so we catch real tradecraft and not just noise from everyday work.*

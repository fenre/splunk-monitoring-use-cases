<!-- AUTO-GENERATED from UC-10.7.518.json — DO NOT EDIT -->
...
# UC-10.7.518 · Windows Event Log Cleared

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Event Log Cleared" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
- [https://learn.microsoft.com/en-us/windows/security/threat-protection/auditing/event-1102](https://learn.microsoft.com/en-us/windows/security/threat-protection/auditing/event-1102)

<!-- AUTO-GENERATED from UC-10.7.607.json — DO NOT EDIT -->
...
# UC-10.7.607 · Windows Raw Access To Master Boot Record Drive

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Raw Access To Master Boot Record Drive" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

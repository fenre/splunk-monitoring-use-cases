<!-- AUTO-GENERATED from UC-10.1.21.json — DO NOT EDIT -->
...
# UC-10.1.21 · Abnormally High Number Of Cloud Security Group API Calls

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects a spike in the number of calls made to cloud security groups by a user — so we know when protection is off, out of date, or bypassed.*

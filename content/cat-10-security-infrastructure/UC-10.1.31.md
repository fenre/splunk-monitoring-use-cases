<!-- AUTO-GENERATED from UC-10.1.31.json — DO NOT EDIT -->
...
# UC-10.1.31 · Linux Stdout Redirection To Dev Null File

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects command-line activities that redirect stdout or stderr to the /dev/null file — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.1.27.json — DO NOT EDIT -->
...
# UC-10.1.27 · Disabling Firewall with Netsh

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies the disabling of the firewall using the netsh application — so we know when protection is off, out of date, or bypassed.*

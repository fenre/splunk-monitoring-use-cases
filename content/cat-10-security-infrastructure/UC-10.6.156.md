<!-- AUTO-GENERATED from UC-10.6.156.json — DO NOT EDIT -->
...
# UC-10.6.156 · F5 TMUI Authentication Bypass

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit the vulnerability, an authentication bypass flaw in F5 BIG-IP's Configuration utility (TMUI), and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.3.220.json — DO NOT EDIT -->
...
# UC-10.3.220 · Linux Possible Access To Credential Files

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Possible Access To Credential Files” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.3.156.json — DO NOT EDIT -->
...
# UC-10.3.156 · Linux Account Manipulation Of SSH Config and Keys

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Account Manipulation Of SSH Config and Keys” so we can see attacker-style moves—not only a one-off file or password mistake.*

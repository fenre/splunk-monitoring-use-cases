<!-- AUTO-GENERATED from UC-10.3.658.json — DO NOT EDIT -->
...
# UC-10.3.658 · Windows WinDBG Spawning AutoIt3

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows WinDBG Spawning AutoIt3”, so we catch real tradecraft and not just noise from everyday work.*

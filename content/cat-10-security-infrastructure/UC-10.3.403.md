<!-- AUTO-GENERATED from UC-10.3.403.json — DO NOT EDIT -->
...
# UC-10.3.403 · Windows Boot or Logon Autostart Execution In Startup Folder

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Boot or Logon Autostart Execution In Startup Folder”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.7.554.json — DO NOT EDIT -->
...
# UC-10.7.554 · Windows Modify Registry on Smart Card Group Policy

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Modify Registry on Smart Card Group Policy" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

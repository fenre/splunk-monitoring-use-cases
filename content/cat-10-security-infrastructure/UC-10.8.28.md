<!-- AUTO-GENERATED from UC-10.8.28.json — DO NOT EDIT -->
...
# UC-10.8.28 · Windows Steal Authentication Certificates CertUtil Backup

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects CertUtil.exe performing a backup of the Certificate Store — so we know when protection is off, out of date, or bypassed.*

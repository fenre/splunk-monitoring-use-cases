<!-- AUTO-GENERATED from UC-10.7.51.json — DO NOT EDIT -->
...
# UC-10.7.51 · Okta New Device Enrolled on Account
...
- [https://developer.okta.com/docs/reference/api/event-types/?q=device.enrollment.create](https://developer.okta.com/docs/reference/api/event-types/?q=device.enrollment.create)

<!-- AUTO-GENERATED from UC-10.3.54.json — DO NOT EDIT -->
...
*We use endpoint and security-agent signals around “CSC Net On The Fly Compilation” so we can see attacker-style moves—not only a one-off file or password mistake.*

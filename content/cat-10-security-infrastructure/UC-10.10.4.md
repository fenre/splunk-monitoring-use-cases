...
*We watch how long our searches run so heavy or fragile rules do not blind us when seconds matter.*
...
Run-time spikes during index or threat-intel growth, ad-hoc backfills, or shared search-head load can look like a broken rule when the system is just busy — compare to scheduled job overlap.

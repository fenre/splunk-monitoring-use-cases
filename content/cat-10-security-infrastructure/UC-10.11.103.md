<!-- AUTO-GENERATED from UC-10.11.103.json — DO NOT EDIT -->
...
*We use CrowdStrike data and alerts to stay ahead of the risks described in "CrowdStrike Cloud Workload Protection Detections". We help the team notice trouble early, while a situation is still small and containable.*
...
- `stats` rolls up events into metrics; results are split **by cluster, image, technique** so each row reflects one combination of those dimensions.

<!-- AUTO-GENERATED from UC-10.3.301.json — DO NOT EDIT -->
...
# UC-10.3.301 · Rundll32 LockWorkStation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Rundll32 LockWorkStation” so we can see attacker-style moves—not only a one-off file or password mistake.*

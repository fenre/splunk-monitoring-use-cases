<!-- AUTO-GENERATED from UC-10.3.251.json — DO NOT EDIT -->
...
# UC-10.3.251 · Modification Of Wallpaper

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Modification Of Wallpaper” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.11.40.json — DO NOT EDIT -->
...
*We use Check Point data and alerts to stay ahead of the risks described in "Check Point Threat Extraction Results". We help the team notice trouble early, while a situation is still small and containable.*
...
- `stats` rolls up events into metrics; results are split **by extract_action, file_name** so each row reflects one combination of those dimensions.

...
*We trend phishing and similar mail so we can see a campaign season or a new bypass path without guessing from anecdotes.*
...
Phishing volume can surge during vendor campaigns, marketing pushes, and broad credential-spray seasons without a new technique — compare to user reports.

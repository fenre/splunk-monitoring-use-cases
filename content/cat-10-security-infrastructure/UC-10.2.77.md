<!-- AUTO-GENERATED from UC-10.2.77.json — DO NOT EDIT -->
...
# UC-10.2.77 · Remote Process Instantiation via WinRM and PowerShell

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of with arguments used to start a process on a remote endpoint using the WinRM protocol, specifically targeting the cmdlet — so we know when protection is off, out of date, or bypassed.*

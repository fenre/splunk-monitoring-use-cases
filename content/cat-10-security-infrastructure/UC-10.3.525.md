<!-- AUTO-GENERATED from UC-10.3.525.json — DO NOT EDIT -->
...
# UC-10.3.525 · Windows Modify Registry DisableSecuritySettings

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Modify Registry DisableSecuritySettings”, so we catch real tradecraft and not just noise from everyday work.*

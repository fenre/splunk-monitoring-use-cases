<!-- AUTO-GENERATED from UC-10.3.275.json — DO NOT EDIT -->
...
# UC-10.3.275 · PowerShell Script Block With URL Chain

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “PowerShell Script Block With URL Chain” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.3.508.json — DO NOT EDIT -->
...
# UC-10.3.508 · Windows LSA Secrets NoLMhash Registry

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows LSA Secrets NoLMhash Registry”, so we catch real tradecraft and not just noise from everyday work.*

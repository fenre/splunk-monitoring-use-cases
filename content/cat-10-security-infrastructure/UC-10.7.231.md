<!-- AUTO-GENERATED from UC-10.7.231.json — DO NOT EDIT -->
...
# UC-10.7.231 · Kubernetes Nginx Ingress LFI

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Kubernetes Nginx Ingress LFI so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

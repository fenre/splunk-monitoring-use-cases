<!-- AUTO-GENERATED from UC-10.3.506.json — DO NOT EDIT -->
...
# UC-10.3.506 · Windows List ENV Variables Via SET Command From Uncommon Parent

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows List ENV Variables Via SET Command From Uncommon Parent”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.8.10.json — DO NOT EDIT -->
...
# UC-10.8.10 · Detect Certify Command Line Arguments

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the use of Certify or Certipy tools to enumerate Active Directory Certificate Services (AD CS) environments — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.3.256.json — DO NOT EDIT -->
...
# UC-10.3.256 · Mshta spawning Rundll32 OR Regsvr32 Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Mshta spawning Rundll32 OR Regsvr32 Process” so we can see attacker-style moves—not only a one-off file or password mistake.*

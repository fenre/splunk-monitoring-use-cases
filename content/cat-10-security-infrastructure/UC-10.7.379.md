<!-- AUTO-GENERATED from UC-10.7.379.json — DO NOT EDIT -->
...
# UC-10.7.379 · Linux Edit Cron Table Parameter

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on the suspicious editing of cron jobs in Linux using the crontab command-line parameter (-e) so unusual activity is visible early — before it spreads or hides in normal noise.*

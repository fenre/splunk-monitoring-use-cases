<!-- AUTO-GENERATED from UC-10.3.364.json — DO NOT EDIT -->
...
# UC-10.3.364 · Trickbot Named Pipe

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Trickbot Named Pipe”, so we catch real tradecraft and not just noise from everyday work.*

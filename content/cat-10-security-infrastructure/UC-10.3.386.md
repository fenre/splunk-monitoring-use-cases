<!-- AUTO-GENERATED from UC-10.3.386.json — DO NOT EDIT -->
...
# UC-10.3.386 · Windows App Layer Protocol Wermgr Connect To NamedPipe

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows App Layer Protocol Wermgr Connect To NamedPipe”, so we catch real tradecraft and not just noise from everyday work.*

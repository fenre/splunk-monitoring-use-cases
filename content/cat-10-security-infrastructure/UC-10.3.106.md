<!-- AUTO-GENERATED from UC-10.3.106.json — DO NOT EDIT -->
...
# UC-10.3.106 · DNS Exfiltration Using Nslookup App

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “DNS Exfiltration Using Nslookup App” so we can see attacker-style moves—not only a one-off file or password mistake.*

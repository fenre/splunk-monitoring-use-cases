<!-- AUTO-GENERATED from UC-10.2.99.json — DO NOT EDIT -->
...
*We catch the potential abuse of the verclsid.exe utility to execute malicious files using generated CLSIDs — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.3.108.json — DO NOT EDIT -->
...
# UC-10.3.108 · Domain Controller Discovery with Nltest

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Domain Controller Discovery with Nltest” so we can see attacker-style moves—not only a one-off file or password mistake.*

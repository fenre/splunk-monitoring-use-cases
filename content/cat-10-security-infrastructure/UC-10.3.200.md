<!-- AUTO-GENERATED from UC-10.3.200.json — DO NOT EDIT -->
...
# UC-10.3.200 · Linux High Frequency Of File Deletion In Boot Folder

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux High Frequency Of File Deletion In Boot Folder” so we can see attacker-style moves—not only a one-off file or password mistake.*

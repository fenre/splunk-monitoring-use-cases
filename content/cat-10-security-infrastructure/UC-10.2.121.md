<!-- AUTO-GENERATED from UC-10.2.121.json — DO NOT EDIT -->
...
# UC-10.2.121 · Windows Impair Defense Disable Win Defender Signature Retirement

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch modifications to the Windows registry that disable Windows Defender Signature Retirement — so we know when protection is off, out of date, or bypassed.*

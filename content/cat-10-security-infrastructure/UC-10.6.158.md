<!-- AUTO-GENERATED from UC-10.6.158.json — DO NOT EDIT -->

---
id: "10.6.158"
title: "HTTP Possible Request Smuggling"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.6.158 · HTTP Possible Request Smuggling

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*HTTP request smuggling is a technique for interfering with the way a web site processes sequences of HTTP requests that are received from one or more users, and we use Splunk so the team can see it early and act.*

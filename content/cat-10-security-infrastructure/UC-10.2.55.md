<!-- AUTO-GENERATED from UC-10.2.55.json — DO NOT EDIT -->

---
id: "10.2.55"
title: "Linux Auditd Find Credentials From Password Managers"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.2.55 · Linux Auditd Find Credentials From Password Managers

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch suspicious attempts to find credentials stored in password managers, which may indicate an attacker's effort to retrieve sensitive login information — so we know when protection is off, out of date, or bypassed.*

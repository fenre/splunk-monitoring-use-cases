<!-- AUTO-GENERATED from UC-10.3.215.json — DO NOT EDIT -->
...
# UC-10.3.215 · Linux Obfuscated Files or Information Base64 Decode

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Obfuscated Files or Information Base64 Decode” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
- [https://man.archlinux.org/man/base64.1](https://man.archlinux.org/man/base64.1)

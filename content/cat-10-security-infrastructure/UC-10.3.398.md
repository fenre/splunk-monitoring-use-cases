<!-- AUTO-GENERATED from UC-10.3.398.json — DO NOT EDIT -->
...
# UC-10.3.398 · Windows Autostart Execution LSASS Driver Registry Modification

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Autostart Execution LSASS Driver Registry Modification”, so we catch real tradecraft and not just noise from everyday work.*

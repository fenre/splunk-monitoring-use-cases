<!-- AUTO-GENERATED from UC-10.3.461.json — DO NOT EDIT -->
...
# UC-10.3.461 · Windows Findstr GPP Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Findstr GPP Discovery”, so we catch real tradecraft and not just noise from everyday work.*

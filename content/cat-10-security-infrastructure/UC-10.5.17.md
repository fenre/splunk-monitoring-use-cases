<!-- AUTO-GENERATED from UC-10.5.17.json — DO NOT EDIT -->

---
id: "10.5.17"
title: "Zscaler Privacy Risk Destinations Threat Blocked"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.5.17 · Zscaler Privacy Risk Destinations Threat Blocked

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We align Splunk with Zscaler so we can see which web threats the SWG blocks and which users and destinations need follow-up.*
...
Compare with the Zscaler ZIA admin portal (web security, policy blocks, and affected users) for the same time range; then confirm field extractions and index permissions in Splunk.
...
Anomalies from new SaaS rollouts, browser or agent updates, or vendor category changes; review against change windows and approved app lists.

## References

- [CIM: Web](https://docs.splunk.com/Documentation/CIM/latest/User/Web)
- [Zscaler ZIA — NSS web log format](https://help.zscaler.com/zia/nss-feed-output-format-web-logs)

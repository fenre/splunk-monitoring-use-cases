<!-- AUTO-GENERATED from UC-10.6.79.json — DO NOT EDIT -->

---
id: "10.6.79"
title: "Windows Credential Target Information Structure in Commandline"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.6.79 · Windows Credential Target Information Structure in Commandline

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch -based Kerberos coercion attacks where adversaries inject marshaled credential structures into records to spoof SPNs and redirect authentication such as, and we use Splunk so the team can see it early and act.*

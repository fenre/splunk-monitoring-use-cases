<!-- AUTO-GENERATED from UC-10.7.478.json — DO NOT EDIT -->
...
# UC-10.7.478 · Windows Archive Collected Data via Powershell

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Archive Collected Data via Powershell" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

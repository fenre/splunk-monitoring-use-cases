<!-- AUTO-GENERATED from UC-10.7.602.json — DO NOT EDIT -->
...
# UC-10.7.602 · Windows Process Injection With Public Source Path

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on a process from a non-standard file path on Windows attempting to create a remote thread in another process so unusual activity is visible early — before it spreads or hides in normal noise.*

<!-- AUTO-GENERATED from UC-10.3.274.json — DO NOT EDIT -->
...
# UC-10.3.274 · Powershell Remove Windows Defender Directory

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Powershell Remove Windows Defender Directory” so we can see attacker-style moves—not only a one-off file or password mistake.*

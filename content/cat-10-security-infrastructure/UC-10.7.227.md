<!-- AUTO-GENERATED from UC-10.7.227.json — DO NOT EDIT -->
...
# UC-10.7.227 · Kubernetes DaemonSet Deployed

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Kubernetes DaemonSet Deployed so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

<!-- AUTO-GENERATED from UC-10.3.521.json — DO NOT EDIT -->
...
# UC-10.3.521 · Windows Modify Registry Disable Win Defender Raw Write Notif

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Modify Registry Disable Win Defender Raw Write Notif”, so we catch real tradecraft and not just noise from everyday work.*

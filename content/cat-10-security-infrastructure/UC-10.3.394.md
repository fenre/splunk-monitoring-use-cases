<!-- AUTO-GENERATED from UC-10.3.394.json — DO NOT EDIT -->
...
# UC-10.3.394 · Windows Audit Policy Disabled via Legacy Auditpol

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Audit Policy Disabled via Legacy Auditpol”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.7.252.json — DO NOT EDIT -->
...
# UC-10.7.252 · AdsiSearcher Account Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for AdsiSearcher Account Discovery so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

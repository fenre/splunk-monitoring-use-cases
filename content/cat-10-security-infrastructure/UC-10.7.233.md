<!-- AUTO-GENERATED from UC-10.7.233.json — DO NOT EDIT -->
...
# UC-10.7.233 · Kubernetes Node Port Creation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Kubernetes Node Port Creation so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

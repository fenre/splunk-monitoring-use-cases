<!-- AUTO-GENERATED from UC-10.6.114.json — DO NOT EDIT -->
...
# UC-10.6.114 · Windows SpeechRuntime COM Hijacking DLL Load

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*SpeechRuntime is vulnerable to an attack that allows a user to run code on another user's session remotely and stealthily by exploiting a Windows COM class, and we use Splunk so the team can see it early and act.*

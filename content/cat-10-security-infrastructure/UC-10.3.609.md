<!-- AUTO-GENERATED from UC-10.3.609.json — DO NOT EDIT -->
...
# UC-10.3.609 · Windows Rundll32 Load DLL in Temp Dir

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Rundll32 Load DLL in Temp Dir”, so we catch real tradecraft and not just noise from everyday work.*

...
*We use endpoint and security-agent signals around “Linux Possible Append Cronjob Entry on Existing Cronjob File” so we can see attacker-style moves—not only a one-off file or password mistake.*

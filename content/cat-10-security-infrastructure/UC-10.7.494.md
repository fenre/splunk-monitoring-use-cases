<!-- AUTO-GENERATED from UC-10.7.494.json — DO NOT EDIT -->
...
# UC-10.7.494 · Windows Computer Account Requesting Kerberos Ticket

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Computer Account Requesting Kerberos Ticket" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.6.179.json — DO NOT EDIT -->
...
# UC-10.6.179 · Spring4Shell Payload URL Request

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit the Spring4Shell vulnerability by identifying specific URL patterns associated with web shell payloads, and we use Splunk so the team can see it early and act.*

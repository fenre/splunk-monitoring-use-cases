<!-- AUTO-GENERATED from UC-10.3.10.json — DO NOT EDIT -->
...
# UC-10.3.10 · Detect HTML Help Spawn Child Process

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Detect HTML Help Spawn Child Process” so we can see attacker-style moves—not only a one-off file or password mistake.*

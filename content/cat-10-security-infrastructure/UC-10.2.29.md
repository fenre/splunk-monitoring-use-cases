<!-- AUTO-GENERATED from UC-10.2.29.json — DO NOT EDIT -->
...
# UC-10.2.29 · GCP Unusual Number of Failed Authentications From Ip

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot a single source IP failing to authenticate into Google Workspace with multiple valid users, potentially indicating a Password Spraying attack — so we know when protection is off, out of date, or bypassed.*
...
Service accounts, data pipelines, and workspace admin operations create noisy IAM and API signals; map projects and owners before escalating.

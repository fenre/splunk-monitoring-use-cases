<!-- AUTO-GENERATED from UC-10.2.54.json — DO NOT EDIT -->
...
# UC-10.2.54 · Linux Auditd Database File And Directory Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch suspicious database file and directory discovery activities, which may signal an attacker attempt to locate and assess critical database assets on a compromised system — so we know when protection is off, out of date, or bypassed.*
...
Benign events include approved admin work, change and maintenance windows, new systems being onboarded, and security or monitoring products that look similar to the activity under test. Tune with asset, identity, and time-based allow lists, and re-check after large architecture changes.

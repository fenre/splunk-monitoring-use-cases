<!-- AUTO-GENERATED from UC-10.7.255.json — DO NOT EDIT -->
...
# UC-10.7.255 · Cisco Isovalent - Late Process Execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Cisco Isovalent - Late Process Execution so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

---

## Description

This detection identifies Cisco Isovalent - Late Process Execution. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.
...
Suspicious process signals from admin tools, software installers, patch engines, and vendor management agents that use the same executables as attackers.

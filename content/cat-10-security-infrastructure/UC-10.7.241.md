<!-- AUTO-GENERATED from UC-10.7.241.json — DO NOT EDIT -->
...
# UC-10.7.241 · Kubernetes Suspicious Image Pulling

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Kubernetes Suspicious Image Pulling so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

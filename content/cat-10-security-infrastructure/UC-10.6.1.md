...
> **Criticality:** Critical &middot; **Difficulty:** Beginner &middot; **Pillar:** Security &middot; **Type:** Compliance

*We watch how many serious, known software flaws on our systems trend over time so we can focus patching, track progress, and see when we are getting stuck.*
...
Critical CVEs may show on legacy systems undergoing controlled lifecycle (e.g., end-of-life ICS gear with documented compensating controls). Some scanner detections are unauthenticated and produce false positives.

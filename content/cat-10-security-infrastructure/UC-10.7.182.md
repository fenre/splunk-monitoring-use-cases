<!-- AUTO-GENERATED from UC-10.7.182.json — DO NOT EDIT -->
...
# UC-10.7.182 · Cloud Security Groups Modifications by User

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Cloud Security Groups Modifications by User so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

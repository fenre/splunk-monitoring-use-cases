<!-- AUTO-GENERATED from UC-10.7.312.json — DO NOT EDIT -->
...
# UC-10.7.312 · Get ADDefaultDomainPasswordPolicy with Powershell Script Block

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use this 'Get ADDefaultDomainPasswordPolicy with Powershell Script Block' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*
...
PowerShell encoded and discovery commands from MDT, SCCM, inventory scripts, and authorized admin; reconcile to jump boxes and PAM.

<!-- AUTO-GENERATED from UC-10.7.188.json — DO NOT EDIT -->
...
# UC-10.7.188 · Detect New Open S3 buckets

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Detect New Open S3 buckets so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

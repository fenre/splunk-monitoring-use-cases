<!-- AUTO-GENERATED from UC-10.2.141.json — DO NOT EDIT -->
...
# UC-10.2.141 · Windows Scheduled Task Service Spawned Shell

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch when the Task Scheduler service ("svchost.exe -k netsvcs -p -s Schedule") spawns common command line, scripting, or shell execution binaries such as "powershell.exe" or "cmd.exe" — so we know when protection is off, out of date, or bypassed.*

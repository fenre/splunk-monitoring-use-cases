<!-- AUTO-GENERATED from UC-10.3.575.json — DO NOT EDIT -->
...
# UC-10.3.575 · Windows Parent PID Spoofing with Explorer

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Parent PID Spoofing with Explorer”, so we catch real tradecraft and not just noise from everyday work.*

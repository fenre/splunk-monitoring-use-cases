<!-- AUTO-GENERATED from UC-10.3.271.json — DO NOT EDIT -->
...
# UC-10.3.271 · Powershell Creating Thread Mutex

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Powershell Creating Thread Mutex” so we can see attacker-style moves—not only a one-off file or password mistake.*

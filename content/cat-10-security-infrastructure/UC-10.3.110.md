<!-- AUTO-GENERATED from UC-10.3.110.json — DO NOT EDIT -->
...
# UC-10.3.110 · Domain Group Discovery With Dsquery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Domain Group Discovery With Dsquery” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.7.412.json — DO NOT EDIT -->
...
# UC-10.7.412 · PowerShell Loading DotNET into Memory via Reflection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "PowerShell Loading DotNET into Memory via Reflection" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
- [https://learn.microsoft.com/en-us/dotnet/api/system.reflection.assembly?view=net-5.0](https://learn.microsoft.com/en-us/dotnet/api/system.reflection.assembly?view=net-5.0)

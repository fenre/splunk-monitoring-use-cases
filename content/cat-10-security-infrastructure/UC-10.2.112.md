<!-- AUTO-GENERATED from UC-10.2.112.json — DO NOT EDIT -->
...
# UC-10.2.112 · Windows Defender ASR Rules Stacking

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot security events from Microsoft Defender, focusing on Exploit Guard and Attack Surface Reduction (ASR) features — so we know when protection is off, out of date, or bypassed.*

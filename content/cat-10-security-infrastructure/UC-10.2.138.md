<!-- AUTO-GENERATED from UC-10.2.138.json — DO NOT EDIT -->
...
*We catch successful Remote Desktop Protocol (remote desktop) connections by monitoring EventCode 1149 from the Windows TerminalServices RemoteConnectionManager Operational log — so we know when protection is off, out of date, or bypassed.*

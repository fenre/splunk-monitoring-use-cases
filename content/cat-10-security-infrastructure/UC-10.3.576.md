<!-- AUTO-GENERATED from UC-10.3.576.json — DO NOT EDIT -->
...
# UC-10.3.576 · Windows Password Managers Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Password Managers Discovery”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.7.455.json — DO NOT EDIT -->
...
# UC-10.7.455 · Windows AD Privileged Account SID History Addition

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Privileged Account SID History Addition" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

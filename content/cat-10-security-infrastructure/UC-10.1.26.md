<!-- AUTO-GENERATED from UC-10.1.26.json — DO NOT EDIT -->
...
# UC-10.1.26 · Allow Network Discovery In Firewall

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects a suspicious modification to the firewall to allow network discovery on a machine — so we know when protection is off, out of date, or bypassed.*

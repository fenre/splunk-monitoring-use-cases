<!-- AUTO-GENERATED from UC-10.7.168.json — DO NOT EDIT -->
...
# UC-10.7.168 · Azure AD User Consent Denied for OAuth Application

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD User Consent Denied for OAuth Application so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

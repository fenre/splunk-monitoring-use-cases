<!-- AUTO-GENERATED from UC-10.2.20.json — DO NOT EDIT -->
...
*We catch when one account suddenly signs in through many different apps and browsers in a short window, so we can spot guessing, token abuse, or a hijacked identity before it spreads.*

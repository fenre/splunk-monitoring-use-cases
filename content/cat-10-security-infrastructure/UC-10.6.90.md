<!-- AUTO-GENERATED from UC-10.6.90.json — DO NOT EDIT -->
...
# UC-10.6.90 · Windows Explorer LNK Exploit Process Launch With Padding

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This detection identifies instances where Windows Explorer.exe spawns PowerShell or cmd.exe processes with abnormally large padding (50 or more spaces) in the command line, and we use Splunk so the team can see it early and act.*

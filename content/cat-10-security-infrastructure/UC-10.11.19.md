<!-- AUTO-GENERATED from UC-10.11.19.json — DO NOT EDIT -->

---
id: "10.11.19"
title: "Palo Alto Threat Log Severity Analysis"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.11.19 · Palo Alto Threat Log Severity Analysis

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use Palo Alto Networks firewall data and alerts to stay ahead of the risks described in "Palo Alto Threat Log Severity Analysis". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

Threat severity analysis prioritizes NGFW alerts for analyst queues.
...
- `stats` rolls up events into metrics; results are split **by severity, threat_name, subtype** so each row reflects one combination of those dimensions.
...
Bar chart (severity), Table (top threats).

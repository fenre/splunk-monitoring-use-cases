<!-- AUTO-GENERATED from UC-10.7.262.json — DO NOT EDIT -->
...
# UC-10.7.262 · Cisco NVM - MSHTML or MSHTA Network Execution Without URL in CLI

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Cisco NVM - MSHTML or MSHTA Network Execution Without URL in CLI so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

---

## Description

This detection identifies Cisco NVM - MSHTML or MSHTA Network Execution Without URL in CLI. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.
...
- [https://learn.microsoft.com/en-us/windows/win32/api/mshtml/nf-mshtml-mshtml_runhtmlapplication](https://learn.microsoft.com/en-us/windows/win32/api/mshtml/nf-mshtml-mshtml_runhtmlapplication)

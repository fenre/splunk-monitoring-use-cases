<!-- AUTO-GENERATED from UC-10.3.366.json — DO NOT EDIT -->
...
# UC-10.3.366 · Uninstall App Using MsiExec

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Uninstall App Using MsiExec”, so we catch real tradecraft and not just noise from everyday work.*

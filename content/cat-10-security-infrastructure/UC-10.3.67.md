<!-- AUTO-GENERATED from UC-10.3.67.json — DO NOT EDIT -->
...
# UC-10.3.67 · Detect Prohibited Applications Spawning cmd exe

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Detect Prohibited Applications Spawning cmd exe” so we can see attacker-style moves—not only a one-off file or password mistake.*

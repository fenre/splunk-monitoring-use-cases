<!-- AUTO-GENERATED from UC-10.7.283.json — DO NOT EDIT -->
...
*We use this 'Detect Computer Changed with Anonymous Account' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*
...
Benign and operational activity can resemble this 'Detect Computer Changed with Anonymous Account' pattern; validate in the vendor console, IdP, or EDR as appropriate.

<!-- AUTO-GENERATED from UC-10.7.688.json — DO NOT EDIT -->
...
# UC-10.7.688 · Detect hosts connecting to dynamic domain providers

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Detect hosts connecting to dynamic domain providers" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.5.8.json — DO NOT EDIT -->
...
# UC-10.5.8 · Detect Web Access to Decommissioned S3 Bucket

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This detection identifies web requests to domains that match previously decommissioned cloud storage buckets through web proxy logs — so we know when protection is off, out of date, or bypassed.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to domain entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires AWS Cloudfront ingested and CIM-normalized.

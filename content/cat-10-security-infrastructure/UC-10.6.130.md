<!-- AUTO-GENERATED from UC-10.6.130.json — DO NOT EDIT -->
...
# UC-10.6.130 · Detect Zerologon via Zeek

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit the Zerologon vulnerability using Zeek RPC, and we use Splunk so the team can see it early and act.*

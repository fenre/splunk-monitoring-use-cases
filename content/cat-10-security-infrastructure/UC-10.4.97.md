<!-- AUTO-GENERATED from UC-10.4.97.json — DO NOT EDIT -->
...
# UC-10.4.97 · O365 New MFA Method Registered
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to user account entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires O365 Update user ingested and CIM-normalized.

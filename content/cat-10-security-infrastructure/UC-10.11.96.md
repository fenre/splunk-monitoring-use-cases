<!-- AUTO-GENERATED from UC-10.11.96.json — DO NOT EDIT -->

---
id: "10.11.96"
title: "Check Point Access Policy Rule Hit Analysis"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.11.96 · Check Point Access Policy Rule Hit Analysis

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use Check Point data and alerts to stay ahead of the risks described in "Check Point Access Policy Rule Hit Analysis". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

Rule hit analysis supports least-privilege firewall redesign.
...
- `stats` rolls up events into metrics; results are split **by rule_name, action** so each row reflects one combination of those dimensions.

<!-- AUTO-GENERATED from UC-10.2.127.json — DO NOT EDIT -->
...
# UC-10.2.127 · Windows MOF Event Triggered Execution via WMI

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of MOFComp.exe loading a MOF file, often triggered by cmd.exe or powershell.exe, or from unusual paths like User Profile directories — so we know when protection is off, out of date, or bypassed.*
...
- [https://learn.microsoft.com/en-us/windows/win32/wmisdk/mofcomp](https://learn.microsoft.com/en-us/windows/win32/wmisdk/mofcomp)

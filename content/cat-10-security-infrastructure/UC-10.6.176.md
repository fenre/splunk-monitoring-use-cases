<!-- AUTO-GENERATED from UC-10.6.176.json — DO NOT EDIT -->
...
# UC-10.6.176 · Log4Shell JNDI Payload Injection with Outbound Connection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects Log4Shell JNDI payload injections using outbound connections, and we use Splunk so the team can see it early and act.*

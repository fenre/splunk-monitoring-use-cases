<!-- AUTO-GENERATED from UC-10.2.115.json — DO NOT EDIT -->
...
# UC-10.2.115 · Windows File and Directory Permissions Remove Inheritance

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the removal of permission inheritance using ICACLS — so we know when protection is off, out of date, or bypassed.*

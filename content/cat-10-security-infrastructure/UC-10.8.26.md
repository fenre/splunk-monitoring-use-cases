<!-- AUTO-GENERATED from UC-10.8.26.json — DO NOT EDIT -->
...
# UC-10.8.26 · Windows Steal Authentication Certificates Certificate Issued

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies the issuance of a new certificate by Certificate Services - AD CS, detected using Event ID 4887 — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.3.405.json — DO NOT EDIT -->
...
# UC-10.3.405 · Windows Bypass UAC via Pkgmgr Tool

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Bypass UAC via Pkgmgr Tool”, so we catch real tradecraft and not just noise from everyday work.*

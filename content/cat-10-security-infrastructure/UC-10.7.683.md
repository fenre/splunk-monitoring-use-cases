<!-- AUTO-GENERATED from UC-10.7.683.json — DO NOT EDIT -->
...
# UC-10.7.683 · Cisco TFTP Server Configuration for Data Exfiltration

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Cisco TFTP Server Configuration for Data Exfiltration" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
- [https://www.cisco.com/c/en/us/td/docs/ios-xml/ios/fundamentals/command/cf_command_ref/T_through_X.html#wp3081407060](https://www.cisco.com/c/en/us/td/docs/ios-xml/ios/fundamentals/command/cf_command_ref/T_through_X.html#wp3081407060)

<!-- AUTO-GENERATED from UC-10.3.297.json — DO NOT EDIT -->
...
# UC-10.3.297 · Resize ShadowStorage volume

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Resize ShadowStorage volume” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
Known false positives for this detection: Legitimate backup, restore drills, and admin-created volume snapshots.
...
Legitimate backup, restore drills, and admin-created volume snapshots.
...
- [https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/vssadmin-resize-shadowstorage](https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/vssadmin-resize-shadowstorage)

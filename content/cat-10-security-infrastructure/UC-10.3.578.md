<!-- AUTO-GENERATED from UC-10.3.578.json — DO NOT EDIT -->
...
# UC-10.3.578 · Windows Powershell Cryptography Namespace

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Powershell Cryptography Namespace”, so we catch real tradecraft and not just noise from everyday work.*

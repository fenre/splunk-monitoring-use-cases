<!-- AUTO-GENERATED from UC-10.2.70.json — DO NOT EDIT -->
...
# UC-10.2.70 · Process Execution via WMI

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of a process by, indicating potential use of WMI (Windows Management Instrumentation) for process creation — so we know when protection is off, out of date, or bypassed.*

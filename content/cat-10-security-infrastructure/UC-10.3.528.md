<!-- AUTO-GENERATED from UC-10.3.528.json — DO NOT EDIT -->
...
# UC-10.3.528 · Windows Modify Registry Do Not Connect To Win Update

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Modify Registry Do Not Connect To Win Update”, so we catch real tradecraft and not just noise from everyday work.*

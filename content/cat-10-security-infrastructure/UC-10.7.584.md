<!-- AUTO-GENERATED from UC-10.7.584.json — DO NOT EDIT -->
...
# UC-10.7.584 · Windows Powershell Logoff User via Quser

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Powershell Logoff User via Quser" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

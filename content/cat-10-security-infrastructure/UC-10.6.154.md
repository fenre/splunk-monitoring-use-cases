<!-- AUTO-GENERATED from UC-10.6.154.json — DO NOT EDIT -->
...
# UC-10.6.154 · Exploit Public Facing Application via Apache Commons Text

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit the vulnerability in the Apache Commons Text Library, known as Text4Shell, and we use Splunk so the team can see it early and act.*

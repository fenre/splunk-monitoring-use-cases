<!-- AUTO-GENERATED from UC-10.3.336.json — DO NOT EDIT -->
...
# UC-10.3.336 · Suspicious Linux Discovery Commands

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Suspicious Linux Discovery Commands” so we can see attacker-style moves—not only a one-off file or password mistake.*

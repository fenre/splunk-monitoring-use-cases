<!-- AUTO-GENERATED from UC-10.2.144.json — DO NOT EDIT -->

---
id: "10.2.144"
title: "Windows Service Created with Suspicious Service Name"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.2.144 · Windows Service Created with Suspicious Service Name

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the creation of a Windows Service with a known suspicious or malicious name using Windows Event ID 7045 — so we know when protection is off, out of date, or bypassed.*
...
```spl
`wineventlog_system` EventCode=7045 ServiceName="$object_name$" dest="$dest$"
```
...
- [https://github.com/mthcht/awesome-lists/blob/main/Lists/suspicious_windows_services_names_list.csv](https://github.com/mthcht/awesome-lists/blob/main/Lists/suspicious_windows_services_names_list.csv)

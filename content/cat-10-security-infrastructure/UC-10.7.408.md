<!-- AUTO-GENERATED from UC-10.7.408.json — DO NOT EDIT -->
...
# UC-10.7.408 · Powershell Fileless Process Injection via GetProcAddress

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Powershell Fileless Process Injection via GetProcAddress" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

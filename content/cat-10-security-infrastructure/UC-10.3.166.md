<!-- AUTO-GENERATED from UC-10.3.166.json — DO NOT EDIT -->

---
id: "10.3.166"
title: "Linux Auditd Data Destruction Command"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.166 · Linux Auditd Data Destruction Command

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Auditd Data Destruction Command” so we can see attacker-style moves—not only a one-off file or password mistake.*

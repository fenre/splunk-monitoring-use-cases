<!-- AUTO-GENERATED from UC-10.1.43.json — DO NOT EDIT -->
...
# UC-10.1.43 · Windows System Network Connections Discovery Netsh

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the execution of the Windows built-in tool netsh.exe to display the state, configuration, and profile of the host firewall — so we know when protection is off, out of date, or bypassed.*

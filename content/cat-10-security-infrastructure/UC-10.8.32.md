<!-- AUTO-GENERATED from UC-10.8.32.json — DO NOT EDIT -->
...
# UC-10.8.32 · Windows Steal Authentication Certificates Export PfxCertificate

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the use of the PowerShell cmdlet on the command line, indicating an attempt to export a certificate from the local Windows Certificate Store — so we know when protection is off, out of date, or bypassed.*

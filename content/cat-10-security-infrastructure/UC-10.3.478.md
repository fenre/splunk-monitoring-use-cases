<!-- AUTO-GENERATED from UC-10.3.478.json — DO NOT EDIT -->
...
# UC-10.3.478 · Windows Impair Defense Delete Win Defender Profile Registry

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Impair Defense Delete Win Defender Profile Registry”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.3.23.json — DO NOT EDIT -->
...
# UC-10.3.23 · Detect Spike in AWS Security Hub Alerts for EC2 Instance

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Detect Spike in AWS Security Hub Alerts for EC2 Instance” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to host or system entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires AWS Security Hub ingested and CIM-normalized.

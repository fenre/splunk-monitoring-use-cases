<!-- AUTO-GENERATED from UC-10.6.87.json — DO NOT EDIT -->

---
id: "10.6.87"
title: "Windows ESX Admins Group Creation via Net"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.6.87 · Windows ESX Admins Group Creation via Net

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This analytic detects attempts to create an "ESX Admins" group using the Windows net.exe or net1.exe commands, and we use Splunk so the team can see it early and act.*

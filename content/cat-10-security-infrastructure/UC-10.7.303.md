<!-- AUTO-GENERATED from UC-10.7.303.json — DO NOT EDIT -->
...
# UC-10.7.303 · Domain Group Discovery with Adsisearcher

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Domain Group Discovery with Adsisearcher so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

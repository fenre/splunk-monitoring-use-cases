<!-- AUTO-GENERATED from UC-10.3.252.json — DO NOT EDIT -->
...
# UC-10.3.252 · Modify ACL permission To Files Or Folder

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Modify ACL permission To Files Or Folder” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.7.623.json — DO NOT EDIT -->
...
# UC-10.7.623 · Windows Scheduled Task Created Via XML

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Scheduled Task Created Via XML" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

---

## Description

This detection identifies Windows Scheduled Task Created Via XML. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

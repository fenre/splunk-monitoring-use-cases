<!-- AUTO-GENERATED from UC-10.11.84.json — DO NOT EDIT -->

---
id: "10.11.84"
title: "Tanium Module Deployment Health"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.11.84 · Tanium Module Deployment Health

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use Tanium data and alerts to stay ahead of the risks described in "Tanium Module Deployment Health". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

Module health guarantees sensors can run latest compliance and threat content.
...
- `stats` rolls up events into metrics; results are split **by module_name, endpoint** so each row reflects one combination of those dimensions.
...
Table (outdated), Bar chart (module coverage).

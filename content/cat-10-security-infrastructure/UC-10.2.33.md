<!-- AUTO-GENERATED from UC-10.2.33.json — DO NOT EDIT -->
...
# UC-10.2.33 · Detect Mimikatz With PowerShell Script Block Logging

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of Mimikatz commands using PowerShell by leveraging PowerShell Script Block Logging (EventCode=4104) — so we know when protection is off, out of date, or bypassed.*

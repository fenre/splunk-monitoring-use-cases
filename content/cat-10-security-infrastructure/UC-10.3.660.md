<!-- AUTO-GENERATED from UC-10.3.660.json — DO NOT EDIT -->
...
# UC-10.3.660 · Windows WMI Process And Service List

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows WMI Process And Service List”, so we catch real tradecraft and not just noise from everyday work.*

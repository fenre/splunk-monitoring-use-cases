<!-- AUTO-GENERATED from UC-10.7.173.json — DO NOT EDIT -->
...
# UC-10.7.173 · Azure Runbook Webhook Created

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure Runbook Webhook Created so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*
...
- [https://learn.microsoft.com/en-us/azure/automation/automation-runbook-types](https://learn.microsoft.com/en-us/azure/automation/automation-runbook-types)
- [https://learn.microsoft.com/en-us/azure/automation/automation-webhooks?tabs=portal](https://learn.microsoft.com/en-us/azure/automation/automation-webhooks?tabs=portal)

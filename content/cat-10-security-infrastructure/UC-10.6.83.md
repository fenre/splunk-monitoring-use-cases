<!-- AUTO-GENERATED from UC-10.6.83.json — DO NOT EDIT -->
...
# UC-10.6.83 · Windows DLL Side-Loading In Calc

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the loading of the "WindowsCodecs.dll" by calc.exe from a non-standard location This could be indicative of a potential DLL side-loading technique, and we use Splunk so the team can see it early and act.*
...
- [https://www.menlosecurity.com/blog/an-anatomy-of-heat-attacks-used-by-qakbot-campaigns](https://www.menlosecurity.com/blog/an-anatomy-of-heat-attacks-used-by-qakbot-campaigns)

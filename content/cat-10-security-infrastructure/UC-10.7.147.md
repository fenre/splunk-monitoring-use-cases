<!-- AUTO-GENERATED from UC-10.7.147.json — DO NOT EDIT -->
...
# UC-10.7.147 · Azure AD Multiple Service Principals Created by SP

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD Multiple Service Principals Created by SP so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

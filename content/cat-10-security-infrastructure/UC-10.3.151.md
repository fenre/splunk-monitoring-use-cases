<!-- AUTO-GENERATED from UC-10.3.151.json — DO NOT EDIT -->
...
# UC-10.3.151 · Hiding Files And Directories With Attrib exe

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Hiding Files And Directories With Attrib exe” so we can see attacker-style moves—not only a one-off file or password mistake.*

...
*We look at the spread of risk scores so we are not piling “critical” on everything and diluting the word when something truly bad happens.*
...
Risk distribution changes when we retune content, merge indexes, or onboard new EDRs — the shape moves without a single incident to blame.

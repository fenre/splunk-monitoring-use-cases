<!-- AUTO-GENERATED from UC-10.2.109.json — DO NOT EDIT -->
...
# UC-10.2.109 · Windows Credential Dumping LSASS Memory Createdump

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the use of CreateDump.exe to perform a process dump — so we know when protection is off, out of date, or bypassed.*

<!-- AUTO-GENERATED from UC-10.6.23.json — DO NOT EDIT -->
...
# UC-10.6.23 · AWS Excessive Security Scanning

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies excessive security scanning activities in AWS by detecting a high number of Describe, List, or Get calls from a single user, and we use Splunk so the team can see it early and act.*

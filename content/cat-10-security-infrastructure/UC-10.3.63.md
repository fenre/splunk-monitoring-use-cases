<!-- AUTO-GENERATED from UC-10.3.63.json — DO NOT EDIT -->
...
# UC-10.3.63 · Detect mshta inline hta execution

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Detect mshta inline hta execution” so we can see attacker-style moves—not only a one-off file or password mistake.*

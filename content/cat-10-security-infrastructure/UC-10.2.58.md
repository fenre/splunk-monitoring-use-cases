<!-- AUTO-GENERATED from UC-10.2.58.json — DO NOT EDIT -->
...
# UC-10.2.58 · LOLBAS With Network Traffic

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot the use of Living Off the Land Binaries and Scripts (LOLBAS) with network traffic — so we know when protection is off, out of date, or bypassed.*

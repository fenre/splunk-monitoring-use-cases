<!-- AUTO-GENERATED from UC-10.7.144.json — DO NOT EDIT -->
...
# UC-10.7.144 · Azure AD Multi-Factor Authentication Disabled

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD Multi-Factor Authentication Disabled so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*
...
- [https://learn.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates](https://learn.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates)

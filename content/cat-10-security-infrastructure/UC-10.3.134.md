<!-- AUTO-GENERATED from UC-10.3.134.json — DO NOT EDIT -->
...
*We use endpoint and security-agent signals around “Get WMIObject Group Discovery with Script Block Logging” so we can see attacker-style moves—not only a one-off file or password mistake.*

...
*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows BitLockerToGo with Network Activity”, so we catch real tradecraft and not just noise from everyday work.*
...
High DNS query volume from browsers, auto-updaters, and load tests; allowlist well-known resolvers and SaaS patterns.

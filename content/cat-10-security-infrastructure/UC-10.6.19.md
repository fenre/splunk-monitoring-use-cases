<!-- AUTO-GENERATED from UC-10.6.19.json — DO NOT EDIT -->
...
# UC-10.6.19 · Amazon EKS Kubernetes Pod scan detection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects unauthenticated requests made against the Kubernetes Pods, indicating potential unauthorized access attempts, and we use Splunk so the team can see it early and act.*

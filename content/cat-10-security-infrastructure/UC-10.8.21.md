<!-- AUTO-GENERATED from UC-10.8.21.json — DO NOT EDIT -->
...
# UC-10.8.21 · Windows PowerShell Export PfxCertificate

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the use of the PowerShell cmdlet by leveraging Script Block Logging — so we know when protection is off, out of date, or bypassed.*

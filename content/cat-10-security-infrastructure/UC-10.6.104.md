<!-- AUTO-GENERATED from UC-10.6.104.json — DO NOT EDIT -->
...
# UC-10.6.104 · Windows Office Product Loaded MSHTML Module

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the loading of the mshtml.dll module into an Office product, which is indicative of exploitation, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.3.296.json — DO NOT EDIT -->
...
# UC-10.3.296 · Remote System Discovery with Wmic

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Remote System Discovery with Wmic” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
- [https://learn.microsoft.com/en-us/windows/win32/wmisdk/wmic](https://learn.microsoft.com/en-us/windows/win32/wmisdk/wmic)

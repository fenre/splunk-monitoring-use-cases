<!-- AUTO-GENERATED from UC-10.3.31.json — DO NOT EDIT -->
...
# UC-10.3.31 · Bcdedit Command Back To Normal Mode Boot

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Bcdedit Command Back To Normal Mode Boot” so we can see attacker-style moves—not only a one-off file or password mistake.*

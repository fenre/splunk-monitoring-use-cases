<!-- AUTO-GENERATED from UC-10.2.128.json — DO NOT EDIT -->
...
# UC-10.2.128 · Windows MSIExec DLLRegisterServer

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of msiexec.exe with the /y switch parameter, which enables the loading of DLLRegisterServer — so we know when protection is off, out of date, or bypassed.*

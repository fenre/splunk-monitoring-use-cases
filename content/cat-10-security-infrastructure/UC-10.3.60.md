<!-- AUTO-GENERATED from UC-10.3.60.json — DO NOT EDIT -->
...
# UC-10.3.60 · Detect HTML Help Renamed

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Detect HTML Help Renamed” so we can see attacker-style moves—not only a one-off file or password mistake.*

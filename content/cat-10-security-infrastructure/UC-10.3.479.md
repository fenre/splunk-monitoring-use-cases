<!-- AUTO-GENERATED from UC-10.3.479.json — DO NOT EDIT -->
...
# UC-10.3.479 · Windows Impair Defense Deny Security Software With Applocker

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Impair Defense Deny Security Software With Applocker”, so we catch real tradecraft and not just noise from everyday work.*

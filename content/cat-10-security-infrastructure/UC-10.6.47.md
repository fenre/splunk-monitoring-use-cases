<!-- AUTO-GENERATED from UC-10.6.47.json — DO NOT EDIT -->
...
# UC-10.6.47 · Detect Baron Samedit CVE-2021-3156 via OSQuery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the execution of the "sudoedit -s *" command, which is associated with the Baron Samedit heap-based buffer overflow vulnerability, and we use Splunk so the team can see it early and act.*

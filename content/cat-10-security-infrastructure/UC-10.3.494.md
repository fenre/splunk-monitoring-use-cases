<!-- AUTO-GENERATED from UC-10.3.494.json — DO NOT EDIT -->
...
# UC-10.3.494 · Windows Indirect Command Execution Via forfiles

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Indirect Command Execution Via forfiles”, so we catch real tradecraft and not just noise from everyday work.*

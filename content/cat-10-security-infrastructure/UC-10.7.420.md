<!-- AUTO-GENERATED from UC-10.7.420.json — DO NOT EDIT -->
...
# UC-10.7.420 · Remote System Discovery with Adsisearcher

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Remote System Discovery with Adsisearcher" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

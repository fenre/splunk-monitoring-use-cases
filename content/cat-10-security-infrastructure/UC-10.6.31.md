<!-- AUTO-GENERATED from UC-10.6.31.json — DO NOT EDIT -->
...
# UC-10.6.31 · Kubernetes Previously Unseen Container Image Name

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies the creation of containerized workloads using previously unseen images in a Kubernetes cluster, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.4.66.json — DO NOT EDIT -->
...
# UC-10.4.66 · O365 Email Suspicious Search Behavior
...
```spl
`o365_management_activity` AND Operation=SearchQueryInitiatedExchange AND UserId = "$user$
```

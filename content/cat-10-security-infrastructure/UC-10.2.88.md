<!-- AUTO-GENERATED from UC-10.2.88.json — DO NOT EDIT -->
...
# UC-10.2.88 · Scheduled Task Initiation on Remote Endpoint

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the use of 'schtasks.exe' to start a Scheduled Task on a remote endpoint — so we know when protection is off, out of date, or bypassed.*

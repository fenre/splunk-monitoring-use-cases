<!-- AUTO-GENERATED from UC-10.7.142.json — DO NOT EDIT -->
...
# UC-10.7.142 · Azure AD High Number Of Failed Authentications For User

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD High Number Of Failed Authentications For User so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

<!-- AUTO-GENERATED from UC-10.3.459.json — DO NOT EDIT -->
...
# UC-10.3.459 · Windows File Transfer Protocol In Non-Common Process Path

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows File Transfer Protocol In Non-Common Process Path”, so we catch real tradecraft and not just noise from everyday work.*

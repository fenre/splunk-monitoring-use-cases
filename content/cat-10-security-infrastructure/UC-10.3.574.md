<!-- AUTO-GENERATED from UC-10.3.574.json — DO NOT EDIT -->
...
# UC-10.3.574 · Windows PaperCut NG Spawn Shell

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows PaperCut NG Spawn Shell”, so we catch real tradecraft and not just noise from everyday work.*

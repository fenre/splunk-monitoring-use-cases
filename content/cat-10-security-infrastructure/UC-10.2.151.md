<!-- AUTO-GENERATED from UC-10.2.151.json — DO NOT EDIT -->
...
# UC-10.2.151 · Windows Snake Malware Registry Modification wav OpenWithProgIds

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot modifications to the registry path.wav\\OpenWithProgIds, associated with the Snake Malware campaign — so we know when protection is off, out of date, or bypassed.*

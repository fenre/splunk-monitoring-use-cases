<!-- AUTO-GENERATED from UC-10.3.183.json — DO NOT EDIT -->
...
# UC-10.3.183 · Linux Data Destruction Command

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Data Destruction Command” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.7.550.json — DO NOT EDIT -->
...
# UC-10.7.550 · Windows Linked Policies In ADSI Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Linked Policies In ADSI Discovery" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

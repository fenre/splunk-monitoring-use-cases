<!-- AUTO-GENERATED from UC-10.3.425.json — DO NOT EDIT -->
...
# UC-10.3.425 · Windows Credentials from Password Stores Query

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Credentials from Password Stores Query”, so we catch real tradecraft and not just noise from everyday work.*

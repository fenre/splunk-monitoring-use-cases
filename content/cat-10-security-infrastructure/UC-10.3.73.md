<!-- AUTO-GENERATED from UC-10.3.73.json — DO NOT EDIT -->
...
# UC-10.3.73 · Detect Regsvr32 Application Control Bypass

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Detect Regsvr32 Application Control Bypass” so we can see attacker-style moves—not only a one-off file or password mistake.*

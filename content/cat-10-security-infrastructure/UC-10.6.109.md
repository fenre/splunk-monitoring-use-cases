<!-- AUTO-GENERATED from UC-10.6.109.json — DO NOT EDIT -->
...
# UC-10.6.109 · Windows Rundll32 WebDAV Request

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies the execution of rundll32.exe with command-line arguments loading davclnt.dll and the davsetcookie function to access a remote WebDAV instance, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.3.592.json — DO NOT EDIT -->
...
# UC-10.3.592 · Windows Proxy Via Netsh

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Proxy Via Netsh”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.6.170.json — DO NOT EDIT -->
...
# UC-10.6.170 · JetBrains TeamCity Authentication Bypass CVE-2024-27198

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies attempts to exploit the JetBrains TeamCity Authentication Bypass vulnerability, and we use Splunk so the team can see it early and act.*

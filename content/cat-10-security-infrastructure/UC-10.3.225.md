<!-- AUTO-GENERATED from UC-10.3.225.json — DO NOT EDIT -->
...
# UC-10.3.225 · Linux Preload Hijack Library Calls

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Preload Hijack Library Calls” so we can see attacker-style moves—not only a one-off file or password mistake.*

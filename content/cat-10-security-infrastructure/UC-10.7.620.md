<!-- AUTO-GENERATED from UC-10.7.620.json — DO NOT EDIT -->
...
# UC-10.7.620 · Windows Root Domain linked policies Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Root Domain linked policies Discovery" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

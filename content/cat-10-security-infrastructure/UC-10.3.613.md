<!-- AUTO-GENERATED from UC-10.3.613.json — DO NOT EDIT -->
...
# UC-10.3.613 · Windows Schtasks Create Run As System

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Schtasks Create Run As System”, so we catch real tradecraft and not just noise from everyday work.*

...
*The following analytic identifies instances of rundll32.exe executing with in the command line, which is indicative of loading.cpl or other file types, and we use Splunk so the team can see it early and act.*

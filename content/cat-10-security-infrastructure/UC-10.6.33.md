<!-- AUTO-GENERATED from UC-10.6.33.json — DO NOT EDIT -->
...
# UC-10.6.33 · Kubernetes Scanning by Unauthenticated IP Address

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies potential scanning activities within a Kubernetes environment by unauthenticated IP addresses, and we use Splunk so the team can see it early and act.*

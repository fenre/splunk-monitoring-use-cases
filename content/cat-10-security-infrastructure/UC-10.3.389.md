<!-- AUTO-GENERATED from UC-10.3.389.json — DO NOT EDIT -->
...
# UC-10.3.389 · Windows Attempt To Stop Security Service

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Attempt To Stop Security Service”, so we catch real tradecraft and not just noise from everyday work.*

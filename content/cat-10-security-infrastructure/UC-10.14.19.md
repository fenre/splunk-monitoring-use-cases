...
*We watch reporting timelines for OT incidents so if something real happens, the clock for official notice does not get missed by accident.*
...
Regulatory reporting clock starts can differ from operations’ first notice when teams use different ticketing systems — reconcile the authoritative incident record before calling a violation.

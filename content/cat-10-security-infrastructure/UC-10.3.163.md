<!-- AUTO-GENERATED from UC-10.3.163.json — DO NOT EDIT -->

---
id: "10.3.163"
title: "Linux Auditd Add User Account"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.163 · Linux Auditd Add User Account

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Auditd Add User Account” so we can see attacker-style moves—not only a one-off file or password mistake.*

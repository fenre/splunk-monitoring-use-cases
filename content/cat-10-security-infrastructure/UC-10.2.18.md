<!-- AUTO-GENERATED from UC-10.2.18.json — DO NOT EDIT -->
...
# UC-10.2.18 · Azure AD Concurrent Sessions From Different Ips

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch an Azure AD account with concurrent sessions originating from multiple unique IP addresses within a 5-minute window — so we know when protection is off, out of date, or bypassed.*

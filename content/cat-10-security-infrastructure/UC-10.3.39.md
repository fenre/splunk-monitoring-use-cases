<!-- AUTO-GENERATED from UC-10.3.39.json — DO NOT EDIT -->
...
# UC-10.3.39 · Clear Unallocated Sector Using Cipher App

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Clear Unallocated Sector Using Cipher App” so we can see attacker-style moves—not only a one-off file or password mistake.*
...
- [https://www.sophos.com/en-us/labs](https://www.sophos.com/en-us/labs)

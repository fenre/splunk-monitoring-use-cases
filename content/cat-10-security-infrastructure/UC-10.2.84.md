<!-- AUTO-GENERATED from UC-10.2.84.json — DO NOT EDIT -->
...
# UC-10.2.84 · Revil Registry Entry

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot suspicious modifications in the registry entry, specifically targeting paths used by malware like REVIL — so we know when protection is off, out of date, or bypassed.*

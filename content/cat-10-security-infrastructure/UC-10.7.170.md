<!-- AUTO-GENERATED from UC-10.7.170.json — DO NOT EDIT -->
...
# UC-10.7.170 · Azure AD User ImmutableId Attribute Updated

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD User ImmutableId Attribute Updated so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*
...
- [https://learn.microsoft.com/en-us/azure/active-directory/hybrid/plan-connect-design-concepts](https://learn.microsoft.com/en-us/azure/active-directory/hybrid/plan-connect-design-concepts)

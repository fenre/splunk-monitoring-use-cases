<!-- AUTO-GENERATED from UC-10.7.711.json — DO NOT EDIT -->
...
# UC-10.7.711 · Detect Remote Access Software Usage URL

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We keep an eye on the execution of known remote access software within the environment so unusual activity is visible early — before it spreads or hides in normal noise.*
...
Known false positives for this detection: Help-desk, vendors, and traveling staff legitimately use remote access tools. Keep the exception lookup and asset inventory in sync, and require change tickets for new tools.
...
```spl
| from datamodel:Web | search src=$src$ url_domain=$url_domain$
```
...
Help-desk, vendors, and traveling staff legitimately use remote access tools. Keep the exception lookup and asset inventory in sync, and require change tickets for new tools.

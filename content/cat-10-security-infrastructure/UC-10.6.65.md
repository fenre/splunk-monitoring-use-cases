<!-- AUTO-GENERATED from UC-10.6.65.json — DO NOT EDIT -->
...
# UC-10.6.65 · Rundll32 Control RunDLL World Writable Directory

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects the execution of rundll32.exe with the command, loading files from world-writable directories such as windows\temp, programdata, or appdata, and we use Splunk so the team can see it early and act.*

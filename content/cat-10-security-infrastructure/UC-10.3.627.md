<!-- AUTO-GENERATED from UC-10.3.627.json — DO NOT EDIT -->
...
# UC-10.3.627 · Windows Snake Malware File Modification Crmlog

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Snake Malware File Modification Crmlog”, so we catch real tradecraft and not just noise from everyday work.*

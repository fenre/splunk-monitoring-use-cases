<!-- AUTO-GENERATED from UC-10.7.294.json — DO NOT EDIT -->
...
# UC-10.7.294 · Detect Remote Access Software Usage FileInfo

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for the endpoint file, process, or registry signals described in 'Detect Remote Access Software Usage FileInfo' so we catch abuse of common tools and persistence paths in time.*

<!-- AUTO-GENERATED from UC-10.3.601.json — DO NOT EDIT -->
...
# UC-10.3.601 · Windows Registry Payload Injection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Registry Payload Injection”, so we catch real tradecraft and not just noise from everyday work.*
...
Known false positives for this detection: Process injection from legitimate AV or EDR tools, browser sandboxing, or Office add-ins.
...
Process injection from legitimate AV or EDR tools, browser sandboxing, or Office add-ins.

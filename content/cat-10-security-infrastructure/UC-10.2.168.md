<!-- AUTO-GENERATED from UC-10.2.168.json — DO NOT EDIT -->
...
# UC-10.2.168 · Windows Remote Desktop Network Bruteforce Attempt

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot potential Remote Desktop Protocol (remote desktop) brute force attacks by monitoring network traffic for remote desktop application activity — so we know when protection is off, out of date, or bypassed.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to IP address entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Sysmon EventID 3 ingested and CIM-normalized.
...
Authorized monitoring (Pingdom, Nagios), password managers retrying, mobile mail clients with stale passwords, and vulnerability tools can resemble brute force or spray behavior.

## References

- [https://www.zscaler.com/blogs/security-research/ransomware-delivered-using-rdp-brute-force-attack](https://www.zscaler.com/blogs/security-research/ransomware-delivered-using-rdp-brute-force-attack)
- [https://www.reliaquest.com/blog/rdp-brute-force-attacks/](https://www.reliaquest.com/blog/rdp-brute-force-attacks/)

<!-- AUTO-GENERATED from UC-10.4.92.json — DO NOT EDIT -->
...
# UC-10.4.92 · O365 Multiple Users Failing To Authenticate From Ip

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We watch Microsoft 365 sign-in and email-related identity signals, so we spot risky logins, token abuse, and account takeover before mailboxes are used to blast attackers’ messages.*
...
Failed sign-ins and MFA from travelers, new devices, mobile token refresh issues, and passwordless rollout piloting; break-glass and emergency access can also create spikes. Correlate with known user activity.

<!-- AUTO-GENERATED from UC-10.7.466.json — DO NOT EDIT -->
...
# UC-10.7.466 · Windows AD Suspicious Attribute Modification

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Suspicious Attribute Modification" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.2.41.json — DO NOT EDIT -->
...
# UC-10.2.41 · Esentutl SAM Copy

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the use of to access credentials stored in the ntds.dit or SAM file — so we know when protection is off, out of date, or bypassed.*

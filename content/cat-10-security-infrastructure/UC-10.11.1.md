<!-- AUTO-GENERATED from UC-10.11.1.json — DO NOT EDIT -->

---
id: "10.11.1"
title: "FortiGate Firewall Policy Violations"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.11.1 · FortiGate Firewall Policy Violations

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use FortiGate data and alerts to stay ahead of the risks described in "FortiGate Firewall Policy Violations". We help the team notice trouble early, while a situation is still small and containable.*

---

## Description

Denied sessions reveal policy gaps, misconfigurations, or active probing against protected assets.
...
Line chart (denies over time), Bar chart (top policies), Table (recent denies).

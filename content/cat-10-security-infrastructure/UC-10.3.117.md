<!-- AUTO-GENERATED from UC-10.3.117.json — DO NOT EDIT -->
...
# UC-10.3.117 · Excessive Attempt To Disable Services

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Excessive Attempt To Disable Services” so we can see attacker-style moves—not only a one-off file or password mistake.*

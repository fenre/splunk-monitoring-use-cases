<!-- AUTO-GENERATED from UC-10.7.427.json — DO NOT EDIT -->
...
# UC-10.7.427 · Unusual Number of Kerberos Service Tickets Requested

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Unusual Number of Kerberos Service Tickets Requested" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

<!-- AUTO-GENERATED from UC-10.3.307.json — DO NOT EDIT -->
...
# UC-10.3.307 · Ryuk Wake on LAN Command

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Ryuk Wake on LAN Command” so we can see attacker-style moves—not only a one-off file or password mistake.*

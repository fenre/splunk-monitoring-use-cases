<!-- AUTO-GENERATED from UC-10.3.616.json — DO NOT EDIT -->
...
# UC-10.3.616 · Windows Security Account Manager Stopped

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Security Account Manager Stopped”, so we catch real tradecraft and not just noise from everyday work.*

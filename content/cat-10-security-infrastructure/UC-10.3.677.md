<!-- AUTO-GENERATED from UC-10.3.677.json — DO NOT EDIT -->
...
# UC-10.3.677 · Windows Gather Victim Network Info Through Ip Check Web Services

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Gather Victim Network Info Through Ip Check Web Services”, so we catch real tradecraft and not just noise from everyday work.*

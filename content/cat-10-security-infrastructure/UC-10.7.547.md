<!-- AUTO-GENERATED from UC-10.7.547.json — DO NOT EDIT -->
...
# UC-10.7.547 · Windows Known Abused DLL Loaded Suspiciously

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows Known Abused DLL Loaded Suspiciously" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

...
*We catch reconnaissance and discovery commands on Cisco ASA devices that may indicate an attacker or insider mapping the network or preparing for further exploitation — so we know when protection is off, out of date, or bypassed.*
...
Legitimate admin discovery or change procedures; verify with change management.

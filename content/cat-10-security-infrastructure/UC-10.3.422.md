<!-- AUTO-GENERATED from UC-10.3.422.json — DO NOT EDIT -->

---
id: "10.3.422"
title: "Windows Credentials from Password Stores Chrome Copied in TEMP Dir"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.3.422 · Windows Credentials from Password Stores Chrome Copied in TEMP Dir

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Credentials from Password Stores Chrome Copied in TEMP Dir”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.6.103.json — DO NOT EDIT -->
...
# UC-10.6.103 · Windows Office Product Dropped Cab or Inf File

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects Office products writing.cab or.inf files, indicative of exploitation, and we use Splunk so the team can see it early and act.*

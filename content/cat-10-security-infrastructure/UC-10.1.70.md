<!-- AUTO-GENERATED from UC-10.1.70.json — DO NOT EDIT -->
...
# UC-10.1.70 · Cisco Secure Firewall - SSH Connection to Non-Standard Port
...
This detection identifies Cisco Secure Firewall - SSH Connection to Non-Standard Port. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

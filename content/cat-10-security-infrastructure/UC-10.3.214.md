<!-- AUTO-GENERATED from UC-10.3.214.json — DO NOT EDIT -->
...
# UC-10.3.214 · Linux NOPASSWD Entry In Sudoers File

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux NOPASSWD Entry In Sudoers File” so we can see attacker-style moves—not only a one-off file or password mistake.*

<!-- AUTO-GENERATED from UC-10.3.62.json — DO NOT EDIT -->
...
# UC-10.3.62 · Detect HTML Help Using InfoTech Storage Handlers

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Detect HTML Help Using InfoTech Storage Handlers” so we can see attacker-style moves—not only a one-off file or password mistake.*

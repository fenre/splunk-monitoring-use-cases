<!-- AUTO-GENERATED from UC-10.2.65.json — DO NOT EDIT -->
...
# UC-10.2.65 · Potential System Network Configuration Discovery Activity

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot the rapid execution of processes used for system network configuration discovery on an endpoint — so we know when protection is off, out of date, or bypassed.*

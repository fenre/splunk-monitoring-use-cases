<!-- AUTO-GENERATED from UC-10.7.337.json — DO NOT EDIT -->
...
# UC-10.7.337 · Kerberos TGT Request Using RC4 Encryption

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Kerberos TGT Request Using RC4 Encryption so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*
...
- [https://learn.microsoft.com/en-us/windows/security/threat-protection/auditing/event-4768](https://learn.microsoft.com/en-us/windows/security/threat-protection/auditing/event-4768)

<!-- AUTO-GENERATED from UC-10.6.60.json — DO NOT EDIT -->
...
# UC-10.6.60 · PetitPotam Network Share Access Request

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects network share access requests indicative of the PetitPotam attack, and we use Splunk so the team can see it early and act.*

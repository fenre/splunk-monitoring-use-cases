<!-- AUTO-GENERATED from UC-10.6.94.json — DO NOT EDIT -->
...
# UC-10.6.94 · Windows Impair Defense Change Win Defender Quick Scan Interval

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects modifications to the Windows registry that change the Windows Defender Quick Scan Interval, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.3.585.json — DO NOT EDIT -->
...
# UC-10.3.585 · Windows Process Execution in Temp Dir

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Process Execution in Temp Dir”, so we catch real tradecraft and not just noise from everyday work.*

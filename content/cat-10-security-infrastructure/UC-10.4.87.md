<!-- AUTO-GENERATED from UC-10.4.87.json — DO NOT EDIT -->
...
# UC-10.4.87 · O365 Multiple Failed MFA Requests For User
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to user account entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires O365 UserLoginFailed ingested and CIM-normalized.

<!-- AUTO-GENERATED from UC-10.3.231.json — DO NOT EDIT -->
...
# UC-10.3.231 · Linux Service Restarted

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Linux Service Restarted” so we can see attacker-style moves—not only a one-off file or password mistake.*

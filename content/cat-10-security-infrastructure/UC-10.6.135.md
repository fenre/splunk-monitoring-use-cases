<!-- AUTO-GENERATED from UC-10.6.135.json — DO NOT EDIT -->
...
# UC-10.6.135 · Internal Vertical Port Scan

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*This analytic detects instances where an internal host attempts to communicate with over 500 ports on a single destination IP address, and we use Splunk so the team can see it early and act.*

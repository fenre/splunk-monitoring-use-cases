<!-- AUTO-GENERATED from UC-10.3.254.json — DO NOT EDIT -->
...
# UC-10.3.254 · MS Scripting Process Loading WMI Module

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “MS Scripting Process Loading WMI Module” so we can see attacker-style moves—not only a one-off file or password mistake.*

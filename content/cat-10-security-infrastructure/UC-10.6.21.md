<!-- AUTO-GENERATED from UC-10.6.21.json — DO NOT EDIT -->
...
# UC-10.6.21 · AWS ECR Container Scanning Findings Low Informational Unknown

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies low, informational, or unknown severity findings from AWS Elastic Container Registry (ECR) image scans, and we use Splunk so the team can see it early and act.*

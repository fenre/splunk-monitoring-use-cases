<!-- AUTO-GENERATED from UC-10.7.172.json — DO NOT EDIT -->
...
# UC-10.7.172 · Azure Automation Runbook Created

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure Automation Runbook Created so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*
...
- [https://learn.microsoft.com/en-us/azure/automation/manage-runbooks](https://learn.microsoft.com/en-us/azure/automation/manage-runbooks)

...
*We use endpoint and security-agent signals around “Detect Path Interception By Creation Of program exe” so we can see attacker-style moves—not only a one-off file or password mistake.*

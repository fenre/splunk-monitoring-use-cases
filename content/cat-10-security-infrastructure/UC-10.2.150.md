<!-- AUTO-GENERATED from UC-10.2.150.json — DO NOT EDIT -->
...
# UC-10.2.150 · Windows SIP WinVerifyTrust Failed Trust Validation

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch failed trust validation attempts using Windows Event Log - CAPI2 (CryptoAPI 2) — so we know when protection is off, out of date, or bypassed.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to host or system entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Windows Event Log CAPI2 81 ingested and CIM-normalized.

<!-- AUTO-GENERATED from UC-10.3.427.json — DO NOT EDIT -->
...
# UC-10.3.427 · Windows Credentials in Registry Reg Query

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Credentials in Registry Reg Query”, so we catch real tradecraft and not just noise from everyday work.*

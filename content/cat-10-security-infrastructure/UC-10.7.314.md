<!-- AUTO-GENERATED from UC-10.7.314.json — DO NOT EDIT -->
...
# UC-10.7.314 · Get ADUserResultantPasswordPolicy with Powershell Script Block

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Get ADUserResultantPasswordPolicy with Powershell Script Block so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*
...
AD and PowerShell discovery from help desk, inventory scripts, and authorized admin work; exclude jump hosts and PAM session IDs where documented.

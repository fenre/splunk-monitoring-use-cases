<!-- AUTO-GENERATED from UC-10.6.137.json — DO NOT EDIT -->
...
# UC-10.6.137 · Access to Vulnerable Ivanti Connect Secure Bookmark Endpoint

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies access to the //v1/configuration/users/user-roles/user-role/rest-userrole1/web/web-bookmarks/bookmark endpoint, which is associated with and vulnerabilities, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.3.371.json — DO NOT EDIT -->
...
# UC-10.3.371 · User Discovery With Env Vars PowerShell

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “User Discovery With Env Vars PowerShell”, so we catch real tradecraft and not just noise from everyday work.*

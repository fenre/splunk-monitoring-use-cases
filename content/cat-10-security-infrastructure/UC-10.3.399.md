<!-- AUTO-GENERATED from UC-10.3.399.json — DO NOT EDIT -->
...
# UC-10.3.399 · Windows Binary Proxy Execution Mavinject DLL Injection

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Binary Proxy Execution Mavinject DLL Injection”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.3.267.json — DO NOT EDIT -->
...
# UC-10.3.267 · Possible Browser Pass View Parameter

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “Possible Browser Pass View Parameter” so we can see attacker-style moves—not only a one-off file or password mistake.*

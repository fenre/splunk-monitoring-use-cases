<!-- AUTO-GENERATED from UC-10.6.187.json — DO NOT EDIT -->
...
# UC-10.6.187 · Web Remote ShellServlet Access

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies attempts to access the Remote ShellServlet on a web server, specifically targeting Confluence servers vulnerable to and, and we use Splunk so the team can see it early and act.*

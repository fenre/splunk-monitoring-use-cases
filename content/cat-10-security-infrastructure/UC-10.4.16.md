<!-- AUTO-GENERATED from UC-10.4.16.json — DO NOT EDIT -->

---
id: "10.4.16"
title: "M365 Copilot Jailbreak Attempts"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.4.16 · M365 Copilot Jailbreak Attempts

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We watch how Copilot is used in Microsoft 365, so we see risky or abusive prompts and odd access before sensitive data is exposed through AI features.*
...
```spl
# Shared SPL: intentional — see UC-10.4.15
...
Unusual but benign Copilot usage from power users, training sessions, and new feature pilots; review Microsoft Copilot activity reports and data protection policies before calling an incident.

...
*We audit YARA version drift so we know who changed what and can roll back when a bundle goes wrong.*
...
Version noise from hotfixes, test bundles, and parallel imports can show as “changes” without a meaningful rule content drift for operations.

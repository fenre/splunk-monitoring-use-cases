<!-- AUTO-GENERATED from UC-10.6.117.json — DO NOT EDIT -->
...
# UC-10.6.117 · Windows Suspicious Child Process Spawned From WebServer

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies the execution of suspicious processes typically associated with WebShell activity on web servers, and we use Splunk so the team can see it early and act.*

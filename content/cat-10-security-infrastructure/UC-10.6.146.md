<!-- AUTO-GENERATED from UC-10.6.146.json — DO NOT EDIT -->
...
# UC-10.6.146 · Confluence Pre-Auth RCE via OGNL Injection CVE-2023-22527

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies attempts to exploit a critical template injection vulnerability in outdated Confluence Data Center and Server versions, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.6.81.json — DO NOT EDIT -->
...
# UC-10.6.81 · Windows Disable LogOff Button Through Registry

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects a suspicious registry modification that disables the logoff feature on a Windows host, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.7.422.json — DO NOT EDIT -->
...
# UC-10.7.422 · ServicePrincipalNames Discovery with PowerShell

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "ServicePrincipalNames Discovery with PowerShell" so the team can spot abuse early without getting lost in one-off alerts that lack context.*
...
- [https://learn.microsoft.com/en-us/dotnet/api/system.identitymodel.tokens.kerberosrequestorsecuritytoken?view=netframework-4.8](https://learn.microsoft.com/en-us/dotnet/api/system.identitymodel.tokens.kerberosrequestorsecuritytoken?view=netframework-4.8)

<!-- AUTO-GENERATED from UC-10.7.519.json — DO NOT EDIT -->
...
*We keep an eye on the shutdown of the Windows Event Log service by leveraging Windows Event ID 1100 so unusual activity is visible early — before it spreads or hides in normal noise.*
...
- [https://github.com/redcanaryco/atomic-red-team/blob/master/atomics/](https://github.com/redcanaryco/atomic-red-team/blob/master/atomics/)

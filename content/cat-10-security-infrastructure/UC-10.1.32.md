<!-- AUTO-GENERATED from UC-10.1.32.json — DO NOT EDIT -->
...
# UC-10.1.32 · Linux System Network Discovery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic identifies potential enumeration of local network configuration on Linux systems — so we know when protection is off, out of date, or bypassed.*

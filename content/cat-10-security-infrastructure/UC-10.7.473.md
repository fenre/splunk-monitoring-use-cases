<!-- AUTO-GENERATED from UC-10.7.473.json — DO NOT EDIT -->
...
# UC-10.7.473 · Windows AppLocker Privilege Escalation via Unauthorized Bypass

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We add these signals to the risk story for "Windows AppLocker Privilege Escalation via Unauthorized Bypa" so the team can spot abuse early without getting lost in one-off alerts that lack context.*

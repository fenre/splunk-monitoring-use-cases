<!-- AUTO-GENERATED from UC-10.8.25.json — DO NOT EDIT -->
...
# UC-10.8.25 · Windows Steal Authentication Certificates - ESC1 Authentication

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects when a suspicious certificate with a Subject Alternative Name (SAN) is issued using Active Directory Certificate Services (AD CS) and then immediately used for authentication — so we know when protection is off, out of date, or bypassed.*

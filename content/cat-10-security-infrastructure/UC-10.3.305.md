<!-- AUTO-GENERATED from UC-10.3.305.json — DO NOT EDIT -->
...
# UC-10.3.305 · RunDLL Loading DLL By Ordinal

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint and security-agent signals around “RunDLL Loading DLL By Ordinal” so we can see attacker-style moves—not only a one-off file or password mistake.*

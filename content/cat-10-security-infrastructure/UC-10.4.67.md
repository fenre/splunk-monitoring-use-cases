<!-- AUTO-GENERATED from UC-10.4.67.json — DO NOT EDIT -->

---
id: "10.4.67"
title: "O365 Email Transport Rule Changed"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.4.67 · O365 Email Transport Rule Changed

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We watch who changes inbox and transport rules, forwarding, and email-related tenant settings, so sneaky auto-forwarding or admin tampering is visible before it becomes a full account takeover.*
...
```spl
`o365_management_activity` Workload=Exchange AND Operation IN ("Set-*","Disable-*","New-*","Remove-*") AND Operation="*Transport*" UserId=$user$
```
...
Legitimate changes from helpdesk, calendar sync, Out-of-Office, exec assistants, migration projects, and admin-approved policy updates; confirm actor and approver in audit logs before elevating.

## References

- [https://attack.mitre.org/techniques/T1114/003/](https://attack.mitre.org/techniques/T1114/003/)
- [https://cardinalops.com/blog/cardinalops-contributes-new-mitre-attck-techniques-related-to-abuse-of-mail-transport-rules/](https://cardinalops.com/blog/cardinalops-contributes-new-mitre-attck-techniques-related-to-abuse-of-mail-transport-rules/)

<!-- AUTO-GENERATED from UC-10.2.36.json — DO NOT EDIT -->
...
# UC-10.2.36 · Detect SharpHound Command-Line Arguments

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the execution of SharpHound command-line arguments, specifically and — so we know when protection is off, out of date, or bypassed.*

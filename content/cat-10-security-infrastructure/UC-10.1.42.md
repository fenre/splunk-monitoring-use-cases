<!-- AUTO-GENERATED from UC-10.1.42.json — DO NOT EDIT -->

---
id: "10.1.42"
title: "Windows Set Network Profile Category to Private via Registry"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.1.42 · Windows Set Network Profile Category to Private via Registry

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to modify the Windows Registry to change a network profile's category to "Private", which may indicate an adversary is preparing the environment for lateral movement or reducing firewall restrictions — so we know when protection is off, out of date, or bypassed.*

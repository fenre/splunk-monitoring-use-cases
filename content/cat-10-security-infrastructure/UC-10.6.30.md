<!-- AUTO-GENERATED from UC-10.6.30.json — DO NOT EDIT -->
...
# UC-10.6.30 · Kubernetes Access Scanning

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects potential scanning activities within a Kubernetes environment, and we use Splunk so the team can see it early and act.*

<!-- AUTO-GENERATED from UC-10.4.112.json — DO NOT EDIT -->

---
id: "10.4.112"
title: "O365 Threat Intelligence Suspicious Email Delivered"
criticality: "high"
splunkPillar: "Security"
---

# UC-10.4.112 · O365 Threat Intelligence Suspicious Email Delivered
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to email entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires Office 365 Universal Audit Log ingested and CIM-normalized.
...
| tstats `summariesonly` count
  ...
  where (All_Email.message_info="*suspicious*" OR All_Email.signature="*suspicious*")
  by All_Email.recipient All_Email.src_user span=1h
| sort -count
```
...
Threat–intel delivered mail for graymail, bulk senders, and newly added indicators that include low-confidence matches. Triage in Defender threat explorer before an incident is opened.
...
- [https://learn.microsoft.com/en-us/microsoft-365/security/office-365-security/office-365-ti?view=o365-worldwide](https://learn.microsoft.com/en-us/microsoft-365/security/office-365-security/office-365-ti?view=o365-worldwide)

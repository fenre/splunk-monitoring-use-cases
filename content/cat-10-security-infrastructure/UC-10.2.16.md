<!-- AUTO-GENERATED from UC-10.2.16.json — DO NOT EDIT -->
...
# UC-10.2.16 · AWS Credential Access GetPasswordData

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We spot more than 10 GetPasswordData calls within a 5-minute window in your AWS account — so we know when protection is off, out of date, or bypassed.*
...
ESCU Risk-Based Alerting detection. Enable in ES Content Management as a Correlation Search. Generates risk events attributed to IP address entities — Notable Events fire when an entity’s cumulative risk exceeds the configured threshold. Requires AWS CloudTrail GetPasswordData ingested and CIM-normalized.

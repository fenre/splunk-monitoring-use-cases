<!-- AUTO-GENERATED from UC-10.3.572.json — DO NOT EDIT -->
...
# UC-10.3.572 · Windows Office Product Spawned Child Process For Download

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Office Product Spawned Child Process For Download”, so we catch real tradecraft and not just noise from everyday work.*
...
- [https://www.trustwave.com/en-us/resources/blogs/spiderlabs-blog/](https://www.trustwave.com/en-us/resources/blogs/spiderlabs-blog/)

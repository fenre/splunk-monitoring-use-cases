<!-- AUTO-GENERATED from UC-10.7.330.json — DO NOT EDIT -->
...
# UC-10.7.330 · Icacls Deny Command

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Icacls Deny Command so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

---

## Description

This detection identifies Icacls Deny Command. It supports security monitoring and incident response. Part of Splunk Security Essentials (ESCU) where applicable.

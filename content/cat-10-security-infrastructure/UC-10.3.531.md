<!-- AUTO-GENERATED from UC-10.3.531.json — DO NOT EDIT -->
...
# UC-10.3.531 · Windows Modify Registry LongPathsEnabled

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Modify Registry LongPathsEnabled”, so we catch real tradecraft and not just noise from everyday work.*

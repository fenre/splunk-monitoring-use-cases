<!-- AUTO-GENERATED from UC-10.10.11.json — DO NOT EDIT -->
...
*We check that scans actually ran everywhere they should so we are not blind to a whole site or system group.*
...
### Step 3 — Validate
Compare the hosts missing scans to an **CMDB or asset list** to see if the gap is decommission, network isolation, or a broken forwarder.
...
Coverage gaps can be planned (some segments intentionally excluded), scanner maintenance, or a host offline — not always an attacker evading the scan.

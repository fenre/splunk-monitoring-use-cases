<!-- AUTO-GENERATED from UC-10.2.120.json — DO NOT EDIT -->
...
# UC-10.2.120 · Windows Impair Defense Disable Realtime Signature Delivery

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch modifications to the Windows registry that disable the Windows Defender real-time signature delivery feature — so we know when protection is off, out of date, or bypassed.*

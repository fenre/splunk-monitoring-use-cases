<!-- AUTO-GENERATED from UC-10.1.39.json — DO NOT EDIT -->
...
# UC-10.1.39 · Windows Modify Registry to Add or Modify Firewall Rule

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects a potential addition or modification of firewall rules, signaling possible configuration changes or security policy adjustments — so we know when protection is off, out of date, or bypassed.*

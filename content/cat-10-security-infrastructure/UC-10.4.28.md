<!-- AUTO-GENERATED from UC-10.4.28.json — DO NOT EDIT -->
...
# UC-10.4.28 · Gdrive suspicious file sharing

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We watch Google mail and file-sharing signals for odd attachments, subjects, and external shares, so we catch credential theft and data sprawl in Workspace.*
...
Legitimate Google Drive and Calendar sharing for partner programs, all-hands content, and external collaboration under approved DLP and sharing policy. Corroborate in Workspace admin and audit before escalation.

<!-- AUTO-GENERATED from UC-10.3.495.json — DO NOT EDIT -->
...
# UC-10.3.495 · Windows Indirect Command Execution Via pcalua

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Indirect Command Execution Via pcalua”, so we catch real tradecraft and not just noise from everyday work.*

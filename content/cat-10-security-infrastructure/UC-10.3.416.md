<!-- AUTO-GENERATED from UC-10.3.416.json — DO NOT EDIT -->
...
# UC-10.3.416 · Windows Command and Scripting Interpreter Path Traversal Exec

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows Command and Scripting Interpreter Path Traversal Exec”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.7.152.json — DO NOT EDIT -->
...
# UC-10.7.152 · Azure AD New MFA Method Registered

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Azure AD New MFA Method Registered so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

<!-- AUTO-GENERATED from UC-10.7.300.json — DO NOT EDIT -->
...
# UC-10.7.300 · Disabled Kerberos Pre-Authentication Discovery With PowerView

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Disabled Kerberos Pre-Authentication Discovery With PowerView so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

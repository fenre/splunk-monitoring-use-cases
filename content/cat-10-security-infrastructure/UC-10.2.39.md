<!-- AUTO-GENERATED from UC-10.2.39.json — DO NOT EDIT -->
...
# UC-10.2.39 · Dump LSASS via comsvcs DLL

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We catch the behavior of dumping credentials from memory by exploiting the Local Security Authority Subsystem Service (LSASS) using the comsvcs.dll and MiniDump using rundll32 — so we know when protection is off, out of date, or bypassed.*

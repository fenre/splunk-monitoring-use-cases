<!-- AUTO-GENERATED from UC-10.7.130.json — DO NOT EDIT -->
...
# UC-10.7.130 · AWS Password Policy Changes

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use this 'AWS Password Policy Changes' search to catch the exact behavior in the data we already collect, so the team can confirm or clear it in the right management console or identity store.*
...
Failed or first-time sign-ins from new devices, mobile apps, CLI sessions, and third-party IDP or SSO synchronization; map to the IAM or identity console before elevating.

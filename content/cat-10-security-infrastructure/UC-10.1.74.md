<!-- AUTO-GENERATED from UC-10.1.74.json — DO NOT EDIT -->
...
# UC-10.1.74 · Detect Remote Access Software Usage Traffic

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects network traffic associated with known remote access software applications, such as AnyDesk, GoToMyPC, LogMeIn, and TeamViewer — so we know when protection is off, out of date, or bypassed.*
...
```spl
| from datamodel:Network_Traffic.All_Traffic | search src=$src$ app=$app$
```

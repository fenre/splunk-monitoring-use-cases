<!-- AUTO-GENERATED from UC-10.3.450.json — DO NOT EDIT -->
...
# UC-10.3.450 · Windows DLL Search Order Hijacking with iscsicpl

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows DLL Search Order Hijacking with iscsicpl”, so we catch real tradecraft and not just noise from everyday work.*

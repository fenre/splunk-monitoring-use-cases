<!-- AUTO-GENERATED from UC-10.6.132.json — DO NOT EDIT -->
...
# UC-10.6.132 · F5 BIG-IP iControl REST Vulnerability CVE-2022-1388

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*The following analytic detects attempts to exploit the F5 BIG-IP iControl REST vulnerability for unauthenticated remote code execution, and we use Splunk so the team can see it early and act.*

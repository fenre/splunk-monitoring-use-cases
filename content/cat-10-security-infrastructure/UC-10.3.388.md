<!-- AUTO-GENERATED from UC-10.3.388.json — DO NOT EDIT -->
...
# UC-10.3.388 · Windows AppLocker Execution from Uncommon Locations

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows AppLocker Execution from Uncommon Locations”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.3.451.json — DO NOT EDIT -->
...
# UC-10.3.451 · Windows DNS Gather Network Info

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We use endpoint security telemetry to stay ahead of the behavior this rule calls “Windows DNS Gather Network Info”, so we catch real tradecraft and not just noise from everyday work.*

<!-- AUTO-GENERATED from UC-10.8.2.json — DO NOT EDIT -->
...
*We review who requested which certificates from our internal CAs so surprise or stolen issuance does not go unnoticed in Splunk or at audit time.*
...
### Step 3 — Validate
Compare with your CA’s audit or issuance log (e.g. AD CS, EJBCA, or Vault) for the same requester, template, and serial, then confirm field extractions in Splunk.
...
High-volume but legitimate issuance from auto-enrollment, cluster renewals, or service accounts; correlate with the CA template, requester, and service catalog before treating as abuse.

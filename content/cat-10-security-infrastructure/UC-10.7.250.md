<!-- AUTO-GENERATED from UC-10.7.250.json — DO NOT EDIT -->
...
# UC-10.7.250 · Active Directory Privilege Escalation Identified

> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security

*We look for Active Directory Privilege Escalation Identified so the security team can catch abuse while it is still small and controllable, before accounts or data are at real risk.*

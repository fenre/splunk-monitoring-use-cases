<!-- AUTO-GENERATED from UC-21.1.14.json — DO NOT EDIT -->

---
id: "21.1.14"
title: "Utility Fleet GPS and Dispatch Optimization"
criticality: "high"
...
*We watch utility trucks and crew routes. We help you catch long silent GPS gaps or odd routes before service windows slip.*

---

## Description

During storms, knowing crew proximity to open tickets reduces travel time and improves ETR accuracy for public communications and mutual aid billing.

## Value

Service and risk leaders use signals from Utility Fleet GPS and Dispatch Optimization to move crews, budget, and customer or regulator communications while the situation is still controllable, so the organization steers from live data rather than a post-incident report.
...
- `stats` rolls up events into metrics; results are split **by vehicle_id, crew_id, _time** so each row reflects one combination of those dimensions.
...
Map (vehicle positions), Table (crews with stale GPS), Line chart (fleet utilization), Bar chart (response time by district).

## Known False Positives

Route or idle-time spikes during storms, large mutual-aid events, detours for roadwork, or vehicle swaps that fleet and dispatch already aligned on the board.

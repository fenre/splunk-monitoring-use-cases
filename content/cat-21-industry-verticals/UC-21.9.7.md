<!-- AUTO-GENERATED from UC-21.9.7.json — DO NOT EDIT -->
...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Security &middot; **Type:** Performance, Fault

*We watch supplied versus billed water. We help you find real loss before non-revenue water explodes on the books.*
...
Service and risk leaders use signals from Water Loss and Non-Revenue Water Detection to move crews, budget, and customer or regulator communications while the situation is still controllable, so the organization steers from live data rather than a post-incident report.
...
- `stats` rolls up events into metrics; results are split **by zone_id, _time** so each row reflects one combination of those dimensions.
...
NRW noise from unmetered use, main breaks under repair, night-flow studies, or billing-cycle lag the water-audit program treats as a known reconciliation item.

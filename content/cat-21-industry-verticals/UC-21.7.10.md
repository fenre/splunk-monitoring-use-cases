<!-- AUTO-GENERATED from UC-21.7.10.json — DO NOT EDIT -->

---
id: "21.7.10"
title: "Airport SCADA Alarm Monitoring"
...
*We watch airport facility SCADA alarms. We help you catch HVAC, power, or baggage plant faults before comfort and ops suffer.*

---

## Description

Airports rely on SCADA for jet bridges, baggage power, and utilities; alarm floods and unacked critical points risk missed responses during IROPS.

## Value

Service and risk leaders use signals from Airport SCADA Alarm Monitoring to move crews, budget, and customer or regulator communications while the situation is still controllable, so the organization steers from live data rather than a post-incident report.
...
- `stats` rolls up events into metrics; results are split **by subsystem, _time** so each row reflects one combination of those dimensions.
...
Timeline (alarm bursts), Bar chart (open alarms by subsystem), Single value (unacked critical count).

## Known False Positives

Alarm bursts during BHS or jet-bridge exercises, utility or fuel system cutovers, airfield lighting certification runs, or fire/life-safety tests that airport facilities logged as supervised work.

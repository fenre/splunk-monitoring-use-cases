<!-- AUTO-GENERATED from UC-21.1.12.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Expert &middot; **Pillar:** Observability &middot; **Type:** Fault, Change

*We watch whether outage tickets match live SCADA. We help you catch wrong customer comms before trust erodes.*
...
Service and risk leaders use signals from Outage Management System vs SCADA State Correlation to move crews, budget, and customer or regulator communications while the situation is still controllable, so the organization steers from live data rather than a post-incident report.
...
State mismatch right after OMS cutovers, mapping refreshes, storm playbooks, or training simulations the control room ran as a planned exercise.

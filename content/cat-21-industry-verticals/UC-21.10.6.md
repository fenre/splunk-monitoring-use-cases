<!-- AUTO-GENERATED from UC-21.10.6.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Advanced &middot; **Pillar:** Security &middot; **Type:** Security, Fault

*We watch patterns that look like organized fraud. We help you connect rings before many small hits become one big loss.*
...
Service and risk leaders use signals from Insurance Fraud Ring Detection to move crews, budget, and customer or regulator communications while the situation is still controllable, so the organization steers from live data rather than a post-incident report.
...
- `stats` rolls up events into metrics; results are split **by entity_id** so each row reflects one combination of those dimensions.
...
Fraud model noise on big marketing campaigns, payment-method tests, or known merchant outage windows the SIU whitelisted as benign clusters.

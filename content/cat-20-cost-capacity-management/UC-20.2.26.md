<!-- AUTO-GENERATED from UC-20.2.26.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by cluster, namespace** so each row reflects one combination of those dimensions.

<!-- AUTO-GENERATED from UC-20.3.11.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Compliance, Cost
...
- `stats` rolls up events into metrics; results are split **by db_name, host** so each row reflects one combination of those dimensions.

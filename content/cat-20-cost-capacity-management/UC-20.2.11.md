<!-- AUTO-GENERATED from UC-20.2.11.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by resource_type, account_id** so each row reflects one combination of those dimensions.

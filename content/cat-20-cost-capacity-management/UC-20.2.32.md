<!-- AUTO-GENERATED from UC-20.2.32.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by _time, host, gpu_index** so each row reflects one combination of those dimensions.

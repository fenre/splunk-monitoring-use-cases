<!-- AUTO-GENERATED from UC-20.1.15.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by app, lineItem_UsageType** so each row reflects one combination of those dimensions.

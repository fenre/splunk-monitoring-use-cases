<!-- AUTO-GENERATED from UC-20.1.8.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by transfer_type, lineItem_ProductCode** so each row reflects one combination of those dimensions.

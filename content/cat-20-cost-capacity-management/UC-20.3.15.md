<!-- AUTO-GENERATED from UC-20.3.15.json — DO NOT EDIT -->
...
> **Criticality:** Medium &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Cost, Performance
...
- `stats` rolls up events into metrics; results are split **by enterprise_slug** so each row reflects one combination of those dimensions.

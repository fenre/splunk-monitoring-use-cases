<!-- AUTO-GENERATED from UC-20.3.9.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by org_id** so each row reflects one combination of those dimensions.

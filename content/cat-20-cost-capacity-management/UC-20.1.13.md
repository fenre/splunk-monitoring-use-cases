<!-- AUTO-GENERATED from UC-20.1.13.json — DO NOT EDIT -->
...
- `eventstats` rolls up events into metrics; results are split **by lineItem_ProductCode** so each row reflects one combination of those dimensions.

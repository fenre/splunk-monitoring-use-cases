<!-- AUTO-GENERATED from UC-20.2.25.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by _time, host, resource_type** so each row reflects one combination of those dimensions.

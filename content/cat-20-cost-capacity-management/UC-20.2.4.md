<!-- AUTO-GENERATED from UC-20.2.4.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by product, vendor, license_type** so each row reflects one combination of those dimensions.

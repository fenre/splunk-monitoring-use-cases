<!-- AUTO-GENERATED from UC-20.2.7.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by week_of_year** so each row reflects one combination of those dimensions.

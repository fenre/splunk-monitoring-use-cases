<!-- AUTO-GENERATED from UC-20.2.12.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by product, pool** so each row reflects one combination of those dimensions.

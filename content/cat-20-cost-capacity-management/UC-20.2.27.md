<!-- AUTO-GENERATED from UC-20.2.27.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by _time, bucket_name, account_id** so each row reflects one combination of those dimensions.

<!-- AUTO-GENERATED from UC-20.2.15.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by pdu_id, rack, zone, _time** so each row reflects one combination of those dimensions.

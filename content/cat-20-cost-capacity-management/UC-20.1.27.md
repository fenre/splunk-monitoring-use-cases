<!-- AUTO-GENERATED from UC-20.1.27.json — DO NOT EDIT -->
...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Cost, Capacity
...
- `stats` rolls up events into metrics; results are split **by _time, cloud_provider, business_unit** so each row reflects one combination of those dimensions.

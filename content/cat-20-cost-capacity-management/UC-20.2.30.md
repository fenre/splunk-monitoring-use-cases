<!-- AUTO-GENERATED from UC-20.2.30.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Capacity, Performance
...
- `stats` rolls up events into metrics; results are split **by _time, cluster_name** so each row reflects one combination of those dimensions.

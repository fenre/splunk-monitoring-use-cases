<!-- AUTO-GENERATED from UC-20.2.29.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by tunnel_id, site_name** so each row reflects one combination of those dimensions.

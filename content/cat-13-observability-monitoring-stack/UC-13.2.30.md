<!-- AUTO-GENERATED from UC-13.2.30.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by recommendation_type action_taken** so each row reflects one combination of those dimensions.

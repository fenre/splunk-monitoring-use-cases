<!-- AUTO-GENERATED from UC-13.5.17.json — DO NOT EDIT -->
...
> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Compliance, Availability
...
- `streamstats` rolls up events into metrics; results are split **by service_name** so each row reflects one combination of those dimensions.

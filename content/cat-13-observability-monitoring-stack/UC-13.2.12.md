<!-- AUTO-GENERATED from UC-13.2.12.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by disposition, severity** so each row reflects one combination of those dimensions.

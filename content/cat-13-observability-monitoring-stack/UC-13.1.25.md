<!-- AUTO-GENERATED from UC-13.1.25.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Configuration
...
- `stats` rolls up events into metrics; results are split **by host, peer, message** so each row reflects one combination of those dimensions.
...
Capacity moves with archive work, new data, or a short burst. We compare with growth plans before a spend jump.

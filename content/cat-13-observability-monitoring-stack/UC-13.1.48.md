...
*We watch how full our indexing and processing queues are so we can act before data stacks up, slows, or is dropped.*
...
Queues fill during indexing surges, search peaks, or after restart. We rule out maintenance, bundle work, and traffic spikes before we chase a single node.

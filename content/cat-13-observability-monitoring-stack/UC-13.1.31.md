<!-- AUTO-GENERATED from UC-13.1.31.json — DO NOT EDIT -->
...
> **Criticality:** High &middot; **Difficulty:** Expert &middot; **Pillar:** Observability &middot; **Type:** Performance
...
- `stats` rolls up events into metrics; results are split **by host, pool_name, message** so each row reflects one combination of those dimensions.
...
Signals move after deploys, config edits, and traffic shifts. We compare with the right product view and a short history before an outage page.

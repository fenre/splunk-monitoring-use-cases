...
• `stats` rolls up events into metrics; results are split **by _time, service_name, db_system, db_name, db_statement_short** so each row reflects one combination of those dimensions.

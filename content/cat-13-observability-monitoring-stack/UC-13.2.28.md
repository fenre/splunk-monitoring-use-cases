<!-- AUTO-GENERATED from UC-13.2.28.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by has_template** so each row reflects one combination of those dimensions.

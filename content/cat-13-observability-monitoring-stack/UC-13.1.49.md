<!-- AUTO-GENERATED from UC-13.1.49.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by _time, uri_path** so each row reflects one combination of those dimensions.
...
- [Splunk Machine Learning Toolkit — overview](https://docs.splunk.com/Documentation/MLApp/latest/ML/Welcome)

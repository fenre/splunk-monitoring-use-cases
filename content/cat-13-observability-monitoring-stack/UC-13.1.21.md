<!-- AUTO-GENERATED from UC-13.1.21.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by host, object, message** so each row reflects one combination of those dimensions.

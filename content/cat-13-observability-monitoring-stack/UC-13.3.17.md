<!-- AUTO-GENERATED from UC-13.3.17.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by service_instance_id, host, k8s_namespace** so each row reflects one combination of those dimensions.

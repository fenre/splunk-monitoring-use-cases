<!-- AUTO-GENERATED from UC-13.1.13.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by st** so each row reflects one combination of those dimensions.

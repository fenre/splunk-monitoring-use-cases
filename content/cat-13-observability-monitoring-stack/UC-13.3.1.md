...
---
id: "13.3.1"
title: "Nagios/Zabbix Alert Ingestion"
criticality: "medium"
...
Consolidating legacy monitoring alerts into Splunk enables cross-tool correlation and single-pane-of-glass operations.
...
• `stats` rolls up events into metrics; results are split **by host, service, state, severity** so each row reflects one combination of those dimensions.
...
Table (third-party alerts), Bar chart (alerts by source tool), Status grid (host × service).

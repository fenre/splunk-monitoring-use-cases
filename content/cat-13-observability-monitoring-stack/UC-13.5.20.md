<!-- AUTO-GENERATED from UC-13.5.20.json — DO NOT EDIT -->
...
*We watch real user experience in the browser so slow pages, errors, and rough interactions are not invisible in production.*
...
- `stats` rolls up events into metrics; results are split **by owning_team** so each row reflects one combination of those dimensions.

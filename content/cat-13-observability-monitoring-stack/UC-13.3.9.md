<!-- AUTO-GENERATED from UC-13.3.9.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by user, resource_name, resource_type** so each row reflects one combination of those dimensions.

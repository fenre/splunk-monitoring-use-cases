<!-- AUTO-GENERATED from UC-14.4.10.json — DO NOT EDIT -->
...
*We watch your connected devices and the messages they send. We help you know if something is off with this area: iot data pipeline throughput and latency before harm, damage, or wasted effort piles up.*
...
- `stats` rolls up events into metrics; results are split **by pipeline_stage, _time** so each row reflects one combination of those dimensions.
...
Devices offline during scheduled OTA updates, battery replacements, or coverage map gaps.

<!-- AUTO-GENERATED from UC-14.6.2.json — DO NOT EDIT -->
...
*We use deep packet inspection to flag program transfer sessions so we can tie uploads and downloads to approved changes.*
...
- `stats` rolls up events into metrics; results are split **by source_h destination_h uid** so each row reflects one combination of those dimensions.
...
Program transfer noise during download windows, recovery restores, or vendor-accepted golden image pushes.

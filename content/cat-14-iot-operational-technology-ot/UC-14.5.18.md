...
*We track retained store growth so runaway topics do not fill disk or slow the broker for everyone.*
...
Retained message store growth from new topics, long-lived test fixtures, or retained policy changes.

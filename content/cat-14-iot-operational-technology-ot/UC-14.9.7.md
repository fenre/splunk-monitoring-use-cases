...
*We log controller program download and upload so we can line up code changes to tickets and windows.*
...
Program download and upload from authorized weekend changes, recovery restores, or vendor golden builds.

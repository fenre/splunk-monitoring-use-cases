<!-- AUTO-GENERATED from UC-14.1.30.json — DO NOT EDIT -->
...
*We watch how your building systems behave. We help you know if something is off with this area: economizer free cooling hours before harm, damage, or wasted effort piles up.*
...
- `stats` rolls up events into metrics; results are split **by ahu_name, _time** so each row reflects one combination of those dimensions.

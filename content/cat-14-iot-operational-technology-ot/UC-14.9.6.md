...
*We use signature-based detection in OT so known bad patterns in front of our process networks surface in one place with context.*
...
IDS hits from test traffic, inline lab sensors, or overlapping IT broadcast domains.

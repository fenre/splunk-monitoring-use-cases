<!-- AUTO-GENERATED from UC-14.3.35.json — DO NOT EDIT -->
...
*We watch what edge sensors report from the physical world. We help you know if something is off with this area: industrial alarm management via opc-ua before harm, damage, or wasted effort piles up.*
...
- `stats` rolls up events into metrics; results are split **by source_node_id, _time** so each row reflects one combination of those dimensions.

...
*We log failed logins and access denials on the message broker so we can spot bad credentials, policy mistakes, or attacks early.*
...
Auth and ACL denials from password rotation drills, new devices onboarding, or mis-typed service accounts.

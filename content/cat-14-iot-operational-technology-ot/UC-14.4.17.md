<!-- AUTO-GENERATED from UC-14.4.17.json — DO NOT EDIT -->
...
*We watch your connected devices and the messages they send. We help you know if something is off with this area: edge-to-cloud sync failures before harm, damage, or wasted effort piles up.*
...
- `stats` rolls up events into metrics; results are split **by edge_id, cloud_endpoint** so each row reflects one combination of those dimensions.

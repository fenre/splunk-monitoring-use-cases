...
> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security, Performance, Compliance

*We use deep packet inspection to track IEC-104 interrogations so a master is not over-polling or probing in a new way.*
...
Interrogation commands during SCADA resync, historian backfills, or new RTU cutovers.

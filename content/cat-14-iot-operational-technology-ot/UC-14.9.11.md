...
*We log mode and run-state changes on controllers so run, program, and remote do not get mixed up without a trail.*
...
Mode changes from run/hold/remote transitions during shift handover, local panel use, or drills.

...
*We log file and Windows-style share use in OT so out-of-profile file access does not look normal just because the network is small.*
...
SMB in OT during imaging, file drops for PLC projects, or backup jobs that are approved but should stay rare.

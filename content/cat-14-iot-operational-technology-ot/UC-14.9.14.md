...
*We log failed authentications in OT so weak credentials and account lockouts are visible next to the same asset data.*
...
Authentication noise from RADIUS rekeys, account lockouts, or certificate rotation on HMI and controllers.

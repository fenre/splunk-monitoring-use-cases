<!-- AUTO-GENERATED from UC-14.5.12.json — DO NOT EDIT -->
...
*We time subscriptions and sampling on the industrial server so late or overrun polls do not erode the picture of the process.*
...
- `stats` rolls up events into metrics; results are split **by host, subscription_id** so each row reflects one combination of those dimensions.
...
Subscription latency during heavy engineering browsing, report exports, or sampling rate changes.

<!-- AUTO-GENERATED from UC-14.5.5.json — DO NOT EDIT -->
...
*We monitor the edge forwarder backlog so a cloud or link hiccup does not quietly pile up work and age out the data we need.*
...
Forwarding backlogs during WAN blips, cloud maintenance, large burst replays, or HEC token rotation windows.

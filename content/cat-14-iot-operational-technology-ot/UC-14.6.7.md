...
*We use deep packet inspection to see identification and enumeration on Modbus so asset sweeps and odd scanners show up.*
...
Device identification requests during asset baselines, spares burn-in, or asset management scans.

<!-- AUTO-GENERATED from UC-14.9.21.json — DO NOT EDIT -->
...
*We keep an audit of administration on our OT security platform so who changed what and when is not argued from memory.*
...
- `stats` rolls up events into metrics; results are split **by user, action, appliance_id** so each row reflects one combination of those dimensions.
...
Administration audit events from platform upgrades, support logins, and scheduled health checks.

<!-- AUTO-GENERATED from UC-14.6.1.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security, Performance, Change

*We use deep packet inspection of industrial control traffic to compare reads and writes to our controllers so unexpected write-heavy patterns stand out.*
...
- `stats` rolls up events into metrics; results are split **by source_h destination_h** so each row reflects one combination of those dimensions.
...
S7 anomalies from authorized engineering access, vendor remote support, or planned PLC programming.

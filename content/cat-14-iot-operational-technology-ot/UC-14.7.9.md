...
> **Criticality:** High &middot; **Difficulty:** Expert &middot; **Pillar:** Observability &middot; **Type:** Performance, Fault

*We follow model retraining and pipeline health for on-device analytics so a bad deploy does not poison predictions we trust.*
...
Model training noise during scheduled retraining, dataset refreshes, or lab-only experiments.

<!-- AUTO-GENERATED from UC-14.2.11.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Expert &middot; **Pillar:** Observability &middot; **Type:** Compliance &middot; **Status:** Verified

*We watch your plant control systems and field data. We help you know if something is off with this area: nerc cip compliance checks before harm, damage, or wasted effort piles up.*
...
- `stats` rolls up events into metrics; results are split **by asset_id, control_id, evidence_type** so each row reflects one combination of those dimensions.

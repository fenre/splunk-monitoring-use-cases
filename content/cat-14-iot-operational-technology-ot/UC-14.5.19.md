...
*We read client disconnect reasons so we can tell a clean shutdown from a network or keep-alive problem.*
...
Client disconnect reason spikes during keep-alive tuning, client upgrades, or roaming wireless clients.

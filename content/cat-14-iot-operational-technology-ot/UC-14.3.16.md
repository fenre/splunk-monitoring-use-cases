<!-- AUTO-GENERATED from UC-14.3.16.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by host, door_id** so each row reflects one combination of those dimensions.

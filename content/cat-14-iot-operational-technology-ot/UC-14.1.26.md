<!-- AUTO-GENERATED from UC-14.1.26.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by vav_id, zone_name, _time** so each row reflects one combination of those dimensions.

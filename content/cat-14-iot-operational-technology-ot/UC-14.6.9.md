<!-- AUTO-GENERATED from UC-14.6.9.json — DO NOT EDIT -->

---
id: "14.6.9"
title: "DNP3 Control Relay Output Block (CROB) Tracking"
...
> **Criticality:** Critical &middot; **Difficulty:** Advanced &middot; **Pillar:** Security &middot; **Type:** Security, Compliance, Change

*We use deep packet inspection to track control relay and binary output actions so remote commands line up with what we expect.*

---

## Description

CROB select/operate sequences directly actuate breakers and outputs; a full audit trail is required for NERC CIP-style reviews and post-incident forensics.
...
- `stats` rolls up events into metrics; results are split **by _time source_h destination_h index_number uid** so each row reflects one combination of those dimensions.
...
Table (full CROB audit), Timeline (SELECT vs OPERATE), Bar chart (operates by index_number).

## Known False Positives

CROB and control events during remote operations drills, switchgear testing, or maintenance cutovers.

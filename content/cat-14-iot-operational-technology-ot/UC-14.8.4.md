<!-- AUTO-GENERATED from UC-14.8.4.json — DO NOT EDIT -->
...
*We trend how many predictive maintenance alerts fire so a jump or drop tells us the model, assets, or process changed in a meaningful way.*
...
Predictive maintenance alert volume changes when models are retrained, thresholds retuned, or new assets are added.

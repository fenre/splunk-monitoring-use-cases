...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Compliance &middot; **Status:** Verified

*We compare live traffic to our zone and conduit policy so a hole in segmentation is a finding, not a hunch on a whiteboard.*
...
Zone and conduit changes during segment builds, I/O migrations, or policy CSV refresh mistakes.

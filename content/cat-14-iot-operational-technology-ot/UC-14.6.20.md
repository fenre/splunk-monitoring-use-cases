...
> **Criticality:** Critical &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security, Compliance, Fault

*We use deep packet inspection to see unknown protocols on the OT VLAN so unexpected traffic is not written off as noise.*
...
Unknown protocols on a VLAN from mirrored traffic, PC helpers, or temporary lab gear.

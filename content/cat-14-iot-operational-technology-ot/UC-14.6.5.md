...
*We use deep packet inspection to chart function codes on Modbus so odd commands or new devices do not blend into background noise.*
...
Unusual function codes from new vendor agents, custom polling, or scheduled diagnostic runs.

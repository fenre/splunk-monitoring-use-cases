...
*We log connector and API authentication on the industrial gateway so a bad key or user does not look like a data drought.*
...
Authentication events during token rotation, service account changes, or password policy updates.

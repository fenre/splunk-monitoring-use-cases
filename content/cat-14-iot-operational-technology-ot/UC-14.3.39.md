<!-- AUTO-GENERATED from UC-14.3.39.json — DO NOT EDIT -->
...
> **Criticality:** High &middot; **Difficulty:** Expert &middot; **Pillar:** Observability &middot; **Type:** Compliance

*We watch what edge sensors report from the physical world. We help you know if something is off with this area: multi-device fleet firmware version compliance before harm, damage, or wasted effort piles up.*
...
- `stats` rolls up events into metrics; results are split **by host, device_id** so each row reflects one combination of those dimensions.

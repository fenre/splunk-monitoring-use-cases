<!-- AUTO-GENERATED from UC-14.9.1.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Inventory

*We use our network security tool’s inventory in Splunk so we know which OT devices exist and how they change over time, which is the basis for protecting them.*
...
New and updated assets from planned commissioning, equipment swaps, discovery scans, or site visits.

<!-- AUTO-GENERATED from UC-14.3.31.json — DO NOT EDIT -->
...
*We watch what edge sensors report from the physical world. We help you know if something is off with this area: opc-ua tag browsing & change before harm, damage, or wasted effort piles up.*
...
- `stats` rolls up events into metrics; results are split **by opcua_tag, host** so each row reflects one combination of those dimensions.

...
*We catch new host-to-host flows in OT so a new path between machines is a first-class event, not a footnote in a pcap.*
...
New communication flows from network redesigns, controller replacements, or vendor remote sessions.

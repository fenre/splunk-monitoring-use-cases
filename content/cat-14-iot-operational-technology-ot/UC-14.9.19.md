...
*We log redundant pair and failover events in OT so a silent switch to backup or a flap is not invisible to the team.*
...
HA and redundancy events from controller failovers, ring healing, or firmware-induced failback tests.

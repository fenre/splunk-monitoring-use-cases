...
*We log forced and overridden variables in the process so a human or tool pinning a value is never invisible.*
...
Forced variables during process holds, interlocks, or operator interventions tied to the runbook.

<!-- AUTO-GENERATED from UC-14.7.6.json — DO NOT EDIT -->
...
*We track transform and connector errors on the industrial gateway so a bad format or field map does not silently drop production data.*
...
Transformation errors during connector upgrades, bad payloads from a test bench, or schema edits.

...
*We track sensor and platform health in our OT security stack so a starving appliance does not create blind spots on the line.*
...
Sensor resource use spikes during traffic storms, pcap replays, or index maintenance on the appliance.

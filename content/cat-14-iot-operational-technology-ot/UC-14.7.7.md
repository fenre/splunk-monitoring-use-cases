...
*We roll up gateway health across sites so we can see which plant or cell is falling behind the fleet norm.*
...
Multi-site blips from regional outages, daylight maintenance slots, or staggered rollouts.

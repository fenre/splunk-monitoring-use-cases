<!-- AUTO-GENERATED from UC-14.5.10.json — DO NOT EDIT -->
...
*We watch local storage and backlogs on the edge box so a full disk or stuck queue does not block messaging into our platform.*
...
SQLite backlog during offline buffering, site power events, or disk cleanup on the edge host.

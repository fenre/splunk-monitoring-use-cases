...
*We flag devices we have not seen before on the OT side so a rogue or mis-placed box is not just another line on a diagram.*
...
Newly seen devices from VLAN mirrors, test gear, or temporary contractor laptops on process segments.

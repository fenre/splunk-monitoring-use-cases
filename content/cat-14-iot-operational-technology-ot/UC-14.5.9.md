<!-- AUTO-GENERATED from UC-14.5.9.json — DO NOT EDIT -->
...
*We watch certificates and trust on the industrial link so an expiry or trust break does not silently cut off secure plant data.*
...
Certificate expiry during planned PKI rollover, vendor certificate refresh, or migration windows.

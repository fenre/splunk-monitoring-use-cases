<!-- AUTO-GENERATED from UC-14.6.10.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Advanced &middot; **Pillar:** Security &middot; **Type:** Fault, Security, Availability

*We use deep packet inspection to see cold and warm restarts in substation telecontrol so we can line up process events with changes.*
...
Restart signatures during cold starts after outages, planned firmware, or control reboot procedures.

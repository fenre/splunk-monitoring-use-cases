<!-- AUTO-GENERATED from UC-14.2.26.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Quality, Safety

*We watch your plant control systems and field data. We help you know if something is off with this area: batch process deviation alerting before harm, damage, or wasted effort piles up.*
...
- `stats` rolls up events into metrics; results are split **by reactor_id** so each row reflects one combination of those dimensions.

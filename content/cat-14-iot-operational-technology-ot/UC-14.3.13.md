<!-- AUTO-GENERATED from UC-14.3.13.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by hvac_mode, host** so each row reflects one combination of those dimensions.

<!-- AUTO-GENERATED from UC-14.5.21.json — DO NOT EDIT -->
...
*We size topic tree depth and fan-out so a messy namespace or runaway auto-topics do not get impossible to run.*
...
- `stats` rolls up events into metrics; results are split **by root, host** so each row reflects one combination of those dimensions.
...
Topic tree depth and fan-out shifts during namespace redesigns, new lines, or discovery agents.

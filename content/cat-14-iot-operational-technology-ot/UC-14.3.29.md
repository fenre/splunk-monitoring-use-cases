<!-- AUTO-GENERATED from UC-14.3.29.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by host, equipment_type** so each row reflects one combination of those dimensions.
...
High sound readings during shift changes, open dock doors, nearby construction, or planned equipment tests.

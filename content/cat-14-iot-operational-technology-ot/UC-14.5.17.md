...
*We check shared subscription balance so work spreads fairly and one consumer does not starve the rest.*
...
Shared subscription imbalance during subscriber scaling, canary clients, or broker-side routing changes.

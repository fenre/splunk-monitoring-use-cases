<!-- AUTO-GENERATED from UC-14.5.6.json — DO NOT EDIT -->
...
*We log retained messages and last-will events so surprise broker-side state does not break downstream logic we rely on.*
...
- `stats` rolls up events into metrics; results are split **by client_id, topic, action, _time** so each row reflects one combination of those dimensions.
...
Retain and last-will changes during topic migrations, test clients, or controlled automation updates.

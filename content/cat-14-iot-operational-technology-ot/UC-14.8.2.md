<!-- AUTO-GENERATED from UC-14.8.2.json — DO NOT EDIT -->
...
*We trend data quality and gap rates so quality drift is visible in the run-up to scrap or unplanned stops.*
...
Quality shifts when calibrations run, sensors are replaced, or quality limits are re-tightened for campaigns.

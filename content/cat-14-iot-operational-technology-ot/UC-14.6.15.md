...
*We use deep packet inspection to follow spontaneous IEC-104 data so bursts from the field are visible to operations.*
...
Spontaneous data bursts during process disturbances, event floods, or maintenance forcing.

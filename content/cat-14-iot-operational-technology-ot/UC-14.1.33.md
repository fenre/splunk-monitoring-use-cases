<!-- AUTO-GENERATED from UC-14.1.33.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by building_name, is_after_hours, _time** so each row reflects one combination of those dimensions.

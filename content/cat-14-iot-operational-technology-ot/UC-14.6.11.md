...
*We use deep packet inspection to audit CIP and EtherNet/IP service use so non-routine service calls stand out.*
...
CIP service traffic from HMI refresh, I/O module scans, or firmware download sessions.

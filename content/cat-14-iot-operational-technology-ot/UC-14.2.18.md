<!-- AUTO-GENERATED from UC-14.2.18.json — DO NOT EDIT -->
...
*We watch your plant control systems and field data. We help you know if something is off with the engineering laptop or desktop in the control zone before harm, damage, or wasted effort piles up.*
...
- `stats` rolls up events into metrics; results are split **by Computer, Image, ParentImage** so each row reflects one combination of those dimensions.

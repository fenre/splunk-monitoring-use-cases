...
*We compare live tag values from the industrial gateway to what we expect so bad scaling or wrong mapping is caught before it steers a decision.*
...
Tag validation noise when tags are re-mapped, scaled, or decommissioned in controlled projects.

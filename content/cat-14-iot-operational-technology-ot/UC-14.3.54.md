<!-- AUTO-GENERATED from UC-14.3.54.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by zone** so each row reflects one combination of those dimensions.

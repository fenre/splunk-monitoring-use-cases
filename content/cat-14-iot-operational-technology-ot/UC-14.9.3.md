...
*We track vulnerability findings on OT gear so we can prioritize what matters even when a patch is not a simple click.*
...
OT vulnerabilities may exist on legacy gear with documented compensating controls and planned lifecycle replacements.

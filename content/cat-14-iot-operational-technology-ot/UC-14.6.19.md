<!-- AUTO-GENERATED from UC-14.6.19.json — DO NOT EDIT -->
...
> **Criticality:** Medium &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Fault, Performance, Compliance

*We use deep packet inspection to read HART-IP device status so instrument problems surface before they hit the process.*
...
- `stats` rolls up events into metrics; results are split **by destination_h _time** so each row reflects one combination of those dimensions.
...
HART additional status from instrument calibrations, range changes, or maintenance bypasses.

...
*We check the health of edge modules that handle messaging so a bad container does not take down collection on the line.*
...
Container health noise during image updates, restarts for config pushes, or resource contention on the edge host.

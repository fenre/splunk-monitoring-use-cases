...
*We log decode and malformed-packet events so a parser gap or a deliberate fuzz is visible next to the same flow metadata.*
...
Decode failures during malformed captures, jumbo or fragmented frames, or sensor version skew on parsers.

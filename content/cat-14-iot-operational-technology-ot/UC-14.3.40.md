<!-- AUTO-GENERATED from UC-14.3.40.json — DO NOT EDIT -->
...
*We watch what edge sensors report from the physical world. We help you know if something is off with this area: device location tracking via gnss before harm, damage, or wasted effort piles up.*
...
- `stats` rolls up events into metrics; results are split **by device_id** so each row reflects one combination of those dimensions.

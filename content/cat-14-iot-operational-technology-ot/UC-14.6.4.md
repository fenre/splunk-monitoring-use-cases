...
*We use deep packet inspection to watch which program blocks are touched so unexpected access to logic surfaces quickly.*
...
Function block access from migration tools, obfuscated projects, or temporary diagnostic screens.

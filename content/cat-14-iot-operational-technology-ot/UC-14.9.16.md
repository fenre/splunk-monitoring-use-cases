...
*We look for port-scan-like behavior in OT so an IT tool or bad actor poking the segment shows up with context.*
...
Port scan-like traffic from misconfigured IT scanners, asset tools, or overlapping address space.

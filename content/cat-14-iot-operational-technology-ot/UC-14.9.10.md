<!-- AUTO-GENERATED from UC-14.9.10.json — DO NOT EDIT -->
...
*We log control actions and writes on industrial assets so we can tell intended automation from something off-script.*
...
- `stats` rolls up events into metrics; results are split **by node_id, zone, _time** so each row reflects one combination of those dimensions.
...
Control actions from routine SCADA operator steps, automatic sequences, or maintenance overrides.

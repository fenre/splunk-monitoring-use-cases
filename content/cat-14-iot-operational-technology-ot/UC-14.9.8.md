...
*We log firmware and image activation on controllers so a software change in the field is always visible to security and ops.*
...
Firmware activations that match approved change windows, golden image rollouts, or spares first-boot.

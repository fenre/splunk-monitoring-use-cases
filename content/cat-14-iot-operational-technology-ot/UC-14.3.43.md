<!-- AUTO-GENERATED from UC-14.3.43.json — DO NOT EDIT -->
...
> **Criticality:** High &middot; **Difficulty:** Expert &middot; **Pillar:** Observability &middot; **Type:** Configuration

*We watch what edge sensors report from the physical world. We help you know if something is off with this area: configuration drift detection across fleet before harm, damage, or wasted effort piles up.*
...
Tag drift during recipe changes, batch transitions, or commissioning of new product runs.

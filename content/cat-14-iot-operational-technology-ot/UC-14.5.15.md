...
*We log denied writes and permission faults so we can tell normal operator limits from something worth investigating.*
...
Write and permission denials from authorized HMI actions, interlocks, or role changes during runbooks.

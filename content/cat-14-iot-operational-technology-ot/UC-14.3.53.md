<!-- AUTO-GENERATED from UC-14.3.53.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Expert &middot; **Pillar:** Observability &middot; **Type:** Performance

*We watch what edge sensors report from the physical world. We help you know if something is off with shaking that might mean a bearing, balance, or mount problem before harm, damage, or wasted effort piles up.*
...
Vibration changes during tool changes, transport moves, or planned equipment startups.

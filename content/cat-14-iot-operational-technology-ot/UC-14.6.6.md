...
> **Criticality:** Critical &middot; **Difficulty:** Advanced &middot; **Pillar:** Security &middot; **Type:** Security, Change, Fault

*We use deep packet inspection to follow register value changes so we can audit what moved and when in the process.*
...
Register churn during recipe edits, setpoint sweeps, or batch phase changes.

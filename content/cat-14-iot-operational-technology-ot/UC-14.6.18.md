...
> **Criticality:** Medium &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Security, Performance, Fault

*We use deep packet inspection to catch BACnet discovery storms so broadcast noise does not hide real trouble.*
...
Who-Is broadcasts during scheduled trend uploads, new device commissioning, or controller reboots.

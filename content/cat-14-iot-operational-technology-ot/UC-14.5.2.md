<!-- AUTO-GENERATED from UC-14.5.2.json — DO NOT EDIT -->
...
*We count industrial server sessions and connections so we see overload or client churn early and keep plant data flowing steadily.*
...
- `stats` rolls up events into metrics; results are split **by host, connection_state** so each row reflects one combination of those dimensions.
...
Connection and session counts shift during client restarts, planned PLC maintenance, or engineering tool reconnects.

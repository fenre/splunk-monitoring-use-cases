<!-- AUTO-GENERATED from UC-14.6.16.json — DO NOT EDIT -->
...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Security &middot; **Type:** Compliance, Fault, Security

*We use deep packet inspection to compare time sync on IEC-104 so clock drift does not break sequence and event trust.*
...
Clock sync offsets during GPS antenna work, NTP source changes, or leap-second handling.

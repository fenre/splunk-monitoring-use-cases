<!-- AUTO-GENERATED from UC-14.1.27.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by chiller_id, _time** so each row reflects one combination of those dimensions.

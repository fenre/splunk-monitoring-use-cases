<!-- AUTO-GENERATED from UC-9.1.16.json — DO NOT EDIT -->
...
*We watch sign-in and ticket patterns that look like forged domain tickets so we can respond before wide compromise.*

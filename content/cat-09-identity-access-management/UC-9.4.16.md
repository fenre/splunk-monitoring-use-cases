<!-- AUTO-GENERATED from UC-9.4.16.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Availability

*We use identity and sign-in data in Splunk so we can notice unusual logins, access changes, and privileged use while it still matters — Vault Synchronization Failures*
...
- `stats` rolls up events into metrics; results are split **by primary_vault, dr_vault** so each row reflects one combination of those dimensions.
...
Routine privileged access from approved change windows, scheduled maintenance, ITSM-tied tickets, or break-glass exercises documented in your runbook.

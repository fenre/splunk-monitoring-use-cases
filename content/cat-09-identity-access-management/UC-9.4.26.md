...
*We search typed commands in privileged remote sessions for dangerous patterns so analysts see risky behavior without watching hours of video.*
...
Admins running legitimate `diskpart` or recovery commands during incidents, false regex matches in transcripts, and lab environments; validate against session owner and change ticket before automated session cut-off.

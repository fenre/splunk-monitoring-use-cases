...
*We flag when someone starts a privileged vault session at odd hours so you can review before off-hours access turns into unnoticed abuse.*
...
Global teams, weekend cutovers, vendor support windows, and on-call maintenance that is normal in your org but off local business hours — tune time zones and account exclude lists.

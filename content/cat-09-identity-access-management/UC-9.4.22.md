...
> **Criticality:** Medium &middot; **Difficulty:** Beginner &middot; **Pillar:** Security &middot; **Type:** Security, Audit &middot; **Status:** Draft

*We add up who pulled which vault passwords to which systems so you can see overuse of shared accounts and odd access to sensitive hosts during reviews.*
...
Legitimate bulk checkouts during patching or large changes, emergency break-glass, and scheduled automation that retrieves credentials from the vault nightly — align counts with change tickets and CMDB owners.

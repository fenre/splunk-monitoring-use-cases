<!-- AUTO-GENERATED from UC-9.5.3.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by actor.alternateId, client.ipAddress, outcome.result, displayMessage** so each row reflects one combination of those dimensions.
...
Risky sign-ins from VPN egress IPs flagged as anonymizers, frequent traveler accounts, or unfamiliar but legitimate new locations; verify with the user and travel calendar.

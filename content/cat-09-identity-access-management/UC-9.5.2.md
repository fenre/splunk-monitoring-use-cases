<!-- AUTO-GENERATED from UC-9.5.2.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by actor.alternateId, client.ipAddress, outcome.reason** so each row reflects one combination of those dimensions.
...
MFA challenges from VPN reconnects, app re-authentications after token expiry, step-up auth flows, Duo or Okta policy tests, and helpdesk-assisted recovery.

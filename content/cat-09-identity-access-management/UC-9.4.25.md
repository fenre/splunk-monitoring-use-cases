...
Planned long maintenance, database restores, and vendor-led sessions that exceed the default minutes but are on the change calendar — join alerts with ITSM and PAM change records.

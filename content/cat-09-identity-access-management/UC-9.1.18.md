...
*We list hybrid-joined devices that are out of policy so you can fix them before they block people or let risky devices stay on the network.*
...
Intune or policy sync delay after patches, device wipe/repair cycles, and grace windows for new builds can show as non-compliance briefly.

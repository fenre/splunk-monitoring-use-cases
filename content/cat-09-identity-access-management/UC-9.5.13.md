<!-- AUTO-GENERATED from UC-9.5.13.json — DO NOT EDIT -->

---
id: "9.5.13"
title: "Okta App Assignment Changes"
criticality: "high"
...
*We use Okta sign-in records so we can see failed logins, risky sessions, and admin changes in one place.*

---

## Description

New access to sensitive SaaS apps is a common attack path; monitoring assignments supports least-privilege and access reviews.
...
- `stats` rolls up events into metrics; results are split **by actor.alternateId, target{}.displayName, target{}.type** so each row reflects one combination of those dimensions.
...
Table (app, user, actor), Timeline (assignments), Bar chart (assignments by app).

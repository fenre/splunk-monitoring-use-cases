<!-- AUTO-GENERATED from UC-9.4.7.json — DO NOT EDIT -->
...
*We use identity and sign-in data in Splunk so we can notice unusual logins, access changes, and privileged use while it still matters — Federated Identity Provider Health*
...
- `stats` rolls up events into metrics; results are split **by idp_host, tenant** so each row reflects one combination of those dimensions.

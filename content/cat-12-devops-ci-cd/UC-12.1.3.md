<!-- AUTO-GENERATED from UC-12.1.3.json — DO NOT EDIT -->
...
*We track how pull requests flow so we see review health, queue time, and where work might be stuck.*
...
PR cycle times vary with review policy, team load, and scope changes; holiday freezes and end-of-quarter pushes shift baselines.

<!-- AUTO-GENERATED from UC-12.2.19.json — DO NOT EDIT -->
...
*We watch test signals so coverage drops and flaky tests do not hide real defects.*
...
- `stats` rolls up events into metrics; results are split **by test_case, class_name** so each row reflects one combination of those dimensions.

<!-- AUTO-GENERATED from UC-12.2.10.json — DO NOT EDIT -->

---
id: "12.2.10"
title: "Jenkins Node Offline Detection"
criticality: "high"
...
Build agents going offline impacts CI capacity and causes job failures. Rapid detection enables agent recovery or failover before queue backlog grows.
...
Table (offline nodes), Single value (offline node count — target: 0), Status grid (node × online/offline), Timeline (offline events).

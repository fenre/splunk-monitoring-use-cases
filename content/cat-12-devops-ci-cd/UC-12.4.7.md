<!-- AUTO-GENERATED from UC-12.4.7.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by image_name, actor, tag** so each row reflects one combination of those dimensions.

<!-- AUTO-GENERATED from UC-12.4.6.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by cause, job_name** so each row reflects one combination of those dimensions.

<!-- AUTO-GENERATED from UC-12.5.6.json — DO NOT EDIT -->
...
- `eventstats` rolls up events into metrics; results are split **by project_id, ref** so each row reflects one combination of those dimensions.

<!-- AUTO-GENERATED from UC-12.3.4.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by project, package_name, license, license_risk** so each row reflects one combination of those dimensions.

...
*We watch for changes that skip the normal review path on important branches, because that is when risky or unreviewed code can reach production.*
...
Bypasses from emergency hotfixes, planned admin pushes during release freezes, or repo migration tasks.

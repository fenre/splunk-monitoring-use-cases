...
*We watch for history rewrites on protected branches so we know when someone may have removed audit history or forced code in without the usual checks.*
...
Force pushes from approved repo cleanup, history rewrites for license remediation, or scheduled rebases on long-running branches.

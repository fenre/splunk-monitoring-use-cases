<!-- AUTO-GENERATED from UC-12.5.10.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by repository, revision** so each row reflects one combination of those dimensions.

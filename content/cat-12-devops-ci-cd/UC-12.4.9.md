<!-- AUTO-GENERATED from UC-12.4.9.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by flag_name, variant, _time** so each row reflects one combination of those dimensions.

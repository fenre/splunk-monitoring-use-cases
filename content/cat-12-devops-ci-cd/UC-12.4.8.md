<!-- AUTO-GENERATED from UC-12.4.8.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by stage_name, environment** so each row reflects one combination of those dimensions.

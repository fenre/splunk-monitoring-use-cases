<!-- AUTO-GENERATED from UC-12.2.22.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by service** so each row reflects one combination of those dimensions.

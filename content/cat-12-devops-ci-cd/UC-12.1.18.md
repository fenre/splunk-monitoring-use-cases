<!-- AUTO-GENERATED from UC-12.1.18.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by repository, ref** so each row reflects one combination of those dimensions.

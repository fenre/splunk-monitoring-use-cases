<!-- AUTO-GENERATED from UC-12.4.3.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by playbook, host** so each row reflects one combination of those dimensions.

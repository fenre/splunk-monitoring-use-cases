<!-- AUTO-GENERATED from UC-15.2.19.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by zone, crac_id** so each row reflects one combination of those dimensions.

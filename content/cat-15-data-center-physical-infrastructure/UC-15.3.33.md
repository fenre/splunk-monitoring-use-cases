<!-- AUTO-GENERATED from UC-15.3.33.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Availability, Performance
...
- `stats` rolls up events into metrics; results are split **by sensorName, sensorModel, location, building** so each row reflects one combination of those dimensions.

<!-- AUTO-GENERATED from UC-15.2.9.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by row_id, _time** so each row reflects one combination of those dimensions.

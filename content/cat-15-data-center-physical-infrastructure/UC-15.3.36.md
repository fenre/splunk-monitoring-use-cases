<!-- AUTO-GENERATED from UC-15.3.36.json — DO NOT EDIT -->
...
- `stats` rolls up events into metrics; results are split **by workspaceName, building, floor** so each row reflects one combination of those dimensions.

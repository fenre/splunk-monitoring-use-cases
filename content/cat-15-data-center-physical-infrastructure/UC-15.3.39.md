<!-- AUTO-GENERATED from UC-15.3.39.json — DO NOT EDIT -->

---
id: "15.3.39"
title: "Cisco Spaces Proximity and Engagement Analytics"
criticality: "medium"
...
- `stats` rolls up events into metrics; results are split **by _time, zone_name, zone_type** so each row reflects one combination of those dimensions.
...
Bar chart (engagement score by zone), Bubble chart (zones by visitor volume, dwell time, repeat rate), Line chart (engagement trend per zone over 90 days), Table (zone performance details), Heatmap (zone × day-of-week engagement).

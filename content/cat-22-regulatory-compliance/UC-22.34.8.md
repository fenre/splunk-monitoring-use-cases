...
- `stats` aggregates events by **operator_id**, producing one row per unique combination for trend analysis and threshold evaluation.
...
Output fields: operator_id, sd, st.

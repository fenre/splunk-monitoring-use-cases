...
- `stats` rolls up events into metrics; results are split **by merchant, risk_flag** so each row reflects one combination of those dimensions.
...
TRM evidence during scheduled audits, controlled remediation cycles, or migration windows.

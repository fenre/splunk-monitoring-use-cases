...
- `stats` rolls up events into metrics; results are split **by PolicyName, Operation, SensitiveInfoType, Severity** so each row reflects one combination of those dimensions.

...
- `stats` aggregates events by **database_name**, producing one row per unique combination for trend analysis and threshold evaluation.
...
Output fields: database_name, db_users, okta_users, stmts.

### Step 3 — Validate
Compare with audit evidence in the database platform, DLP where database exports are monitored, and change records for planned DBA work.
...
PII detections from authorized data exports, finance reports, support cases with logged PII, or anonymized data testing.

...
- `stats` rolls up events into metrics; results are split **by ComputerName, ClassName, DeviceID** so each row reflects one combination of those dimensions.
...
Mass record access during research projects, audit exports, billing batches, or HEDIS reporting.

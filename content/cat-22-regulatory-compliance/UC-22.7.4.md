...
- `stats` rolls up events into metrics; results are split **by userPrincipalName, authenticationRequirement, conditionalAccessStatus, appDisplayName** so each row reflects one combination of those dimensions.
...
Protect-control failures during planned exception windows, application compatibility testing, or vendor lag.

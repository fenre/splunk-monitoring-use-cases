...
- `stats` aggregates events by **senior_manager**, producing one row per unique combination for trend analysis and threshold evaluation.
...
Output fields: depts, roles, senior_manager.

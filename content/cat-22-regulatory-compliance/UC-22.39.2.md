...
- `stats` aggregates events by **incident_id regulator**, producing one row per unique combination for trend analysis and threshold evaluation.
...
Output fields: ack_tracking_id, acked, incident_id, regulator, regulator], submitted, tracking_id.

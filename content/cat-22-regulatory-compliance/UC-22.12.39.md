...
### Step 3 — Validate
Compare with the GRC system or SoD tool, match findings to the latest role matrix, and confirm ticket IDs and approval paths look correct in both systems.
...
SoD violations from scheduled role changes, contractor offboarding gaps, or planned segregation review windows.

...
- `stats` rolls up events into metrics; results are split **by ComputerName, EventCode, EventDescription** so each row reflects one combination of those dimensions.

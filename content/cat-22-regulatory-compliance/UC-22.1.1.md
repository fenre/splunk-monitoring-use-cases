...
*We look for email, phone, and SSN patterns in indexed application and web logs so controllers can prove technical measures for data minimisation and lawful processing under Arts so we can show we meet our privacy duties when people ask for proof.*

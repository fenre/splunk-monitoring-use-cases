...
- `eval` defines or adjusts **chg_hint** — applying business logic to classify, threshold, or derive compliance-relevant indicators.
...
- `eval` defines or adjusts **missing_ticket** — applying business logic to classify, threshold, or derive compliance-relevant indicators.
...
Output fields: _time, assigned_to, chg_hint, host, missing_ticket.
...
Firewall changes during scheduled change windows, controlled segmentation rollouts, or planned audits.

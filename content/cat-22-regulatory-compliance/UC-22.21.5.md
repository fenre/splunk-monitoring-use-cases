...
- `eventstats` rolls up events into metrics; results are split **by attribute, model_id** so each row reflects one combination of those dimensions.
...
Bias drift from new training data, demographic mix shifts, or controlled algorithm tuning.

...
- `eval` defines or adjusts **notice** — applying business logic to classify, threshold, or derive compliance-relevant indicators.
- Correlates data from a subsearch to enrich the primary result set with additional context.
- `eval` defines or adjusts **lag_days** — applying business logic to classify, threshold, or derive compliance-relevant indicators.
...
Output fields: lag_days, notice, notice_received_at, provider_id, reg, registered_at, subprocessor_name.

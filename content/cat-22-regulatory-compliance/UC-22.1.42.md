...
- `eval` defines or adjusts **dest_host** — applying business logic to classify, threshold, or derive compliance-relevant indicators.
...
Output fields: affected_users, dest_host, pii_hits.

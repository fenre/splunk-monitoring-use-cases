...
- `stats` rolls up events into metrics; results are split **by ComputerName, TargetUserName, LogonType, WorkstationName** so each row reflects one combination of those dimensions.

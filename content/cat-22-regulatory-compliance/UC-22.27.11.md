...
- `stats` aggregates events by **service_title**, producing one row per unique combination for trend analysis and threshold evaluation.
...
Output fields: desc, hs, missing, service_title.

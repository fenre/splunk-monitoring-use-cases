...
Setting a test host's baseline_version to a superseded value returns it in the drift table.

### Negative scenario

A host fully converged in the last 30m is absent.
...
- `eval` defines or adjusts **drift_count** — applying business logic to classify, threshold, or derive compliance-relevant indicators.
...
Output fields: baseline_version, drift_count, hostname, last_converged, resource_failed, role.

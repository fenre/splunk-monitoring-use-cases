...
- `stats` rolls up events into metrics; results are split **by uri, program_id, material_terms_version** so each row reflects one combination of those dimensions.

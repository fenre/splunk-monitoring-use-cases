...
- `eval` defines or adjusts **dormant** — often to normalize units, derive a ratio, or prepare for thresholds.
- Filters the current rows with `where dormant=1` — typically the threshold or rule expression for this monitoring goal.

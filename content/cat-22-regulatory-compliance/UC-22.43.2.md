...
- `streamstats` rolls up events into metrics; results are split **by host cve** so each row reflects one combination of those dimensions.
...
Output fields: _time, cve, host, rediscovered_at, remediated_at.

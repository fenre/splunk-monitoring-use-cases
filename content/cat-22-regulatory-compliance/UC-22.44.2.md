...
Output fields: change_id, change_id], controllers_in_scope, controllers_notified, days_since, missing, vendor.

### Step 3 — Validate
Compare with the GRC system and the third-party or vendor risk register so score changes match onboarding and review cycles.
...
Risk score shifts from new vendor onboarding, M&A integration, or scheduled risk reviews.

...
- `stats` rolls up events into metrics; results are split **by UserName, client_ip, PublishedApplication** so each row reflects one combination of those dimensions.

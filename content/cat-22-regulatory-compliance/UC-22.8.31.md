...
- `stats` rolls up events into metrics; results are split **by src dest dest_port protocol tls_version is_deprecated** so each row reflects one combination of those dimensions.

...
- `stats` rolls up events into metrics; results are split **by metric_name, branch** so each row reflects one combination of those dimensions.
...
NCA evidence during scheduled regulatory reporting, planned audits, or controlled exception periods.

...
- `stats` rolls up events into metrics; results are split **by signature, src_ip, dest_zone, sourcetype** so each row reflects one combination of those dimensions.

...
- `stats` rolls up events into metrics; results are split **by client_ip, server_name, database_principal_name** so each row reflects one combination of those dimensions.

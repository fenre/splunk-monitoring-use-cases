...
- `stats` rolls up events into metrics; results are split **by UserName, client_ip, PublishedApplication, ClientDrive, Clipboard** so each row reflects one combination of those dimensions.

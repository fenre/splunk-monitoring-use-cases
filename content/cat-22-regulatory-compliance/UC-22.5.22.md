...
- `stats` rolls up events into metrics; results are split **by client_segment, instrument_class, symbol** so each row reflects one combination of those dimensions.

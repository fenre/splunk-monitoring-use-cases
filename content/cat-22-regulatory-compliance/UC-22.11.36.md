...
- `eval` defines or adjusts **review_ok** — applying business logic to classify, threshold, or derive compliance-relevant indicators.
...
Output fields: _time, labels, repo, review_count, review_ok, url, user.

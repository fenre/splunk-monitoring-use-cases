...
- `stats` aggregates events by **scenario_id, ibs**, producing one row per unique combination for trend analysis and threshold evaluation.
...
Output fields: ibs, res, scenario_id, t.

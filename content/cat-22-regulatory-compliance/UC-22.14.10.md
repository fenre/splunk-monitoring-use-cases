...
### Step 3 — Validate
Compare the results with the same setting in the Splunk Admin UI, then export the list for the assessor if they ask for screen evidence. Spot-check a few source events, reconcile counts, and verify field extractions, thresholds, and index permissions for the people who need this evidence.

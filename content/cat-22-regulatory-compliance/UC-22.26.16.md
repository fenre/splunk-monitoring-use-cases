...
- `eval` defines or adjusts **confirmed** — applying business logic to classify, threshold, or derive compliance-relevant indicators.
...
- `eval` defines or adjusts **breach_sla** — applying business logic to classify, threshold, or derive compliance-relevant indicators.
...
Output fields: breach_id, breach_sla, confirmed, confirmed_at, datatilsynet_filed_at, filed, hours.
...
DSA reporting during scheduled control reviews, planned exception cycles, or after major regulatory changes.

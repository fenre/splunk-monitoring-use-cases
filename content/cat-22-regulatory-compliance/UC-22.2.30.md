...
• `eval` defines or adjusts **training_age** — applying business logic to classify, threshold, or derive compliance-relevant indicators.
...
Output fields: last_training, role_name, training_age, user_id.

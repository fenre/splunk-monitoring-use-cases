...
- `stats` rolls up events into metrics; results are split **by ict_service cvss cve hostname registration_sla_met** so each row reflects one combination of those dimensions.

...
- `stats` aggregates events by **outsource_id**, producing one row per unique combination for trend analysis and threshold evaluation.
...
Output fields: exit_ok, outsource_id, t, vendor.

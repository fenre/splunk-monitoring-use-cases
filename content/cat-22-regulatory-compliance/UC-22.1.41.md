...
- `stats` aggregates events by **dest_host**, producing one row per unique combination for trend analysis and threshold evaluation.
...
Output fields: approval_status, dest_host, upload_bytes, users.

...
- `stats` aggregates events by **system tier test_id**, producing one row per unique combination for trend analysis and threshold evaluation.
...
Output fields: rpo_s, rpo_slo, rto_s, rto_slo, system, test_id, tier.

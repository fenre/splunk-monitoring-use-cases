...
- `eval` defines or adjusts **uploaded** — applying business logic to classify, threshold, or derive compliance-relevant indicators.
...
Output fields: age_days, breach, period_end, provider_id, report_type, tier, uploaded.

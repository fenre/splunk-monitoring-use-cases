...
- `stats` aggregates events by **scope_id**, producing one row per unique combination for trend analysis and threshold evaluation.
...
Output fields: ex, ex_epoch, lvl, scope_id.

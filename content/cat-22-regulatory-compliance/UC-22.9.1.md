...
- `eval` defines or adjusts **fw** — applying business logic to classify, threshold, or derive compliance-relevant indicators.
...
Output fields: _time, avg_score, fw, portfolio_score.

...
- `stats` rolls up events into metrics; results are split **by client_app, client_ip, historian_cluster** so each row reflects one combination of those dimensions.

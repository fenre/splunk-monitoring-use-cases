...
- `stats` rolls up events into metrics; results are split **by session_server_principal_name, object_name, application_name** so each row reflects one combination of those dimensions.

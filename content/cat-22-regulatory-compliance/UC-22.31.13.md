...
- `stats` rolls up events into metrics; results are split **by user, Object_Name** so each row reflects one combination of those dimensions.
...
CPS 234 evidence during scheduled board reviews, planned audits, or controlled exception cycles.

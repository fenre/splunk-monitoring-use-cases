...
- `stats` rolls up events into metrics; results are split **by TargetUserName, vendor_name, WorkstationName, IpAddress** so each row reflects one combination of those dimensions.

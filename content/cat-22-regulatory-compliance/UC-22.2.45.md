...
• `stats` rolls up events into metrics; results are split **by csirt_id delivery_status template_version required_template_version** so each row reflects one combination of those dimensions.

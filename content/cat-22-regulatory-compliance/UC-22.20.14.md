...
- Filters the current rows with `where match(Process,"(?i)procdump|mimikatz") AND cui_host="true"` — typically the threshold or rule expression for this monitoring goal.

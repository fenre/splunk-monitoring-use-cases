...
- Filters the current rows with `where match(short_description,"(?i)US-CERT|CISA") AND isnull(resolved_at)` — typically the threshold or rule expression for this monitoring goal.

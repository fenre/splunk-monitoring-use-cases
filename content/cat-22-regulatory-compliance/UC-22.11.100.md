...
Forcing a 2-second offset via NTP test fires the UC within 15m.

### Negative scenario

A host with <100ms offset is absent.
...
Output fields: hostname, last_ntp_sync, offset_ms, stratum.

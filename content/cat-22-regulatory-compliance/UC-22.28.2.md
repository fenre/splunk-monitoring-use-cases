...
- `stats` aggregates events by **sector, site**, producing one row per unique combination for trend analysis and threshold evaluation.
...
Output fields: cnt, registered_count, sector, site.

...
• `eval` defines or adjusts **pi_ok** — often to normalize units, derive a ratio, or prepare for thresholds.
...
• Pipeline stage (see **Emergency change retrospective documentation completeness (SOX ITGC)**): table number, u_service_ci, start_date, state, short_description

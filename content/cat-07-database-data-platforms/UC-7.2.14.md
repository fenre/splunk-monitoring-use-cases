<!-- AUTO-GENERATED from UC-7.2.14.json — DO NOT EDIT -->
...
*We watch Cassandra Compaction Backlog and Throughput so we can keep this part of the data platform within the capacity and quality targets our teams expect.*

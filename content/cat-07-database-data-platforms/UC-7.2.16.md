...
*Read/write throttle events mean application retries and latency spikes We use it to stay ahead of pain for applications and the people who depend on the data.*

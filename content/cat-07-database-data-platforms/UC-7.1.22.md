...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Fault, Capacity

*We monitor WAL and transaction log growth so replication and recovery do not stall when logs or archive destinations fill the disk.*
...
Lag spikes during large transactions, schema changes, or network maintenance to standby; align with RPO and change windows.

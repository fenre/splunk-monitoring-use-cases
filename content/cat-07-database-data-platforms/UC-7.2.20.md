<!-- AUTO-GENERATED from UC-7.2.20.json — DO NOT EDIT -->
...
*We follow buffer and cache hit rates so we can see when memory is too small for the working set and query latency starts to depend on disk more than it should.*

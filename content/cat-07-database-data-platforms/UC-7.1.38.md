...
*Compares current average CPU/duration from Query Store or AWR to baselines by / We use it to stay ahead of pain for applications and the people who depend on the data.*

...
> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Data Quality, Availability &middot; **Status:** Draft

*We watch ClickHouse Dictionary Reload and Source Failures so we can keep this part of the data platform within the capacity and quality targets our teams expect.*

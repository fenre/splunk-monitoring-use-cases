...
> **Criticality:** High &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Cost, Performance &middot; **Status:** Draft

*We watch Snowflake Credit Consumption Trending by Warehouse so we can keep this part of the data platform within the capacity and quality targets our teams expect.*

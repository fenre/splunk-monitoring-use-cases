<!-- AUTO-GENERATED from UC-7.2.17.json — DO NOT EDIT -->
...
• `stats` rolls up events into metrics; results are split **by database_name, source, target** so each row reflects one combination of those dimensions.

<!-- AUTO-GENERATED from UC-7.1.2.json — DO NOT EDIT -->
...
*We count deadlocks and contention in our databases so we can tune hot paths and application order before they turn into long outages of customer-facing work.*
...
Transient deadlocks during high-concurrency batch processing are common in OLTP; tune when frequency or total wait time clearly exceeds the baseline, not on one-off events.

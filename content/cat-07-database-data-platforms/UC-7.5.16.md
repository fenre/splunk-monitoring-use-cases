<!-- AUTO-GENERATED from UC-7.5.16.json — DO NOT EDIT -->

---
id: "7.5.16"
title: "Elasticsearch Cross-Cluster Replication Lag"
...
> **Criticality:** Critical &middot; **Difficulty:** Advanced &middot; **Pillar:** Observability &middot; **Type:** Performance, Availability
...
CCR follower lag directly impacts disaster recovery readiness. Excessive lag means a failover would lose recent data. Monitoring ensures replication SLAs are met.
...
Line chart (lag per follower index), Table (follower status), Single value (max lag across all followers).

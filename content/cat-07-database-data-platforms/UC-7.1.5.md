<!-- AUTO-GENERATED from UC-7.1.5.json — DO NOT EDIT -->
...
*We trend space use on our data files and tablespaces so we can add capacity or archive data before a database runs out of room during peak load.*

...
*We watch Snowflake Query Queuing Time from Query History so we can keep this part of the data platform within the capacity and quality targets our teams expect.*

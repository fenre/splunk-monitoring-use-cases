<!-- AUTO-GENERATED from UC-7.4.6.json — DO NOT EDIT -->
...
> **Criticality:** Critical &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Availability, Fault

*We follow search cluster health, indexing, and query latency so we can keep log and search services responsive when load or mapping changes.*
...
Planned index rollovers, rebalancing, and cluster restarts can move shard counts and health states briefly; correlate with Elasticsearch or OpenSearch change records.

...
*We track replication lag on standbys and replicas so we know when reads or failover could fall behind our recovery expectations before an outage or SLA miss.*
...
Lag spikes during large transactions, schema changes, or network maintenance to standby; align thresholds with RPO and published change windows.

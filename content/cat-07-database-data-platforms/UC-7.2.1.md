...
*We watch replica set and cluster membership events so we can spot unplanned node changes or elections before they become availability or data-safety issues.*
...
Intentional node adds, removals, or elections during scaling, cloud zone work, or rolling upgrades can match the rule; correlate with the change and deployment calendar.

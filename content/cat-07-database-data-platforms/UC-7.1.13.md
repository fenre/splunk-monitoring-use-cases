...
> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Security &middot; **Type:** Configuration
...
Planned release DDL, CI/CD deploys, and data-migration projects emit schema changes during approved windows; require a change ticket or pipeline ID before treating a match as abuse.

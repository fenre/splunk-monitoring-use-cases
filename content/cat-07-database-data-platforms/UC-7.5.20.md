<!-- AUTO-GENERATED from UC-7.5.20.json — DO NOT EDIT -->
...
*Core-level errors (recovery failures, corrupt data flags, leader election issues) degrade search for specific collections; admin health checks catch -core problems early We use it to stay ahead of pain for applications and the people who depend on the data.*
...
- `stats` rolls up events into metrics; results are split **by core, collection, node_name** so each row reflects one combination of those dimensions.

...
> **Criticality:** High &middot; **Difficulty:** Advanced &middot; **Pillar:** Security &middot; **Type:** Audit, Governance &middot; **Status:** Draft

*We watch Snowflake Data Sharing and Secure View Access Audit so we can keep this part of the data platform within the capacity and quality targets our teams expect.*

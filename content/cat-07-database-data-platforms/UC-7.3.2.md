<!-- AUTO-GENERATED from UC-7.3.2.json — DO NOT EDIT -->
...
*Managed database failovers cause brief outages We use it to stay ahead of pain for applications and the people who depend on the data.*

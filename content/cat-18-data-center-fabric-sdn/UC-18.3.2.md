...
• `stats` rolls up events into metrics; results are split **by action, resource_type, user, project_name** so each row reflects one combination of those dimensions.

...
• `stats` rolls up events into metrics; results are split **by src_epg, dst_epg, contract_name, filter_name** so each row reflects one combination of those dimensions.

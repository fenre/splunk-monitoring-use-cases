...
*We spot when our main ISP or transit path is sliding on scorecards, so we can escalate before the whole site feels it.*
...
ISP scorecards move with planned peering work, DDoS scrubbing, or when tests share congested last-mile access.

...
*We make sure the pipeline from the vendor into Splunk is still flowing, so a silent gap does not look like a clean bill of health.*
...
Ingestion gaps can be clock skew, search-time macro mistakes, or indexer maintenance—not always ThousandEyes.

...
*We watch how much packet delay wiggles, because uneven delay hurts voice and video even when the average looks okay.*
...
Jitter can rise on Wi‑Fi, shared last-mile links, or during local congestion even when mean latency looks fine.

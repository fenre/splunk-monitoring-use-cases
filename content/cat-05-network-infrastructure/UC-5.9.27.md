...
*We see how people connect and how healthy that path is, so wired versus Wi‑Fi issues show up in plain language.*
...
Connection type and client network score can flag captive portals or policy gaps that are user-local, not data-center.

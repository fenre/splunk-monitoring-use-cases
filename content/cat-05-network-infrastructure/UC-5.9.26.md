...
*We watch the VPN path itself, so slow tunnels and hairpins do not get mistaken for a random internet problem.*
...
VPN path metrics track concentrator load, client versions, and split vs full tunnel more than the raw internet.

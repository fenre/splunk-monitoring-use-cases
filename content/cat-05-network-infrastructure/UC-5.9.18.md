...
*We match broad internet test failures with our own signals, so we can tell a real outage from a test glitch faster.*
...
Synthetic “outage” events can track third-party or far-edge networks your users never touch for that app.

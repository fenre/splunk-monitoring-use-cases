...
*We open up traces and spans, so a slow end-to-end story breaks into steps you can actually fix.*
...
Trace volume reflects enabled tests and client sampling; spikes often follow new deployments, not new faults.

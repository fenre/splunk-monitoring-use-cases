...
*We map how we reach big cloud services, so a reroute or detour in the provider is visible, not just “cloud is slow.”*
...
Cloud path visualization changes on provider reroutes; cross-region and cross-tenant paths are not identical.

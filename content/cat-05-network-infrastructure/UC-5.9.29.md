...
*We put overlay and underlay side by side, so we can tell if the problem is the SD-WAN fabric or the raw links under it.*
...
Overlay and underlay differ by design; policy routing and backhaul can look “worse” while apps stay on SLA.

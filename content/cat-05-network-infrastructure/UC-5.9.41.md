...
*We track how often scripted business flows complete, so a broken checkout or login is not a surprise in production.*
...
Transaction completion tracks scripted steps; one selector change in the app can false-fail a whole script.

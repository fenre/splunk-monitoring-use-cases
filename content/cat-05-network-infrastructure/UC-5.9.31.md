...
*We line up more than one cloud and carrier path, so we are not stuck arguing about one provider’s good day.*
...
Multi-cloud path tests can reflect provider-local routing and test placement, not your whole user base.

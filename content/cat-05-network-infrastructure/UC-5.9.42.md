...
*We time each step in a flow, so we can tell which hop in a chain is dragging without opening ten dashboards.*
...
Transaction duration stretches when third parties add pixels, consent banners, or when backends scale cold.

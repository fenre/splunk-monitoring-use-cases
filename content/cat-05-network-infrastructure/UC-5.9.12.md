...
*We see whether a prefix is reachable from different parts of the world, so a regional break does not take us by surprise.*
...
Prefix reachability varies by region when tests or targets sit in different clouds or anycast fronts.

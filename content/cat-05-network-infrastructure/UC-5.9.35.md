...
*We follow how long pages take to answer at the web layer, so a creeping slowdown is a chart, not a gut feeling.*
...
Response time can rise from third-party scripts, A/B tests, and CDN experiment buckets—not your origin alone.

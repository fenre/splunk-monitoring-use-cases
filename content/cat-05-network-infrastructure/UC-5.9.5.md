...
*We count how many hops our traffic takes, because a sudden change can mean the carrier took a different path.*
...
Hop count changes when carriers reroute or when tests briefly use cold paths; not every hop change hurts users.

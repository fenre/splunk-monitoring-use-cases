...
*We look at how much data those tests can pull, so a thin pipe or throttled path shows up before bulk transfers fail.*
...
Throughput is sensitive to test agent placement, time-of-day, and throttling; compare like-for-like runs.

...
*We watch when the path between two points flips, so we can tell a reroute that hurt performance from a small blip.*
...
Paths shift during normal ISP and cloud reroutes; some changes add hops without hurting latency or loss.

...
*We watch how long DNS answers take, so a creeping slowdown is obvious before the help desk does trial and error.*
...
Resolution time trends shift with cache warmth, geo anycast, and resolver load—not only your authoritative DNS.

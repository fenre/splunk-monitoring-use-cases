...
*We watch the software agents that run the tests, so a dead laptop or bad upgrade does not masquerade as a network blackout.*
...
Local agent alarms fire during host reboots, software upgrades, and laptop sleep—not always user outages.

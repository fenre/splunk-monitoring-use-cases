...
*We catch DNS test errors in one place, so a resolver or name-server hiccup is not hiding in a dozen tools.*
...
DNS error bursts may reflect one resolver path or a test artifact; confirm in the live DNS and web UIs.

...
> **Criticality:** Medium &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Availability, Performance

*We test old-fashioned file transfer paths, so batch jobs that still ride FTP are not flying blind.*
...
FTP numbers swing with passive port ranges, large file choices, and transfer mode; confirm test realism.

...
*We blend loss, delay, and jitter into one score for key links, so we get a simple read on whether the WAN feels good.*
...
Composite WAN scores move with scheduled tests, agent updates, or weighted thresholds that do not match every site.

...
> **Criticality:** High &middot; **Difficulty:** Beginner &middot; **Pillar:** Observability &middot; **Type:** Anomaly

*We follow how often our BGP paths change, so sudden churn stands out and we can check if something fishy is going on.*
...
Path change counts spike during ISP hot-potato changes and cloud scaling; not every change is a hijack or outage.

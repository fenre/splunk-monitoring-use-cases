...
*We see how often full page loads finish, so half-loaded sites and third-party blocks are not invisible.*
...
Completion rate dips during CDN cutovers, WAF false positives, or new certificate chains browsers accept slowly.

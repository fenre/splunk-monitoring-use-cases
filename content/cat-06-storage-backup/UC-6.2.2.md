...
*We notice when object storage is used in unusual ways so you can spot stolen credentials, misconfigured apps, or abuse before large data leaves the bucket.*
...
Legitimate bulk operations, month-end reporting, or new application releases can change access patterns; compare to change windows and owner notifications.

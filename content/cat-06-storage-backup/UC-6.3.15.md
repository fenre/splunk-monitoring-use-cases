<!-- AUTO-GENERATED from UC-6.3.15.json — DO NOT EDIT -->
...
• `stats` rolls up events into metrics; results are split **by system_name, scenario** so each row reflects one combination of those dimensions.

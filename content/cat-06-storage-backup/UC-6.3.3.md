<!-- AUTO-GENERATED from UC-6.3.3.json — DO NOT EDIT -->
...
Failures during DR test runs, application quiesce timeouts, or VSS provider issues can occur; confirm in the backup console whether a retry succeeded.

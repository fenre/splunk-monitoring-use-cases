...
*We check that objects move through the right storage classes on schedule so old data does not sit in expensive tiers or miss deletion when policy says it should.*

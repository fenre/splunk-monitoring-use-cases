...
Long-running backups during initial fulls, large database backups, or after data growth events can exceed the window without indicating a broken schedule.

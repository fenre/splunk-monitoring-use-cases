...
> **Criticality:** High &middot; **Difficulty:** Intermediate &middot; **Pillar:** Observability &middot; **Type:** Capacity, Availability &middot; **Status:** Draft
...
Slot counts change during vaulting, import/export jobs, or library reconfiguration; compare to the operator console before treating as data loss.

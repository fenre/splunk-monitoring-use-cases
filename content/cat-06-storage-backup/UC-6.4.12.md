...
Lag spikes during initial baseline sync, large data transfers, or scheduled resync windows. A short red window during an approved change is normal if the relationship returns to healthy afterward.

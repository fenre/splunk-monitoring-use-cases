<!-- AUTO-GENERATED from UC-6.4.14.json — DO NOT EDIT -->
...
• `stats` rolls up events into metrics; results are split **by Share_Name, Account_Name, ComputerName** so each row reflects one combination of those dimensions.

...
A curated, machine-readable, versioned catalog of **16,600+ IT infrastructure
monitoring use cases** for Splunk, organized across 25 technology domains.
...
| **Per-doc citation mappings** | [`data/source-mappings.json`](data/source-mappings.json) — explicit Primary / Supporting / Related source IDs for documented topics; `_topic_keywords` heuristics fill guides without explicit entries. |

...
# scripts/audit_mitre_taxonomy.py to src/splunk_uc/audits/mitre_taxonomy.py.
...
def audit_uc_json(path: str, data: dict[str, Any]) -> list[Finding]:
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(description="Audit mitreAttack arrays in content/cat-*/UC-*.json")

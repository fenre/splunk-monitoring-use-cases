...
WELL_KNOWN_SOURCETYPES: set[str] = {
    ...
    "zettel:note",
    "zigbee2mqtt:bridge",
    # Industry verticals (cat-21) — docs/guides/industry-verticals.md canonical sourcetypes
    "scada:alarm",
    "scada:event",
    "scada:hmi",
    "scada:tag",
    ...
    "finance:custody",
    "finance:wealth",
    "finance:premium_finance",
    "finance:acquiring",
    "finance:gateway",
    "finance:open_banking",
    "finance:bnpl",
    "finance:remittance",
    "finance:trade_finance",
    "finance:corp_bank",
    "finance:private_bank",
    "finance:mortgage",
    "finance:auto_loan",
    ...
    "finance:repo",
    "finance:derivatives",
    "finance:prime_broker",
    "finance:market_making",
    "finance:dark_pool",
    "finance:reg_report",
    "finance:sanctions",
    "finance:kyc",
...
WELL_KNOWN_INDEXES: set[str] = {
    ...
    "summary",
    # Industry verticals (cat-21) custom indexes
    "scada",
    "energy",
    "mfg",
    "healthcare",

...
Splunkbase<sup class="ref">[<a href="#ref-2">2</a>]</sup> TA / ITSI / ES content packs, or calling the JSON API. Users have
...
<a id="ref-3"></a>**[3]** github.com. *GitHub: fenre/splunk-monitoring-use-cases*. Retrieved May 11, 2026, from https://github.com/fenre/splunk-monitoring-use-cases/blob/main/GOVERNANCE.md

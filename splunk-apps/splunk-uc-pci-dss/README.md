...
This app packages **147 use cases** from the upstream catalogue that cite Payment Card Industry Data Security Standard (`pci-dss`), together with the macros, eventtypes, tags, and lookup needed to operate them.  Every saved search is shipped **disabled by default** so an operator can review the SPL and tune indexes before enabling.

* Regulation tier: **1**
* Jurisdictions: GLOBAL
* Versions covered: v3.2.1, v4.0
* UCs by criticality: critical = 48, high = 74, medium = 25
...
| UC-5.13.28 | Device Compliance Status Overview | high | 1.1.1 |
| UC-5.13.29 | Non-Compliant Device Alerting | critical | 1.1.1 |
| UC-5.13.30 | Compliance Status Trending | high | 1.1.1 |
| UC-5.13.31 | Compliance by Rule/Policy Category | medium | 1.1.1 |
| UC-5.13.33 | Compliance Violation Detail Drill-Down | high | 1.1.1 |
| UC-5.13.35 | Critical/High PSIRT Alerting | critical | 6.3.1 |
| UC-5.13.61 | Rogue AP and aWIPS Alert Monitoring | critical | 11.2.1 |

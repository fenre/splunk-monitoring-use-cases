...
This app packages **162 use cases** from the upstream catalogue that cite NIST SP 800-53 Rev. 5 (`nist-800-53`), together with the macros, eventtypes, tags, and lookup needed to operate them.  Every saved search is shipped **disabled by default** so an operator can review the SPL and tune indexes before enabling.

* Regulation tier: **1**
* Jurisdictions: US
* Versions covered: Rev. 5
* UCs by criticality: critical = 52, high = 91, medium = 19
...
|----|-------|-------------|---------|
| UC-5.13.28 | Device Compliance Status Overview | high | CM-6 |
| UC-5.13.29 | Non-Compliant Device Alerting | critical | CM-6 |
| UC-5.13.30 | Compliance Status Trending | high | CM-6 |
| UC-5.13.31 | Compliance by Rule/Policy Category | medium | CM-6 |
| UC-5.13.32 | Compliance Drift Detection (Was Compliant, Now Not) | high | CM-3 |
| UC-5.13.33 | Compliance Violation Detail Drill-Down | high | CM-6 |
| UC-5.13.34 | Security Advisory (PSIRT) Overview | critical | RA-5, SI-2 |
| UC-5.13.35 | Critical/High PSIRT Alerting | critical | RA-5, SI-2 |
| UC-5.13.36 | Advisory Trending and New Advisory Detection | high | RA-5, SI-2 |
| UC-5.13.37 | Devices Affected by Active Advisories | critical | RA-5, SI-2 |
| UC-5.13.38 | Advisory Remediation Progress Tracking | high | RA-5, SI-2 |
| UC-5.13.39 | Advisory Severity Distribution and Risk Scoring | high | RA-5, SI-2 |
| UC-5.13.45 | Audit Log Activity Overview | high | AU-2 |
| UC-5.13.46 | Configuration Change Audit Trail | high | CM-3 |
| UC-5.13.47 | Privileged User Activity Monitoring | high | AC-6, AU-2 |
| UC-5.13.48 | Failed API/Login Attempt Detection | critical | AC-7 |
| UC-5.13.49 | After-Hours Administrative Activity | high | AC-2 |
| UC-5.13.50 | Audit Log Completeness and Gap Detection | high | AU-3, AU-6 |
| UC-5.13.56 | Firmware Non-Compliance Detection (Running vs Golden Image) | critical | CM-2, SI-2 |
| UC-5.13.57 | Image Distribution and Upgrade Progress Tracking | high | CM-2, SI-2 |
| UC-5.13.58 | SWIM Upgrade Failure Alerting | critical | IR-4, SI-2 |
| UC-5.13.59 | End-of-Life / End-of-Support Software Detection | high | SA-22 |
| UC-5.13.61 | Rogue AP and aWIPS Alert Monitoring | critical | AC-18 |

...
This app packages **110 use cases** from the upstream catalogue that cite ISO/IEC 27001 — ISMS (`iso-27001`), together with the macros, eventtypes, tags, and lookup needed to operate them.  Every saved search is shipped **disabled by default** so an operator can review the SPL and tune indexes before enabling.

* Regulation tier: **1**
* Jurisdictions: GLOBAL
* Versions covered: 2013, 2022
* UCs by criticality: critical = 16, high = 61, medium = 33
...
|----|-------|-------------|---------|
| UC-5.13.38 | Advisory Remediation Progress Tracking | high | A.8.8 |

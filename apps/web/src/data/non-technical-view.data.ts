...
export const NON_TECHNICAL: NonTechnicalCatalog = {
  ...
  "24": {
    ...
    areas: [
      { name: "Reports & dashboards", description: "We watch your business-intelligence tools like Tableau and Power BI — so broken refreshes, slow dashboards, and unused reports are visible before anyone complains.", ucs: [

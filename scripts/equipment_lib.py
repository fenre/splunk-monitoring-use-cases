...
EQUIPMENT_ALIASES: Dict[str, str] = {
    ...
    "splunk_stream": "stream",
    "5g": "fiveg",
    "cisco-cybervision": "cisco",
    "cisco-cyber-vision": "cisco",
    "cisco_cyber_vision": "cisco",
    "cisco_ise": "cisco",
    "nozomi-networks": "nozomi",
    "nozomi_networks": "nozomi",
    "nozomi-guardian": "nozomi",
    ...
    "linux_server": "linux",
    "openshift_container_platform": "openshift",
    "openshift_cluster": "openshift",
    "nexus": "cisco",
    "apic": "cisco",
    "meraki": "cisco",
    "thousandeyes": "cisco",
    "fluentd": "log_pipeline",
    "fluentbit": "log_pipeline",
    "fluent-bit": "log_pipeline",
    "isilon": "dell_emc",
    "emc_isilon": "dell_emc",
    "corelight": "zeek",
    "garland": "zeek",
